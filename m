...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 08BDD356136
	for <lists+linux-scsi@lfdr.de>; Wed,  7 Apr 2021 04:04:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243543AbhDGCEg (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 6 Apr 2021 22:04:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53964 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229720AbhDGCEf (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Tue, 6 Apr 2021 22:04:35 -0400
Received: from mail-pf1-x441.google.com (mail-pf1-x441.google.com [IPv6:2607:f8b0:4864:20::441])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 78344C06174A
        for <linux-scsi@vger.kernel.org>; Tue,  6 Apr 2021 19:04:26 -0700 (PDT)
Received: by mail-pf1-x441.google.com with SMTP id s11so11794172pfm.1
        for <linux-scsi@vger.kernel.org>; Tue, 06 Apr 2021 19:04:26 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=5MSvEUO7nC56AVBjm0gRmzFqU9kyqlEhera85VH2kPY=;
        b=dz1ysipraDR/nuYjjhzkjXuUTy8KHDEkqd44vsM+jxef94N0daHCydwwGqSPo3n9If
         eeDD5kxFuHjRLEyqnFtcGwlnnpwVAqcdAa+62YK2FNzYzKeq7TGGixX2Wnfl5f7xpeF3
         SpEgEa8/oN8nSPBktdevuPHJ6vc5eLaTsOsRA=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=5MSvEUO7nC56AVBjm0gRmzFqU9kyqlEhera85VH2kPY=;
        b=
X-Gm-Message-State: AOAM5305pbLBWoNEeAQBfaua//0pvKLTwhjcigtnQbZQ1ysVVqJDWEUi
        fwOwuiok/i7Rd6D0L2wH5N1QXzrmzsIZ+omrXoBwAFe49d2WMDU7/le+y/gvbk6+S779XtpTzKw
        ObpCNNZxVH4fu8TxN/KottMI+fI3SCH08jf58MH5GltzNMccLqn/8uv+SC4vICGApAbaWdkrotA
        071vfIpQ==
X-Google-Smtp-Source: ABdhPJwcgE6aX+aX3oRUd6vmk6RNu7xh51n7mQMrqRc0ui6e4Gl596TML/O68YLSbcJa+kgpuIdrjQ==
X-Received: by 2002:a65:5289:: with SMTP id y9mr992514pgp.447.1617761064991;
        Tue, 06 Apr 2021 19:04:24 -0700 (PDT)
Received: from drv-bst-rhel8.dhcp.broadcom.net ([192.19.234.250])
        by smtp.gmail.com with ESMTPSA id y9sm3435858pja.50.2021.04.06.19.04.23
...
Subject: [PATCH v2 04/24] mpi3mr: add support of queue command processing
Date:   Wed,  7 Apr 2021 07:34:31 +0530
Message-Id: <20210407020451.924822-5-kashyap.desai@broadcom.com>
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
        boundary="000000000000a78e0605bf585939"
Precedence: bulk
List-ID: <linux-scsi.vger.kernel.org>
X-Mailing-List: linux-scsi@vger.kernel.org

--000000000000a78e0605bf585939
...
index 203b3d861ffa..a87a3edde2e7 100644
...
+
 ...
 {
 	u16 i, max_vectors;
@@ -282,6 +299,85 @@ static int mpi3mr_process_admin_reply_q(struct mpi3mr_ioc *mrioc)
...
@@ -1314,6 +1410,74 @@ static int mpi3mr_create_op_queues(struct mpi3mr_ioc *mrioc)
 	return retval;
 }
...
@@ -1901,6 +2065,91 @@ static int mpi3mr_alloc_chain_bufs(struct mpi3mr_ioc *mrioc)
 	return retval;
 }
...

--000000000000a78e0605bf585939--
