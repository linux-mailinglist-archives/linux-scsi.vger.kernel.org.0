...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 603CB28EAE1
	for <lists+linux-scsi@lfdr.de>; Thu, 15 Oct 2020 04:07:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732572AbgJOCHr (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 14 Oct 2020 22:07:47 -0400
Received: from smtp.infotech.no ([82.134.31.41]:40279 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1732562AbgJOCHj (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Wed, 14 Oct 2020 22:07:39 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 0A827204275;
        Thu, 15 Oct 2020 04:07:33 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 6Y2TC9GmgqTn; Thu, 15 Oct 2020 04:07:30 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-104-157-204-209.dyn.295.ca [104.157.204.209])
        by smtp.infotech.no (Postfix) with ESMTPA id 45672204248;
        Thu, 15 Oct 2020 04:07:24 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v11 35/44] sg: first debugfs support
Date:   Wed, 14 Oct 2020 22:06:34 -0400
Message-Id: <20201015020643.432908-36-dgilbert@interlog.com>
...
index af9cb2a9702d..249d56cb08c7 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -3287,7 +3272,7 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
...
@@ -3726,17 +3711,6 @@ sg_remove_sfp(struct kref *kref)
...
@@ -3766,7 +3740,7 @@ sg_get_dev(int dev)
 	return sdp;
 }
...
+#if IS_ENABLED(SG_PROC_OR_DEBUG_FS)
 ...
 {
@@ -3795,7 +3769,35 @@ sg_rq_st_str(enum sg_rq_state rq_st, bool long_str)
 }
 #endif
...
+}
 ...
 static int
 sg_last_dev(void)
@@ -3809,6 +3811,41 @@ sg_last_dev(void)
 	return k + 1;		/* origin 1 */
 }
...
+
 ...
 {
@@ -3822,7 +3859,7 @@ sg_proc_single_open_adio(struct inode *inode, struct file *filp)
...
+static ssize_t
 ...
 {
@@ -3844,7 +3881,7 @@ sg_proc_single_open_dressz(struct inode *inode, struct file *filp)
...
+static ssize_t
 sg_proc_write_dressz(struct file *filp, const char __user *buffer,
 		     size_t count, loff_t *off)
 {
@@ -3879,43 +3916,6 @@ sg_proc_seq_show_devhdr(struct seq_file *s, void *v)
 	return 0;
 }
...
-
 ...
 {
@@ -3962,6 +3962,10 @@ sg_proc_seq_show_devstrs(struct seq_file *s, void *v)
 	return 0;
 }
...
@@ -4104,18 +4108,20 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	bool found = false;
 	bool trunc = false;
...
@@ -4127,8 +4133,31 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	}
...
@@ -4168,6 +4197,10 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	return 0;
 }
...
+
 static const struct proc_ops adio_proc_ops = {
 	...
 	.proc_read      = seq_read,
@@ -4226,7 +4259,226 @@ sg_proc_init(void)
