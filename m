...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5761C2CF735
	for <lists+linux-scsi@lfdr.de>; Sat,  5 Dec 2020 00:02:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726467AbgLDXC1 (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Fri, 4 Dec 2020 18:02:27 -0500
Received: from esa4.microchip.iphmx.com ([68.232.154.123]:48973 "EHLO
        esa4.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726296AbgLDXC0 (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Fri, 4 Dec 2020 18:02:26 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1607122946; x=1638658946;
  h=subject:from:to:cc:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=8dwWX2L3/9VmL7PtVYB/NWgSO4aRCl/LgYNKCJetvLM=;
  b=NqvZXGQk4LGp638orlddmJJ1bXpjDgq1o6irRn+iKlv9jWuwHHNTf9xm
   +t4AZj3F3nXDG0iCUqxpmF3y5BlDmuEAmCdVn8iWQ4H1PW1HukV9rq1KM
   RVsxGj/9q+WPxrS1g13vJBYF37ojehb7ljT+LrFX8hypaXLerCESMajEZ
   HaUSUTS1lAZesH2XTs4KAXELqdls45j/ZuGGZwjRzXLeQFjP5BBiFZQEm
   CFcUXeYI+WHSCi7H64iz91MDaJDVL5U7Qh6q0w8JvGDQ/O9/ez1ckY7QG
   mo5WxFtcFXon3FpRH2eYiTUMWoZMFpX4/GfxGaV+LjFqHBPKeh+Q6BAVQ
   g==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.78,393,1599548400"; 
   d="scan'208";a="95934564"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa4.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 04 Dec 2020 16:01:20 -0700
Received: from chn-vm-ex03.mchp-main.com (10.10.85.151) by
 chn-vm-ex03.mchp-main.com (10.10.85.151) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1979.3; Fri, 4 Dec 2020 16:01:20 -0700
Received: from [127.0.1.1] (10.10.115.15) by chn-vm-ex03.mchp-main.com
 (10.10.85.151) with Microsoft SMTP Server id 15.1.1979.3 via Frontend
 Transport; Fri, 4 Dec 2020 16:01:19 -0700
Subject: [PATCH 05/25] smartpqi: add support for raid1 writes
...
Date:   Fri, 4 Dec 2020 17:01:19 -0600
Message-ID: <160712287970.21372.16965959498935407325.stgit@brunhilda>
...
index 555d821e72ce..2bceea7b8dc7 100644
...
@@ -2364,64 +2367,6 @@ static int pci_get_aio_common_raid_map_values(struct pqi_ctrl_info *ctrl_info,
 	return 0;
 }
...
-
 ...
 {
@@ -2508,12 +2453,34 @@ static void pqi_set_aio_cdb(struct pqi_scsi_dev_raid_map_data *rmd)
 	}
 }
...
@@ -2536,13 +2503,18 @@ static int pqi_raid_bypass_submit_scsi_cmd(struct pqi_ctrl_info *ctrl_info,
 	if (rc)
...
@@ -2586,6 +2558,10 @@ static int pqi_raid_bypass_submit_scsi_cmd(struct pqi_ctrl_info *ctrl_info,
...
@@ -4913,6 +4889,44 @@ static int pqi_build_raid_sg_list(struct pqi_ctrl_info *ctrl_info,
 	return 0;
 }
...
+
 static int pqi_build_aio_r56_sg_list(struct pqi_ctrl_info *ctrl_info,
 	...
 	struct pqi_io_request *io_request)
@@ -5355,6 +5369,83 @@ static int pqi_aio_submit_io(struct pqi_ctrl_info *ctrl_info,
 	return 0;
 }
