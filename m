...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5480F7CA7D7
	for <lists+linux-scsi@lfdr.de>; Mon, 16 Oct 2023 14:16:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233637AbjJPMQR (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Mon, 16 Oct 2023 08:16:17 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58558 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233326AbjJPMP5 (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Mon, 16 Oct 2023 08:15:57 -0400
Received: from smtp-out2.suse.de (smtp-out2.suse.de [IPv6:2001:67c:2178:6::1d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4B73E107
        for <linux-scsi@vger.kernel.org>; Mon, 16 Oct 2023 05:15:51 -0700 (PDT)
Received: from relay2.suse.de (relay2.suse.de [149.44.160.134])
        by smtp-out2.suse.de (Postfix) with ESMTP id 4E6FE1F74B;
        Mon, 16 Oct 2023 12:15:49 +0000 (UTC)
Received: from adalid.arch.suse.de (adalid.arch.suse.de [10.161.8.13])
        by relay2.suse.de (Postfix) with ESMTP id EAEC92D151;
        Mon, 16 Oct 2023 12:15:48 +0000 (UTC)
Received: by adalid.arch.suse.de (Postfix, from userid 16045)
        id 1941851EBDF6; Mon, 16 Oct 2023 14:15:49 +0200 (CEST)
...
Subject: [PATCH 3/9] scsi: Use scsi_target as argument for eh_target_reset_handler()
Date:   Mon, 16 Oct 2023 14:15:36 +0200
Message-Id: <20231016121542.111501-4-hare@suse.de>
...
---
 ...
 34 files changed, 229 insertions(+), 208 deletions(-)
...
index a04d222a2694..286c7c1953ef 100644
...
index e2c8fb09915b..84993fb58e60 100644
...
index a561eefabb50..4ac96a7dfbe2 100644
--- a/drivers/scsi/libiscsi.c
+++ b/drivers/scsi/libiscsi.c
@@ -2662,7 +2662,7 @@ static void iscsi_prep_tgt_reset_pdu(struct iscsi_tm *hdr)
...
index d40cb8b05b24..66486f03c287 100644
--- a/drivers/scsi/pmcraid.c
+++ b/drivers/scsi/pmcraid.c
@@ -3060,15 +3060,15 @@ static int pmcraid_eh_bus_reset_handler(struct Scsi_Host *host,
 				    RESET_DEVICE_BUS);
 }
...
index 186b9b19be25..c247a3c7ae17 100644
