...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A68FA36D383
	for <lists+linux-scsi@lfdr.de>; Wed, 28 Apr 2021 09:56:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236932AbhD1H5k (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 28 Apr 2021 03:57:40 -0400
Received: from mailout3.samsung.com ([203.254.224.33]:58908 "EHLO
        mailout3.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230317AbhD1H5j (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Wed, 28 Apr 2021 03:57:39 -0400
Received: from epcas2p1.samsung.com (unknown [182.195.41.53])
        by mailout3.samsung.com (KnoxPortal) with ESMTP id 20210428075653epoutp03fd555a615b7dd091c39e95dcec4ff07d~59on1lWlz0854308543epoutp03V
        for <linux-scsi@vger.kernel.org>; Wed, 28 Apr 2021 07:56:53 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout3.samsung.com 20210428075653epoutp03fd555a615b7dd091c39e95dcec4ff07d~59on1lWlz0854308543epoutp03V
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1619596613;
        bh=DRlLfmxk21u5CtoxvWUFfAx/RaFk2XXDJrZ0mWzSWu8=;
        h=Subject:Reply-To:From:To:CC:In-Reply-To:Date:References:From;
        b=L9DWqTxaTlejv9QJDYZH5XDma2sQmVNOgOa/UnmZtW1wvk7xElv5+uiszpPMxQifs
         CPyjOaaxbW7L6Np93seqDfdyAuQ2A1AVWpyGFYgdkmyRBTL0uZQcoUjOaS2aVMw41j
         iBc1gMxY2PQGLib945NCxsCuUnCZjiGOShUdBkxc=
Received: from epsnrtp1.localdomain (unknown [182.195.42.162]) by
        epcas2p4.samsung.com (KnoxPortal) with ESMTP id
        20210428075652epcas2p438238436ce6a7c256de07e027d96d8dd~59om5TLTj2207122071epcas2p4x;
        Wed, 28 Apr 2021 07:56:52 +0000 (GMT)
Received: from epsmges2p3.samsung.com (unknown [182.195.40.182]) by
        epsnrtp1.localdomain (Postfix) with ESMTP id 4FVWDf2Wr4z4x9Pp; Wed, 28 Apr
        2021 07:56:50 +0000 (GMT)
X-AuditID: b6c32a47-f4bff700000024d9-06-608915425a48
Received: from epcas2p1.samsung.com ( [182.195.41.53]) by
        epsmges2p3.samsung.com (Symantec Messaging Gateway) with SMTP id
        3E.57.09433.24519806; Wed, 28 Apr 2021 16:56:50 +0900 (KST)
Mime-Version: 1.0
Subject: [PATCH v33 1/4] scsi: ufs: Introduce HPB feature
...
X-Msg-Type: PERSONAL
X-Reply-Demand: N
Message-ID: <20210428075649epcms2p61d0beff4f5d04206d66d50ccd8793d8d@epcms2p6>
Date:   Wed, 28 Apr 2021 16:56:49 +0900
X-CMS-MailID: 20210428075649epcms2p61d0beff4f5d04206d66d50ccd8793d8d
...
X-CPGSPASS: Y
CMS-TYPE: 102P
X-Brightmail-Tracker: 
DLP-Filter: Pass
...
index d7c3cff9662f..5e03446d8d65 100644
...
index 0625da7a42ee..5826bfdf1f31 100644
...
@@ -4850,6 +4851,25 @@ static int ufshcd_change_queue_depth(struct scsi_device *sdev, int depth)
...
@@ -4859,6 +4879,8 @@ static int ufshcd_slave_configure(struct scsi_device *sdev)
...
@@ -4880,6 +4902,9 @@ static void ufshcd_slave_destroy(struct scsi_device *sdev)
 	struct ufs_hba *hba;
...
+
 	...
 	if (ufshcd_scsi_to_upiu_lun(sdev->lun) == UFS_UPIU_UFS_DEVICE_WLUN) {
 		unsigned long flags;
@@ -6970,6 +6995,8 @@ static int ufshcd_host_reset_and_restore(struct ufs_hba *hba)
...
@@ -7372,6 +7399,7 @@ static int ufs_get_device_desc(struct ufs_hba *hba)
 {
 	int err;
 	u8 model_index;
...
@@ -7399,9 +7427,16 @@ static int ufs_get_device_desc(struct ufs_hba *hba)
...
+
 	...
 	if (err < 0) {
@@ -7630,6 +7665,10 @@ static int ufshcd_device_geo_params_init(struct ufs_hba *hba)
...
+
 out:
 	kfree(desc_buf);
 	return err;
@@ -7772,6 +7811,7 @@ static int ufshcd_add_lus(struct ufs_hba *hba)
 	}
...
@@ -7919,6 +7959,7 @@ static int ufshcd_probe_hba(struct ufs_hba *hba, bool async)
...
+	ufshpb_reset(hba);
 out:
 	spin_lock_irqsave(hba->host->host_lock, flags);
 	if (ret)
@@ -7966,6 +8007,9 @@ static void ufshcd_async_scan(void *data, async_cookie_t cookie)
...
@@ -8682,6 +8726,8 @@ static int ufshcd_suspend(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
@@ -8817,6 +8863,7 @@ static int ufshcd_suspend(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
@@ -8924,6 +8971,8 @@ static int ufshcd_resume(struct ufs_hba *hba, enum ufs_pm_op pm_op)
 	/* Enable Auto-Hibernate if configured */
 	ufshcd_auto_hibern8_enable(hba);
...
index 5eb66a8debc7..ab4f0abec252 100644
