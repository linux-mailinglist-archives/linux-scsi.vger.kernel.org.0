Return-Path: <linux-scsi+bounces-25708-lists+linux-scsi=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-scsi@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id RvtfOgmVTGo5mgEAu9opvQ
	(envelope-from <linux-scsi+bounces-25708-lists+linux-scsi=lfdr.de@vger.kernel.org>)
	for <lists+linux-scsi@lfdr.de>; Tue, 07 Jul 2026 07:56:25 +0200
X-Original-To: lists+linux-scsi@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 20CD3717A27
	for <lists+linux-scsi@lfdr.de>; Tue, 07 Jul 2026 07:56:25 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=marvell.com header.s=pfpt0220 header.b=XKfr16gi;
	dmarc=pass (policy=quarantine) header.from=marvell.com;
	spf=pass (mail.lfdr.de: domain of "linux-scsi+bounces-25708-lists+linux-scsi=lfdr.de@vger.kernel.org" designates 2600:3c04:e001:36c::12fc:5321 as permitted sender) smtp.mailfrom="linux-scsi+bounces-25708-lists+linux-scsi=lfdr.de@vger.kernel.org";
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 586773039C7F
	for <lists+linux-scsi@lfdr.de>; Tue,  7 Jul 2026 05:55:45 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EE72633DED9;
	Tue,  7 Jul 2026 05:55:41 +0000 (UTC)
X-Original-To: linux-scsi@vger.kernel.org
Received: from mx0b-0016f401.pphosted.com (mx0b-0016f401.pphosted.com [67.231.156.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 55A09202C48
	for <linux-scsi@vger.kernel.org>; Tue,  7 Jul 2026 05:55:37 +0000 (UTC)
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1783403741; cv=none; b=NHr+5GsRzjrLQ5lvqKSvqB7dXVGx8Pj+gcQlN0wi3IVuMe/oSM6QEnrpfi9s8f+xaLjxHMXkdYOPjBN+tY2+lUJqWG+vn63MY2M9gnr2YMV5k+NIb7yeeSu8VzcH6/mN1byQ599WT2g9rQR+9WJ3Zh8ZD0SkPWGB9JgzGiwpP9g=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1783403741; c=relaxed/simple;
	bh=or4MAplZ/ryqrfrgo2AVtkcJZWWA/z/fMV6QJwAfy+c=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=Zs1ePHem7WRoMKEICzGcD1sEeuJvWSF/EhynblZwhUs0DnnuBF+rDPCFHin9JVgYK2oqDUDKHvasz1iTdjkhT7ebhbMkcCaGl1anzHI0XHAf609fNvO4rt04GiqoBpyq9WAnB7OUu3wXEPzIciOSxZfiJiVwE7P+w9Rts8zcS7g=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=marvell.com; spf=pass smtp.mailfrom=marvell.com; dkim=pass (2048-bit key) header.d=marvell.com header.i=@marvell.com header.b=XKfr16gi; arc=none smtp.client-ip=67.231.156.173
Received: from pps.filterd (m0045851.ppops.net [127.0.0.1])
	by mx0b-0016f401.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id 66748bZQ1656071;
	Mon, 6 Jul 2026 22:55:34 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=marvell.com; h=
	cc:content-transfer-encoding:content-type:date:from:in-reply-to
	:message-id:mime-version:references:subject:to; s=pfpt0220; bh=d
	bkWKQ79YJRDBm0pbzhQwx1L6ijBITPA8UPMMGl8CoA=; b=XKfr16giEyGupR6rB
	
Received: from dc6wp-exch02.marvell.com ([4.21.29.225])
	by mx0b-0016f401.pphosted.com (PPS) with ESMTPS id 4f71phqdtu-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Mon, 06 Jul 2026 22:55:34 -0700 (PDT)
Received: from DC6WP-EXCH02.marvell.com (10.76.176.209) by
 DC6WP-EXCH02.marvell.com (10.76.176.209) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1544.25; Mon, 6 Jul 2026 22:55:33 -0700
Received: from maili.marvell.com (10.69.176.80) by DC6WP-EXCH02.marvell.com
 (10.76.176.209) with Microsoft SMTP Server id 15.2.1544.25 via Frontend
 Transport; Mon, 6 Jul 2026 22:55:33 -0700
Received: from stgdev-a5u16.punelab.marvell.com (stgdev-a5u16.punelab.marvell.com [10.31.33.164])
	by maili.marvell.com (Postfix) with ESMTP id 5ABA93F7066;
	Mon,  6 Jul 2026 22:55:29 -0700 (PDT)
From: Nilesh Javali <njavali@marvell.com>
To: <martin.petersen@oracle.com>
CC: <linux-scsi@vger.kernel.org>, <GR-FC-Storage-Upstream@marvell.com>,
        <agurumurthy@marvell.com>, <emilne@redhat.com>, <jmeneghi@redhat.com>,
        <hare@suse.com>
Subject: [PATCH v3 11/88] scsi: qla2xxx: Update IO path to use 128-byte IOCBs for 29xx
Date: Tue, 7 Jul 2026 11:23:18 +0530
Message-ID: <20260707055435.2680300-12-njavali@marvell.com>
...
X-Proofpoint-GUID: beIPxp9LfHN5_qo6ptpKJ5LSwULo7v01
X-Authority-Analysis: v=2.4 cv=Hf4kiCE8 c=1 sm=1 tr=0 ts=6a4c94d6 cx=c_pps
 a=gIfcoYsirJbf48DBMSPrZA==:117 a=gIfcoYsirJbf48DBMSPrZA==:17
 a=RAioF0-LDSMA:10 a=VkNPw1HP01LnGYTKEx00:22 a=l0iWHRpgs5sLHlkKQ1IR:22
 a=QXcCYyLzdtTjyudCfB6f:22 a=M5GUcnROAAAA:8 a=VwQbUJbxAAAA:8
 a=JMkM0egdopB7VeAhaHQA:9 a=OBjm3rFKGHvpk9ecZwUJ:22
X-Proofpoint-ORIG-GUID: beIPxp9LfHN5_qo6ptpKJ5LSwULo7v01
X-Proofpoint-Spam-Info: AW1haW4tMjYwNzA3MDA1MyBTYWx0ZWRfX0Sscg9bjdSgM
 8Rl9fYblJfp6loXT+imP4+6wItQ6Uyz2VNQQiBnf3qmYjlyAjDRvtwR2Pt+w5bjDX3gdUq3cRG9
 7H6tx4zhanf2zwWyUW+A+WIR/RVAjmE=
X-Proofpoint-Spam-Details-Enc: AW1haW4tMjYwNzA3MDA1MyBTYWx0ZWRfXw8SVH+gLJJX4
 
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-25708-lists,linux-scsi=lfdr.de];
...
---
 ...
 drivers/scsi/qla2xxx/qla_iocb.c   | 990 +++++++++++++++++++++++++-----
 ...
 13 files changed, 1397 insertions(+), 325 deletions(-)
...
index 4de0de5cccc8..fcd185807e2b 100644
...
index 79b8026cb33d..bd0684d97fef 100644
...
index 9038f6723444..13882a399fbc 100644
...
@@ -1654,12 +1674,7 @@ qla24xx_start_scsi(srb_t *sp)
...
@@ -1829,11 +1844,11 @@ qla24xx_dif_start_scsi(srb_t *sp)
 	req->cnt -= req_cnt;
...
@@ -1849,8 +1864,8 @@ qla24xx_dif_start_scsi(srb_t *sp)
...
+	    fw_prot_opts) != QLA_SUCCESS)
 	...
 	cmd_pkt->entry_count = (uint8_t)req_cnt;
@@ -1860,12 +1875,7 @@ qla24xx_dif_start_scsi(srb_t *sp)
 	wmb();
...
+	qla_req_ring_advance(ha, req);
 	...
 	sp->qpair->cmd_cnt++;
 	/* Set chip new ring index. */
@@ -1954,7 +1964,17 @@ qla2xxx_start_scsi_mq(srb_t *sp)
 		nseg = 0;
...
+		req_cnt = qla24xx_calc_iocbs(vha, tot_dsds);
 	...
 	sp->iores.exch_cnt = 1;
@@ -1987,46 +2007,84 @@ qla2xxx_start_scsi_mq(srb_t *sp)
 	cmd->host_scribble = (unsigned char *)(unsigned long)handle;
 	req->cnt -= req_cnt;
...
+	qla_req_ring_advance(ha, req);
 	...
 	sp->qpair->cmd_cnt++;
 	sp->flags |= SRB_DMA_VALID;
@@ -2034,8 +2092,12 @@ qla2xxx_start_scsi_mq(srb_t *sp)
 	/* Set chip new ring index. */
 	wrt_reg_dword(req->req_q_in, req->ring_index);
...
@@ -2180,7 +2242,20 @@ qla2xxx_dif_start_scsi_mq(srb_t *sp)
...
@@ -2211,18 +2286,35 @@ qla2xxx_dif_start_scsi_mq(srb_t *sp)
 	cmd->host_scribble = (unsigned char *)(unsigned long)handle;
 	req->cnt -= req_cnt;
...
+	 */
 	...
 	int_to_scsilun(cmd->device->lun, &cmd_pkt->lun);
 	host_to_fcp_swap((uint8_t *)&cmd_pkt->lun, sizeof(cmd_pkt->lun));
@@ -2231,29 +2323,41 @@ qla2xxx_dif_start_scsi_mq(srb_t *sp)
 	cmd_pkt->dseg_count = cpu_to_le16(tot_dsds);
...
@@ -2303,7 +2407,7 @@ __qla2x00_alloc_iocbs(struct qla_qpair *qpair, srb_t *sp)
...
@@ -3271,7 +3385,7 @@ qla2x00_ct_iocb(srb_t *sp, ms_iocb_entry_t *ct_iocb)
 			* Type 1 IOCB.
 			       */
 			cont_pkt = qla2x00_prep_cont_type1_iocb(vha,
-			    vha->hw->req_q_map[0]);
+			    ha, ha->req_q_map[0]);
 			...
 			avail_dsds = 5;
 			entry_count++;
@@ -3297,7 +3411,6 @@ qla24xx_ct_iocb(srb_t *sp, struct ct_entry_24xx *ct_iocb)
 	struct qla_hw_data *ha = vha->hw;
...
@@ -3322,16 +3435,29 @@ qla24xx_ct_iocb(srb_t *sp, struct ct_entry_24xx *ct_iocb)
 	index = 0;
...
@@ -3342,16 +3468,22 @@ qla24xx_ct_iocb(srb_t *sp, struct ct_entry_24xx *ct_iocb)
 	index = 0;
...
@@ -3905,16 +4037,31 @@ static int qla_get_iocbs_resource(struct srb *sp)
 }
...
@@ -4100,7 +4247,8 @@ qla25xx_build_bidir_iocb(srb_t *sp, struct scsi_qla_host *vha,
...
+			    vha->hw, vha->req);
 			...
 			avail_dsds = 5;
 			entry_count++;
@@ -4122,7 +4270,8 @@ qla25xx_build_bidir_iocb(srb_t *sp, struct scsi_qla_host *vha,
 			/* Continuation type 1 IOCB can accomodate
 			 * 5 DSDS
 			 */
-			cont_pkt = qla2x00_prep_cont_type1_iocb(vha, vha->req);
...
+			    vha->hw, vha->req);
 			...
 			avail_dsds = 5;
 			entry_count++;
@@ -4154,6 +4303,21 @@ qla2x00_start_bidir(srb_t *sp, struct scsi_qla_host *vha, uint32_t tot_dsds)
 	rsp = ha->rsp_q_map[0];
 	req = vha->req;
...
@@ -4291,8 +4455,15 @@ qla_start_scsi_type6(srb_t *sp)
...
+		req_cnt = qla24xx_calc_iocbs(vha, tot_dsds);
 	...
 	sp->iores.res_type = RESOURCE_IOCB | RESOURCE_EXCH;
 	sp->iores.exch_cnt = 1;
@@ -4396,23 +4567,44 @@ qla_start_scsi_type6(srb_t *sp)
 	cmd->host_scribble = (unsigned char *)(unsigned long)handle;
 	req->cnt -= req_cnt;
...
+	}
 	...
 	int_to_scsilun(cmd->device->lun, &cmd_pkt->lun);
 	host_to_fcp_swap((uint8_t *)&cmd_pkt->lun, sizeof(cmd_pkt->lun));
@@ -4447,14 +4639,8 @@ qla_start_scsi_type6(srb_t *sp)
 	cmd_pkt->entry_count = (uint8_t)req_cnt;
...
+	qla_req_ring_advance(ha, req);
 	...
 	sp->qpair->cmd_cnt++;
 	sp->flags |= SRB_DMA_VALID;
@@ -4462,8 +4648,11 @@ qla_start_scsi_type6(srb_t *sp)
 	/* Set chip new ring index. */
 	wrt_reg_dword(req->req_q_in, req->ring_index);
...
@@ -4489,3 +4678,498 @@ qla_start_scsi_type6(srb_t *sp)
