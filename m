...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 42D425E8746
	for <lists+linux-scsi@lfdr.de>; Sat, 24 Sep 2022 04:11:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233008AbiIXCLF (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Fri, 23 Sep 2022 22:11:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60322 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233112AbiIXCLA (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Fri, 23 Sep 2022 22:11:00 -0400
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5588C121654
        for <linux-scsi@vger.kernel.org>; Fri, 23 Sep 2022 19:10:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1663985432; x=1695521432;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=R7XXIHqIP9+l8PstTeDu1S3tVb8FUFx0qZ6X5AuK00s=;
  b=Y8IR4eT4EDr0Po8g1iK1RN9Q38kQH8+wR30EBOb32jUzDJSoMe46RFrM
   B8Gqsb76Ie7mEEtShh+IT/pIqieoxuqXALocJReUDu3Pb0Ra166tQCG7B
   2/8Aq51XDcRTqE5Ut8i3Bu+35jZBC1Lqa7A+ODwcDkyz8K01qMabGxLzi
   y+B/w29zgk5YxAcmBBUibVp5ZCChF4nlcx6fFtX5jnzkVGAjRrQhG4VmC
   qRP4qSh6QocwsBNgt+GIqXkXoge2KFU1dQ4LL2ylwCY0FOGOYXRKOflHm
   37WN8mNzymeZ0ZKTjerVmB5NXw8a8ZIs7TTp+ii2/JuSC+xYDUDRJ4GDD
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10479"; a="299457119"
X-IronPort-AV: E=Sophos;i="5.93,340,1654585200"; 
   d="scan'208";a="299457119"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Sep 2022 19:10:30 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,340,1654585200"; 
   d="scan'208";a="746007769"
Received: from lkp-server01.sh.intel.com (HELO c0a60f19fe7e) ([10.239.97.150])
  by orsmga004.jf.intel.com with ESMTP; 23 Sep 2022 19:10:15 -0700
Received: from kbuild by c0a60f19fe7e with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1obucP-00066I-0w;
        Sat, 24 Sep 2022 02:10:13 +0000
Date:   Sat, 24 Sep 2022 10:10:01 +0800
From:   kernel test robot <lkp@intel.com>
To:     Bart Van Assche <bvanassche@acm.org>,
        "Martin K . Petersen" <martin.petersen@oracle.com>
Cc:     kbuild-all@lists.01.org, Jaegeuk Kim <jaegeuk@kernel.org>,
...
Subject: Re: [PATCH 2/8] scsi: core: Change the return type of .eh_timed_out()
Message-ID: <202209240833.z5j87h8t-lkp@intel.com>
References: <20220923201138.2113123-3-bvanassche@acm.org>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="O8NjjOBMo5yRGP4i"
Content-Disposition: inline
In-Reply-To: <20220923201138.2113123-3-bvanassche@acm.org>
...
[also build test WARNING on jejb-scsi/for-next linus/master v6.0-rc6 next-20220923]
...
reproduce (this is a W=1 build):
        ...
        # https://github.com/intel-lab-lkp/linux/commit/7bc4b0fc4020042f87539d32e24d2e49e613b541
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Bart-Van-Assche/Fix-a-deadlock-in-the-UFS-driver/20220924-041421
        git checkout 7bc4b0fc4020042f87539d32e24d2e49e613b541
...
All warnings (new ones prefixed by >>):
   ...
   drivers/scsi/scsi_transport_fc.c: In function 'fc_bsg_job_timeout':
>> drivers/scsi/scsi_transport_fc.c:4063:32: warning: implicit conversion from 'enum scsi_timeout_action' to 'enum blk_eh_timer_return' [-Wenum-conversion]
    4063 |                         return SCSI_EH_RESET_TIMER;
         |                                ^~~~~~~~~~~~~~~~~~~


vim +4063 drivers/scsi/scsi_transport_fc.c
