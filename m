 
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-26130-lists,linux-scsi=lfdr.de];
...
---
 ...
 drivers/scsi/qla2xxx/qla_iocb.c   | 1121 ++++++++++++++++++++++++-----
 drivers/scsi/qla2xxx/qla_isr.c    |   55 +-
 drivers/scsi/qla2xxx/qla_mid.c    |   65 +-
 drivers/scsi/qla2xxx/qla_nvme.c   |  156 ++--
 drivers/scsi/qla2xxx/qla_os.c     |   39 +-
 drivers/scsi/qla2xxx/qla_target.c |   34 +-
 13 files changed, 1502 insertions(+), 354 deletions(-)
...
index 4de0de5cccc8..7220617c2568 100644
...
+	struct request_ext *ring_ext_ptr;
 	...
 	uint16_t  ring_index;
@@ -4488,7 +4512,8 @@ struct qla_hw_data {
...
index 106f95a4e7f0..91900a601a97 100644
...
index f6a8bcbb2a03..bea7b5403650 100644
...
index 47fbd830ff16..d5178e0ace22 100644
...
index dbe3cd4e274c..7136ad4ec9a8 100644
...
@@ -464,16 +473,16 @@ qla2x00_start_iocbs(struct scsi_qla_host *vha, struct req_que *req)
 	if (IS_P3P_TYPE(ha)) {
...
@@ -747,7 +766,8 @@ qla24xx_build_scsi_iocbs(srb_t *sp, struct cmd_type_7 *cmd_pkt,
 			 * Five DSDs are available in the Continuation
 			 * Type 1 IOCB.
 			 */
-			cont_pkt = qla2x00_prep_cont_type1_iocb(vha, req);
...
@@ -1798,7 +1856,20 @@ qla24xx_dif_start_scsi(srb_t *sp)
...
@@ -1829,17 +1900,24 @@ qla24xx_dif_start_scsi(srb_t *sp)
 	req->cnt -= req_cnt;
...
+	 */
 	...
 	int_to_scsilun(cmd->device->lun, &cmd_pkt->lun);
 	host_to_fcp_swap((uint8_t *)&cmd_pkt->lun, sizeof(cmd_pkt->lun));
@@ -1848,10 +1926,22 @@ qla24xx_dif_start_scsi(srb_t *sp)
 	cmd_pkt->dseg_count = cpu_to_le16(tot_dsds);
...
@@ -1860,12 +1950,7 @@ qla24xx_dif_start_scsi(srb_t *sp)
 	wmb();
...
+	qla_req_ring_advance(ha, req);
 	...
 	sp->qpair->cmd_cnt++;
 	/* Set chip new ring index. */
@@ -1954,7 +2039,17 @@ qla2xxx_start_scsi_mq(srb_t *sp)
 		nseg = 0;
...
+		req_cnt = qla24xx_calc_iocbs(vha, tot_dsds);
 	...
 	sp->iores.res_type = RESOURCE_IOCB | RESOURCE_EXCH;
 	sp->iores.exch_cnt = 1;
@@ -1987,46 +2082,84 @@ qla2xxx_start_scsi_mq(srb_t *sp)
 	cmd->host_scribble = (unsigned char *)(unsigned long)handle;
 	req->cnt -= req_cnt;
...
+	qla_req_ring_advance(ha, req);
 	...
 	sp->qpair->cmd_cnt++;
 	sp->flags |= SRB_DMA_VALID;
@@ -2034,8 +2167,12 @@ qla2xxx_start_scsi_mq(srb_t *sp)
 	/* Set chip new ring index. */
 	wrt_reg_dword(req->req_q_in, req->ring_index);
...
@@ -2180,7 +2317,20 @@ qla2xxx_dif_start_scsi_mq(srb_t *sp)
...
@@ -2211,18 +2361,35 @@ qla2xxx_dif_start_scsi_mq(srb_t *sp)
 	cmd->host_scribble = (unsigned char *)(unsigned long)handle;
 	req->cnt -= req_cnt;
...
+	 */
 	...
 	int_to_scsilun(cmd->device->lun, &cmd_pkt->lun);
 	host_to_fcp_swap((uint8_t *)&cmd_pkt->lun, sizeof(cmd_pkt->lun));
@@ -2231,29 +2398,41 @@ qla2xxx_dif_start_scsi_mq(srb_t *sp)
 	cmd_pkt->dseg_count = cpu_to_le16(tot_dsds);
...
@@ -2343,10 +2522,20 @@ __qla2x00_alloc_iocbs(struct qla_qpair *qpair, srb_t *sp)
 		sp->handle = handle;
 	}
...
@@ -3269,7 +3458,7 @@ qla2x00_ct_iocb(srb_t *sp, ms_iocb_entry_t *ct_iocb)
 			* Type 1 IOCB.
 			       */
 			cont_pkt = qla2x00_prep_cont_type1_iocb(vha,
-			    vha->hw->req_q_map[0]);
+			    ha, ha->req_q_map[0]);
 			...
 			avail_dsds = 5;
 			entry_count++;
@@ -3295,7 +3484,6 @@ qla24xx_ct_iocb(srb_t *sp, struct ct_entry_24xx *ct_iocb)
 	struct qla_hw_data *ha = vha->hw;
...
@@ -3320,16 +3508,29 @@ qla24xx_ct_iocb(srb_t *sp, struct ct_entry_24xx *ct_iocb)
 	index = 0;
...
@@ -3340,16 +3541,22 @@ qla24xx_ct_iocb(srb_t *sp, struct ct_entry_24xx *ct_iocb)
 	index = 0;
...
@@ -3903,16 +4110,31 @@ static int qla_get_iocbs_resource(struct srb *sp)
 }
...
@@ -4098,7 +4320,8 @@ qla25xx_build_bidir_iocb(srb_t *sp, struct scsi_qla_host *vha,
...
+			    vha->hw, vha->req);
 			...
 			avail_dsds = 5;
 			entry_count++;
@@ -4120,7 +4343,8 @@ qla25xx_build_bidir_iocb(srb_t *sp, struct scsi_qla_host *vha,
 			/* Continuation type 1 IOCB can accomodate
 			 * 5 DSDS
 			 */
-			cont_pkt = qla2x00_prep_cont_type1_iocb(vha, vha->req);
...
+			    vha->hw, vha->req);
 			...
 			avail_dsds = 5;
 			entry_count++;
@@ -4152,6 +4376,21 @@ qla2x00_start_bidir(srb_t *sp, struct scsi_qla_host *vha, uint32_t tot_dsds)
 	rsp = ha->rsp_q_map[0];
 	req = vha->req;
...
@@ -4289,8 +4528,15 @@ qla_start_scsi_type6(srb_t *sp)
...
+		req_cnt = qla24xx_calc_iocbs(vha, tot_dsds);
 	...
 	sp->iores.res_type = RESOURCE_IOCB | RESOURCE_EXCH;
 	sp->iores.exch_cnt = 1;
@@ -4394,23 +4640,44 @@ qla_start_scsi_type6(srb_t *sp)
 	cmd->host_scribble = (unsigned char *)(unsigned long)handle;
 	req->cnt -= req_cnt;
...
+	}
 	...
 	int_to_scsilun(cmd->device->lun, &cmd_pkt->lun);
 	host_to_fcp_swap((uint8_t *)&cmd_pkt->lun, sizeof(cmd_pkt->lun));
@@ -4445,14 +4712,8 @@ qla_start_scsi_type6(srb_t *sp)
 	cmd_pkt->entry_count = (uint8_t)req_cnt;
...
+	qla_req_ring_advance(ha, req);
 	...
 	sp->qpair->cmd_cnt++;
 	sp->flags |= SRB_DMA_VALID;
@@ -4460,8 +4721,11 @@ qla_start_scsi_type6(srb_t *sp)
 	/* Set chip new ring index. */
 	wrt_reg_dword(req->req_q_in, req->ring_index);
...
@@ -4487,3 +4751,498 @@ qla_start_scsi_type6(srb_t *sp)
...
index c47c38e099ff..e95fb0e59f38 100644
...
@@ -4079,7 +4050,7 @@ void qla24xx_process_response_queue(struct scsi_qla_host *vha,
...
@@ -4127,8 +4098,8 @@ void qla24xx_process_response_queue(struct scsi_qla_host *vha,
...
@@ -4150,8 +4121,8 @@ void qla24xx_process_response_queue(struct scsi_qla_host *vha,
 		case PT_LS4_UNSOL:
 			p = (void *)pkt;
...
index e75b7ae22bc5..bb2521c052bf 100644
...
+	size_t req_entry_size = qla_req_entry_size(ha);
 	...
 	if (req == NULL) {
@@ -724,18 +720,19 @@ qla25xx_create_req_que(struct qla_hw_data *ha, uint16_t options,
 		goto failed;
 	}
...
+	}
 	...
 	if (ret != QLA_SUCCESS)
@@ -781,7 +778,15 @@ qla25xx_create_req_que(struct qla_hw_data *ha, uint16_t options,
 		req->outstanding_cmds[cnt] = NULL;
...
+		req->ring_ext_ptr = req->ring_ext;
 	...
 	req->cnt = req->length;
 	req->id = que_id;
@@ -789,7 +794,15 @@ qla25xx_create_req_que(struct qla_hw_data *ha, uint16_t options,
...
@@ -846,7 +859,7 @@ qla25xx_create_rsp_que(struct qla_hw_data *ha, uint16_t options,
...
+	size_t rsp_entry_size = qla_rsp_entry_size(ha);
 	...
 	if (rsp == NULL) {
@@ -855,18 +868,19 @@ qla25xx_create_rsp_que(struct qla_hw_data *ha, uint16_t options,
 		goto failed;
 	}
...
@@ -905,7 +919,10 @@ qla25xx_create_rsp_que(struct qla_hw_data *ha, uint16_t options,
...
index 2531e71c39dc..b2eacf0277f4 100644
...
index 948242f0088e..146701445485 100644
...
+
 	if (IS_QLAFX00(ha)) {
 		if (req && req->ring_fx00)
 			dma_free_coherent(&ha->pdev->dev,
@@ -509,8 +511,8 @@ static void qla2x00_free_req_que(struct qla_hw_data *ha, struct req_que *req)
...
@@ -520,6 +522,8 @@ static void qla2x00_free_req_que(struct qla_hw_data *ha, struct req_que *req)
...
+
 	if (IS_QLAFX00(ha)) {
 		if (rsp && rsp->ring_fx00)
 			dma_free_coherent(&ha->pdev->dev,
@@ -527,8 +531,8 @@ static void qla2x00_free_rsp_que(struct qla_hw_data *ha, struct rsp_que *rsp)
...
@@ -4249,6 +4254,8 @@ qla2x00_mem_alloc(struct qla_hw_data *ha, uint16_t req_len, uint16_t rsp_len,
 {
 	char	name[16];
 	int rc;
+	size_t req_entry_size = qla_req_entry_size(ha);
...
@@ -4444,13 +4451,17 @@ qla2x00_mem_alloc(struct qla_hw_data *ha, uint16_t req_len, uint16_t rsp_len,
 	}
 	(*req)->length = req_len;
 	(*req)->ring = dma_alloc_coherent(&ha->pdev->dev,
-		((*req)->length + 1) * sizeof(request_t),
...
+	}
 	...
 	*rsp = kzalloc_obj(struct rsp_que);
 	if (!*rsp) {
@@ -4461,13 +4472,17 @@ qla2x00_mem_alloc(struct qla_hw_data *ha, uint16_t req_len, uint16_t rsp_len,
 	(*rsp)->hw = ha;
 	(*rsp)->length = rsp_len;
 	(*rsp)->ring = dma_alloc_coherent(&ha->pdev->dev,
-		((*rsp)->length + 1) * sizeof(response_t),
...
@@ -4617,16 +4632,18 @@ qla2x00_mem_alloc(struct qla_hw_data *ha, uint16_t req_len, uint16_t rsp_len,
 fail_ex_init_cb:
 	kfree(ha->npiv_info);
 fail_npiv_info:
-	dma_free_coherent(&ha->pdev->dev, ((*rsp)->length + 1) *
...
+		(*req)->ring, (*req)->dma);
 	...
 	(*req)->dma = 0;
 fail_req_ring:
@@ -8324,6 +8341,7 @@ qla2x00_module_init(void)
...
@@ -8351,6 +8369,7 @@ qla2x00_module_init(void)
