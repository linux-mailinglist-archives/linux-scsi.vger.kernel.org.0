Return-Path: <linux-scsi+bounces-17195-lists+linux-scsi=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-scsi@lfdr.de
Delivered-To: lists+linux-scsi@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id B5852B55621
	for <lists+linux-scsi@lfdr.de>; Fri, 12 Sep 2025 20:28:39 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 687A63BE701
	for <lists+linux-scsi@lfdr.de>; Fri, 12 Sep 2025 18:28:38 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C125B32BF44;
	Fri, 12 Sep 2025 18:28:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=acm.org header.i=@acm.org header.b="zdSOMD89"
X-Original-To: linux-scsi@vger.kernel.org
Received: from 003.mia.mailroute.net (003.mia.mailroute.net [199.89.3.6])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 09046324B25
	for <linux-scsi@vger.kernel.org>; Fri, 12 Sep 2025 18:28:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=199.89.3.6
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1757701713; cv=none; b=KulBj4ij7fWIGiokituks5A8KFEHPK/6M9fbuffrQM+pzHHivIHWPqZXB2KhdTJBytjxvspLHjXo3hpnNPyZmHwXnimFJmNpA7qrWZqBFY740krU3DWB1HsoUMcnc2sLmfoVQrnooSfmyQzDAsAK4eTG1D91qAovUieyJ3yS/64=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1757701713; c=relaxed/simple;
	bh=GxVTZDyoINzWiJ3V0iNzYk8QZKLW+rRBGHvO8Xmav6k=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=FqNuiFsGGOyNL/WFZfSLsnNccoYXKw57lAuANcfkbbJA2EFVkvi0QW7KMUgMLgWzUvy4TJD9q69Bwe0wi9Vk+fJT4/kC+4IUpAeSarcKsX6/2DZ+sO77OhUToWR3DtBP+KNLdWRztOOj/aHD33DcinFM70/VzdqHYMedgQ7zE/Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=acm.org; spf=pass smtp.mailfrom=acm.org; dkim=pass (2048-bit key) header.d=acm.org header.i=@acm.org header.b=zdSOMD89; arc=none smtp.client-ip=199.89.3.6
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=acm.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=acm.org
Received: from localhost (localhost [127.0.0.1])
	by 003.mia.mailroute.net (Postfix) with ESMTP id 4cNjby2TMPzltQLt;
	Fri, 12 Sep 2025 18:28:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=acm.org; h=
	content-transfer-encoding:mime-version:references:in-reply-to
	:x-mailer:message-id:date:date:subject:subject:from:from
	:received:received; s=mr01; t=1757701706; x=1760293707; bh=IhZVw
	VB1CC3uYRO5AmTCgdrV3chc0q3T0YhR+Wzjszo=; b=zdSOMD89/bvw5UpLisr8m
	
X-Virus-Scanned: by MailRoute
Received: from 003.mia.mailroute.net ([127.0.0.1])
 by localhost (003.mia [127.0.0.1]) (mroute_mailscanner, port 10029) with LMTP
 id 8c4AscN7-p8e; Fri, 12 Sep 2025 18:28:26 +0000 (UTC)
Received: from bvanassche.mtv.corp.google.com (unknown [104.135.204.82])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	(Authenticated sender: bvanassche@acm.org)
	by 003.mia.mailroute.net (Postfix) with ESMTPSA id 4cNjbf52lYzlgqTs;
	Fri, 12 Sep 2025 18:28:13 +0000 (UTC)
...
Subject: [PATCH v4 23/29] ufs: core: Optimize the hot path
Date: Fri, 12 Sep 2025 11:21:44 -0700
Message-ID: <20250912182340.3487688-24-bvanassche@acm.org>
...
@@ -6624,7 +6632,7 @@ static bool ufshcd_abort_one(struct request *rq, vo=
id *priv)
=20
...
=20
 	return *ret =3D=3D 0;
@@ -7341,14 +7349,15 @@ static int ufshcd_issue_devman_upiu_cmd(struct uf=
s_hba *hba,
...
=20
@@ -7373,7 +7382,7 @@ static int ufshcd_issue_devman_upiu_cmd(struct ufs_=
hba *hba,
...
@@ -7487,7 +7496,8 @@ int ufshcd_advanced_rpmb_req_handler(struct ufs_hba=
...
+	struct ufshcd_lrb *lrbp =3D scsi_cmd_priv(cmd);
 	...
 	int result;
 	u8 upiu_flags;
@@ -7498,7 +7508,8 @@ int ufshcd_advanced_rpmb_req_handler(struct ufs_hba=
 *hba, struct utp_upiu_req *r
 	/* Protects use of hba->reserved_slot. */
...
=20
@@ -7515,7 +7526,7 @@ int ufshcd_advanced_rpmb_req_handler(struct ufs_hba=
 *hba, struct utp_upiu_req *r
=20
...
=20
 	if (!err) {
 		/* Just copy the upiu response as it is */
@@ -7616,11 +7627,12 @@ static int ufshcd_eh_device_reset_handler(struct =
scsi_cmnd *cmd)
=20
...
@@ -7628,7 +7640,7 @@ static void ufshcd_set_req_abort_skip(struct ufs_hb=
...
here can
@@ -7640,7 +7652,8 @@ static void ufshcd_set_req_abort_skip(struct ufs_hb=
a *hba, unsigned long bitmap)
  */
 int ufshcd_try_to_abort_task(struct ufs_hba *hba, int tag)
 {
...
+	struct ufshcd_lrb *lrbp =3D scsi_cmd_priv(cmd);
 	...
 	int poll_cnt;
 	u8 resp =3D 0xF;
@@ -7662,7 +7675,7 @@ int ufshcd_try_to_abort_task(struct ufs_hba *hba, i=
nt tag)
 				hba->dev,
...
=20
 	err =3D SUCCESS;
=20
@@ -8885,8 +8898,6 @@ static void ufshcd_release_sdb_queue(struct ufs_hba=
 *hba, int nutrs)
...
@@ -9164,6 +9175,7 @@ static const struct scsi_host_template ufshcd_drive=
r_template =3D {
 	.name			=3D UFSHCD,
 	.proc_name		=3D UFSHCD,
