...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3F5791B3236
	for <lists+linux-scsi@lfdr.de>; Tue, 21 Apr 2020 23:53:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726430AbgDUVxg (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 21 Apr 2020 17:53:36 -0400
Received: from smtp.infotech.no ([82.134.31.41]:43101 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726387AbgDUVxe (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Tue, 21 Apr 2020 17:53:34 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 3784E20425A;
        Tue, 21 Apr 2020 23:53:31 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 9LS78NkeK56Y; Tue, 21 Apr 2020 23:53:28 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-23-251-188-50.dyn.295.ca [23.251.188.50])
        by smtp.infotech.no (Postfix) with ESMTPA id EB5402041B2;
        Tue, 21 Apr 2020 23:53:24 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v9 19/40] sg: introduce request state machine
Date:   Tue, 21 Apr 2020 17:52:37 -0400
Message-Id: <20200421215258.14348-20-dgilbert@interlog.com>
...
index b60bbc7add82..3d58edd11b9f 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
-	u8 cmnd[SG_MAX_CDB_SIZE];
 	...
 	if (res)
@@ -743,10 +776,25 @@ sg_common_write(struct sg_fd *sfp, struct sg_comm_wr_t *cwrp)
 	return 0;
 }
...
@@ -781,6 +829,32 @@ srp_done(struct sg_fd *sfp, struct sg_request *srp)
 	return ret;
 }
...
+
 ...
 sg_receive_v3(struct sg_fd *sfp, char __user *buf, size_t count,
 	      struct sg_request *srp)
@@ -1308,7 +1382,7 @@ sg_ioctl_common(struct file *filp, struct sg_device *sdp, struct sg_fd *sfp,
 	case SG_GET_LOW_DMA:
...
+	case SG_NEXT_CMD_LEN:	/* active only in v2 interface */
 		...
 		if (result)
@@ -2251,48 +2325,37 @@ sg_remove_sgat(struct sg_fd *sfp, struct sg_scatter_hold *schp)
 static int
...
+	return res;
 ...
 static void
@@ -2341,6 +2404,22 @@ sg_unlink_reserve(struct sg_fd *sfp, struct sg_request *srp)
 	sfp->res_in_use = 0;
 }
...
@@ -2372,23 +2451,21 @@ sg_add_request(struct sg_fd *sfp)
 	return NULL;
 }
...
-	return res;
 ...
 static struct sg_fd *
@@ -2446,6 +2523,15 @@ sg_add_sfp(struct sg_device *sdp)
 	return sfp;
 }
...
+ */
 ...
 {
@@ -2541,6 +2627,33 @@ sg_get_dev(int dev)
 	return sdp;
 }
...
@@ -2837,8 +2950,9 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
