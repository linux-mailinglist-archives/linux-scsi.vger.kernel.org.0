...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1EE5E4202C5
	for <lists+linux-scsi@lfdr.de>; Sun,  3 Oct 2021 18:37:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231175AbhJCQjS (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 3 Oct 2021 12:39:18 -0400
Received: from smtp.infotech.no ([82.134.31.41]:55190 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231250AbhJCQjR (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 3 Oct 2021 12:39:17 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 774D1204155;
        Sun,  3 Oct 2021 18:37:28 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id Ta8P4KvZkBAF; Sun,  3 Oct 2021 18:37:25 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-23-91-187-47.dyn.295.ca [23.91.187.47])
        by smtp.infotech.no (Postfix) with ESMTPA id 30E762041BD;
        Sun,  3 Oct 2021 18:34:42 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        Damien.LeMoal@wdc.com
Subject: [PATCH v21 13/46] sg: split sg_read
Date:   Sun,  3 Oct 2021 12:31:18 -0400
Message-Id: <20211003163151.585349-14-dgilbert@interlog.com>
...
index 03f8f0aeb1f4..6a4bd268d820 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -758,8 +758,8 @@ sg_get_rq_mark(struct sg_fd *sfp, int pack_id)
 }
...
+	      struct sg_request *srp)
 {
 	...
 	int err = 0, err2;
@@ -814,170 +814,164 @@ srp_done(struct sg_fd *sfp, struct sg_request *srp)
 	return ret;
 }
...
+	return ret < 0 ? ret : (int)count;
 ...
 static int
@@ -1050,7 +1044,7 @@ sg_ctl_sg_io(struct file *filp, struct sg_device *sdp, struct sg_fd *sfp,
 	if (srp->done) {
 		srp->done = 2;
...
+		res = sg_receive_v3(sfp, p, SZ_SG_IO_HDR, srp);
 	...
 	srp->orphan = 1;
@@ -2144,7 +2138,7 @@ sg_remove_scat(struct sg_fd *sfp, struct sg_scatter_hold *schp)
