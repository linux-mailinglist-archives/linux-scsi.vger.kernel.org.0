...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D7F3F34F610
	for <lists+linux-scsi@lfdr.de>; Wed, 31 Mar 2021 03:17:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230284AbhCaBQv (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 30 Mar 2021 21:16:51 -0400
Received: from mailout3.samsung.com ([203.254.224.33]:34019 "EHLO
        mailout3.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232515AbhCaBQX (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Tue, 30 Mar 2021 21:16:23 -0400
Received: from epcas2p4.samsung.com (unknown [182.195.41.56])
        by mailout3.samsung.com (KnoxPortal) with ESMTP id 20210331011621epoutp031201d01afa61aa8588bfe0095313169d~xSG61o8-Y1763217632epoutp03Z
        for <linux-scsi@vger.kernel.org>; Wed, 31 Mar 2021 01:16:21 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout3.samsung.com 20210331011621epoutp031201d01afa61aa8588bfe0095313169d~xSG61o8-Y1763217632epoutp03Z
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1617153381;
        bh=Tc/fs0UJlLgHYpQNXM18Od3KEsVREeTOMFDGwYaTDOk=;
        h=Subject:Reply-To:From:To:CC:In-Reply-To:Date:References:From;
        b=X5aLRX2TLbJ950bBxLFiPtNMXJaDwjp7AlXnUW+gGTYWYjxR9xjMOmmzDnJViEuE9
         Gp2P18x01YoHITutjiuyMiRIJYkQyK0naHrJRWJbjqIVBa1MjB9LHWxSQ3uAcMLfdb
         9CyhqE+OocuxRlulx+i3Ezw7AsWcr6VbUcNdDjL4=
Received: from epsnrtp1.localdomain (unknown [182.195.42.162]) by
        epcas2p4.samsung.com (KnoxPortal) with ESMTP id
        20210331011619epcas2p405ea89d9cd51b32bfabb028aec4028bb~xSG5Yfd9T0265802658epcas2p4u;
        Wed, 31 Mar 2021 01:16:19 +0000 (GMT)
Received: from epsmges2p4.samsung.com (unknown [182.195.40.190]) by
        epsnrtp1.localdomain (Postfix) with ESMTP id 4F97gP4jzHz4x9QB; Wed, 31 Mar
        2021 01:16:17 +0000 (GMT)
X-AuditID: b6c32a48-50fff7000000cd1f-26-6063cd61a479
Received: from epcas2p3.samsung.com ( [182.195.41.55]) by
        epsmges2p4.samsung.com (Symantec Messaging Gateway) with SMTP id
        82.4F.52511.16DC3606; Wed, 31 Mar 2021 10:16:17 +0900 (KST)
Mime-Version: 1.0
Subject: [PATCH v32 1/4] scsi: ufs: Introduce HPB feature
...
X-Msg-Type: PERSONAL
X-Reply-Demand: N
Message-ID: <20210331011616epcms2p407b56f3ae01bdf71910055f54933e66f@epcms2p4>
Date:   Wed, 31 Mar 2021 10:16:16 +0900
X-CMS-MailID: 20210331011616epcms2p407b56f3ae01bdf71910055f54933e66f
...
X-CPGSPASS: Y
CMS-TYPE: 102P
X-Brightmail-Tracker: H4sIAAAAAAAAA+NgFnrOJsWRmVeSWpSXmKPExsWy7bCmuW7i2eQEg1WX5SwezNvGZrG37QS7
        ...
        
DLP-Filter: Pass
...
index 8ca8ceb9c145..045a14843c14 100644
...
@@ -4848,6 +4849,25 @@ static int ufshcd_change_queue_depth(struct scsi_device *sdev, int depth)
...
@@ -4857,6 +4877,8 @@ static int ufshcd_slave_configure(struct scsi_device *sdev)
...
@@ -4878,6 +4900,9 @@ static void ufshcd_slave_destroy(struct scsi_device *sdev)
 	struct ufs_hba *hba;
...
+
 	...
 	if (ufshcd_scsi_to_upiu_lun(sdev->lun) == UFS_UPIU_UFS_DEVICE_WLUN) {
 		unsigned long flags;
@@ -6967,6 +6992,8 @@ static int ufshcd_host_reset_and_restore(struct ufs_hba *hba)
...
@@ -7369,6 +7396,7 @@ static int ufs_get_device_desc(struct ufs_hba *hba)
 {
 	int err;
 	u8 model_index;
...
@@ -7396,9 +7424,16 @@ static int ufs_get_device_desc(struct ufs_hba *hba)
...
+
 	...
 	if (err < 0) {
@@ -7627,6 +7662,10 @@ static int ufshcd_device_geo_params_init(struct ufs_hba *hba)
...
+
 out:
 	kfree(desc_buf);
 	return err;
@@ -7769,6 +7808,7 @@ static int ufshcd_add_lus(struct ufs_hba *hba)
 	}
...
@@ -7914,6 +7954,7 @@ static int ufshcd_probe_hba(struct ufs_hba *hba, bool async)
...
+	ufshpb_reset(hba);
 out:
 	spin_lock_irqsave(hba->host->host_lock, flags);
 	if (ret)
@@ -7961,6 +8002,9 @@ static void ufshcd_async_scan(void *data, async_cookie_t cookie)
...
@@ -8677,6 +8721,8 @@ static int ufshcd_suspend(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
@@ -8812,6 +8858,7 @@ static int ufshcd_suspend(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
@@ -8919,6 +8966,8 @@ static int ufshcd_resume(struct ufs_hba *hba, enum ufs_pm_op pm_op)
 	/* Enable Auto-Hibernate if configured */
 	ufshcd_auto_hibern8_enable(hba);
