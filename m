Return-Path: <linux-scsi+bounces-8633-lists+linux-scsi=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-scsi@lfdr.de
Delivered-To: lists+linux-scsi@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F77898E44F
	for <lists+linux-scsi@lfdr.de>; Wed,  2 Oct 2024 22:40:35 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 6CD091F21F6E
	for <lists+linux-scsi@lfdr.de>; Wed,  2 Oct 2024 20:40:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AA2C2216A20;
	Wed,  2 Oct 2024 20:40:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=acm.org header.i=@acm.org header.b="dZc8Tv0l"
X-Original-To: linux-scsi@vger.kernel.org
Received: from 009.lax.mailroute.net (009.lax.mailroute.net [199.89.1.12])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 70D831D0E3F
	for <linux-scsi@vger.kernel.org>; Wed,  2 Oct 2024 20:40:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=199.89.1.12
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1727901628; cv=none; b=loG7FAESYRBQ7BB51NFKH39BGTAni/Pr0EIMnGTK6YjU/neW67lSEVip5lDI51qkgEPH+kmts5aPEfqVvViwui2w0V8uW5EZnVSGjpM0zGcnYrZJqzTJ5J2I1FKAYKdUl7T/ShZ4Lm7L1mqD/xHviC2ERTD4tlZQggs4MmDivQM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1727901628; c=relaxed/simple;
	bh=v2kQWjnvS5BHTqefK1aALf/+DDOS8oohrsR0pD54IpA=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=M4TZ8fxCDzLw6PQ86h6joDqcPAIm/g7orIKMh+j8tSjao3h9ltwYRv9gtnVGKINNYvbZwv+1WZzoPojLCQqGBri34ycapAsZyyXE79J0WBKHAaGAPjTWBWSRQWMFxYet02iIstYkgufiY0DTAiiwCMA1D12vB09K81o0LUgt8JY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=acm.org; spf=pass smtp.mailfrom=acm.org; dkim=pass (2048-bit key) header.d=acm.org header.i=@acm.org header.b=dZc8Tv0l; arc=none smtp.client-ip=199.89.1.12
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=acm.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=acm.org
Received: from localhost (localhost [127.0.0.1])
	by 009.lax.mailroute.net (Postfix) with ESMTP id 4XJmsP01rZzlgMVN;
	Wed,  2 Oct 2024 20:40:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=acm.org; h=
	content-transfer-encoding:mime-version:references:in-reply-to
	:x-mailer:message-id:date:date:subject:subject:from:from
	:received:received; s=mr01; t=1727901447; x=1730493448; bh=eJqkR
	0PiaV6MofSvkLGPsIyeDDdSmdnqhLuI6jk7FMs=; b=dZc8Tv0lJi3n8O1AyQZgQ
	
X-Virus-Scanned: by MailRoute
Received: from 009.lax.mailroute.net ([127.0.0.1])
 by localhost (009.lax [127.0.0.1]) (mroute_mailscanner, port 10029) with LMTP
 id QmIGzZEnsmKX; Wed,  2 Oct 2024 20:37:27 +0000 (UTC)
Received: from bvanassche.mtv.corp.google.com (unknown [104.135.204.82])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	(Authenticated sender: bvanassche@acm.org)
	by 009.lax.mailroute.net (Postfix) with ESMTPSA id 4XJmnY3jqzzlgMWL;
	Wed,  2 Oct 2024 20:37:05 +0000 (UTC)
...
Subject: [PATCH v2 09/11] scsi: Convert SCSI drivers to .sdev_configure()
Date: Wed,  2 Oct 2024 13:34:01 -0700
Message-ID: <20241002203528.4104996-10-bvanassche@acm.org>
...
---
 ...
 46 files changed, 163 insertions(+), 123 deletions(-)
...
c.c
index c86ca66ad326..415fc1c9a11b 100644
...
sas.c
index 932f67aace1e..9807b61beea6 100644
...
spi.c
index 2fe8cecff458..53a47a2437d0 100644
--- a/drivers/message/fusion/mptspi.c
+++ b/drivers/message/fusion/mptspi.c
@@ -746,7 +746,8 @@ static int mptspi_sdev_prep(struct scsi_device *sdev)
 	return 0;
 }
=20
...
c
index 2e217b007b9c..a8e272cc34d9 100644
...
index 9568401b80e9..9169d10165f6 100644
...
@@ -2029,7 +2030,7 @@ NCR_700_sdev_prep(struct scsi_device *SDp)
 }
=20
 STATIC int
...
c79xx_osm.c
index 9f65c5150119..3f992228dc57 100644
--- a/drivers/scsi/aic7xxx/aic79xx_osm.c
+++ b/drivers/scsi/aic7xxx/aic79xx_osm.c
@@ -701,7 +701,7 @@ ahd_linux_sdev_prep(struct scsi_device *sdev)
 }
=20
 static int
...
c7xxx_osm.c
index 122dce89a009..83bec830bb16 100644
--- a/drivers/scsi/aic7xxx/aic7xxx_osm.c
+++ b/drivers/scsi/aic7xxx/aic7xxx_osm.c
@@ -664,7 +664,7 @@ ahc_linux_sdev_prep(struct scsi_device *sdev)
 }
=20
 static int
...
index fad91a5c5a71..240ffbf91032 100644
...
fc_fcoe.c
index bc3873211d6c..d84727ce5a0f 100644
...
io_scsi.c
index b30c0e19a78a..7d261264ad49 100644
--- a/drivers/scsi/csiostor/csio_scsi.c
+++ b/drivers/scsi/csiostor/csio_scsi.c
@@ -2237,7 +2237,7 @@ csio_sdev_prep(struct scsi_device *sdev)
 }
=20
 static int
...
index 06551b4f8bac..623408689931 100644
...
+	/* Start with a clear state, domain validation (via ->sdev_configure,
 	 ...
 	 * commands.
 	 */
@@ -2463,7 +2463,7 @@ static int esp_sdev_prep(struct scsi_device *dev)
 	return 0;
 }
=20
...
index 674278cd6ff3..72eb72a48d7e 100644
...
@@ -2142,7 +2143,8 @@ static int hpsa_sdev_prep(struct scsi_device *sdev)
=20
...
c.c
index e8b6a9a779a0..b095d979640d 100644
...
c
index 6726fa91306c..29b79c8505e4 100644
--- a/drivers/scsi/lpfc/lpfc_scsi.c
+++ b/drivers/scsi/lpfc/lpfc_scsi.c
@@ -6342,8 +6342,9 @@ lpfc_sdev_prep(struct scsi_device *sdev)
 }
=20
 /**
...
@@ -6353,7 +6354,7 @@ lpfc_sdev_prep(struct scsi_device *sdev)
  *   0 - Success
  **/
 static int
...
+	.sdev_prep		=3D lpfc_prep_no_sdev,
...
index bc5b2473cadf..0d6370c23ebc 100644
--- a/drivers/scsi/myrb.c
+++ b/drivers/scsi/myrb.c
@@ -1715,7 +1715,8 @@ static int myrb_sdev_prep(struct scsi_device *sdev)
...
index d2bc2843a274..775ebda81f7d 100644
--- a/drivers/scsi/myrs.c
+++ b/drivers/scsi/myrs.c
@@ -1882,7 +1882,8 @@ static int myrs_sdev_prep(struct scsi_device *sdev)
 	return 0;
 }
=20
...
index 5181107ba0ab..7949b1c7d94d 100644
--- a/drivers/scsi/ncr53c8xx.c
+++ b/drivers/scsi/ncr53c8xx.c
@@ -7796,7 +7796,8 @@ static int ncr53c8xx_sdev_prep(struct scsi_device *=
device)
 	return 0;
 }
=20
...
@@ -8093,8 +8094,8 @@ struct Scsi_Host * __init ncr_attach(struct scsi_ho=
st_template *tpnt,
...
c
index cf13148ba281..d18458289535 100644
...
c
index f04033dbf12d..344ece55b5e5 100644
--- a/drivers/scsi/qla2xxx/qla_os.c
+++ b/drivers/scsi/qla2xxx/qla_os.c
@@ -1947,7 +1947,7 @@ qla2xxx_sdev_prep(struct scsi_device *sdev)
 }
=20
 static int
...
index aca10454bd91..bba8edd75b53 100644
--- a/drivers/scsi/scsi_debug.c
+++ b/drivers/scsi/scsi_debug.c
@@ -5890,14 +5890,15 @@ static int scsi_debug_sdev_prep(struct scsi_devic=
e *sdp)
 	return 0;
 }
=20
...
index 768a469f3f7f..8eae48b0b821 100644
...
i/smartpqi_init.c
index 2c1e16ebe890..685b306ce5b3 100644
...
c
index c8d90586f51b..acab3cce6562 100644
--- a/drivers/scsi/snic/snic_main.c
+++ b/drivers/scsi/snic/snic_main.c
@@ -57,11 +57,11 @@ snic_sdev_prep(struct scsi_device *sdev)
 }
=20
 /*
...
index a5d615326993..b692cf54fe20 100644
...
_2/sym_glue.c
index c1075aaf6501..94fc65dcdb51 100644
--- a/drivers/scsi/sym53c8xx_2/sym_glue.c
+++ b/drivers/scsi/sym53c8xx_2/sym_glue.c
@@ -825,7 +825,8 @@ static int sym53c8xx_sdev_prep(struct scsi_device *sd=
ev)
 /*
...
x.c
index 27662e465f49..e1f83f397f72 100644
