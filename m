...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6EECC28EAD4
	for <lists+linux-scsi@lfdr.de>; Thu, 15 Oct 2020 04:07:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732556AbgJOCH0 (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 14 Oct 2020 22:07:26 -0400
Received: from smtp.infotech.no ([82.134.31.41]:40127 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730034AbgJOCHO (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Wed, 14 Oct 2020 22:07:14 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 54AB820424C;
        Thu, 15 Oct 2020 04:07:13 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id lwkE0HWn+gWs; Thu, 15 Oct 2020 04:07:10 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-104-157-204-209.dyn.295.ca [104.157.204.209])
        by smtp.infotech.no (Postfix) with ESMTPA id 1A67020414F;
        Thu, 15 Oct 2020 04:07:05 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v11 19/44] sg: introduce request state machine
Date:   Wed, 14 Oct 2020 22:06:18 -0400
Message-Id: <20201015020643.432908-20-dgilbert@interlog.com>
...
index 6f7093baa3ff..591852609ba5 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
+	case SG_NEXT_CMD_LEN:	/* active only in v2 interface */
 		...
 		if (result)
@@ -2253,48 +2327,37 @@ sg_remove_sgat(struct sg_fd *sfp, struct sg_scatter_hold *schp)
 static int
...
+	return res;
 ...
 static void
@@ -2343,6 +2406,22 @@ sg_unlink_reserve(struct sg_fd *sfp, struct sg_request *srp)
 	sfp->res_in_use = 0;
 }
...
@@ -2374,23 +2453,21 @@ sg_setup_req(struct sg_fd *sfp)
 	return NULL;
 }
...
-	return res;
 ...
 static struct sg_fd *
@@ -2448,6 +2525,15 @@ sg_add_sfp(struct sg_device *sdp)
 	return sfp;
 }
...
+ */
 ...
 {
@@ -2543,6 +2629,33 @@ sg_get_dev(int dev)
 	return sdp;
 }
...
@@ -2839,8 +2952,9 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
