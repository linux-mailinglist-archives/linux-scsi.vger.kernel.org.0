...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2525F38DEB7
	for <lists+linux-scsi@lfdr.de>; Mon, 24 May 2021 03:02:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232300AbhEXBEU (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 23 May 2021 21:04:20 -0400
Received: from smtp.infotech.no ([82.134.31.41]:33295 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232249AbhEXBEH (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 23 May 2021 21:04:07 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id BD833204278;
        Mon, 24 May 2021 03:02:37 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id gVDk-Onwfs6j; Mon, 24 May 2021 03:02:34 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-45-58-219-4.dyn.295.ca [45.58.219.4])
        by smtp.infotech.no (Postfix) with ESMTPA id AC2E5204275;
        Mon, 24 May 2021 03:02:30 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v19 35/45] sg: first debugfs support
Date:   Sun, 23 May 2021 21:01:37 -0400
Message-Id: <20210524010147.94845-36-dgilbert@interlog.com>
...
index c67edc76d0e1..ffcf09440ca6 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -2683,22 +2690,6 @@ sg_remove_device(struct device *cl_dev, struct class_interface *cl_intf)
...
@@ -3201,7 +3186,7 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
...
@@ -3638,17 +3623,6 @@ sg_remove_sfp(struct kref *kref)
...
@@ -3678,7 +3652,7 @@ sg_get_dev(int dev)
 	return sdp;
 }
...
+#if IS_ENABLED(SG_PROC_OR_DEBUG_FS)
 ...
 {
@@ -3707,7 +3681,35 @@ sg_rq_st_str(enum sg_rq_state rq_st, bool long_str)
 }
 #endif
...
+}
 ...
 static int
 sg_last_dev(void)
@@ -3721,6 +3723,41 @@ sg_last_dev(void)
 	return k + 1;		/* origin 1 */
 }
...
+
 ...
 {
@@ -3734,7 +3771,7 @@ sg_proc_single_open_adio(struct inode *inode, struct file *filp)
...
+static ssize_t
 ...
 {
@@ -3756,7 +3793,7 @@ sg_proc_single_open_dressz(struct inode *inode, struct file *filp)
...
+static ssize_t
 sg_proc_write_dressz(struct file *filp, const char __user *buffer,
 		     size_t count, loff_t *off)
 {
@@ -3791,43 +3828,6 @@ sg_proc_seq_show_devhdr(struct seq_file *s, void *v)
 	return 0;
 }
...
-
 ...
 {
@@ -3874,6 +3874,10 @@ sg_proc_seq_show_devstrs(struct seq_file *s, void *v)
 	return 0;
 }
...
@@ -4016,18 +4020,20 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	bool found = false;
 	bool trunc = false;
...
@@ -4039,8 +4045,31 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	}
...
@@ -4080,6 +4109,10 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	return 0;
 }
...
+
 static const struct proc_ops adio_proc_ops = {
 	...
 	.proc_read      = seq_read,
@@ -4138,7 +4171,226 @@ sg_proc_init(void)
