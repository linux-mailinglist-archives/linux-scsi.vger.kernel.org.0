...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 847914F882D
	for <lists+linux-scsi@lfdr.de>; Thu,  7 Apr 2022 21:33:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229782AbiDGTfs (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Thu, 7 Apr 2022 15:35:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33442 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229469AbiDGTfr (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Thu, 7 Apr 2022 15:35:47 -0400
Received: from mail-pg1-x543.google.com (mail-pg1-x543.google.com [IPv6:2607:f8b0:4864:20::543])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 39FFD2C6718
        for <linux-scsi@vger.kernel.org>; Thu,  7 Apr 2022 12:33:28 -0700 (PDT)
Received: by mail-pg1-x543.google.com with SMTP id c2so5805212pga.10
        for <linux-scsi@vger.kernel.org>; Thu, 07 Apr 2022 12:33:28 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version;
        bh=2YyuSvP/yCD7e9rJtE+iov2lNs3Cmy+/Pdxw8BUBG1M=;
        b=JRSQwTjVAoHno2HfXNn8OdLYExzJAwCqVkSUxHIF1+ZyYgAiRvf/bj621TDoppVNom
         9ChVGr4sW60vvyTApV5nPCAKoNpG6YUYCLGEGZPtCjYI7SK/gCIARpbFNkzqFghHRBvn
         Yg6gb7kfP1TFjSMLp3szrVqV/c388nIGsSKp0=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version;
        bh=2YyuSvP/yCD7e9rJtE+iov2lNs3Cmy+/Pdxw8BUBG1M=;
        b=
X-Gm-Message-State: AOAM533zBtneyekOhjktxs1oTGGfHmBAND+v80bTExMMi5SrinriPeMU
        XA5eHDSwPcX4P+08lsYh3Cul93VKxrqGbtLI/p2EF8R4cYo1Fqzn0WKvL2IeCqAwN3jOcPyQAWn
        V6unVV4fqTd2nT+9etyJY/Og1DsA1Oo2piu2FT6p3wPqOYep/eSfsrwJp5YWUvgdIvh42YwPTO7
        Pb7DioyLoYtQ==
X-Google-Smtp-Source: ABdhPJzJVlrRv7+2/DBLxI2zH7ggV2WIHg1TP9mjWKAz7I8grAzMI60gWQXanfoo0tn1/zlVQE17Lw==
X-Received: by 2002:a63:354f:0:b0:398:4ead:866e with SMTP id c76-20020a63354f000000b003984ead866emr12776075pga.322.1649359804799;
        Thu, 07 Apr 2022 12:30:04 -0700 (PDT)
Received: from dhcp-10-123-20-15.dhcp.broadcom.net ([192.19.234.250])
        by smtp.gmail.com with ESMTPSA id o3-20020a056a0015c300b004fb24adc4b8sm23579275pfu.159.2022.04.07.12.30.01
...
Subject: [PATCH v3 5/8] mpi3mr: add support for PEL commands
Date:   Thu,  7 Apr 2022 15:29:10 -0400
Message-Id: <20220407192913.345411-6-sumit.saxena@broadcom.com>
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
        boundary="0000000000005219cb05dc1581dd"
...
index e77a0744cac1..2c043e6b9d6a 100644
...
@@ -893,8 +907,20 @@ struct mpi3mr_ioc {
...
@@ -930,6 +957,7 @@ struct mpi3mr_fwevt {
 	bool send_ack;
 	bool process_evt;
 	u32 evt_ctx;
+	u16 event_data_size;
...
@@ -1021,5 +1049,11 @@ int mpi3mr_issue_tm(struct mpi3mr_ioc *mrioc, u8 tm_type,
...
index 515329aeb8b3..0b9710c83065 100644
...

--0000000000005219cb05dc1581dd--
