...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6F07738DEA0
	for <lists+linux-scsi@lfdr.de>; Mon, 24 May 2021 03:02:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232207AbhEXBDo (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 23 May 2021 21:03:44 -0400
Received: from smtp.infotech.no ([82.134.31.41]:33116 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232192AbhEXBDm (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 23 May 2021 21:03:42 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 06142204273;
        Mon, 24 May 2021 03:02:10 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id iJgDNhPDdvMx; Mon, 24 May 2021 03:02:06 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-45-58-219-4.dyn.295.ca [45.58.219.4])
        by smtp.infotech.no (Postfix) with ESMTPA id 6165920426D;
        Mon, 24 May 2021 03:02:02 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v19 10/45] sg: improve naming
Date:   Sun, 23 May 2021 21:01:12 -0400
Message-Id: <20210524010147.94845-11-dgilbert@interlog.com>
...
index ee45bde9bb3a..a21c6e416b73 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -1889,13 +1904,13 @@ sg_start_req(struct sg_request *srp, u8 *cmd)
...
+			if (dxfer_len > rsv_schp->buflen)
 			...
 			mutex_unlock(&sfp->f_mutex);
 			return res;
@@ -1910,7 +1925,7 @@ sg_start_req(struct sg_request *srp, u8 *cmd)
...
@@ -1999,7 +2014,7 @@ sg_build_indirect(struct sg_scatter_hold *schp, struct sg_fd *sfp,
 		  int buff_size)
 {
...
@@ -2007,13 +2022,13 @@ sg_build_indirect(struct sg_scatter_hold *schp, struct sg_fd *sfp,
 		return -EFAULT;
 	if (0 == blk_size)
...
+	for (k = 0; k < schp->num_sgat && schp->pages[k]; k++) {
 		if (num > num_xfer) {
 			if (copy_to_user(outp, page_address(schp->pages[k]),
 					   num_xfer))
@@ -2150,22 +2165,21 @@ sg_link_reserve(struct sg_fd *sfp, struct sg_request *srp, int size)
 	rem = size;
...
-	}
 ...
 static void
@@ -2173,10 +2187,10 @@ sg_unlink_reserve(struct sg_fd *sfp, struct sg_request *srp)
 {
...
@@ -2187,7 +2201,7 @@ sg_unlink_reserve(struct sg_fd *sfp, struct sg_request *srp)
...
@@ -2266,7 +2280,7 @@ sg_add_sfp(struct sg_device *sdp)
 		kfree(sfp);
...
@@ -2275,8 +2289,8 @@ sg_add_sfp(struct sg_device *sdp)
...
@@ -2286,7 +2300,7 @@ sg_add_sfp(struct sg_device *sdp)
 static void
...
+	struct sg_fd *sfp = container_of(work, struct sg_fd, ew_fd.work);
 	...
 	struct sg_request *srp;
 	unsigned long iflags;
@@ -2301,9 +2315,9 @@ sg_remove_sfp_usercontext(struct work_struct *work)
 	}
...
@@ -2323,11 +2337,11 @@ sg_remove_sfp(struct kref *kref)
 	unsigned long iflags;
...
+	schedule_work(&sfp->ew_fd.work);
 ...
 static int
@@ -2614,22 +2628,22 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
...
@@ -2649,8 +2663,8 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
 					cp = "     ";
 			}
 			seq_puts(s, cp);
...
+			usg = srp->data.num_sgat;
 			seq_puts(s, srp->done ?
 				 ((1 == srp->done) ?  "rcv:" : "fin:")
 				  : "act:");
@@ -2703,8 +2717,8 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 				   scsidp->lun,
