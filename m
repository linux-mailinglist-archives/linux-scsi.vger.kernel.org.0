...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E2D9C3579C5
	for <lists+linux-scsi@lfdr.de>; Thu,  8 Apr 2021 03:46:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231290AbhDHBqz (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 7 Apr 2021 21:46:55 -0400
Received: from smtp.infotech.no ([82.134.31.41]:45252 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231297AbhDHBqf (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Wed, 7 Apr 2021 21:46:35 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 7BDD3204272;
        Thu,  8 Apr 2021 03:46:22 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id EWoVa+A2QoUK; Thu,  8 Apr 2021 03:46:19 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-45-58-219-4.dyn.295.ca [45.58.219.4])
        by smtp.infotech.no (Postfix) with ESMTPA id 0F8F2204277;
        Thu,  8 Apr 2021 03:46:14 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v17 35/45] sg: first debugfs support
Date:   Wed,  7 Apr 2021 21:45:21 -0400
Message-Id: <20210408014531.248890-36-dgilbert@interlog.com>
...
index e751e1dc832a..726f6df4b9fc 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -2732,22 +2739,6 @@ sg_remove_device(struct device *cl_dev, struct class_interface *cl_intf)
...
@@ -3255,7 +3240,7 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
...
@@ -3692,17 +3677,6 @@ sg_remove_sfp(struct kref *kref)
...
@@ -3732,7 +3706,7 @@ sg_get_dev(int dev)
 	return sdp;
 }
...
+#if IS_ENABLED(SG_PROC_OR_DEBUG_FS)
 ...
 {
@@ -3761,7 +3735,35 @@ sg_rq_st_str(enum sg_rq_state rq_st, bool long_str)
 }
 #endif
...
+}
 ...
 static int
 sg_last_dev(void)
@@ -3775,6 +3777,41 @@ sg_last_dev(void)
 	return k + 1;		/* origin 1 */
 }
...
+
 ...
 {
@@ -3788,7 +3825,7 @@ sg_proc_single_open_adio(struct inode *inode, struct file *filp)
...
+static ssize_t
 ...
 {
@@ -3810,7 +3847,7 @@ sg_proc_single_open_dressz(struct inode *inode, struct file *filp)
...
+static ssize_t
 sg_proc_write_dressz(struct file *filp, const char __user *buffer,
 		     size_t count, loff_t *off)
 {
@@ -3845,43 +3882,6 @@ sg_proc_seq_show_devhdr(struct seq_file *s, void *v)
 	return 0;
 }
...
-
 ...
 {
@@ -3928,6 +3928,10 @@ sg_proc_seq_show_devstrs(struct seq_file *s, void *v)
 	return 0;
 }
...
@@ -4070,18 +4074,20 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	bool found = false;
 	bool trunc = false;
...
@@ -4093,8 +4099,31 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	}
...
@@ -4134,6 +4163,10 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	return 0;
 }
...
+
 static const struct proc_ops adio_proc_ops = {
 	...
 	.proc_read      = seq_read,
@@ -4192,7 +4225,226 @@ sg_proc_init(void)
