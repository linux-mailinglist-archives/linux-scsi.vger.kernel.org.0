Return-Path: <linux-scsi+bounces-660-lists+linux-scsi=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-scsi@lfdr.de
Delivered-To: lists+linux-scsi@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 3DB41807993
	for <lists+linux-scsi@lfdr.de>; Wed,  6 Dec 2023 21:39:16 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 6BFF8B20FAE
	for <lists+linux-scsi@lfdr.de>; Wed,  6 Dec 2023 20:39:13 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D14C4249EA
	for <lists+linux-scsi@lfdr.de>; Wed,  6 Dec 2023 20:39:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=cisco.com header.i=@cisco.com header.b="frm3XDb5"
X-Original-To: linux-scsi@vger.kernel.org
Received: from rcdn-iport-9.cisco.com (rcdn-iport-9.cisco.com [173.37.86.80])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D9B82D6D;
	Wed,  6 Dec 2023 10:47:08 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=cisco.com; i=@cisco.com; l=57507; q=dns/txt;
  s=iport; t=1701888429; x=1703098029;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=9QOnGHdkx3g/ByKajcXBeYDmMM4/dALltuNEDcn6M5E=;
  b=frm3XDb5xmuO2TwCd5wCzzIXcTZIVpLWPzLKTTXu/XyamgidZcpwkiIz
   S8NXPu6HFUEDd+E/VI7XbaVeS/l85H5OCpxVlHXYWHMA5XZ93/tE73oC9
   gDlnyNhu7+aWbDmq+mscaYvU6K9EjPqRk1dmxczdz1aRZPm/heeS6cVTU
   0=;
X-CSE-ConnectionGUID: hMaQfV/DQM+LtEmO8DfbSA==
X-CSE-MsgGUID: DG84a5UqTXWWqcmHw2DOiQ==
X-IronPort-AV: E=Sophos;i="6.04,256,1695686400"; 
   d="scan'208";a="154982435"
Received: from alln-core-4.cisco.com ([173.36.13.137])
  by rcdn-iport-9.cisco.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 06 Dec 2023 18:47:07 +0000
Received: from localhost.cisco.com ([10.193.101.253])
	(authenticated bits=0)
	by alln-core-4.cisco.com (8.15.2/8.15.2) with ESMTPSA id 3B6IkHD7010013
	(version=TLSv1.2 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=NO);
	Wed, 6 Dec 2023 18:47:06 GMT
...
Subject: [PATCH v5 11/13] scsi: fnic: Add support for multiqueue (MQ) in fnic driver
Date: Wed,  6 Dec 2023 10:46:13 -0800
Message-Id: <20231206184615.878755-12-kartilak@cisco.com>
