...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BF26D1C810F
	for <lists+linux-scsi@lfdr.de>; Thu,  7 May 2020 06:29:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725923AbgEGE3J (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Thu, 7 May 2020 00:29:09 -0400
Received: from mail-pj1-f66.google.com ([209.85.216.66]:55213 "EHLO
        mail-pj1-f66.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725905AbgEGE3G (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Thu, 7 May 2020 00:29:06 -0400
Received: by mail-pj1-f66.google.com with SMTP id y6so2066028pjc.4
        for <linux-scsi@vger.kernel.org>; Wed, 06 May 2020 21:29:02 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=wHfjAGUIjQNRRsVuCsPmg0HykZd+mp+kvoPvoYtDGCk=;
        b=
X-Gm-Message-State: AGi0PubXfx73RqokbJBIcjLn7Torh6wzG4LbE/WCKpYB57s2DDuGuaXF
        wnwOWsvNzloAr4XKEPSaSc0=
X-Google-Smtp-Source: APiQypLnrm2hDkZA5KToSA0COPkaoqAOo2emJEkqy2Eg3oXJMQIjauC5opJ8ZxTordvKx9NxXBavrg==
X-Received: by 2002:a17:90a:224b:: with SMTP id c69mr13829137pje.8.1588825741763;
        Wed, 06 May 2020 21:29:01 -0700 (PDT)
Received: from localhost.localdomain ([2601:647:4000:d7:246f:3453:e672:e40c])
        by smtp.gmail.com with ESMTPSA id z28sm3471028pfr.3.2020.05.06.21.29.00
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 06 May 2020 21:29:00 -0700 (PDT)
...
Subject: [PATCH v5 11/11] qla2xxx: Fix endianness annotations in source files
Date:   Wed,  6 May 2020 21:28:35 -0700
Message-Id: <20200507042835.9135-12-bvanassche@acm.org>
...
index 3a5f6f27587e..54017f472b22 100644
...
index 02614e28451b..24af775782fc 100644
...
@@ -7509,7 +7511,7 @@ qla28xx_get_aux_images(
...
@@ -7542,7 +7544,7 @@ qla28xx_get_aux_images(
...
@@ -7607,7 +7609,7 @@ qla27xx_get_active_image(struct scsi_qla_host *vha,
 		goto check_sec_image;
 	}
...
+	if (qla24xx_read_flash_data(vha, (uint32_t *)&pri_image_status,
 	    ...
 	    QLA_SUCCESS) {
 		WARN_ON_ONCE(true);
@@ -7714,7 +7716,7 @@ qla24xx_load_risc_flash(scsi_qla_host_t *vha, uint32_t *srisc_addr,
...
@@ -7727,18 +7729,18 @@ qla24xx_load_risc_flash(scsi_qla_host_t *vha, uint32_t *srisc_addr,
...
@@ -7778,9 +7780,9 @@ qla24xx_load_risc_flash(scsi_qla_host_t *vha, uint32_t *srisc_addr,
 		fwdt->template = NULL;
 		fwdt->length = 0;
...
@@ -7982,7 +7985,7 @@ qla24xx_load_risc_blob(scsi_qla_host_t *vha, uint32_t *srisc_addr)
 		return QLA_FUNCTION_FAILED;
 	}
