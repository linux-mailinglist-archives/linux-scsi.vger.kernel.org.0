...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 86B8C64C3BA
	for <lists+linux-scsi@lfdr.de>; Wed, 14 Dec 2022 07:17:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236626AbiLNGR2 (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 14 Dec 2022 01:17:28 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52088 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229501AbiLNGRZ (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Wed, 14 Dec 2022 01:17:25 -0500
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A4E391057A
        for <linux-scsi@vger.kernel.org>; Tue, 13 Dec 2022 22:17:21 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1670998641; x=1702534641;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=qEilNtPL9fByqgOZikW9vVsfRSIjcpCndrILUdutNwE=;
  b=E41oqLkHzdVmRqYvs6kDqxCwjs1M2rwtsocOzJT0JdZCv5RtKcz84jKv
   ZT1edIEHpeChST9DkASHzwcIX+4D4mEi2prgoUiRliEqK7FvixEyZKET6
   1LKneigmtME5nr7EKjwkwAfZkj3PcI2rkCTe0Rz12y9QDYCvxgcnQ6TNw
   qfnp9pyTb74+axDVttmx1zmvrb11y/UMvP3CD/lnRF3+mcF0HMj5wyQgz
   m+wawTwco4h2FQ0oSCkiRXh/Lc931qA+2ktoqfZy0ROmBXD4btgq0LPbF
   KUGj6IzvQB/8CgUvIkuOXkpnAOoySiTAjTRnbF3LmvBNfEsXErnEWRQwM
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10560"; a="318365518"
X-IronPort-AV: E=Sophos;i="5.96,243,1665471600"; 
   d="scan'208";a="318365518"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Dec 2022 22:17:20 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10560"; a="823145867"
X-IronPort-AV: E=Sophos;i="5.96,243,1665471600"; 
   d="scan'208";a="823145867"
Received: from lkp-server01.sh.intel.com (HELO b5d47979f3ad) ([10.239.97.150])
  by orsmga005.jf.intel.com with ESMTP; 13 Dec 2022 22:17:16 -0800
Received: from kbuild by b5d47979f3ad with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1p5L4u-0005FG-0E;
        Wed, 14 Dec 2022 06:17:16 +0000
Date:   Wed, 14 Dec 2022 14:16:26 +0800
From:   kernel test robot <lkp@intel.com>
To:     Nilesh Javali <njavali@marvell.com>, martin.petersen@oracle.com
Cc:     oe-kbuild-all@lists.linux.dev, linux-scsi@vger.kernel.org,
        GR-QLogic-Storage-Upstream@marvell.com, bhazarika@marvell.com,
        agurumurthy@marvell.com
Subject: Re: [PATCH 05/10] qla2xxx: Fix exchange over subscription for mgt cmd
Message-ID: <202212141416.9Y795Cd0-lkp@intel.com>
References: <20221214045014.19362-6-njavali@marvell.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="+Zbwfq8jOEdQP2WO"
Content-Disposition: inline
In-Reply-To: <20221214045014.19362-6-njavali@marvell.com>
...
[auto build test WARNING on ae8011fe076da06f471258269b8ea28ed7df185b]

url:    https://github.com/intel-lab-lkp/linux/commits/Nilesh-Javali/Misc-qla2xxx-driver-bug-fixes/20221214-125154
base:   ae8011fe076da06f471258269b8ea28ed7df185b
patch link:    https://lore.kernel.org/r/20221214045014.19362-6-njavali%40marvell.com
patch subject: [PATCH 05/10] qla2xxx: Fix exchange over subscription for mgt cmd
config: ia64-allyesconfig
compiler: ia64-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/323c8d6475c67c19a054218cdac39d62d5263a78
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Nilesh-Javali/Misc-qla2xxx-driver-bug-fixes/20221214-125154
        git checkout 323c8d6475c67c19a054218cdac39d62d5263a78
...
>> drivers/scsi/qla2xxx/qla_iocb.c:3820:5: warning: no previous prototype for 'qla_get_iocbs_resource' [-Wmissing-prototypes]
    3820 | int qla_get_iocbs_resource(struct srb *sp)
         |     ^~~~~~~~~~~~~~~~~~~~~~


vim +/qla_get_iocbs_resource +3820 drivers/scsi/qla2xxx/qla_iocb.c

  3819	
> 3820	int qla_get_iocbs_resource(struct srb *sp)
  3821	{
  3822		bool get_exch;
  3823		bool push_it_through = false;
  3824	
  3825		if (!ql2xenforce_iocb_limit) {
  3826			sp->iores.res_type = RESOURCE_NONE;
  3827			return 0;
  3828		}
  3829		sp->iores.res_type = RESOURCE_NONE;
  3830	
  3831		switch (sp->type) {
  3832		case SRB_TM_CMD:
  3833		case SRB_PRLI_CMD:
  3834		case SRB_ADISC_CMD:
  3835			push_it_through = true;
  3836			fallthrough;
  3837		case SRB_LOGIN_CMD:
  3838		case SRB_ELS_CMD_RPT:
  3839		case SRB_ELS_CMD_HST:
  3840		case SRB_ELS_CMD_HST_NOLOGIN:
  3841		case SRB_CT_CMD:
  3842		case SRB_NVME_LS:
  3843		case SRB_ELS_DCMD:
  3844			get_exch = true;
  3845			break;
  3846	
  3847		case SRB_FXIOCB_DCMD:
  3848		case SRB_FXIOCB_BCMD:
  3849			sp->iores.res_type = RESOURCE_NONE;
  3850			return 0;
  3851	
  3852		case SRB_SA_UPDATE:
  3853		case SRB_SA_REPLACE:
  3854		case SRB_MB_IOCB:
  3855		case SRB_ABT_CMD:
  3856		case SRB_NACK_PLOGI:
  3857		case SRB_NACK_PRLI:
  3858		case SRB_NACK_LOGO:
  3859		case SRB_LOGOUT_CMD:
  3860		case SRB_CTRL_VP:
  3861			push_it_through = true;
  3862			fallthrough;
  3863		default:
  3864			get_exch = false;
  3865		}
  3866	
  3867		sp->iores.res_type |= RESOURCE_IOCB;
  3868		sp->iores.iocb_cnt = 1;
  3869		if (get_exch) {
  3870			sp->iores.res_type |= RESOURCE_EXCH;
  3871			sp->iores.exch_cnt = 1;
  3872		}
  3873		if (push_it_through)
  3874			sp->iores.res_type |= RESOURCE_FORCE;
  3875	
  3876		return qla_get_fw_resources(sp->qpair, &sp->iores);
  3877	}
  3878	
