...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A6A6FCF445
	for <lists+linux-scsi@lfdr.de>; Tue,  8 Oct 2019 09:50:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730454AbfJHHuf (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 8 Oct 2019 03:50:35 -0400
Received: from smtp.infotech.no ([82.134.31.41]:34857 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730420AbfJHHu3 (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Tue, 8 Oct 2019 03:50:29 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 2D39B204274;
        Tue,  8 Oct 2019 09:50:24 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 2OaQ7zLVIRi1; Tue,  8 Oct 2019 09:50:24 +0200 (CEST)
Received: from xtwo70.bingwo.ca (unknown [82.134.31.172])
        by smtp.infotech.no (Postfix) with ESMTPA id 9F7F1204248;
        Tue,  8 Oct 2019 09:50:23 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v5 15/23] sg: sg_common_write add structure for arguments
Date:   Tue,  8 Oct 2019 09:50:14 +0200
Message-Id: <20191008075022.30055-16-dgilbert@interlog.com>
...
index cbd75e34ca4b..903faafaeff9 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
@@ -177,6 +177,13 @@ struct sg_device { /* holds the state of each scsi generic device */
 	struct kref d_ref;
 };
...
@@ -189,8 +196,7 @@ static ssize_t sg_submit(struct sg_fd *sfp, struct file *filp,
...
@@ -495,6 +501,7 @@ sg_write(struct file *filp, const char __user *p, size_t count, loff_t *ppos)
...
@@ -594,7 +601,11 @@ sg_write(struct file *filp, const char __user *p, size_t count, loff_t *ppos)
...
@@ -667,23 +679,28 @@ sg_submit(struct sg_fd *sfp, struct file *filp, const char __user *buf,
...
+	srp->data.cmd_opcode = cwrp->cmnd[0];	/* hold opcode of command */
 	...
 	hp->masked_status = 0;
 	hp->msg_status = 0;
@@ -692,12 +709,12 @@ sg_common_write(struct sg_fd *sfp, struct sg_request *srp,
 	hp->driver_status = 0;
 	hp->resid = 0;
...
@@ -719,13 +736,13 @@ sg_common_write(struct sg_fd *sfp, struct sg_request *srp,
