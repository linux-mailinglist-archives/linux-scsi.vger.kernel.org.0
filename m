...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 215243EE965
	for <lists+linux-scsi@lfdr.de>; Tue, 17 Aug 2021 11:17:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239719AbhHQJRn (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 17 Aug 2021 05:17:43 -0400
Received: from smtp-out2.suse.de ([195.135.220.29]:47568 "EHLO
        smtp-out2.suse.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239369AbhHQJRR (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Tue, 17 Aug 2021 05:17:17 -0400
Received: from relay2.suse.de (relay2.suse.de [149.44.160.134])
        by smtp-out2.suse.de (Postfix) with ESMTP id 30E0E2001E;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        ...
        bh=UJb1IBWuSk2r7ui782/pWNT3C8FG0uroxhhZllr4sPw=;
        b=uW18VO8VoS3OpLcOIeXvqvIv8Kfhk7RHpVcEQDC1eRWiF/pR14njMbmzVLDaQmIBVI55xU
        wl5dtU6gdDmMXTAce4EDGzCO+MWLaUqt9pTHRs2dcT36oziaLn2VFq+w6QAfwaMI4S1/60
        E4nIGJaajRpoZ1RWeCBVbfGaAITZa7s=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        ...
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         ...
         in-reply-to:in-reply-to:references:references;
        bh=UJb1IBWuSk2r7ui782/pWNT3C8FG0uroxhhZllr4sPw=;
        b=jallY+OYiLXLed9a/AVjSQ751Ca3dfsN0mYBltQw6re0LS0VxHJbTtro0rj+kaUQdrtDlU
        damR+bQHSVbWwXCA==
Received: from adalid.arch.suse.de (adalid.arch.suse.de [10.161.8.13])
        by relay2.suse.de (Postfix) with ESMTP id 29B64A3BA5;
        Tue, 17 Aug 2021 09:16:42 +0000 (UTC)
Received: by adalid.arch.suse.de (Postfix, from userid 16045)
        id 256D5518CE89; Tue, 17 Aug 2021 11:16:42 +0200 (CEST)
...
Subject: [PATCH 21/51] scsi: Use Scsi_Host and channel number as argument for eh_bus_reset_handler()
Date:   Tue, 17 Aug 2021 11:14:26 +0200
Message-Id: <20210817091456.73342-22-hare@suse.de>
...
---
 ...
 .../staging/unisys/visorhba/visorhba_main.c   |  5 +--
 drivers/usb/storage/scsiglue.c                |  4 +-
 include/scsi/scsi_host.h                      |  2 +-
 36 files changed, 148 insertions(+), 163 deletions(-)

diff --git a/Documentation/scsi/scsi_eh.rst b/Documentation/scsi/scsi_eh.rst
index 1ca451ad57df..cf0649e0c3a9 100644
...
index 578e762da28d..0cc8c0b795dc 100644
...
index 3bf06dfcd4f9..c1f6aeae514d 100644
...
index 50af52a81505..54f260482f77 100644
...
index 028af6b1057c..eee119c06b48 100644
...
index 59909a8e4813..ae3bc94fc571 100644
--- a/drivers/scsi/aacraid/linit.c
+++ b/drivers/scsi/aacraid/linit.c
@@ -1023,20 +1023,18 @@ static int aac_eh_target_reset(struct scsi_cmnd *cmd)
...
@@ -1044,6 +1042,7 @@ static int aac_eh_bus_reset(struct scsi_cmnd* cmd)
...
index b13b5c85f3de..6fbdb6f3c996 100644
--- a/drivers/scsi/aha152x.c
+++ b/drivers/scsi/aha152x.c
@@ -1163,9 +1163,9 @@ static int aha152x_bus_reset_host(struct Scsi_Host *shpnt)
  * Reset the bus
  *
  */
...
index f38812a1556e..64d427200d8f 100644
--- a/drivers/scsi/aha1542.c
+++ b/drivers/scsi/aha1542.c
@@ -983,9 +983,9 @@ static int aha1542_reset(struct Scsi_Host *sh, u8 reset_cmd)
 	return SUCCESS;
 }
...
index 92ea24a075b8..9b2e15c4fe07 100644
--- a/drivers/scsi/aic7xxx/aic79xx_osm.c
+++ b/drivers/scsi/aic7xxx/aic79xx_osm.c
@@ -864,21 +864,21 @@ ahd_linux_dev_reset(struct scsi_cmnd *cmd)
  * Reset the SCSI bus.
  */
 static int
...
index 8b3d472aa3cc..0a487c9a43b8 100644
--- a/drivers/scsi/aic7xxx/aic7xxx_osm.c
+++ b/drivers/scsi/aic7xxx/aic7xxx_osm.c
@@ -754,16 +754,16 @@ ahc_linux_dev_reset(struct scsi_cmnd *cmd)
  * Reset the SCSI bus.
  */
 static int
...
index ec1a834c922d..25809d9fed7d 100644
...
@@ -4575,12 +4575,12 @@ static uint8_t arcmsr_iop_reset(struct AdapterControlBlock *acb)
 	return rtnval;
 }
...
index b23e8caad57b..4f17b24a291f 100644
...
index 50e540f5c214..0e86c54ca6fe 100644
...
index 24c7cefb0b78..673652060d3e 100644
...
@@ -1174,7 +1173,7 @@ static int __dc395x_eh_bus_reset(struct scsi_cmnd *cmd)
...
@@ -1184,7 +1183,7 @@ static int __dc395x_eh_bus_reset(struct scsi_cmnd *cmd)
...
@@ -1192,13 +1191,13 @@ static int __dc395x_eh_bus_reset(struct scsi_cmnd *cmd)
 	return SUCCESS;
 }
...
@@ -3343,7 +3342,7 @@ static void srb_done(struct AdapterCtlBlk *acb, struct DeviceCtlBlk *dcb,
...
@@ -3391,7 +3390,7 @@ static void doing_srb_done(struct AdapterCtlBlk *acb, u8 did_flag,
...
index ef38f964fa32..cceb25ada357 100644
--- a/drivers/scsi/dpt_i2o.c
+++ b/drivers/scsi/dpt_i2o.c
@@ -719,17 +719,18 @@ static int adpt_device_reset(struct scsi_cmnd* cmd)
...
index 167163820457..72af1fed419e 100644
...
index 45c83e3d887d..3d091333bd0b 100644
--- a/drivers/scsi/esp_scsi.c
+++ b/drivers/scsi/esp_scsi.c
@@ -2606,9 +2606,9 @@ static int esp_eh_abort_handler(struct scsi_cmnd *cmd)
 	return FAILED;
 }
...
index 9b75e19a9bab..f4a1dd83e768 100644
--- a/drivers/scsi/initio.c
+++ b/drivers/scsi/initio.c
@@ -2630,20 +2630,21 @@ static DEF_SCSI_QCMD(i91u_queuecommand)
...
index 3720f88ebc68..30d8482ddc7f 100644
...
index e7115cba4b28..b80ff27bb78c 100644
--- a/drivers/scsi/ncr53c8xx.c
+++ b/drivers/scsi/ncr53c8xx.c
@@ -7939,9 +7939,9 @@ static void ncr53c8xx_timeout(struct timer_list *t)
...
index 04b3d52e3547..1f65033458e3 100644
--- a/drivers/scsi/pcmcia/nsp_cs.c
+++ b/drivers/scsi/pcmcia/nsp_cs.c
@@ -1473,11 +1473,11 @@ static int nsp_bus_reset(nsp_hw_data *data)
 	return SUCCESS;
 }
...
index fe1e598e1746..8ccfc410c931 100644
...
index f29107536887..9397eaef0bac 100644
...
index dd69bfa85f04..f478e609d0ba 100644
...
index a84a85288c2e..b9cc7cfb5c21 100644
...
@@ -1581,8 +1576,8 @@ qla2xxx_eh_bus_reset(struct scsi_cmnd *cmd)
...
index 884bdaf26e10..63bbbcc94bbc 100644
--- a/drivers/scsi/scsi_debug.c
+++ b/drivers/scsi/scsi_debug.c
@@ -5218,36 +5218,27 @@ static int scsi_debug_target_reset(struct scsi_cmnd *SCpnt)
 	return SUCCESS;
 }
...
index 8218e2976482..d5e36488c87b 100644
--- a/drivers/scsi/scsi_error.c
+++ b/drivers/scsi/scsi_error.c
@@ -841,7 +841,7 @@ static enum scsi_disposition scsi_try_bus_reset(struct scsi_cmnd *scmd)
...
index 85b66286b4be..2e5ab844fe09 100644
--- a/drivers/scsi/sym53c8xx_2/sym_glue.c
+++ b/drivers/scsi/sym53c8xx_2/sym_glue.c
@@ -645,14 +645,13 @@ static int sym53c8xx_eh_device_reset_handler(struct scsi_cmnd *cmd)
...
index 05ef6651506b..847535fce8eb 100644
...
index 9485cbf5f946..85abbc82e7c8 100644
...
index bfb4a70432f3..7277cb5c8108 100644
...
index e5a971b83e3f..33456368ca1e 100644
...
index 3b1acf91f4d0..e0a102339317 100644
