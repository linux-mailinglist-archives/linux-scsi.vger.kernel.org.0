...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B5E8224F01E
	for <lists+linux-scsi@lfdr.de>; Mon, 24 Aug 2020 00:13:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727066AbgHWWNg (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 23 Aug 2020 18:13:36 -0400
Received: from smtp.infotech.no ([82.134.31.41]:54098 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726858AbgHWWN1 (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 23 Aug 2020 18:13:27 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 837E520426F;
        Mon, 24 Aug 2020 00:13:24 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 7brfcymypBhV; Mon, 24 Aug 2020 00:13:22 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-45-78-251-166.dyn.295.ca [45.78.251.166])
        by smtp.infotech.no (Postfix) with ESMTPA id 3F7C9204157;
        Mon, 24 Aug 2020 00:13:21 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v10 19/40] sg: introduce request state machine
Date:   Sun, 23 Aug 2020 18:12:27 -0400
Message-Id: <20200823221248.15678-20-dgilbert@interlog.com>
...
index 770e17bf96d0..c8224428b15f 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
+	case SG_NEXT_CMD_LEN:	/* active only in v2 interface */
 		...
 		if (result)
@@ -2256,48 +2330,37 @@ sg_remove_sgat(struct sg_fd *sfp, struct sg_scatter_hold *schp)
 static int
...
+	return res;
 ...
 static void
@@ -2346,6 +2409,22 @@ sg_unlink_reserve(struct sg_fd *sfp, struct sg_request *srp)
 	sfp->res_in_use = 0;
 }
...
@@ -2377,23 +2456,21 @@ sg_add_request(struct sg_fd *sfp)
 	return NULL;
 }
...
-	return res;
 ...
 static struct sg_fd *
@@ -2451,6 +2528,15 @@ sg_add_sfp(struct sg_device *sdp)
 	return sfp;
 }
...
+ */
 ...
 {
@@ -2546,6 +2632,33 @@ sg_get_dev(int dev)
 	return sdp;
 }
...
@@ -2842,8 +2955,9 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
