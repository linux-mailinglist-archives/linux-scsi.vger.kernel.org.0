...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 042822F5710
	for <lists+linux-scsi@lfdr.de>; Thu, 14 Jan 2021 02:59:26 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728339AbhANB6b (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 13 Jan 2021 20:58:31 -0500
Received: from smtp.infotech.no ([82.134.31.41]:50002 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729549AbhAMXks (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Wed, 13 Jan 2021 18:40:48 -0500
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id C004E20429F;
        Wed, 13 Jan 2021 23:45:45 +0100 (CET)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id JnLnukP1Tqut; Wed, 13 Jan 2021 23:45:43 +0100 (CET)
Received: from xtwo70.bingwo.ca (host-104-157-204-209.dyn.295.ca [104.157.204.209])
        by smtp.infotech.no (Postfix) with ESMTPA id D83E020426D;
        Wed, 13 Jan 2021 23:45:41 +0100 (CET)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        kashyap.desai@broadcom.com, Hannes Reinecke <hare@suse.com>
Subject: [PATCH v13 09/45] sg: sg_allow_if_err_recovery and renames
Date:   Wed, 13 Jan 2021 17:44:50 -0500
Message-Id: <20210113224526.861000-10-dgilbert@interlog.com>
...
index c85940c89700..37024c8c1905 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -916,7 +938,7 @@ sg_read(struct file *filp, char __user *buf, size_t count, loff_t *ppos)
...
+			ret = -EFAULT;
 		...
 		buf += SZ_SG_HEADER;
@@ -924,19 +946,19 @@ sg_read(struct file *filp, char __user *buf, size_t count, loff_t *ppos)
...
+	return ret;
 ...
 static int
@@ -1024,12 +1046,11 @@ sg_ioctl_common(struct file *filp, struct sg_device *sdp, struct sg_fd *sfp,
...
@@ -1229,8 +1250,7 @@ sg_ioctl_common(struct file *filp, struct sg_device *sdp, struct sg_fd *sfp,
 		break;
 	}
...
@@ -1410,7 +1430,7 @@ sg_rq_end_io_usercontext(struct work_struct *work)
...
@@ -1933,7 +1953,7 @@ sg_start_req(struct sg_request *srp, u8 *cmd)
 }
...
@@ -2078,7 +2098,7 @@ sg_remove_scat(struct sg_fd *sfp, struct sg_scatter_hold *schp)
...
+sg_rd_append(struct sg_request *srp, void __user *outp, int num_xfer)
 {
 	...
 	int k, num;
@@ -2281,7 +2301,7 @@ sg_remove_sfp_usercontext(struct work_struct *work)
...
@@ -2359,7 +2379,7 @@ sg_get_dev(int dev)
...
@@ -2370,7 +2390,7 @@ static const struct proc_ops adio_proc_ops = {
...
@@ -2419,13 +2439,13 @@ sg_proc_init(void)
 	if (!p)
 		return 1;
...
@@ -2449,9 +2469,9 @@ sg_proc_seq_show_int(struct seq_file *s, void *v)
 }
...
+	return single_open(filp, sg_proc_seq_show_int, &sg_allow_dio);
 ...
 static ssize_t 
@@ -2471,9 +2491,9 @@ sg_proc_write_adio(struct file *filp, const char __user *buffer,
 }
...
+	return single_open(filp, sg_proc_seq_show_int, &sg_big_buff);
 ...
 static ssize_t 
@@ -2535,7 +2555,7 @@ dev_seq_start(struct seq_file *s, loff_t *pos)
 static void *
...
@@ -2550,7 +2570,7 @@ dev_seq_stop(struct seq_file *s, void *v)
 static int
...
@@ -2576,7 +2596,7 @@ sg_proc_seq_show_dev(struct seq_file *s, void *v)
 static int
...
+	struct sg_proc_deviter *it = (struct sg_proc_deviter *)v;
 	...
 	struct scsi_device *scsidp;
 	unsigned long iflags;
@@ -2664,7 +2684,7 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
 static int
