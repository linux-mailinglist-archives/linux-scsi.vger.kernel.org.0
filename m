...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D9AD24202CE
	for <lists+linux-scsi@lfdr.de>; Sun,  3 Oct 2021 18:37:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231166AbhJCQjd (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 3 Oct 2021 12:39:33 -0400
Received: from smtp.infotech.no ([82.134.31.41]:55254 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231302AbhJCQja (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 3 Oct 2021 12:39:30 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id CD2FA2041BB;
        Sun,  3 Oct 2021 18:37:41 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id zOkZy0SerUWw; Sun,  3 Oct 2021 18:37:39 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-23-91-187-47.dyn.295.ca [23.91.187.47])
        by smtp.infotech.no (Postfix) with ESMTPA id C9174204201;
        Sun,  3 Oct 2021 18:35:36 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        Damien.LeMoal@wdc.com
Subject: [PATCH v21 23/46] sg: xarray for fds in device
Date:   Sun,  3 Oct 2021 12:31:28 -0400
Message-Id: <20211003163151.585349-24-dgilbert@interlog.com>
...
index b2f2bd23abc1..b5a0ee6e64ec 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
+	else if (o_count < 2)
 	...
 	mutex_unlock(&sdp->open_rel_lock);
 	return 0;
@@ -793,21 +788,6 @@ sg_common_write(struct sg_fd *sfp, struct sg_comm_wr_t *cwrp)
 	return 0;
 }
...
@@ -868,32 +848,6 @@ sg_rec_state_v3(struct sg_fd *sfp, struct sg_request *srp)
 	return 0;
 }
...
-
 ...
 sg_receive_v3(struct sg_fd *sfp, struct sg_request *srp, size_t count,
 	      void __user *p)
@@ -1497,6 +1451,8 @@ sg_ioctl_common(struct file *filp, struct sg_device *sdp, struct sg_fd *sfp,
 		if (result)
 			return result;
...
@@ -1896,11 +1852,9 @@ sg_add_device_helper(struct scsi_device *scsidp)
...
-	sg_calc_sgat_param(sdp);
 	...
 	kref_init(&sdp->d_ref);
 	error = 0;
@@ -1966,6 +1920,7 @@ sg_add_device(struct device *cl_dev, struct class_interface *cl_intf)
 	} else
...
@@ -2000,6 +1955,7 @@ sg_device_destroy(struct kref *kref)
 	 * any other cleanup.
 	 */
...
@@ -2012,7 +1968,7 @@ sg_remove_device(struct device *cl_dev, struct class_interface *cl_intf)
 {
...
+	unsigned long idx;
 	...
 	if (!sdp)
@@ -2024,13 +1980,13 @@ sg_remove_device(struct device *cl_dev, struct class_interface *cl_intf)
...
@@ -2556,9 +2512,11 @@ sg_deact_request(struct sg_fd *sfp, struct sg_request *srp)
 static struct sg_fd *
...
+	struct xa_limit xal;
 	...
 	if (!sfp)
@@ -2586,14 +2544,10 @@ sg_add_sfp(struct sg_device *sdp)
...
@@ -2602,6 +2556,20 @@ sg_add_sfp(struct sg_device *sdp)
 	if (rbuf_len > 0)
...
@@ -2620,9 +2588,11 @@ sg_add_sfp(struct sg_device *sdp)
 static void
...
+	struct sg_fd *e_sfp;
 	...
 	if (!sfp) {
@@ -2647,7 +2617,15 @@ sg_remove_sfp_usercontext(struct work_struct *work)
 		sg_remove_sgat(sfp, &sfp->reserve);
 	}
...
@@ -2658,13 +2636,7 @@ sg_remove_sfp_usercontext(struct work_struct *work)
 static void
...
@@ -2986,9 +2959,14 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
 	unsigned int ms;
...
@@ -3057,8 +3035,7 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
...
@@ -3076,7 +3053,6 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 			   atomic_read(&sdp->open_cnt));
