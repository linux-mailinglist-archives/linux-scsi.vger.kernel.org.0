...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CCD8B175252
	for <lists+linux-scsi@lfdr.de>; Mon,  2 Mar 2020 04:33:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727072AbgCBDdl (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 1 Mar 2020 22:33:41 -0500
Received: from smtp.infotech.no ([82.134.31.41]:60652 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726758AbgCBDdl (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 1 Mar 2020 22:33:41 -0500
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 454F0204259;
        Mon,  2 Mar 2020 04:33:39 +0100 (CET)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id AKXevEQka2Y3; Mon,  2 Mar 2020 04:33:36 +0100 (CET)
Received: from xtwo70.bingwo.ca (host-23-251-188-50.dyn.295.ca [23.251.188.50])
        by smtp.infotech.no (Postfix) with ESMTPA id 0552D20424C;
        Mon,  2 Mar 2020 04:33:31 +0100 (CET)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v8 35/38] sg: first debugfs support
Date:   Sun,  1 Mar 2020 22:32:46 -0500
Message-Id: <20200302033249.4515-36-dgilbert@interlog.com>
...
index 9156975d7fd3..7f3c0052c135 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -338,7 +345,7 @@ static const char *sg_rq_st_str(enum sg_rq_state rq_st, bool long_str);
...
@@ -2751,22 +2758,6 @@ sg_remove_device(struct device *cl_dev, struct class_interface *cl_intf)
...
@@ -3293,7 +3278,7 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
...
@@ -3733,17 +3718,6 @@ sg_remove_sfp(struct kref *kref)
...
@@ -3773,7 +3747,7 @@ sg_get_dev(int dev)
 	return sdp;
 }
...
+#if IS_ENABLED(SG_PROC_OR_DEBUG_FS)
 ...
 {
@@ -3802,7 +3776,35 @@ sg_rq_st_str(enum sg_rq_state rq_st, bool long_str)
 }
 #endif
...
+}
 ...
 static int
 sg_last_dev(void)
@@ -3816,6 +3818,41 @@ sg_last_dev(void)
 	return k + 1;		/* origin 1 */
 }
...
+
 ...
 {
@@ -3829,7 +3866,7 @@ sg_proc_single_open_adio(struct inode *inode, struct file *filp)
...
+static ssize_t
 ...
 {
@@ -3851,7 +3888,7 @@ sg_proc_single_open_dressz(struct inode *inode, struct file *filp)
...
+static ssize_t
 sg_proc_write_dressz(struct file *filp, const char __user *buffer,
 		     size_t count, loff_t *off)
 {
@@ -3886,43 +3923,6 @@ sg_proc_seq_show_devhdr(struct seq_file *s, void *v)
 	return 0;
 }
...
-
 ...
 {
@@ -3969,6 +3969,10 @@ sg_proc_seq_show_devstrs(struct seq_file *s, void *v)
 	return 0;
 }
...
@@ -4111,18 +4115,20 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	bool found = false;
 	bool trunc = false;
...
@@ -4134,8 +4140,31 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	}
...
@@ -4175,6 +4204,10 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	return 0;
 }
...
+
 static const struct proc_ops adio_proc_ops = {
 	...
 	.proc_read      = seq_read,
@@ -4233,7 +4266,226 @@ sg_proc_init(void)
