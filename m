Return-Path: <linux-scsi+bounces-18553-lists+linux-scsi=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-scsi@lfdr.de
Delivered-To: lists+linux-scsi@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B627C22089
	for <lists+linux-scsi@lfdr.de>; Thu, 30 Oct 2025 20:42:42 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id CD4F1462B9E
	for <lists+linux-scsi@lfdr.de>; Thu, 30 Oct 2025 19:41:38 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6FD87303A0F;
	Thu, 30 Oct 2025 19:41:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=acm.org header.i=@acm.org header.b="u44s96fz"
X-Original-To: linux-scsi@vger.kernel.org
Received: from 003.mia.mailroute.net (003.mia.mailroute.net [199.89.3.6])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 88545302163
	for <linux-scsi@vger.kernel.org>; Thu, 30 Oct 2025 19:41:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=199.89.3.6
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1761853276; cv=none; b=Q6K1PDEXobYholbmlr1ZL9BjGK2b4dp+zlpef3XPNeCTIcpWC1LmWizccgpsu9pLGuR/89Q7hueZxbKgqhIT9SkjPg9s9SR/aDd9h4xce6U6ZskV7K6JYfqTqPH6am1EXAbPG7tSm5MSX5LcKrFt5gYbjPBoXv0AVXBWrUIHxbY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1761853276; c=relaxed/simple;
	bh=rtkhEZSnAXocWZ/ATht7EnnmNbvNzMHooPezUfxSnbU=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=Xwvjp9Ne4N2jumB5xvmrGjcAPcJg0icCt0MgOqia+MFJhxIBY9ahsIz7ho0TAN/DbcPpcqywdtB5KDIxPMn7AhvopG/ipVlJIo4+1akEnWNpp1TjkWJJKTMnenYy89Fs5kTmVPeBKgXl2eEqvYGt7FGe1ZsbpgTB21NXhW9UUwo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=acm.org; spf=pass smtp.mailfrom=acm.org; dkim=pass (2048-bit key) header.d=acm.org header.i=@acm.org header.b=u44s96fz; arc=none smtp.client-ip=199.89.3.6
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=acm.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=acm.org
Received: from localhost (localhost [127.0.0.1])
	by 003.mia.mailroute.net (Postfix) with ESMTP id 4cyDxh3sPXzlssyp;
	Thu, 30 Oct 2025 19:41:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=acm.org; h=
	content-transfer-encoding:mime-version:references:in-reply-to
	:x-mailer:message-id:date:date:subject:subject:from:from
	:received:received; s=mr01; t=1761853268; x=1764445269; bh=9HsFg
	Q4AhROjKbcMwO5Xdrcu3vhi5aeugMLE1/tkkWY=; b=u44s96fzR4Ne32dIxhvt4
	
X-Virus-Scanned: by MailRoute
Received: from 003.mia.mailroute.net ([127.0.0.1])
 by localhost (003.mia [127.0.0.1]) (mroute_mailscanner, port 10029) with LMTP
 id vLz29Zy6l7ge; Thu, 30 Oct 2025 19:41:08 +0000 (UTC)
Received: from bvanassche.mtv.corp.google.com (unknown [104.135.180.219])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	(Authenticated sender: bvanassche@acm.org)
	by 003.mia.mailroute.net (Postfix) with ESMTPSA id 4cyDxL5KNVzlvRxf;
	Thu, 30 Oct 2025 19:40:53 +0000 (UTC)
...
Subject: [PATCH v7 23/28] ufs: core: Optimize the hot path
Date: Thu, 30 Oct 2025 12:36:22 -0700
Message-ID: <20251030193720.871635-24-bvanassche@acm.org>
...
index 1757aa0237da..f19af12cb7a7 100644
...
@@ -2925,27 +2939,30 @@ static void ufshcd_init_lrb(struct ufs_hba *hba, =
...
=20
 /**
@@ -3016,7 +3033,6 @@ static int ufshcd_queuecommand(struct Scsi_Host *ho=
...
=20
@@ -3067,11 +3083,10 @@ static int ufshcd_queuecommand(struct Scsi_Host *=
...
+	err =3D ufshcd_map_sg(hba, cmd);
 	if (err) {
 		ufshcd_release(hba);
 		goto out;
@@ -3080,7 +3095,7 @@ static int ufshcd_queuecommand(struct Scsi_Host *ho=
st, struct scsi_cmnd *cmd)
 	if (hba->mcq_enabled)
...
@@ -3094,10 +3109,12 @@ static int ufshcd_queuecommand(struct Scsi_Host *=
host, struct scsi_cmnd *cmd)
 	return err;
 }
=20
...
@@ -3105,10 +3122,12 @@ static void ufshcd_setup_dev_cmd(struct ufs_hba *=
...
@@ -3320,13 +3339,14 @@ static void ufshcd_dev_man_unlock(struct ufs_hba =
*hba)
...
@@ -3351,17 +3371,17 @@ static int ufshcd_exec_dev_cmd(struct ufs_hba *hb=
a,
...
=20
 /**
@@ -3991,14 +4011,6 @@ static int ufshcd_memory_alloc(struct ufs_hba *hba=
)
 	}
=20
 skip_utmrdl:
...
-	}
 ...
 out:
 	return -ENOMEM;
@@ -5411,19 +5423,18 @@ static void ufshcd_sdev_destroy(struct scsi_devic=
e *sdev)
=20
 /**
...
@@ -5431,7 +5442,7 @@ ufshcd_scsi_cmd_status(struct ufshcd_lrb *lrbp, int=
 scsi_status)
...
+		ufshcd_copy_sense_data(cmd);
 		...
 		break;
 	default:
@@ -5445,15 +5456,16 @@ ufshcd_scsi_cmd_status(struct ufshcd_lrb *lrbp, i=
nt scsi_status)
 /**
...
+	struct ufshcd_lrb *lrbp =3D scsi_cmd_priv(cmd);
 	...
 	int scsi_status;
 	enum utp_ocs ocs;
@@ -5467,7 +5479,7 @@ ufshcd_transfer_rsp_status(struct ufs_hba *hba, str=
uct ufshcd_lrb *lrbp,
 	 * not set either flag.
 	 */
...
@@ -5488,7 +5500,7 @@ ufshcd_transfer_rsp_status(struct ufs_hba *hba, str=
uct ufshcd_lrb *lrbp,
...
@@ -5553,7 +5565,7 @@ ufshcd_transfer_rsp_status(struct ufs_hba *hba, str=
uct ufshcd_lrb *lrbp,
...
@@ -5620,13 +5632,10 @@ static irqreturn_t ufshcd_uic_cmd_compl(struct uf=
...
@@ -5640,20 +5649,20 @@ void ufshcd_release_scsi_cmd(struct ufs_hba *hba,
...
@@ -5690,7 +5699,7 @@ static void ufshcd_clear_polled(struct ufs_hba *hba=
,
 	int tag;
=20
...
=20
 		if (!cmd)
 			continue;
@@ -5741,7 +5750,6 @@ static bool ufshcd_mcq_force_compl_one(struct reque=
st *rq, void *priv)
...
=20
 	if (!hwq)
@@ -5756,7 +5764,7 @@ static bool ufshcd_mcq_force_compl_one(struct reque=
st *rq, void *priv)
...
@@ -6641,7 +6649,7 @@ static bool ufshcd_abort_one(struct request *rq, vo=
id *priv)
=20
...
=20
 	return *ret =3D=3D 0;
@@ -7371,14 +7379,15 @@ static int ufshcd_issue_devman_upiu_cmd(struct uf=
s_hba *hba,
...
=20
@@ -7403,7 +7412,7 @@ static int ufshcd_issue_devman_upiu_cmd(struct ufs_=
hba *hba,
...
@@ -7518,7 +7527,8 @@ int ufshcd_advanced_rpmb_req_handler(struct ufs_hba=
...
+	struct ufshcd_lrb *lrbp =3D scsi_cmd_priv(cmd);
 	...
 	int result;
 	u8 upiu_flags;
@@ -7529,7 +7539,8 @@ int ufshcd_advanced_rpmb_req_handler(struct ufs_hba=
 *hba, struct utp_upiu_req *r
 	/* Protects use of hba->reserved_slot. */
...
=20
@@ -7546,7 +7557,7 @@ int ufshcd_advanced_rpmb_req_handler(struct ufs_hba=
 *hba, struct utp_upiu_req *r
=20
...
=20
 	if (!err) {
 		/* Just copy the upiu response as it is */
@@ -7647,11 +7658,12 @@ static int ufshcd_eh_device_reset_handler(struct =
scsi_cmnd *cmd)
=20
...
@@ -7659,7 +7671,7 @@ static void ufshcd_set_req_abort_skip(struct ufs_hb=
...
here can
@@ -7671,7 +7683,8 @@ static void ufshcd_set_req_abort_skip(struct ufs_hb=
a *hba, unsigned long bitmap)
  */
 int ufshcd_try_to_abort_task(struct ufs_hba *hba, int tag)
 {
...
+	struct ufshcd_lrb *lrbp =3D scsi_cmd_priv(cmd);
 	...
 	int poll_cnt;
 	u8 resp =3D 0xF;
@@ -7693,7 +7706,7 @@ int ufshcd_try_to_abort_task(struct ufs_hba *hba, i=
nt tag)
 				hba->dev,
...
+			if (!ufshcd_cmd_inflight(cmd)) {
 				dev_info(hba->dev,
 					 ...
 					 __func__, tag);
@@ -7741,7 +7754,7 @@ static int ufshcd_abort(struct scsi_cmnd *cmd)
 	struct Scsi_Host *host =3D cmd->device->host;
 	struct ufs_hba *hba =3D shost_priv(host);
 	int tag =3D scsi_cmd_to_rq(cmd)->tag;
-	struct ufshcd_lrb *lrbp =3D &hba->lrb[tag];
+	struct ufshcd_lrb *lrbp =3D scsi_cmd_priv(cmd);
 	...
 	int err =3D FAILED;
 	bool outstanding;
@@ -7776,9 +7789,9 @@ static int ufshcd_abort(struct scsi_cmnd *cmd)
...
+		ufshcd_print_tr(hba, cmd, false);
 	...
 	hba->req_abort_count++;
=20
@@ -7822,7 +7835,7 @@ static int ufshcd_abort(struct scsi_cmnd *cmd)
 		goto release;
 	}
=20
...
@@ -7839,7 +7852,7 @@ static int ufshcd_abort(struct scsi_cmnd *cmd)
...
=20
 	err =3D SUCCESS;
=20
@@ -8919,8 +8932,6 @@ static void ufshcd_release_sdb_queue(struct ufs_hba=
 *hba, int nutrs)
...
@@ -9191,6 +9202,7 @@ static const struct scsi_host_template ufshcd_drive=
r_template =3D {
 	.name			=3D UFSHCD,
 	.proc_name		=3D UFSHCD,
