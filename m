...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id ED6FE24F014
	for <lists+linux-scsi@lfdr.de>; Mon, 24 Aug 2020 00:13:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726676AbgHWWNS (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 23 Aug 2020 18:13:18 -0400
Received: from smtp.infotech.no ([82.134.31.41]:54050 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726909AbgHWWNN (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 23 Aug 2020 18:13:13 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 5BC6620424C;
        Mon, 24 Aug 2020 00:13:12 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id tjyT-4Zjw9oE; Mon, 24 Aug 2020 00:13:11 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-45-78-251-166.dyn.295.ca [45.78.251.166])
        by smtp.infotech.no (Postfix) with ESMTPA id B145B204258;
        Mon, 24 Aug 2020 00:13:09 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v10 11/40] sg: change rwlock to spinlock
Date:   Sun, 23 Aug 2020 18:12:19 -0400
Message-Id: <20200823221248.15678-12-dgilbert@interlog.com>
...
index 4e23ce27d692..a724610e8cf5 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -2220,7 +2220,7 @@ sg_add_request(struct sg_fd *sfp)
 	unsigned long iflags;
...
+	spin_lock_irqsave(&sfp->rq_list_lock, iflags);
 	if (!list_empty(&sfp->rq_list)) {
 		if (!sfp->cmd_q)
 			goto out_unlock;
@@ -2236,10 +2236,10 @@ sg_add_request(struct sg_fd *sfp)
 	rp->parentfp = sfp;
