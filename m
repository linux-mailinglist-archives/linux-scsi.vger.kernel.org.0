...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0BC102CBC18
	for <lists+linux-scsi@lfdr.de>; Wed,  2 Dec 2020 12:56:52 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729745AbgLBLzM (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 2 Dec 2020 06:55:12 -0500
Received: from mx2.suse.de ([195.135.220.15]:41062 "EHLO mx2.suse.de"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729196AbgLBLzL (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Wed, 2 Dec 2020 06:55:11 -0500
X-Virus-Scanned: by amavisd-new at test-mx.suse.de
Received: from relay2.suse.de (unknown [195.135.221.27])
        by mx2.suse.de (Postfix) with ESMTP id 464C8ADD9;
...
Subject: [PATCH 19/34] aic7xxx,aic79xx: drop internal SCSI message definition
Date:   Wed,  2 Dec 2020 12:52:34 +0100
Message-Id: <20201202115249.37690-20-hare@suse.de>
...
---
 drivers/scsi/aic7xxx/aic79xx_core.c | 144 ++++++++++++++++++------------------
 ...
 6 files changed, 141 insertions(+), 180 deletions(-)

diff --git a/drivers/scsi/aic7xxx/aic79xx_core.c b/drivers/scsi/aic7xxx/aic79xx_core.c
index b32a2d9f3a94..411605e72621 100644
...
+	msg_out = INITIATOR_ERROR;
 	...
 	/*
@@ -2817,20 +2817,20 @@ ahd_handle_transmission_error(struct ahd_softc *ahd)
...
+			&& ahd->msgout_buf[index] <= IGNORE_WIDE_RESIDUE) {
 			...
 			index += 2;
@@ -5089,36 +5089,36 @@ ahd_parse_msg(struct ahd_softc *ahd, struct ahd_devinfo *devinfo)
...
+			       devinfo->lun, tag_type == ORDERED_QUEUE_TAG
 			...
 			mask = ~0x03;
@@ -5605,9 +5605,9 @@ ahd_handle_msg_reject(struct ahd_softc *ahd, struct ahd_devinfo *devinfo)
 		 */
