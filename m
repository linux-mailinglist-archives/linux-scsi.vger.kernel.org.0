...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0D24338DE9D
	for <lists+linux-scsi@lfdr.de>; Mon, 24 May 2021 03:02:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232194AbhEXBDn (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 23 May 2021 21:03:43 -0400
Received: from smtp.infotech.no ([82.134.31.41]:33131 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232191AbhEXBDl (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 23 May 2021 21:03:41 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 04A88204155;
        Mon, 24 May 2021 03:02:10 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id KBIU6-DXuicp; Mon, 24 May 2021 03:02:08 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-45-58-219-4.dyn.295.ca [45.58.219.4])
        by smtp.infotech.no (Postfix) with ESMTPA id 7AC7720425A;
        Mon, 24 May 2021 03:02:03 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v19 11/45] sg: change rwlock to spinlock
Date:   Sun, 23 May 2021 21:01:13 -0400
Message-Id: <20210524010147.94845-12-dgilbert@interlog.com>
...
index a21c6e416b73..6a5375862583 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -2207,7 +2207,7 @@ sg_setup_req(struct sg_fd *sfp)
 	unsigned long iflags;
...
+	spin_lock_irqsave(&sfp->rq_list_lock, iflags);
 	if (!list_empty(&sfp->rq_list)) {
 		if (!sfp->cmd_q)
 			goto out_unlock;
@@ -2223,10 +2223,10 @@ sg_setup_req(struct sg_fd *sfp)
 	rp->parentfp = sfp;
...
@@ -2239,13 +2239,13 @@ sg_remove_request(struct sg_fd *sfp, struct sg_request *srp)
...
@@ -2261,7 +2261,7 @@ sg_add_sfp(struct sg_device *sdp)
...
@@ -2306,14 +2306,14 @@ sg_remove_sfp_usercontext(struct work_struct *work)
 	unsigned long iflags;
...
@@ -2593,9 +2593,9 @@ sg_proc_seq_show_dev(struct seq_file *s, void *v)
...
+			      (int)scsi_device_online(scsidp));
 	...
 	return 0;
@@ -2635,7 +2635,7 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
 	k = 0;
...
@@ -2684,7 +2684,7 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
 		}
