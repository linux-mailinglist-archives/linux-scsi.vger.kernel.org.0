...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 55644304962
	for <lists+linux-scsi@lfdr.de>; Tue, 26 Jan 2021 20:59:09 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732908AbhAZF2n (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 26 Jan 2021 00:28:43 -0500
Received: from smtp.infotech.no ([82.134.31.41]:48670 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1731587AbhAYTNN (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Mon, 25 Jan 2021 14:13:13 -0500
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 5401720426D;
        Mon, 25 Jan 2021 20:11:37 +0100 (CET)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 6YfsgFq7kXxM; Mon, 25 Jan 2021 20:11:34 +0100 (CET)
Received: from xtwo70.bingwo.ca (host-104-157-204-209.dyn.295.ca [104.157.204.209])
        by smtp.infotech.no (Postfix) with ESMTPA id 29CD32041CF;
        Mon, 25 Jan 2021 20:11:33 +0100 (CET)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        kashyap.desai@broadcom.com, Hannes Reinecke <hare@suse.com>
Subject: [PATCH v15 05/45] sg: bitops in sg_device
Date:   Mon, 25 Jan 2021 14:10:42 -0500
Message-Id: <20210125191122.345858-6-dgilbert@interlog.com>
...
index 4b8e6a3d243f..087e2d7f5474 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -2246,7 +2248,7 @@ sg_add_sfp(struct sg_device *sdp)
...
@@ -2343,8 +2345,8 @@ sg_get_dev(int dev)
...
+		/* If detaching, then the refcount may already be 0, in
 		 ...
 		 */
 		sdp = ERR_PTR(-ENODEV);
@@ -2556,8 +2558,7 @@ sg_proc_seq_show_dev(struct seq_file *s, void *v)
...
+	if (!sdp || !sdp->device || SG_IS_DETACHING(sdp))
 		...
 		scsidp = sdp->device;
@@ -2584,7 +2585,7 @@ sg_proc_seq_show_devstrs(struct seq_file *s, void *v)
 	read_lock_irqsave(&sg_index_lock, iflags);
 	sdp = it ? sg_lookup_dev(it->index) : NULL;
...
@@ -2676,7 +2677,7 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
...
@@ -2688,7 +2689,8 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
