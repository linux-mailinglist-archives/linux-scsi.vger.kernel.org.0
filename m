...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E793D3A937E
	for <lists+linux-scsi@lfdr.de>; Wed, 16 Jun 2021 09:08:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231303AbhFPHKZ (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 16 Jun 2021 03:10:25 -0400
Received: from mailout4.samsung.com ([203.254.224.34]:26954 "EHLO
        mailout4.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231256AbhFPHKY (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Wed, 16 Jun 2021 03:10:24 -0400
Received: from epcas2p3.samsung.com (unknown [182.195.41.55])
        by mailout4.samsung.com (KnoxPortal) with ESMTP id 20210616070817epoutp0417359ac25057d9a36d552a5d13f529aa~I-lLK3hX22072920729epoutp04Y
        for <linux-scsi@vger.kernel.org>; Wed, 16 Jun 2021 07:08:17 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout4.samsung.com 20210616070817epoutp0417359ac25057d9a36d552a5d13f529aa~I-lLK3hX22072920729epoutp04Y
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1623827297;
        bh=kLJhEEFY0h00zyR+/E/V2gSBD5Xm1zXS9WKzXBYrGi4=;
        h=Subject:Reply-To:From:To:CC:In-Reply-To:Date:References:From;
        b=UnPKLJ8qfJo5oTq4V/oUjJci7lo2KYlrawUT8HSbFbR0zpjYinL8XkWRy8ex9QziK
         rXzs0aKk7fXFBL5AK0PvGz4vC+9s2MZxJ8QelcF0A4V9GuzuQhYV3ztItyzYhC+hHK
         pJAL8x5fsBauJGbDIHfJGfo/7L2JCS1g7md4TAtU=
Received: from epsnrtp1.localdomain (unknown [182.195.42.162]) by
        epcas2p4.samsung.com (KnoxPortal) with ESMTP id
        20210616070815epcas2p42da999b37922799a205bd162a4ce1eda~I-lJzvUIl2444924449epcas2p4w;
        Wed, 16 Jun 2021 07:08:15 +0000 (GMT)
Received: from epsmges2p1.samsung.com (unknown [182.195.40.188]) by
        epsnrtp1.localdomain (Postfix) with ESMTP id 4G4bqw5SRHz4x9Ps; Wed, 16 Jun
        2021 07:08:12 +0000 (GMT)
X-AuditID: b6c32a45-38939a8000002584-3f-60c9a35cac56
Received: from epcas2p4.samsung.com ( [182.195.41.56]) by
        epsmges2p1.samsung.com (Symantec Messaging Gateway) with SMTP id
        B0.37.09604.C53A9C06; Wed, 16 Jun 2021 16:08:12 +0900 (KST)
Mime-Version: 1.0
Subject: [PATCH v38 1/4] scsi: ufs: Introduce HPB feature
...
X-Msg-Type: PERSONAL
X-Reply-Demand: N
Message-ID: <20210616070812epcms2p4650ce5cd78056dce9162482e59bb74dd@epcms2p4>
Date:   Wed, 16 Jun 2021 16:08:12 +0900
X-CMS-MailID: 20210616070812epcms2p4650ce5cd78056dce9162482e59bb74dd
...
X-CPGSPASS: Y
CMS-TYPE: 102P
X-Brightmail-Tracker: 
        53jmX/n1cLZ7BAAA
DLP-Filter: Pass
...
index 8380866d8ed0..c3d80bd15f74 100644
...
index 25fe18a36cd2..1911e030a441 100644
...
@@ -4984,6 +4985,25 @@ static int ufshcd_change_queue_depth(struct scsi_device *sdev, int depth)
...
@@ -4993,6 +5013,8 @@ static int ufshcd_slave_configure(struct scsi_device *sdev)
...
@@ -5019,6 +5041,9 @@ static void ufshcd_slave_destroy(struct scsi_device *sdev)
 	struct ufs_hba *hba;
...
+	ufshpb_reset_host(hba);
 	 ...
 	 * cleared by h/w
@@ -7496,6 +7522,7 @@ static int ufs_get_device_desc(struct ufs_hba *hba)
 {
 	int err;
 	u8 model_index;
...
@@ -7523,9 +7550,16 @@ static int ufs_get_device_desc(struct ufs_hba *hba)
...
+
 	...
 	if (err < 0) {
@@ -7757,6 +7791,10 @@ static int ufshcd_device_geo_params_init(struct ufs_hba *hba)
...
+
 out:
 	kfree(desc_buf);
 	return err;
@@ -7899,6 +7937,7 @@ static int ufshcd_add_lus(struct ufs_hba *hba)
 	}
...
@@ -8047,6 +8086,7 @@ static int ufshcd_probe_hba(struct ufs_hba *hba, bool async)
...
+	ufshpb_reset(hba);
 out:
 	...
 	if (ret)
@@ -8094,6 +8134,9 @@ static void ufshcd_async_scan(void *data, async_cookie_t cookie)
...
@@ -8795,6 +8838,8 @@ static int __ufshcd_wl_suspend(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
@@ -8918,6 +8963,7 @@ static int __ufshcd_wl_suspend(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
+		ufshpb_resume(hba);
 	...
 	return ret;
@@ -8995,6 +9041,8 @@ static int __ufshcd_wl_resume(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
index c98d540ac044..12e39972c7be 100644
...
index 000000000000..91313c95e9b1
--- /dev/null
