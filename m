Return-Path: <linux-scsi+bounces-20855-lists+linux-scsi=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-scsi@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 57/3OkWEj2mRRQEAu9opvQ
	(envelope-from <linux-scsi+bounces-20855-lists+linux-scsi=lfdr.de@vger.kernel.org>)
	for <lists+linux-scsi@lfdr.de>; Fri, 13 Feb 2026 21:06:29 +0100
X-Original-To: lists+linux-scsi@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D6281394F4
	for <lists+linux-scsi@lfdr.de>; Fri, 13 Feb 2026 21:06:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 0990A302962E
	for <lists+linux-scsi@lfdr.de>; Fri, 13 Feb 2026 20:06:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3BDF61F9ECB;
	Fri, 13 Feb 2026 20:06:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=hansenpartnership.com header.i=@hansenpartnership.com header.b="fELWHCQY"
X-Original-To: linux-scsi@vger.kernel.org
Received: from lamorak.hansenpartnership.com (lamorak.hansenpartnership.com [198.37.111.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5604A2940D
	for <linux-scsi@vger.kernel.org>; Fri, 13 Feb 2026 20:06:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.37.111.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1771013185; cv=none; b=jVCaTlm6cB7czPmdguJPA7ZadEQSlwYQ4hCTxlN5ICKhY2DohYD3nHuL+lrpuWypk0/Tdk/H7DEOUQQ/Md4niGoncyVt7EVW5hrn0k6/iULnEWahqIbciddHwweBam+JFU7wNpsCLZ4NPZnhJ3JIxsnc9wQ3oPeI1rLDrfWq/ag=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1771013185; c=relaxed/simple;
	bh=Zj/+PrP1YedlYwFeOTLc13QVZVkeRmFYZZUSYajGsIc=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=s2MW9yOwqm3BOWjr45f9n5cqhRnIt/O/GDLeoJada5DaN7MMzY6CtxZbSG3zdo1SpQdptWODpOAvsLm4z4TzrNNjnnvMePMfvhULm4RzZVbEfTIbqGNBycPnw5Q4zwmI5dVeE3qq5RRUVuE2h8UdNoGNk8KFymdnKh7XFScbEic=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=HansenPartnership.com; spf=pass smtp.mailfrom=HansenPartnership.com; dkim=pass (1024-bit key) header.d=hansenpartnership.com header.i=@hansenpartnership.com header.b=fELWHCQY; arc=none smtp.client-ip=198.37.111.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=HansenPartnership.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=HansenPartnership.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
	d=hansenpartnership.com; s=20151216; t=1771013182;
	bh=Zj/+PrP1YedlYwFeOTLc13QVZVkeRmFYZZUSYajGsIc=;
	h=Message-ID:Subject:From:To:Date:In-Reply-To:References:From;
	b=fELWHCQYibrTYE8r7ESyI+VMvVH3HxzsMZOdKRZW9RaNXc7QuCm4JXMEpd1TDDM3R
	 5CVUMUMb0u0Y2PQQQjm1MqyYxEcRH3Ygqz2Od74AeTmvOIRRRAbcv/qe3utsmy1GwD
	 Fm4p/jcoKVHDRs8wjlWkhHXOM49GFniH1FV/QMBc=
Received: from [192.168.131.4] (unknown [4.16.0.251])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lamorak.hansenpartnership.com (Postfix) with ESMTPSA id E767D1C0248;
	Fri, 13 Feb 2026 15:06:21 -0500 (EST)
Message-ID: <cf29eaeec0557ea2c3800746d1b34a74c56337d8.camel@HansenPartnership.com>
Subject: Re: [PATCH] drivers/scsi: Log spin up retries as standalone
 messages instead of continuations
From: James Bottomley <James.Bottomley@HansenPartnership.com>
To: Stephan Brunner <s.brunner@stephan-brunner.net>, "Martin K. Petersen"
	 <martin.petersen@oracle.com>
Cc: linux-scsi@vger.kernel.org
Date: Fri, 13 Feb 2026 12:06:20 -0800
In-Reply-To: <ea0a0facf69c1b3029292897d4b8cf90cab0d0aa.1771012198.git.s.brunner@stephan-brunner.net>
References: 
	<ea0a0facf69c1b3029292897d4b8cf90cab0d0aa.1771012198.git.s.brunner@stephan-brunner.net>
...
X-Spamd-Result: default: False [-2.16 / 15.00];
	...
	TO_DN_SOME(0.00)[];
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-20855-lists,linux-scsi=lfdr.de];
...
X-Rspamd-Queue-Id: 5D6281394F4
X-Rspamd-Action: no action

On Fri, 2026-02-13 at 20:57 +0100, Stephan Brunner wrote:
...
> > .ready
> > sd 0:0:0:0: [sda] 976773168 512-byte logical blocks: (500 GB/466
> > GiB)

You shouldn't see this.  Because of the KERN_CONT placement in the
messages the first two should be all on one line.

> The single ".ready" message looks ugly and can not be easily matched
> to other messages concerning this particular disk, especially when a
> lot is going on in dmesg.
...
> Additionally, make the "spin up failed" message a warning to be able
> to distinguish it from normal messages.
>=20
