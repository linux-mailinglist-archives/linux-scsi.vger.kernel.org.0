Return-Path: <linux-scsi+bounces-24260-lists+linux-scsi=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-scsi@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id uNdwO0VVHGqFMwkAu9opvQ
	(envelope-from <linux-scsi+bounces-24260-lists+linux-scsi=lfdr.de@vger.kernel.org>)
	for <lists+linux-scsi@lfdr.de>; Sun, 31 May 2026 17:35:33 +0200
X-Original-To: lists+linux-scsi@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 1EB8E616EA5
	for <lists+linux-scsi@lfdr.de>; Sun, 31 May 2026 17:35:32 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id EC9553019F3E
	for <lists+linux-scsi@lfdr.de>; Sun, 31 May 2026 15:34:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F29AB3546EA;
	Sun, 31 May 2026 15:34:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=hansenpartnership.com header.i=@hansenpartnership.com header.b="OLtzECGn"
X-Original-To: linux-scsi@vger.kernel.org
Received: from lamorak.hansenpartnership.com (lamorak.hansenpartnership.com [198.37.111.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C73FB2E7BD9;
	Sun, 31 May 2026 15:34:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.37.111.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1780241642; cv=none; b=euf+HHS7PpFVDGMvUdbGypmg5QVaGz3u9l7kLercpPHkN0Gu3TqzoYICoFN851ebVBWnLbJWXl7J6yr5zGhZWDM7+Ggv4xUFYktLVioo4Rt3JHmYuBhui7vlH9eKmziGLAoae7E/9inaEc7A+fGc616wN4mJqYSJVgg7ycvUlQU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1780241642; c=relaxed/simple;
	bh=O9/7KPlUFjke9GdKgm0regMZSuRcyPZ0ksLkZRMcy9k=;
	h=Message-ID:Subject:From:To:Cc:Date:Content-Type:MIME-Version; b=OSLCmrxckFpQKO76YbPOzZRRUE6/9fpPNBAKehbvvccdI4SlkZv3oAoGFEKKYNZOB2dlF4g3hEvLnu7GKeh5gSj+UX05h3zUgVWfVtqwzAhGQFh52o4e+mgzr2m6+BUD8u0p5cAtXhMZLW72FNIwPZy3fTFtgbvhiNsbPpp6cYM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=HansenPartnership.com; spf=pass smtp.mailfrom=HansenPartnership.com; dkim=pass (1024-bit key) header.d=hansenpartnership.com header.i=@hansenpartnership.com header.b=OLtzECGn; arc=none smtp.client-ip=198.37.111.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=HansenPartnership.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=HansenPartnership.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
	d=hansenpartnership.com; s=20151216; t=1780241639;
	bh=O9/7KPlUFjke9GdKgm0regMZSuRcyPZ0ksLkZRMcy9k=;
	h=Message-ID:Subject:From:To:Date:From;
	b=OLtzECGnP3V6cxy7nB5sPVZBqmfbXkM86HlzM/miAgwffZjg0zIpVmW0uYCwNKY3j
	 UMi9M95cn26/fEtgzXy8GULlKM7LQf7fSKh22Z70RiE1j9X5WuJ3RGKZAnOgyMFI9j
	 w30fObm6R9ipsigKhPtzlMHZJaKIBcY+6jpUdpM4=
Received: from lingrow.int.hansenpartnership.com (unknown [IPv6:2601:5c4:4300:d341::8c71])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lamorak.hansenpartnership.com (Postfix) with ESMTPSA id 343F71C0212;
	Sun, 31 May 2026 11:33:59 -0400 (EDT)
Message-ID: <145613e24e565d8a539ee4d647d4766541fce526.camel@HansenPartnership.com>
...
Date: Sun, 31 May 2026 11:33:58 -0400
...
X-Spamd-Result: default: False [-2.16 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-24260-lists,linux-scsi=lfdr.de];
	FROM_HAS_DN(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[sea.lore.kernel.org:rdns,sea.lore.kernel.org:helo,HansenPartnership.com:mid,hansenpartnership.com:dkim]
X-Rspamd-Queue-Id: 1EB8E616EA5
...
for you to fetch changes up to 85db7391310b1304d2dc8ae3b0b12105a9567147:
  ...
  scsi: target: iscsi: Validate CHAP_R length before base64 decode (2026-05=
-22 23:06:00 -0400)

----------------------------------------------------------------

Two core changes, the only one of significance being the change to kick que=
ues
in SDEV_CANCEL which had a small window for stuck requests.  The major driv=
er
fixes are the one to the FC transport class to widen the FPIN counter to
counter a theoretical (and privileged) fabric traffic injection attack and =
the
other is an iscsi fix where a malicious target could trick the kernel into =
an
...
Milan P. Gandhi (1):
      scsi: megaraid_sas: Fix NULL pointer dereference on firmware duplicat=
e completion
