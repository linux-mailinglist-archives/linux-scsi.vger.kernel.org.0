...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CB9DA4FF997
	for <lists+linux-scsi@lfdr.de>; Wed, 13 Apr 2022 16:59:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236341AbiDMPBu (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 13 Apr 2022 11:01:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49836 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236339AbiDMPBr (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Wed, 13 Apr 2022 11:01:47 -0400
Received: from mail-pl1-x62f.google.com (mail-pl1-x62f.google.com [IPv6:2607:f8b0:4864:20::62f])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3D2686141
        for <linux-scsi@vger.kernel.org>; Wed, 13 Apr 2022 07:59:24 -0700 (PDT)
Received: by mail-pl1-x62f.google.com with SMTP id y6so2210976plg.2
        for <linux-scsi@vger.kernel.org>; Wed, 13 Apr 2022 07:59:24 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version;
        bh=8xFh5ICi/8cUNF62n+v/+BwQA3yAHV7DOshl3LipXAA=;
        b=C07HcNdOR3kYaYDDDDa6CaknJwWhIZowS6jXV11iOgR9P0gMV9+A/SUKufMm+XaIw2
         ts9j0NiwJzEYkqW6W8Hh1Iu94F3My/hb5clBvGGYeV5hS9WC5HRFyPMfeHZqZPzK9GRD
         ui3PX4z4kXpBFNfNs0pqkePXvSY2Xi+YPW+uM=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version;
        bh=8xFh5ICi/8cUNF62n+v/+BwQA3yAHV7DOshl3LipXAA=;
        b=
X-Gm-Message-State: AOAM531R2pS9zyckDs5X+Wl5T0yBneFu2p3rR+wAY20QBhggQWKWEh7W
        Fl3nzDf8TzAEUFzhuucQFTg8a/KVQY3fLa+kBxzl+VsWtDck4Buj2PF4qcYcCQ2/gKvlR8237iN
        LIQ/OiBV/s2586p9LyX5Z2RJNqPooaMr7+f7gMQduF78Om2H2exM8d/+leYZ+Bq77RyeN0TMKUe
        NdlC0Jrc8=
X-Google-Smtp-Source: ABdhPJxPxRXpmI12/MYpQgCZBa6mFLyme7XVJ5/UNKksi4XXHUZlp5QSc8IDkCWaRJbSOIFIsV6MPA==
X-Received: by 2002:a17:902:8644:b0:153:9f01:2090 with SMTP id y4-20020a170902864400b001539f012090mr42062218plt.101.1649861963883;
        Wed, 13 Apr 2022 07:59:23 -0700 (PDT)
Received: from dhcp-10-123-20-15.dhcp.broadcom.net ([192.19.234.250])
        by smtp.gmail.com with ESMTPSA id e14-20020aa78c4e000000b00506475da4cesm2488379pfd.49.2022.04.13.07.59.11
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 13 Apr 2022 07:59:20 -0700 (PDT)
...
Subject: [PATCH v4 5/8] mpi3mr: add support for PEL commands
Date:   Wed, 13 Apr 2022 10:56:49 -0400
Message-Id: <20220413145652.112271-6-sumit.saxena@broadcom.com>
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
        boundary="000000000000535fe105dc8a6cf8"
...
@@ -108,6 +197,87 @@ static long mpi3mr_get_logdata(struct mpi3mr_ioc *mrioc,
 	return -EINVAL;
 }
...
+}
  ...
  * @mrioc: Adapter instance reference
@@ -374,6 +544,9 @@ static long mpi3mr_bsg_process_drv_cmds(struct bsg_job *job)
...
@@ -899,6 +1072,38 @@ static long mpi3mr_bsg_process_mpt_cmds(struct bsg_job *job, unsigned int *reply
 	return rval;
 }
...

--000000000000535fe105dc8a6cf8--
