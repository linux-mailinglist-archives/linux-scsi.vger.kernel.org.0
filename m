...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 629DE4202CD
	for <lists+linux-scsi@lfdr.de>; Sun,  3 Oct 2021 18:37:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231303AbhJCQja (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 3 Oct 2021 12:39:30 -0400
Received: from smtp.infotech.no ([82.134.31.41]:55244 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231298AbhJCQj3 (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 3 Oct 2021 12:39:29 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 600962041D7;
        Sun,  3 Oct 2021 18:37:39 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id MF-Kol+WKBB0; Sun,  3 Oct 2021 18:37:36 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-23-91-187-47.dyn.295.ca [23.91.187.47])
        by smtp.infotech.no (Postfix) with ESMTPA id 4C9692041E3;
        Sun,  3 Oct 2021 18:35:26 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        Damien.LeMoal@wdc.com, Hannes Reinecke <hare@suse.com>
Subject: [PATCH v21 21/46] sg: sg_fill_request_element
Date:   Sun,  3 Oct 2021 12:31:26 -0400
Message-Id: <20211003163151.585349-22-dgilbert@interlog.com>
...
index f30665a66cb4..870e33543ae2 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -920,6 +921,11 @@ sg_receive_v3(struct sg_fd *sfp, struct sg_request *srp, size_t count,
 	return err;
 }
...
+	case SG_GET_PACK_ID:    /* or tag of oldest "read"-able, -1 if none */
 		...
 		spin_lock_irqsave(&sfp->rq_list_lock, iflags);
 		list_for_each_entry(srp, &sfp->rq_list, entry) {
@@ -1723,6 +1727,39 @@ sg_rq_end_io_usercontext(struct work_struct *work)
...
+	int done = 1;
 	...
 	if (WARN_ON(srp->done != 0))
 		return;
@@ -1750,44 +1787,22 @@ sg_rq_end_io(struct request *rq, blk_status_t status)
...
@@ -1844,6 +1859,7 @@ static struct class *sg_sysfs_class;
...
+
 ...
 {
@@ -2182,15 +2214,8 @@ sg_start_req(struct sg_request *srp, u8 *cmd)
 		}
