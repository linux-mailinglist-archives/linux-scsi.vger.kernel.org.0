...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2A5B04202B6
	for <lists+linux-scsi@lfdr.de>; Sun,  3 Oct 2021 18:33:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231245AbhJCQfR (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 3 Oct 2021 12:35:17 -0400
Received: from smtp.infotech.no ([82.134.31.41]:55098 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231234AbhJCQfQ (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 3 Oct 2021 12:35:16 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 6C53D2041AE;
        Sun,  3 Oct 2021 18:32:58 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id YApeCjOYxOYT; Sun,  3 Oct 2021 18:32:55 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-23-91-187-47.dyn.295.ca [23.91.187.47])
        by smtp.infotech.no (Postfix) with ESMTPA id 1694A2041CB;
        Sun,  3 Oct 2021 18:32:03 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        Damien.LeMoal@wdc.com, Hannes Reinecke <hare@suse.com>
Subject: [PATCH v21 04/46] sg: rework sg_poll(), minor changes
Date:   Sun,  3 Oct 2021 12:31:09 -0400
Message-Id: <20211003163151.585349-5-dgilbert@interlog.com>
...
index 4c8070467b5d..3fa2e230a0a1 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -799,7 +799,7 @@ sg_read(struct file *filp, char __user *buf, size_t count, loff_t *ppos)
...
@@ -812,7 +812,7 @@ sg_read(struct file *filp, char __user *buf, size_t count, loff_t *ppos)
 					retval = -ENOMEM;
 					goto free_old_hdr;
 				}
...
@@ -917,7 +917,7 @@ sg_read(struct file *filp, char __user *buf, size_t count, loff_t *ppos)
...
@@ -1259,38 +1259,34 @@ sg_ioctl(struct file *filp, unsigned int cmd_in, unsigned long arg)
 static __poll_t
...
+	return p_res;
 ...
 static int
@@ -1794,7 +1790,7 @@ sg_start_req(struct sg_request *srp, u8 *cmd)
...
@@ -1804,7 +1800,7 @@ sg_start_req(struct sg_request *srp, u8 *cmd)
...
+	       (r0w ? "OUT" : "IN"));
 	...
 	/*
 	 * NOTE
@@ -1880,7 +1876,7 @@ sg_start_req(struct sg_request *srp, u8 *cmd)
...
@@ -2045,33 +2041,32 @@ sg_remove_scat(struct sg_fd *sfp, struct sg_scatter_hold *schp)
