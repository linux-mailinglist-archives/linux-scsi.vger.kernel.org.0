Return-Path: <linux-scsi+bounces-24288-lists+linux-scsi=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-scsi@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id WMHXHeNhHWojZwkAu9opvQ
	(envelope-from <linux-scsi+bounces-24288-lists+linux-scsi=lfdr.de@vger.kernel.org>)
	for <lists+linux-scsi@lfdr.de>; Mon, 01 Jun 2026 12:41:39 +0200
X-Original-To: lists+linux-scsi@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id D186A61DB93
	for <lists+linux-scsi@lfdr.de>; Mon, 01 Jun 2026 12:41:38 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id A235C307C305
	for <lists+linux-scsi@lfdr.de>; Mon,  1 Jun 2026 10:30:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 69A933988FB;
	Mon,  1 Jun 2026 10:30:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=marvell.com header.i=@marvell.com header.b="CnyG2Fm9"
X-Original-To: linux-scsi@vger.kernel.org
Received: from mx0b-0016f401.pphosted.com (mx0a-0016f401.pphosted.com [67.231.148.174])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 79997233953
	for <linux-scsi@vger.kernel.org>; Mon,  1 Jun 2026 10:29:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=67.231.148.174
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1780309801; cv=none; b=GZ1uGJmgE3DFHMEKb7CGG0SrFLUvfNr+KBIvAeZr9qMwSDEdxHOq1iYCs93+zDoFj0EsV49TeZ4nMUt0hXYZ9ySpiei+y5fz0z2wKG91t/G7Ug+/Ztjecfvoc4jBmUsRTtRSvrdXJcOciSuyZqz038uiLhOhi1vUhUra2U0p2bk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1780309801; c=relaxed/simple;
	bh=ez/Yz6ZHyHJ3NO9Pe3DDFpJpw8P09R58NG0DwtGmzI8=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=fUQiwTg58m6ro2wuIR0zvYIhALHWweHCFXS9Erc78IxXbTXl9n7VAIH4HAOXEtF8kgP5KvmHPbz3D+4wFqiYYZ/N1KKRc92NQHZKCIX9L48+qR2Xnx40NiAkcid+XnIlTCQF+fCZroJZiB/c6gsm/XAJ8cPGZrp/4xzxlWgJxBA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=marvell.com; spf=pass smtp.mailfrom=marvell.com; dkim=pass (2048-bit key) header.d=marvell.com header.i=@marvell.com header.b=CnyG2Fm9; arc=none smtp.client-ip=67.231.148.174
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=marvell.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=marvell.com
Received: from pps.filterd (m0045849.ppops.net [127.0.0.1])
	by mx0a-0016f401.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id 64VLqXsv1009679;
	Mon, 1 Jun 2026 03:29:54 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=marvell.com; h=
	cc:content-transfer-encoding:content-type:date:from:in-reply-to
	:message-id:mime-version:references:subject:to; s=pfpt0220; bh=H
	r7D5oA4ymjs8Gg7iHqvODvS1jitaSNuhiscM5Er1d0=; b=CnyG2Fm9+22i26yHb
	
Received: from dc5-exch05.marvell.com ([199.233.59.128])
	by mx0a-0016f401.pphosted.com (PPS) with ESMTPS id 4efw8hwpn9-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Mon, 01 Jun 2026 03:29:53 -0700 (PDT)
Received: from DC5-EXCH05.marvell.com (10.69.176.209) by
 DC5-EXCH05.marvell.com (10.69.176.209) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1544.25; Mon, 1 Jun 2026 03:29:53 -0700
Received: from maili.marvell.com (10.69.176.80) by DC5-EXCH05.marvell.com
 (10.69.176.209) with Microsoft SMTP Server id 15.2.1544.25 via Frontend
 Transport; Mon, 1 Jun 2026 03:29:53 -0700
Received: from stgdev-a5u16.punelab.marvell.com (stgdev-a5u16.punelab.marvell.com [10.31.33.164])
	by maili.marvell.com (Postfix) with ESMTP id D8D243F7053;
	Mon,  1 Jun 2026 03:29:49 -0700 (PDT)
From: Nilesh Javali <njavali@marvell.com>
To: <martin.petersen@oracle.com>
CC: <linux-scsi@vger.kernel.org>, <GR-QLogic-Storage-Upstream@marvell.com>,
        <agurumurthy@marvell.com>, <emilne@redhat.com>, <jmeneghi@redhat.com>,
        <hare@suse.com>
Subject: [PATCH 12/44] scsi: qla2xxx: Update IO path to use 128-byte IOCBs for 29xx
Date: Mon, 1 Jun 2026 15:58:21 +0530
Message-ID: <20260601102853.328426-13-njavali@marvell.com>
...
X-Proofpoint-Spam-Details-Enc: AW1haW4tMjYwNjAxMDEwNSBTYWx0ZWRfX79wPEYF1lBJj
 
X-Proofpoint-GUID: b4dKU6o4CEsOHBy94G2eaMRuEqZ74ZVX
X-Proofpoint-ORIG-GUID: b4dKU6o4CEsOHBy94G2eaMRuEqZ74ZVX
X-Authority-Analysis: v=2.4 cv=F99nsKhN c=1 sm=1 tr=0 ts=6a1d5f21 cx=c_pps
 a=rEv8fa4AjpPjGxpoe8rlIQ==:117 a=rEv8fa4AjpPjGxpoe8rlIQ==:17
 a=FelO9ux0wxsA:10 a=VkNPw1HP01LnGYTKEx00:22 a=l0iWHRpgs5sLHlkKQ1IR:22
 a=EAYMVhzMl8SCOHhVQcBL:22 a=M5GUcnROAAAA:8 a=VwQbUJbxAAAA:8
 a=JVz5fAixIZ8A-HfLLPsA:9 a=OBjm3rFKGHvpk9ecZwUJ:22
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-24288-lists,linux-scsi=lfdr.de];
...
index 485c744a59fb..38651b5024bf 100644
...
index eccedb38a515..4f5a1824b14c 100644
...
index 26345e308a2c..e3b8d3aba756 100644
...
@@ -689,4 +700,70 @@ struct vp_rpt_id_entry_24xx_ext {
 		} f2;
 	} u;
 };
+
...
index 84aaff130400..a865fad8fa62 100644
--- a/drivers/scsi/qla2xxx/qla_gbl.h
+++ b/drivers/scsi/qla2xxx/qla_gbl.h
@@ -298,6 +298,8 @@ void qla_els_pt_iocb(struct scsi_qla_host *vha,
...
index 20214f2736d9..4a825a18ce31 100644
...
index 9038f6723444..38127313fd79 100644
...
+	uint16_t tot_prot_dsds, uint16_t fw_prot_opts, uint8_t dif_bundling);
  ...
  * @sp: SCSI command
@@ -464,13 +477,12 @@ qla2x00_start_iocbs(struct scsi_qla_host *vha, struct req_que *req)
 	if (IS_P3P_TYPE(ha)) {
...
@@ -523,6 +535,29 @@ __qla2x00_marker(struct scsi_qla_host *vha, struct qla_qpair *qpair,
 		return (QLA_FUNCTION_FAILED);
 	}
...
@@ -542,6 +577,8 @@ __qla2x00_marker(struct scsi_qla_host *vha, struct qla_qpair *qpair,
...
@@ -1954,7 +1991,17 @@ qla2xxx_start_scsi_mq(srb_t *sp)
 		nseg = 0;
...
+		req_cnt = qla24xx_calc_iocbs(vha, tot_dsds);
 	...
 	sp->iores.exch_cnt = 1;
@@ -1987,46 +2034,84 @@ qla2xxx_start_scsi_mq(srb_t *sp)
...
@@ -2034,8 +2119,12 @@ qla2xxx_start_scsi_mq(srb_t *sp)
 	/* Set chip new ring index. */
 	wrt_reg_dword(req->req_q_in, req->ring_index);
...
@@ -2180,7 +2269,20 @@ qla2xxx_dif_start_scsi_mq(srb_t *sp)
...
@@ -2211,18 +2313,35 @@ qla2xxx_dif_start_scsi_mq(srb_t *sp)
 	cmd->host_scribble = (unsigned char *)(unsigned long)handle;
 	req->cnt -= req_cnt;
...
+	 */
 	...
 	int_to_scsilun(cmd->device->lun, &cmd_pkt->lun);
 	host_to_fcp_swap((uint8_t *)&cmd_pkt->lun, sizeof(cmd_pkt->lun));
@@ -2231,29 +2350,41 @@ qla2xxx_dif_start_scsi_mq(srb_t *sp)
 	cmd_pkt->dseg_count = cpu_to_le16(tot_dsds);
...
@@ -2343,10 +2474,20 @@ __qla2x00_alloc_iocbs(struct qla_qpair *qpair, srb_t *sp)
 		sp->handle = handle;
 	}
...
@@ -3297,7 +3438,6 @@ qla24xx_ct_iocb(srb_t *sp, struct ct_entry_24xx *ct_iocb)
...
@@ -3322,16 +3462,29 @@ qla24xx_ct_iocb(srb_t *sp, struct ct_entry_24xx *ct_iocb)
 	index = 0;
...
@@ -3342,16 +3495,22 @@ qla24xx_ct_iocb(srb_t *sp, struct ct_entry_24xx *ct_iocb)
 	index = 0;
...
@@ -4154,6 +4313,21 @@ qla2x00_start_bidir(srb_t *sp, struct scsi_qla_host *vha, uint32_t tot_dsds)
 	rsp = ha->rsp_q_map[0];
 	req = vha->req;
...
@@ -4291,8 +4465,15 @@ qla_start_scsi_type6(srb_t *sp)
...
+		req_cnt = qla24xx_calc_iocbs(vha, tot_dsds);
 	...
 	sp->iores.res_type = RESOURCE_IOCB | RESOURCE_EXCH;
 	sp->iores.exch_cnt = 1;
@@ -4396,23 +4577,44 @@ qla_start_scsi_type6(srb_t *sp)
 	cmd->host_scribble = (unsigned char *)(unsigned long)handle;
 	req->cnt -= req_cnt;
...
+	}
 	...
 	int_to_scsilun(cmd->device->lun, &cmd_pkt->lun);
 	host_to_fcp_swap((uint8_t *)&cmd_pkt->lun, sizeof(cmd_pkt->lun));
@@ -4447,14 +4649,8 @@ qla_start_scsi_type6(srb_t *sp)
 	cmd_pkt->entry_count = (uint8_t)req_cnt;
...
+	qla_req_ring_advance(ha, req);
 	...
 	sp->qpair->cmd_cnt++;
 	sp->flags |= SRB_DMA_VALID;
@@ -4462,8 +4658,11 @@ qla_start_scsi_type6(srb_t *sp)
 	/* Set chip new ring index. */
 	wrt_reg_dword(req->req_q_in, req->ring_index);
...
@@ -4489,3 +4688,491 @@ qla_start_scsi_type6(srb_t *sp)
...
index 3a8a6c42d968..a0f10f58421c 100644
...
@@ -4435,13 +4439,19 @@ qla2x00_mem_alloc(struct qla_hw_data *ha, uint16_t req_len, uint16_t rsp_len,
 	}
 	(*req)->length = req_len;
...
+	}
 	...
 	*rsp = kzalloc_obj(struct rsp_que);
 	if (!*rsp) {
@@ -4452,13 +4462,19 @@ qla2x00_mem_alloc(struct qla_hw_data *ha, uint16_t req_len, uint16_t rsp_len,
 	(*rsp)->hw = ha;
 	(*rsp)->length = rsp_len;
...
@@ -4609,7 +4625,8 @@ qla2x00_mem_alloc(struct qla_hw_data *ha, uint16_t req_len, uint16_t rsp_len,
 	kfree(ha->npiv_info);
 fail_npiv_info:
...
+		(*rsp)->ring, (*rsp)->dma);
 	...
 	(*rsp)->dma = 0;
 fail_rsp_ring:
@@ -4617,7 +4634,8 @@ qla2x00_mem_alloc(struct qla_hw_data *ha, uint16_t req_len, uint16_t rsp_len,
 	*rsp = NULL;
 fail_rsp:
