...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id AB97713545A
	for <lists+linux-scsi@lfdr.de>; Thu,  9 Jan 2020 09:30:47 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728494AbgAIIaq (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Thu, 9 Jan 2020 03:30:46 -0500
Received: from smtp.infotech.no ([82.134.31.41]:33889 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728437AbgAIIao (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Thu, 9 Jan 2020 03:30:44 -0500
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id B0984204199;
        Thu,  9 Jan 2020 09:30:40 +0100 (CET)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 7udjhd23m+uE; Thu,  9 Jan 2020 09:30:40 +0100 (CET)
Received: from xtwo70.infotech.no (unknown [82.134.31.177])
        by smtp.infotech.no (Postfix) with ESMTPA id 63162204193;
        Thu,  9 Jan 2020 09:30:40 +0100 (CET)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [RFC v2 2/6] scsi_debug: add doublestore option
Date:   Thu,  9 Jan 2020 09:30:35 +0100
Message-Id: <20200109083039.16582-3-dgilbert@interlog.com>
...
---
 drivers/scsi/scsi_debug.c | 261 ++++++++++++++++++++++++++------------
 1 file changed, 182 insertions(+), 79 deletions(-)

diff --git a/drivers/scsi/scsi_debug.c b/drivers/scsi/scsi_debug.c
index 18c07e9ace15..7ca6c6c43c93 100644
...
@@ -4788,16 +4830,22 @@ static ssize_t fake_rw_store(struct device_driver *ddp, const char *buf,
 		n = (n > 0);
...
@@ -4848,6 +4896,47 @@ static ssize_t dev_size_mb_show(struct device_driver *ddp, char *buf)
 }
...
+
 ...
 {
 	return scnprintf(buf, PAGE_SIZE, "%d\n", sdebug_num_parts);
@@ -5225,6 +5314,7 @@ static struct attribute *sdebug_drv_attrs[] = {
...
@@ -5266,7 +5356,10 @@ static int __init scsi_debug_init(void)
 	int k;
 	int ret;
...
@@ -5363,14 +5456,22 @@ static int __init scsi_debug_init(void)
 	}
...
+		}
 	...
 	if (sdebug_dix) {
@@ -5467,7 +5568,8 @@ static int __init scsi_debug_init(void)
 free_vm:
 	vfree(map_storep);
 	vfree(dif_storep);
-	vfree(fake_storep);
...
+	vfree(fake_store_a[0]);
 free_q_arr:
 	kfree(sdebug_q_arr);
 	return ret;
@@ -5487,7 +5589,8 @@ static void __exit scsi_debug_exit(void)
