...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 2D7AC172446
	for <lists+linux-scsi@lfdr.de>; Thu, 27 Feb 2020 18:00:11 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729758AbgB0Q7z (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Thu, 27 Feb 2020 11:59:55 -0500
Received: from smtp.infotech.no ([82.134.31.41]:47285 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729601AbgB0Q7y (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Thu, 27 Feb 2020 11:59:54 -0500
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id D6C4D20419D;
        Thu, 27 Feb 2020 17:59:52 +0100 (CET)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 8iu3sqvCoMPE; Thu, 27 Feb 2020 17:59:50 +0100 (CET)
Received: from xtwo70.bingwo.ca (host-23-251-188-50.dyn.295.ca [23.251.188.50])
        by smtp.infotech.no (Postfix) with ESMTPA id 2FD9320419B;
        Thu, 27 Feb 2020 17:59:42 +0100 (CET)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v7 28/38] sg: rework debug info
Date:   Thu, 27 Feb 2020 11:58:52 -0500
Message-Id: <20200227165902.11861-29-dgilbert@interlog.com>
...
index 58ba30409790..608b2e605281 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
@@ -2398,7 +2398,7 @@ sg_rq_end_io(struct request *rq, blk_status_t status)
...
+		if (scsi_rp->sense && !srp->sense_bp) {
 			srp->sense_bp = mempool_alloc(sg_sense_pool,
 						      GFP_ATOMIC);
 			if (srp->sense_bp) {
@@ -2411,6 +2411,9 @@ sg_rq_end_io(struct request *rq, blk_status_t status)
...
@@ -3939,116 +3942,211 @@ sg_proc_seq_show_devstrs(struct seq_file *s, void *v)
 	return 0;
 }
