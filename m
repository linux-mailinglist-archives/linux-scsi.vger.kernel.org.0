...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1F2B66487A3
	for <lists+linux-scsi@lfdr.de>; Fri,  9 Dec 2022 18:21:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229960AbiLIRV2 (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Fri, 9 Dec 2022 12:21:28 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42918 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229470AbiLIRV0 (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Fri, 9 Dec 2022 12:21:26 -0500
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 90129250
        for <linux-scsi@vger.kernel.org>; Fri,  9 Dec 2022 09:21:22 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1670606482; x=1702142482;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=FMVuYxLuqwhBP8icotFD7W/BzaQGY+esrtyhPNWyoTI=;
  b=eVMPtuQQ5ui+igkBmZFK+/mZ0xtV2rRBysPmsJy+QJrOjA+IKzucHP2T
   +f1VJhHb8QBHdm0yZ/Lc1wcS5OusdG9GrzJTLbHWwoLczpSK8z3QxkpgE
   Oq558Ct5fIFRE4hYHEIQwh4m5UQj6zRy5ygeL7Ie2r5HmH82X7e/UUAlj
   KYKvuq1ty4yEa+I2uCKKZLA9R5BNM+/LEsJCGU5i1XBLQqes1e9RoTk6o
   XBu4zugumEOTdkgGPuRsYoho7beK58LnkDaGqLerFjSCa13StFMTUgBa1
   TFfuC26J4Od7TcFu5y4Wdpcza1ibOuH5oYItM1HiQaKdns4ycP+IqzCgu
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10556"; a="379719422"
X-IronPort-AV: E=Sophos;i="5.96,230,1665471600"; 
   d="scan'208";a="379719422"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Dec 2022 09:21:20 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10556"; a="821789971"
X-IronPort-AV: E=Sophos;i="5.96,230,1665471600"; 
   d="scan'208";a="821789971"
Received: from lkp-server01.sh.intel.com (HELO b5d47979f3ad) ([10.239.97.150])
  by orsmga005.jf.intel.com with ESMTP; 09 Dec 2022 09:21:17 -0800
Received: from kbuild by b5d47979f3ad with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1p3h3k-0001yb-1y;
        Fri, 09 Dec 2022 17:21:16 +0000
Date:   Sat, 10 Dec 2022 01:20:46 +0800
...
Message-ID: <202212100156.LnDY85i3-lkp@intel.com>
References: <20221209061325.705999-5-michael.christie@oracle.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="7jLs7nVJ9XNYtR8u"
...
patch link:    https://lore.kernel.org/r/20221209061325.705999-5-michael.christie%40oracle.com
patch subject: [PATCH v2 04/15] scsi: ch: Convert to scsi_execute_args
config: i386-randconfig-a002
compiler: clang version 14.0.6 (https://github.com/llvm/llvm-project f28c006a5895fc0e329fe15fead81e37457cb1d1)
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/97774504bf2fd8f79d06ad9377eaa4b892489555
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Mike-Christie/scsi-Add-struct-for-args-to-execution-functions/20221209-141751
        git checkout 97774504bf2fd8f79d06ad9377eaa4b892489555
...
>> drivers/scsi/ch.c:200:11: error: call to __compiletime_assert_284 declared with 'error' attribute: BUILD_BUG_ON failed: exec_args.sense && exec_args.sense_len != SCSI_SENSE_BUFFERSIZE
...
vim +/error +200 drivers/scsi/ch.c
   ...
   198	 retry:
   199		errno = 0;
 > 200		result = scsi_execute_args(ch->device, cmd, op, buffer, buflength,
