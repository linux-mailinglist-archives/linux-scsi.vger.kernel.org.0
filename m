...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8FEB738DEBC
	for <lists+linux-scsi@lfdr.de>; Mon, 24 May 2021 03:03:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232318AbhEXBE0 (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 23 May 2021 21:04:26 -0400
Received: from smtp.infotech.no ([82.134.31.41]:33266 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232246AbhEXBEK (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 23 May 2021 21:04:10 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id D24AB20429F;
        Mon, 24 May 2021 03:02:42 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id muliNoVPl-Hr; Mon, 24 May 2021 03:02:40 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-45-58-219-4.dyn.295.ca [45.58.219.4])
        by smtp.infotech.no (Postfix) with ESMTPA id 21F8D20425C;
        Mon, 24 May 2021 03:02:36 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v19 40/45] sg: remove rcv_done request state
Date:   Sun, 23 May 2021 21:01:42 -0400
Message-Id: <20210524010147.94845-41-dgilbert@interlog.com>
...
index b682bdd15bf8..94d853c183b7 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -2487,8 +2488,7 @@ sg_rq_end_io(struct request *rq, blk_status_t status)
 	}
...
@@ -2970,6 +2970,8 @@ sg_start_req(struct sg_request *srp, struct sg_comm_wr_t *cwrp, int dxfer_dir)
 	}
 fini:
...
+			blk_rq_unmap_user(rq->bio);
 		...
 		srp->rq = NULL;
 		if (us_xfer && rq->bio)
@@ -3183,9 +3185,10 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
...
@@ -3197,8 +3200,7 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
 				continue;
...
@@ -3208,14 +3210,37 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
 			}
 			break;
 		}
...
@@ -3333,8 +3358,9 @@ sg_setup_req(struct sg_comm_wr_t *cwrp, int dxfr_len)
 	bool found = false;
...
@@ -3347,45 +3373,48 @@ sg_setup_req(struct sg_comm_wr_t *cwrp, int dxfr_len)
 		act_empty = true;
 		mk_new_srp = true;
...
+		WRITE_ONCE(fp->prev_used_idx, r_srp->rq_idx);
 		...
 		mk_new_srp = true;
@@ -3458,7 +3487,7 @@ sg_deact_request(struct sg_fd *sfp, struct sg_request *srp)
 	sbp = srp->sense_bp;
 	srp->sense_bp = NULL;
...
@@ -3549,7 +3578,7 @@ sg_add_sfp(struct sg_device *sdp)
 		}
 		srp->rq_idx = idx;
 		srp->parentfp = sfp;
...
@@ -3698,8 +3727,6 @@ sg_rq_st_str(enum sg_rq_state rq_st, bool long_str)
...
-		return long_str ? "receive_done" : "fin";
 	...
 	default:
@@ -3976,7 +4003,8 @@ sg_proc_debug_fd(struct sg_fd *fp, char *obp, int len, unsigned long idx)
