...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 7831C14467
	for <lists+linux-scsi@lfdr.de>; Mon,  6 May 2019 08:19:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725813AbfEFGTY (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Mon, 6 May 2019 02:19:24 -0400
Received: from mx2.suse.de ([195.135.220.15]:41482 "EHLO mx1.suse.de"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1725710AbfEFGTY (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Mon, 6 May 2019 02:19:24 -0400
X-Virus-Scanned: by amavisd-new at test-mx.suse.de
Received: from relay2.suse.de (unknown [195.135.220.254])
        by mx1.suse.de (Postfix) with ESMTP id 9C555AEBF;
        Mon,  6 May 2019 06:19:19 +0000 (UTC)
...
Subject: [PATCHv2] osst: kill obsolete driver
Date:   Mon,  6 May 2019 08:19:15 +0200
Message-Id: <20190506061915.47172-1-hare@suse.de>
...
The osst driver is becoming obsolete, as the manufacturer went out
of business ages ago, and the maintainer has no means of testing
any improvements anymore.
Plus these days flash drives are cheaper and offer a higher capacity.
...
index 30f280b560a6..4d6a331b5192 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -11485,16 +11485,6 @@ S:	Maintained
...
index 19c022e66d63..13424b9374ca 100644
--- a/drivers/scsi/st.c
+++ b/drivers/scsi/st.c
@@ -227,7 +227,6 @@ static DEFINE_IDR(st_index_idr);
...
-#include "osst_detect.h"
 ...
 #define SIGS_FROM_OSST \
 	{"OnStream", "SC-", "", "osst"}, \
@@ -4266,9 +4265,10 @@ static int st_probe(struct device *dev)
