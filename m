...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 31B622CF739
	for <lists+linux-scsi@lfdr.de>; Sat,  5 Dec 2020 00:03:07 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726920AbgLDXCv (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Fri, 4 Dec 2020 18:02:51 -0500
Received: from esa6.microchip.iphmx.com ([216.71.154.253]:21357 "EHLO
        esa6.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726296AbgLDXCv (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Fri, 4 Dec 2020 18:02:51 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1607122969; x=1638658969;
  h=subject:from:to:cc:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=zATmGYzTr/c20Cousm9+QT8PROh+O+5lwsKMTNpKrqU=;
  b=qhHBVW0sbbjLoKOYWJJTRq+ID6GeBu2GcaehL2kGo7B8FSMfWojHlYey
   cuDJ5rZZ+EHv+qJRqJ2+uZAZA0PmnIc/SuXaTPBiyhIbs0LETr/t4fKsZ
   WnxG37/7VG3are/hUp1UPJTO5zLghky5Gno+kKqko9DONrBvSRCb7l7m7
   dr2uqSsbVK37zR0cq5OaxT+/dNMMc3ty8XiZNzc7CG3HtC5E8eqiwl2U2
   soi3A07Lsd1YnH0u2SjSTOIIblmJJF5eFNiI569zyy9vQhmKUBNoIxNKO
   +NQDJ5ESqUQFdekcZoIGwsHR0tCDMTce5/0JTL2dqb6Q6W4zVYPx5gUaV
   w==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.78,393,1599548400"; 
   d="scan'208";a="36193035"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa6.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 04 Dec 2020 16:01:44 -0700
Received: from chn-vm-ex04.mchp-main.com (10.10.85.152) by
 chn-vm-ex02.mchp-main.com (10.10.85.144) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1979.3; Fri, 4 Dec 2020 16:01:43 -0700
Received: from [127.0.1.1] (10.10.115.15) by chn-vm-ex04.mchp-main.com
 (10.10.85.152) with Microsoft SMTP Server id 15.1.1979.3 via Frontend
 Transport; Fri, 4 Dec 2020 16:01:43 -0700
Subject: [PATCH 09/25] smartpqi: align code with oob driver
...
Date:   Fri, 4 Dec 2020 17:01:42 -0600
Message-ID: <160712290293.21372.10543821844870220439.stgit@brunhilda>
...
index 15f07df91a8c..ddd2ed8f4283 100644
...
@@ -2687,12 +2665,10 @@ static int pqi_raid_bypass_submit_scsi_cmd(struct pqi_ctrl_info *ctrl_info,
...
@@ -2707,7 +2683,7 @@ static int pqi_raid_bypass_submit_scsi_cmd(struct pqi_ctrl_info *ctrl_info,
 		case SA_RAID_5:
 		case SA_RAID_6:
...
@@ -3093,8 +3069,7 @@ static int pqi_process_io_intr(struct pqi_ctrl_info *ctrl_info, struct pqi_queue
...
+				&((struct pqi_vendor_general_response *)response)->status);
 		...
 		case PQI_RESPONSE_IU_TASK_MANAGEMENT:
 			io_request->status =
@@ -3306,7 +3281,7 @@ static void pqi_ofa_process_event(struct pqi_ctrl_info *ctrl_info,
...
@@ -3356,8 +3331,7 @@ static void pqi_heartbeat_timer_handler(struct timer_list *t)
 {
 	int num_interrupts;
 	u32 heartbeat_count;
...
+	struct pqi_ctrl_info *ctrl_info = from_timer(ctrl_info, t, heartbeat_timer);
 	...
 	if (pqi_ctrl_offline(ctrl_info))
@@ -3430,7 +3404,7 @@ static void pqi_ofa_capture_event_payload(struct pqi_event *event,
...
@@ -3572,8 +3546,7 @@ static inline bool pqi_is_valid_irq(struct pqi_ctrl_info *ctrl_info)
 		valid_irq = true;
 		break;
 	case IRQ_MODE_INTX:
-		intx_status =
...
@@ -3894,7 +3867,8 @@ static int pqi_alloc_admin_queues(struct pqi_ctrl_info *ctrl_info)
...
@@ -3908,8 +3882,8 @@ static int pqi_alloc_admin_queues(struct pqi_ctrl_info *ctrl_info)
...
@@ -3945,6 +3919,7 @@ static int pqi_create_admin_queues(struct pqi_ctrl_info *ctrl_info)
...
@@ -4241,8 +4216,7 @@ static int pqi_submit_raid_request_synchronous(struct pqi_ctrl_info *ctrl_info,
...
@@ -4260,13 +4234,11 @@ static int pqi_submit_raid_request_synchronous(struct pqi_ctrl_info *ctrl_info,
...
@@ -4344,8 +4316,7 @@ static int pqi_report_device_capability(struct pqi_ctrl_info *ctrl_info)
 	if (rc)
 		goto out;
...
@@ -4694,7 +4665,7 @@ static int pqi_configure_events(struct pqi_ctrl_info *ctrl_info,
...
@@ -4769,7 +4740,6 @@ static void pqi_free_all_io_requests(struct pqi_ctrl_info *ctrl_info)
...
@@ -4789,9 +4759,8 @@ static int pqi_alloc_io_resources(struct pqi_ctrl_info *ctrl_info)
 	struct device *dev;
...
@@ -4804,8 +4773,7 @@ static int pqi_alloc_io_resources(struct pqi_ctrl_info *ctrl_info)
...
+		io_request->iu = kmalloc(ctrl_info->max_inbound_iu_length, GFP_KERNEL);
 		...
 		if (!io_request->iu) {
 			dev_err(&ctrl_info->pci_dev->dev,
@@ -4825,8 +4793,7 @@ static int pqi_alloc_io_resources(struct pqi_ctrl_info *ctrl_info)
...
@@ -4941,8 +4908,8 @@ static void pqi_calculate_queue_resources(struct pqi_ctrl_info *ctrl_info)
...
@@ -5164,16 +5131,14 @@ static int pqi_raid_submit_scsi_cmd_with_io_request(
...
@@ -5183,30 +5148,20 @@ static int pqi_raid_submit_scsi_cmd_with_io_request(
 	case 10:
 	case 12:
 	case 16:
...
@@ -5451,8 +5406,7 @@ static int pqi_aio_submit_io(struct pqi_ctrl_info *ctrl_info,
...
@@ -5510,7 +5464,6 @@ static  int pqi_aio_submit_r1_write_io(struct pqi_ctrl_info *ctrl_info,
...
-
 {
 	int rc;
 	struct pqi_io_request *io_request;
@@ -5525,7 +5478,6 @@ static  int pqi_aio_submit_r1_write_io(struct pqi_ctrl_info *ctrl_info,
...
@@ -5854,6 +5806,7 @@ static void pqi_fail_io_queued_for_device(struct pqi_ctrl_info *ctrl_info,
...
+
 				...
 				if (!scmd)
 					continue;
@@ -6047,8 +6000,7 @@ static int pqi_lun_reset(struct pqi_ctrl_info *ctrl_info,
...
@@ -6738,7 +6690,8 @@ static ssize_t pqi_unique_id_show(struct device *dev,
...
@@ -7038,17 +6991,13 @@ static int pqi_register_scsi(struct pqi_ctrl_info *ctrl_info)
...
@@ -7118,8 +7067,7 @@ static int pqi_reset(struct pqi_ctrl_info *ctrl_info)
...
@@ -7359,12 +7307,10 @@ static void pqi_ctrl_update_feature_flags(struct pqi_ctrl_info *ctrl_info,
...
@@ -7509,7 +7455,7 @@ static void pqi_process_firmware_features(
...
@@ -7559,21 +7505,18 @@ static int pqi_process_config_table(struct pqi_ctrl_info *ctrl_info)
...
@@ -7587,8 +7530,7 @@ static int pqi_process_config_table(struct pqi_ctrl_info *ctrl_info)
...
@@ -7600,8 +7542,7 @@ static int pqi_process_config_table(struct pqi_ctrl_info *ctrl_info)
 			break;
 		}
...
+		section_offset = get_unaligned_le16(&section->next_section_offset);
 	...
 	kfree(config_table);
@@ -7700,12 +7641,12 @@ static int pqi_ctrl_init(struct pqi_ctrl_info *ctrl_info)
 	if (reset_devices) {
...
@@ -8022,8 +7963,7 @@ static int pqi_ctrl_init_resume(struct pqi_ctrl_info *ctrl_info)
 	return 0;
 }
...
@@ -8275,8 +8215,8 @@ static int pqi_ofa_alloc_mem(struct pqi_ctrl_info *ctrl_info,
 			break;
