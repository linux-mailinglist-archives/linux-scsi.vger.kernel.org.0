...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3081434F621
	for <lists+linux-scsi@lfdr.de>; Wed, 31 Mar 2021 03:19:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232600AbhCaBS6 (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 30 Mar 2021 21:18:58 -0400
Received: from mailout2.samsung.com ([203.254.224.25]:27359 "EHLO
        mailout2.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232997AbhCaBSr (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Tue, 30 Mar 2021 21:18:47 -0400
Received: from epcas2p2.samsung.com (unknown [182.195.41.54])
        by mailout2.samsung.com (KnoxPortal) with ESMTP id 20210331011845epoutp023c6af5fa0ec001476fa33c55f895bd8e~xSJA--smu0763607636epoutp02S
        for <linux-scsi@vger.kernel.org>; Wed, 31 Mar 2021 01:18:45 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout2.samsung.com 20210331011845epoutp023c6af5fa0ec001476fa33c55f895bd8e~xSJA--smu0763607636epoutp02S
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1617153525;
        bh=1scqnsZhtAJ2myEum8/wDDlTZ9vw476aVgrl2XGobig=;
        h=Subject:Reply-To:From:To:CC:In-Reply-To:Date:References:From;
        b=iOzZfxzuumN10iXauIdQaS9zXlg5hLbtrf+29RQkyChQt1UdvvFTbjDIywbRTPgzw
         Qb5ydauYJkqUSQk0E2hYSOTYhI4r1kZaY7e+n+Cy30XI3PrqiGDe40OdY3iKOcMOXj
         BIq7aFSVBvkBynSRv8sCSTZOVRzKewEENV7T/tbg=
Received: from epsnrtp2.localdomain (unknown [182.195.42.163]) by
        epcas2p1.samsung.com (KnoxPortal) with ESMTP id
        20210331011844epcas2p1c4290f07e63df30f43d3b8522bd25c05~xSJATSbOm0252002520epcas2p1V;
        Wed, 31 Mar 2021 01:18:44 +0000 (GMT)
Received: from epsmges2p1.samsung.com (unknown [182.195.40.188]) by
        epsnrtp2.localdomain (Postfix) with ESMTP id 4F97k82v0fz4x9QD; Wed, 31 Mar
        2021 01:18:40 +0000 (GMT)
X-AuditID: b6c32a45-205ff7000001748b-7f-6063cdf0ea40
Received: from epcas2p3.samsung.com ( [182.195.41.55]) by
        epsmges2p1.samsung.com (Symantec Messaging Gateway) with SMTP id
        82.C7.29835.0FDC3606; Wed, 31 Mar 2021 10:18:40 +0900 (KST)
Mime-Version: 1.0
Subject: [PATCH v32 4/4] scsi: ufs: Add HPB 2.0 support
...
X-Msg-Type: PERSONAL
X-Reply-Demand: N
Message-ID: <20210331011839epcms2p45d3d059fcd9e85a548014a79c3f388bc@epcms2p4>
Date:   Wed, 31 Mar 2021 10:18:39 +0900
X-CMS-MailID: 20210331011839epcms2p45d3d059fcd9e85a548014a79c3f388bc
...
X-CPGSPASS: Y
CMS-TYPE: 102P
X-Brightmail-Tracker: 
DLP-Filter: Pass
...
index 2145360d74da..f31778dbb995 100644
--- a/drivers/scsi/ufs/ufshcd.c
+++ b/drivers/scsi/ufs/ufshcd.c
@@ -2645,7 +2645,12 @@ static int ufshcd_queuecommand(struct Scsi_Host *host, struct scsi_cmnd *cmd)
...
@@ -3099,7 +3104,7 @@ int ufshcd_query_attr(struct ufs_hba *hba, enum query_opcode opcode,
  *
...
+int ufshcd_query_attr_retry(struct ufs_hba *hba,
 	...
 	u32 *attr_val)
 {
@@ -4854,7 +4859,8 @@ static int ufshcd_change_queue_depth(struct scsi_device *sdev, int depth)
...
@@ -7435,8 +7441,18 @@ static int ufs_get_device_desc(struct ufs_hba *hba)
...
@@ -8009,6 +8025,7 @@ static const struct attribute_group *ufshcd_driver_groups[] = {
...
index f789339f68d9..86805af9abe7 100644
...
@@ -351,28 +613,45 @@ void ufshpb_prep(struct ufs_hba *hba, struct ufshcd_lrb *lrbp)
 		 * active state.
 		 */
...
@@ -380,35 +659,54 @@ static struct ufshpb_req *ufshpb_get_map_req(struct ufshpb_lu *hpb,
 	}
...
@@ -491,6 +789,13 @@ static void ufshpb_activate_subregion(struct ufshpb_lu *hpb,
...
@@ -498,8 +803,8 @@ static void ufshpb_map_req_compl_fn(struct request *req, blk_status_t error)
 	struct ufshpb_subregion *srgn;
 	unsigned long flags;
...
+		map_req->rb.srgn_idx;
 	...
 	spin_lock_irqsave(&hpb->rgn_state_lock, flags);
@@ -509,6 +814,16 @@ static void ufshpb_map_req_compl_fn(struct request *req, blk_status_t error)
...
+
 ...
 {
@@ -522,6 +837,25 @@ static void ufshpb_set_read_buf_cmd(unsigned char *cdb, int rgn_idx,
 	cdb[9] = 0x00;
 }
...
+
 ...
 {
@@ -534,12 +868,12 @@ static int ufshpb_execute_map_req(struct ufshpb_lu *hpb,
...
@@ -555,8 +889,8 @@ static int ufshpb_execute_map_req(struct ufshpb_lu *hpb,
 	if (unlikely(last))
...
@@ -688,6 +1022,31 @@ static void ufshpb_purge_active_subregion(struct ufshpb_lu *hpb,
 	}
 }
...
+
 static void __ufshpb_evict_region(struct ufshpb_lu *hpb,
 				  struct ufshpb_region *rgn)
 {
@@ -1210,6 +1569,17 @@ static void ufshpb_lu_parameter_init(struct ufs_hba *hba,
 	u32 entries_per_rgn;
...
@@ -1357,7 +1727,7 @@ ufshpb_sysfs_attr_show_func(rb_active_cnt);
...
@@ -1368,10 +1738,118 @@ static struct attribute *hpb_dev_attrs[] = {
 };
...
+
 ...
 {
 	hpb->stats.hit_cnt = 0;
@@ -1382,6 +1860,11 @@ static void ufshpb_stat_init(struct ufshpb_lu *hpb)
...
+
 ...
 {
 	int ret;
@@ -1414,14 +1897,24 @@ static int ufshpb_lu_hpb_init(struct ufs_hba *hba, struct ufshpb_lu *hpb)
...
+	ufshpb_pre_req_mempool_destroy(hpb);
 ...
 release_req_cache:
@@ -1430,7 +1923,7 @@ static int ufshpb_lu_hpb_init(struct ufs_hba *hba, struct ufshpb_lu *hpb)
 }
...
+ufshpb_alloc_hpb_lu(struct ufs_hba *hba, struct scsi_device *sdev,
 ...
 {
@@ -1441,7 +1934,8 @@ ufshpb_alloc_hpb_lu(struct ufs_hba *hba, int lun,
 	if (!hpb)
 		return NULL;
...
@@ -1451,6 +1945,7 @@ ufshpb_alloc_hpb_lu(struct ufs_hba *hba, int lun,
 		goto release_hpb;
 	}
...
+	sdev->hostdata = hpb;
 ...
 release_hpb:
@@ -1653,6 +2148,7 @@ void ufshpb_destroy_lu(struct ufs_hba *hba, struct scsi_device *sdev)
...
@@ -1692,6 +2188,7 @@ static void ufshpb_hpb_lu_prepared(struct ufs_hba *hba)
...
+			ufshpb_issue_umap_all_req(hpb);
 			...
 			ufshpb_destroy_lu(hba, sdev);
@@ -1716,7 +2213,7 @@ void ufshpb_init_hpb_lu(struct ufs_hba *hba, struct scsi_device *sdev)
 	if (ret)
 		goto out;
...
+	hpb = ufshpb_alloc_hpb_lu(hba, sdev, &hba->ufshpb_dev,
 	...
 	if (!hpb)
 		goto out;
@@ -1724,9 +2221,6 @@ void ufshpb_init_hpb_lu(struct ufs_hba *hba, struct scsi_device *sdev)
...
@@ -1813,8 +2307,9 @@ void ufshpb_get_geo_info(struct ufs_hba *hba, u8 *geo_buf)
...
@@ -1825,13 +2320,27 @@ void ufshpb_get_dev_info(struct ufs_hba *hba, u8 *desc_buf)
 	}
