...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 670AF4E3E65
	for <lists+linux-scsi@lfdr.de>; Tue, 22 Mar 2022 13:22:18 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233490AbiCVMXn (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 22 Mar 2022 08:23:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33418 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234502AbiCVMXa (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Tue, 22 Mar 2022 08:23:30 -0400
Received: from mail-pf1-x444.google.com (mail-pf1-x444.google.com [IPv6:2607:f8b0:4864:20::444])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7BC1D84EFE
        for <linux-scsi@vger.kernel.org>; Tue, 22 Mar 2022 05:22:02 -0700 (PDT)
Received: by mail-pf1-x444.google.com with SMTP id s8so17951640pfk.12
        for <linux-scsi@vger.kernel.org>; Tue, 22 Mar 2022 05:22:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version;
        bh=qGmvy7qiPcsPfrVLYtjGNocjAziyEJmxgCnfDcpYWbs=;
        b=XtUsk9TFM1DFlYwDV/v+vfs8dfJRliYVjM1+67XXlICnVm2tE1OpO/w9Y/tEyZOl7e
         p1FsTLnMs6g54mBe7Ls8obxvfx/7hYE46OcRTg73/vc3gT1MsvwyfzYM12la/fNa15N0
         QaplPgqkjlaAdWnsBhmkv2/O6M8OD6+NMk4cQ=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version;
        bh=qGmvy7qiPcsPfrVLYtjGNocjAziyEJmxgCnfDcpYWbs=;
        b=
X-Gm-Message-State: AOAM5305QPyM0LAuV+aeJqSyFFdzXJBn5ZWHbYQiSjod+KeXfIGTcxMe
        8vnVz9b3YzAmvkzjeGUl9cR51xFRy1/TmO3riTX6J3n3EIt4RAauFKAtoXXaL1II5gvoG1T88gz
        Wfs2gOnKZYIbz9PxFslTgABvvqX/mlBaeRfnlLte8u1OzjpqJzO2VsoYCzF7ttEH+3Kbv7sYXQf
        51+jXKVNKJiQ==
X-Google-Smtp-Source: ABdhPJwy7Ip82zrLDt4OZ2R1X5dIlj//mxy9S0vwkscgvxX4/kprHt9sp7pccy3u+hpbT4CVIQZPQQ==
X-Received: by 2002:a63:d216:0:b0:382:24ef:147a with SMTP id a22-20020a63d216000000b0038224ef147amr18197832pgg.413.1647951721381;
        Tue, 22 Mar 2022 05:22:01 -0700 (PDT)
Received: from dhcp-10-123-20-15.dhcp.broadcom.net ([192.19.234.250])
        by smtp.gmail.com with ESMTPSA id d11-20020a056a0010cb00b004e1b76b09c0sm23225259pfu.74.2022.03.22.05.21.58
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 22 Mar 2022 05:22:00 -0700 (PDT)
...
Subject: [PATCH 4/7] mpi3mr: add support for PEL commands
Date:   Tue, 22 Mar 2022 08:21:04 -0400
Message-Id: <20220322122107.8482-5-sumit.saxena@broadcom.com>
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
        boundary="00000000000001268105dacda91d"
...
index 9dd87013767d..10c074c1eea6 100644
...
@@ -860,8 +874,20 @@ struct mpi3mr_ioc {
...
@@ -897,6 +924,7 @@ struct mpi3mr_fwevt {
 	bool send_ack;
 	bool process_evt;
 	u32 evt_ctx;
+	u16 event_data_size;
...
@@ -988,5 +1016,11 @@ int mpi3mr_issue_tm(struct mpi3mr_ioc *mrioc, u8 tm_type,
...
index cd354cacf3e0..aa95bff5412a 100644
...
@@ -904,6 +1077,38 @@ static long mpi3mr_bsg_process_mpt_cmds(struct bsg_job *job)
 	return rval;
 }
...

--00000000000001268105dacda91d--
