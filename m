...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3AF257D1631
	for <lists+linux-scsi@lfdr.de>; Fri, 20 Oct 2023 21:08:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233155AbjJTTI3 (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Fri, 20 Oct 2023 15:08:29 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43580 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230321AbjJTTH2 (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Fri, 20 Oct 2023 15:07:28 -0400
Received: from rcdn-iport-6.cisco.com (rcdn-iport-6.cisco.com [173.37.86.77])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 68E1FD46;
        Fri, 20 Oct 2023 12:07:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=cisco.com; i=@cisco.com; l=57048; q=dns/txt;
  s=iport; t=1697828842; x=1699038442;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=zPYZHw9Xur2XqhrJ4FjO7dshiZ/7USPAkS9gOs0T6h0=;
  b=KmV0WaH5xL4XENpys5p8/bdTTO5hw3618icodAJSD0ubnIEfyde9as9H
   JUdLPoimsQjp6VLvVGy6yBC5lfT7G6voMhowi4KcfC45gzYgzqI8qymgl
   LUsN+xGIA1A0zdtcDg1BweRzl8qS74Ya7CmiWJteg+7ZVJQh/q7+zlpBp
   A=;
X-CSE-ConnectionGUID: DnXP316OQBa15gpQh3n46Q==
X-CSE-MsgGUID: ow7Ns1tqRL2aQe8xZ7wUrQ==
X-IronPort-AV: E=Sophos;i="6.03,239,1694736000"; 
   d="scan'208";a="126928635"
Received: from rcdn-core-11.cisco.com ([173.37.93.147])
  by rcdn-iport-6.cisco.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 20 Oct 2023 19:07:22 +0000
Received: from localhost.cisco.com ([10.193.101.253])
        (authenticated bits=0)
        by rcdn-core-11.cisco.com (8.15.2/8.15.2) with ESMTPSA id 39KJ6XPO026372
        (version=TLSv1.2 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=NO);
        Fri, 20 Oct 2023 19:07:21 GMT
...
Subject: [PATCH 12/13] scsi: fnic: Add support for multiqueue (MQ) in fnic driver
Date:   Fri, 20 Oct 2023 12:06:28 -0700
Message-Id: <20231020190629.338623-13-kartilak@cisco.com>
...
---
 ...
 drivers/scsi/fnic/fnic_scsi.c | 579 +++++++++++++++++++++-------------
 4 files changed, 359 insertions(+), 227 deletions(-)

diff --git a/drivers/scsi/fnic/fnic.h b/drivers/scsi/fnic/fnic.h
index 182194b6d51d..bfc333366d1f 100644
...
index ffdbdbfcdf57..7ca34a76f84e 100644
...
+	fnic_queue_wq_copy_desc_icmnd_16(wq, mqtag,
 					 ...
 					 io_req->sgl_list_pa,
@@ -396,7 +380,6 @@ static inline int fnic_queue_wq_copy_desc(struct fnic *fnic,
...
@@ -514,7 +495,7 @@ static int fnic_queuecommand_lck(struct scsi_cmnd *sc)
...
@@ -549,11 +530,9 @@ static int fnic_queuecommand_lck(struct scsi_cmnd *sc)
 	}
...
+		spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 		if (io_req) {
 			...
 			mempool_free(io_req, fnic->io_req_pool);
@@ -601,18 +593,43 @@ static int fnic_queuecommand_lck(struct scsi_cmnd *sc)
 			sc->cmnd[5]);
...
@@ -789,20 +806,21 @@ static inline void fnic_fcpio_ack_handler(struct fnic *fnic,
...
@@ -812,12 +830,12 @@ static inline void fnic_fcpio_ack_handler(struct fnic *fnic,
...
@@ -825,27 +843,49 @@ static void fnic_fcpio_icmnd_cmpl_handler(struct fnic *fnic,
 	struct scsi_cmnd *sc;
 	struct fnic_stats *fnic_stats = &fnic->fnic_stats;
 	unsigned long flags;
-	spinlock_t *io_lock;
...
@@ -861,14 +901,19 @@ static void fnic_fcpio_icmnd_cmpl_handler(struct fnic *fnic,
 		return;
 	}
...
@@ -892,7 +937,7 @@ static void fnic_fcpio_icmnd_cmpl_handler(struct fnic *fnic,
 		 */
...
@@ -980,7 +1025,11 @@ static void fnic_fcpio_icmnd_cmpl_handler(struct fnic *fnic,
...
@@ -1014,7 +1063,6 @@ static void fnic_fcpio_icmnd_cmpl_handler(struct fnic *fnic,
...
@@ -1051,12 +1099,12 @@ static void fnic_fcpio_icmnd_cmpl_handler(struct fnic *fnic,
...
+	struct fcpio_tag ftag;
 	...
 	struct scsi_cmnd *sc;
 	struct fnic_io_req *io_req;
@@ -1065,35 +1113,76 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
...
@@ -1114,7 +1203,7 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
...
+		spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 		...
 		switch (hdr_status) {
@@ -1149,7 +1238,7 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
 		}
...
@@ -1175,14 +1264,14 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
 		 */
 		if (io_req->abts_done) {
 			complete(io_req->abts_done);
-			spin_unlock_irqrestore(io_lock, flags);
...
+			spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 			...
 			fnic_release_ioreq_buf(fnic, io_req, sc);
 			mempool_free(io_req, fnic->io_req_pool);
@@ -1208,7 +1297,7 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
...
@@ -1223,7 +1312,7 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
 		}
...
@@ -1243,13 +1332,13 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
 			      fnic_fcpio_status_to_str(hdr_status));
 		if (io_req->dr_done)
...
@@ -1276,17 +1365,19 @@ static int fnic_fcpio_cmpl_handler(struct vnic_dev *vdev,
 		break;
 	}
...
@@ -1339,18 +1430,33 @@ int fnic_wq_copy_cmpl_handler(struct fnic *fnic, int copy_work_to_do, unsigned i
...
+
 	if ((fnic_priv(sc)->flags & FNIC_DEVICE_RESET) &&
 	    !(fnic_priv(sc)->flags & FNIC_DEV_RST_DONE)) {
 		/*
@@ -1362,20 +1468,16 @@ static bool fnic_cleanup_io_iter(struct scsi_cmnd *sc, void *data)
 			complete(io_req->dr_done);
...
@@ -1385,7 +1487,6 @@ static bool fnic_cleanup_io_iter(struct scsi_cmnd *sc, void *data)
 	fnic_release_ioreq_buf(fnic, io_req, sc);
 	mempool_free(io_req, fnic->io_req_pool);
...
@@ -1396,12 +1497,6 @@ static bool fnic_cleanup_io_iter(struct scsi_cmnd *sc, void *data)
 	else
...
-
 	FNIC_TRACE(fnic_cleanup_io,
 		   ...
 		   jiffies_to_msecs(jiffies - start_time),
@@ -1430,8 +1525,8 @@ void fnic_wq_copy_cleanup_handler(struct vnic_wq_copy *wq,
 	struct fnic_io_req *io_req;
 	struct scsi_cmnd *sc;
 	unsigned long flags;
-	spinlock_t *io_lock;
...
@@ -1444,8 +1539,8 @@ void fnic_wq_copy_cleanup_handler(struct vnic_wq_copy *wq,
 	if (!sc)
 		return;
...
+	spin_lock_irqsave(&fnic->wq_copy_lock[hwq], flags);
 	...
 	io_req = fnic_priv(sc)->io_req;
@@ -1453,13 +1548,15 @@ void fnic_wq_copy_cleanup_handler(struct vnic_wq_copy *wq,
...
+	spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	fnic_release_ioreq_buf(fnic, io_req, sc);
@@ -1483,9 +1580,10 @@ void fnic_wq_copy_cleanup_handler(struct vnic_wq_copy *wq,
...
@@ -1498,13 +1596,13 @@ static inline int fnic_queue_abort_io_req(struct fnic *fnic, int tag,
...
@@ -1521,7 +1619,7 @@ static inline int fnic_queue_abort_io_req(struct fnic *fnic, int tag,
 		atomic64_set(&fnic->fnic_stats.fw_stats.max_fw_reqs,
 		  atomic64_read(&fnic->fnic_stats.fw_stats.active_fw_reqs));
...
+	spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	return 0;
@@ -1535,24 +1633,27 @@ struct fnic_rport_abort_io_iter_data {
...
@@ -1561,7 +1662,7 @@ static bool fnic_rport_abort_io_iter(struct scsi_cmnd *sc, void *data)
 		FNIC_SCSI_DBG(KERN_DEBUG, fnic->lport->host,
...
@@ -1570,7 +1671,7 @@ static bool fnic_rport_abort_io_iter(struct scsi_cmnd *sc, void *data)
...
+		spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	if (io_req->abts_done) {
@@ -1601,31 +1702,31 @@ static bool fnic_rport_abort_io_iter(struct scsi_cmnd *sc, void *data)
 	FNIC_SCSI_DBG(KERN_DEBUG, fnic->lport->host,
...
@@ -1703,7 +1804,6 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
 	struct fnic *fnic;
 	struct fnic_io_req *io_req = NULL;
 	struct fc_rport *rport;
-	spinlock_t *io_lock;
 	...
 	unsigned long start_time = 0;
 	int ret = SUCCESS;
@@ -1713,8 +1813,10 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
...
@@ -1724,23 +1826,25 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
...
@@ -1753,18 +1857,17 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
 	 *
...
@@ -1796,7 +1899,7 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
...
@@ -1813,15 +1916,15 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
 	/* Now queue the abort command to firmware */
 	int_to_scsilun(sc->device->lun, &fc_lun);
...
@@ -1845,12 +1948,12 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
 				     fnic->config.ed_tov));
...
+		spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 		...
 		ret = FAILED;
 		goto fnic_abort_cmd_end;
@@ -1859,7 +1962,7 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
...
@@ -1873,7 +1976,7 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
 	/* IO out of order */
...
@@ -1889,15 +1992,18 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
...
+	spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	fnic_release_ioreq_buf(fnic, io_req, sc);
 	mempool_free(io_req, fnic->io_req_pool);
@@ -1912,7 +2018,7 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
 		atomic64_inc(&fnic_stats->io_stats.io_completions);
...
@@ -1930,25 +2036,31 @@ static inline int fnic_queue_dr_io_req(struct fnic *fnic,
 				       struct scsi_cmnd *sc,
 				       struct fnic_io_req *io_req)
 {
-	struct vnic_wq_copy *wq = &fnic->hw_copy_wq[0];
...
+		free_wq_copy_descs(fnic, wq, hwq);
 	...
 	if (!vnic_wq_copy_desc_avail(wq)) {
 		FNIC_SCSI_DBG(KERN_DEBUG, fnic->lport->host,
@@ -1973,7 +2085,7 @@ static inline int fnic_queue_dr_io_req(struct fnic *fnic,
 		  atomic64_read(&fnic->fnic_stats.fw_stats.active_fw_reqs));
...
+	spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	return ret;
@@ -1988,12 +2100,13 @@ struct fnic_pending_aborts_iter_data {
...
-	spinlock_t *io_lock;
 	...
 	struct scsi_lun fc_lun;
 	DECLARE_COMPLETION_ONSTACK(tm_done);
@@ -2002,11 +2115,13 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
...
@@ -2019,7 +2134,7 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
...
+		spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	if ((fnic_priv(sc)->flags & FNIC_DEVICE_RESET) &&
@@ -2027,7 +2142,7 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
 		FNIC_SCSI_DBG(KERN_INFO, fnic->lport->host,
...
@@ -2048,35 +2163,34 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
...
@@ -2084,10 +2198,10 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
 				    (fnic->config.ed_tov));
...
@@ -2096,7 +2210,7 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
...
+		spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 		...
 		iter_data->ret = FAILED;
 		return false;
@@ -2104,9 +2218,11 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
...
+	spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	/* original sc used for lr is handled by dev reset code */
 	if (sc != iter_data->lr_sc) {
@@ -2178,15 +2294,15 @@ int fnic_device_reset(struct scsi_cmnd *sc)
 	struct fc_rport *rport;
 	int status;
 	int ret = FAILED;
-	spinlock_t *io_lock;
...
+	uint16_t hwq = 0;
 	...
 	/* Wait for rport to unblock */
 	fc_block_scsi_eh(sc);
@@ -2216,7 +2332,7 @@ int fnic_device_reset(struct scsi_cmnd *sc)
...
@@ -2225,11 +2341,14 @@ int fnic_device_reset(struct scsi_cmnd *sc)
...
+	spin_lock_irqsave(&fnic->wq_copy_lock[hwq], flags);
 	...
 	/*
@@ -2239,34 +2358,43 @@ int fnic_device_reset(struct scsi_cmnd *sc)
 	if (!io_req) {
...
@@ -2275,12 +2403,12 @@ int fnic_device_reset(struct scsi_cmnd *sc)
...
+				"io_req is null mqtag 0x%x sc 0x%p\n", mqtag, sc);
 	...
 	io_req->dr_done = NULL;
@@ -2296,41 +2424,41 @@ int fnic_device_reset(struct scsi_cmnd *sc)
 		FNIC_SCSI_DBG(KERN_DEBUG, fnic->lport->host,
...
+				spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 				...
 				msecs_to_jiffies(FNIC_LUN_RESET_TIMEOUT));
 				break;
@@ -2341,12 +2469,12 @@ int fnic_device_reset(struct scsi_cmnd *sc)
 			}
 		}
 	} else {
-		spin_unlock_irqrestore(io_lock, flags);
...
@@ -2362,7 +2490,7 @@ int fnic_device_reset(struct scsi_cmnd *sc)
 	 * succeeds
 	 */
...
+		spin_lock_irqsave(&fnic->wq_copy_lock[hwq], flags);
 		...
 		FNIC_SCSI_DBG(KERN_DEBUG, fnic->lport->host,
 			      "Device reset failed"
@@ -2371,17 +2499,20 @@ int fnic_device_reset(struct scsi_cmnd *sc)
 	}
...
+	spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	if (io_req) {
 		start_time = io_req->start_time;
@@ -2619,12 +2750,17 @@ void fnic_exch_mgr_reset(struct fc_lport *lp, u32 sid, u32 did)
...
@@ -2635,12 +2771,11 @@ static bool fnic_abts_pending_iter(struct scsi_cmnd *sc, void *data)
...
@@ -2652,7 +2787,7 @@ static bool fnic_abts_pending_iter(struct scsi_cmnd *sc, void *data)
