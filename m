...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 52C684202C0
	for <lists+linux-scsi@lfdr.de>; Sun,  3 Oct 2021 18:37:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231158AbhJCQis (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 3 Oct 2021 12:38:48 -0400
Received: from smtp.infotech.no ([82.134.31.41]:55151 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230519AbhJCQis (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 3 Oct 2021 12:38:48 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 40775204247;
        Sun,  3 Oct 2021 18:36:49 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id QsvzifLX1vbJ; Sun,  3 Oct 2021 18:34:03 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-23-91-187-47.dyn.295.ca [23.91.187.47])
        by smtp.infotech.no (Postfix) with ESMTPA id 0D2E020414B;
        Sun,  3 Oct 2021 18:33:54 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        Damien.LeMoal@wdc.com, Hannes Reinecke <hare@suse.com>
Subject: [PATCH v21 09/46] sg: sg_allow_if_err_recovery and renames
Date:   Sun,  3 Oct 2021 12:31:14 -0400
Message-Id: <20211003163151.585349-10-dgilbert@interlog.com>
...
index 9ba19c4e10ba..0ade94d5fd91 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -675,7 +696,7 @@ sg_common_write(struct sg_fd *sfp, struct sg_request *srp,
 			srp->rq = NULL;
 		}
...
@@ -761,7 +782,7 @@ sg_new_read(struct sg_fd *sfp, char __user *buf, size_t count,
...
@@ -785,23 +806,24 @@ sg_read(struct file *filp, char __user *buf, size_t count, loff_t *ppos)
 	struct sg_fd *sfp;
 	struct sg_request *srp;
 	int req_pack_id = -1;
+	int ret = 0;
...
+		return ret;
 	...
 	if (!access_ok(buf, count))
 		return -EFAULT;
@@ -810,7 +832,7 @@ sg_read(struct file *filp, char __user *buf, size_t count, loff_t *ppos)
 		if (!old_hdr)
 			return -ENOMEM;
 		if (copy_from_user(old_hdr, buf, SZ_SG_HEADER)) {
-			retval = -EFAULT;
+			ret = -EFAULT;
 		...
 		if (old_hdr->reply_len < 0) {
@@ -819,15 +841,15 @@ sg_read(struct file *filp, char __user *buf, size_t count, loff_t *ppos)
...
@@ -838,28 +860,28 @@ sg_read(struct file *filp, char __user *buf, size_t count, loff_t *ppos)
...
@@ -867,7 +889,7 @@ sg_read(struct file *filp, char __user *buf, size_t count, loff_t *ppos)
 	if (!old_hdr) {
...
@@ -920,7 +942,7 @@ sg_read(struct file *filp, char __user *buf, size_t count, loff_t *ppos)
...
+			ret = -EFAULT;
 		...
 		buf += SZ_SG_HEADER;
@@ -928,19 +950,19 @@ sg_read(struct file *filp, char __user *buf, size_t count, loff_t *ppos)
...
+	return ret;
 ...
 static int
@@ -1028,12 +1050,11 @@ sg_ioctl_common(struct file *filp, struct sg_device *sdp, struct sg_fd *sfp,
...
@@ -1232,8 +1253,7 @@ sg_ioctl_common(struct file *filp, struct sg_device *sdp, struct sg_fd *sfp,
 		break;
 	}
...
@@ -1390,7 +1410,7 @@ sg_rq_end_io_usercontext(struct work_struct *work)
...
@@ -1898,7 +1918,7 @@ sg_start_req(struct sg_request *srp, u8 *cmd)
 }
...
@@ -2039,7 +2059,7 @@ sg_remove_scat(struct sg_fd *sfp, struct sg_scatter_hold *schp)
...
+sg_rd_append(struct sg_request *srp, void __user *outp, int num_xfer)
 {
 	...
 	int k, num;
@@ -2242,7 +2262,7 @@ sg_remove_sfp_usercontext(struct work_struct *work)
...
@@ -2320,7 +2340,7 @@ sg_get_dev(int dev)
...
@@ -2331,7 +2351,7 @@ static const struct proc_ops adio_proc_ops = {
...
@@ -2380,13 +2400,13 @@ sg_proc_init(void)
 	if (!p)
 		return 1;
...
@@ -2410,9 +2430,9 @@ sg_proc_seq_show_int(struct seq_file *s, void *v)
 }
...
+	return single_open(filp, sg_proc_seq_show_int, &sg_allow_dio);
 ...
 static ssize_t 
@@ -2432,9 +2452,9 @@ sg_proc_write_adio(struct file *filp, const char __user *buffer,
 }
...
+	return single_open(filp, sg_proc_seq_show_int, &sg_big_buff);
 ...
 static ssize_t 
@@ -2496,7 +2516,7 @@ dev_seq_start(struct seq_file *s, loff_t *pos)
 static void *
...
@@ -2511,7 +2531,7 @@ dev_seq_stop(struct seq_file *s, void *v)
 static int
...
@@ -2537,7 +2557,7 @@ sg_proc_seq_show_dev(struct seq_file *s, void *v)
 static int
...
+	struct sg_proc_deviter *it = (struct sg_proc_deviter *)v;
 	...
 	struct scsi_device *scsidp;
 	unsigned long iflags;
@@ -2624,7 +2644,7 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
 static int
