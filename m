...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DDA6A32BBAF
	for <lists+linux-scsi@lfdr.de>; Wed,  3 Mar 2021 22:30:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1379447AbhCCMq7 (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 3 Mar 2021 07:46:59 -0500
Received: from z11.mailgun.us ([104.130.96.11]:42473 "EHLO z11.mailgun.us"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1840618AbhCCEcD (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Tue, 2 Mar 2021 23:32:03 -0500
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1614745903; h=Message-ID: References: In-Reply-To: Subject:
 Cc: To: From: Date: Content-Transfer-Encoding: Content-Type:
 MIME-Version: Sender; bh=N7yfJnPftwUvMzg0RVK6pjjU64FL/NcNTBs3J89YEQ0=;
 b=lK8OczX2wrARxUIhXUop2dvcdMxGayCHlHibmktUNYOaJFAmFdqh6mCR5cAcWbyWRQIiL/L1
 ryUfVC9V1mdvtnqbUypm9w0ITbhiEDxTwTHuNvo+CQJ+OGuhDWyCAhd45WSlRH39fmUvOJAF
 gYdT5rq8nFJoujyI0Eoe44lOlEo=
X-Mailgun-Sending-Ip: 104.130.96.11
X-Mailgun-Sid: WyJlNmU5NiIsICJsaW51eC1zY3NpQHZnZXIua2VybmVsLm9yZyIsICJiZTllNGEiXQ==
Received: from smtp.codeaurora.org
 (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171]) by
 smtp-out-n01.prod.us-west-2.postgun.com with SMTP id
 603f110a0071502ba9de45ec (version=TLS1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256); Wed, 03 Mar 2021 04:31:06
 GMT
Sender: cang=codeaurora.org@mg.codeaurora.org
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id 46489C43464; Wed,  3 Mar 2021 04:31:06 +0000 (UTC)
...
Received: from mail.codeaurora.org (localhost.localdomain [127.0.0.1])
        ...
        by smtp.codeaurora.org (Postfix) with ESMTPSA id C486CC433C6;
        Wed,  3 Mar 2021 04:31:00 +0000 (UTC)
MIME-Version: 1.0
Content-Type: text/plain; charset=US-ASCII;
 format=flowed
Content-Transfer-Encoding: 7bit
Date:   Wed, 03 Mar 2021 12:31:00 +0800
...
Message-ID: <c76cfa925ce2b91735577a030564a3c2@codeaurora.org>
...
> recommended by
> @@ -1292,10 +1292,33 @@ Description:	This entry shows the number of
...
>  	ufshpb_get_pos_from_lpn(hpb, lpn, &rgn_idx, &srgn_idx, &srgn_offset);
> @@ -323,18 +593,18 @@ void ufshpb_prep(struct ufs_hba *hba, struct
> ufshcd_lrb *lrbp)
...
> &ppn);
> @@ -347,28 +617,46 @@ void ufshpb_prep(struct ufs_hba *hba, struct
> ufshcd_lrb *lrbp)
>  		 * active state.
>  		 */
...
> @@ -376,35 +664,54 @@ static struct ufshpb_req
...
> @@ -487,6 +794,13 @@ static void ufshpb_activate_subregion(struct
> ufshpb_lu *hpb,
...
> @@ -494,8 +808,8 @@ static void ufshpb_map_req_compl_fn(struct request
...
>  	spin_lock_irqsave(&hpb->rgn_state_lock, flags);
> @@ -505,6 +819,16 @@ static void ufshpb_map_req_compl_fn(struct
...
>  {
> @@ -518,6 +842,27 @@ static void ufshpb_set_read_buf_cmd(unsigned char
> *cdb, int rgn_idx,
>  	cdb[9] = 0x00;
>  }
> 
...
>  {
> @@ -530,12 +875,12 @@ static int ufshpb_execute_map_req(struct 
> ufshpb_lu *hpb,
> 
>  	q = hpb->sdev_ufs_lu->request_queue;
...
>  		}
>  	}
> @@ -551,8 +896,8 @@ static int ufshpb_execute_map_req(struct ufshpb_lu 
> *hpb,
>  	if (unlikely(last))
...
> @@ -684,6 +1029,31 @@ static void ufshpb_purge_active_subregion(struct
> ufshpb_lu *hpb,
>  	}
>  }
> 
...
>  {
>  	hpb->stats.hit_cnt = 0;
> @@ -1381,6 +1860,11 @@ static void ufshpb_stat_init(struct ufshpb_lu 
> *hpb)
...
>  {
>  	int ret;
> @@ -1413,14 +1897,24 @@ static int ufshpb_lu_hpb_init(struct ufs_hba
...
>  release_req_cache:
> @@ -1429,7 +1923,7 @@ static int ufshpb_lu_hpb_init(struct ufs_hba
> *hba, struct ufshpb_lu *hpb)
>  }
> 
...
> 
>  release_hpb:
> @@ -1652,6 +2148,7 @@ void ufshpb_destroy_lu(struct ufs_hba *hba,
...
> @@ -1691,6 +2188,7 @@ static void ufshpb_hpb_lu_prepared(struct ufs_hba 
> *hba)
...
> @@ -1715,7 +2213,7 @@ void ufshpb_init_hpb_lu(struct ufs_hba *hba,
> struct scsi_device *sdev)
>  	if (ret)
>  		goto out;
> 
...
>  	if (!hpb)
>  		goto out;
> @@ -1723,9 +2221,6 @@ void ufshpb_init_hpb_lu(struct ufs_hba *hba,
> struct scsi_device *sdev)
