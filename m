...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C53B27EB964
	for <lists+linux-scsi@lfdr.de>; Tue, 14 Nov 2023 23:33:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234150AbjKNWdP (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 14 Nov 2023 17:33:15 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52624 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234136AbjKNWdO (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Tue, 14 Nov 2023 17:33:14 -0500
Received: from rcdn-iport-6.cisco.com (rcdn-iport-6.cisco.com [173.37.86.77])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 788CCE6;
        Tue, 14 Nov 2023 14:33:09 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=cisco.com; i=@cisco.com; l=12925; q=dns/txt;
  s=iport; t=1700001189; x=1701210789;
  h=from:to:cc:subject:date:message-id:mime-version:
   content-transfer-encoding;
  bh=Rhg2ugcC3u+HeuPQxqVutuYlGNbwKVeDgCLq2ZWf7co=;
  b=cMuuLpLVBaMOeIrDgoY9vkHFUrRjzuMWHNzArwKjjBpihLs5pes8jtYN
   lWyxaHOjzIhwT6a48wlqF3jZZVsiEZNhNictGEaFb+4lGntQWOg68c07P
   I8HiCGKPyMsayjRpQhWwgkZNaKfQc0AykNIuQTdcQOT5S9goCf9xdCEnb
   A=;
X-CSE-ConnectionGUID: pIPcI9s/SiGU651sDvntFg==
X-CSE-MsgGUID: vYD5UCjvRHCjo+TegwisrA==
X-IronPort-AV: E=Sophos;i="6.03,303,1694736000"; 
   d="scan'208";a="138688603"
Received: from rcdn-core-3.cisco.com ([173.37.93.154])
  by rcdn-iport-6.cisco.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Nov 2023 22:33:08 +0000
Received: from localhost.cisco.com ([10.193.101.253])
        (authenticated bits=0)
        by rcdn-core-3.cisco.com (8.15.2/8.15.2) with ESMTPSA id 3AEMWx0h005968
        (version=TLSv1.2 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=NO);
        Tue, 14 Nov 2023 22:33:07 GMT
...
Subject: [PATCH v3 03/13] scsi: fnic: Add and improve log messages
Date:   Tue, 14 Nov 2023 14:32:57 -0800
Message-Id: <20231114223257.633779-1-kartilak@cisco.com>
...
index ea7b1ba27ac7..98ae2e4cdf10 100644
--- a/drivers/scsi/fnic/fnic_main.c
+++ b/drivers/scsi/fnic/fnic_main.c
@@ -212,7 +212,7 @@ static struct fc_host_statistics *fnic_get_stats(struct Scsi_Host *host)
 	spin_unlock_irqrestore(&fnic->fnic_lock, flags);
...
+		FNIC_MAIN_DBG(KERN_DEBUG, fnic->lport->host, fnic->fnic_num,
 			      ...
 			      " 0x%x", ret);
 		return stats;
@@ -324,7 +324,7 @@ static void fnic_reset_host_stats(struct Scsi_Host *host)
 	spin_unlock_irqrestore(&fnic->fnic_lock, flags);
