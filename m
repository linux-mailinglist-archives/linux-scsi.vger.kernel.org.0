...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6889539D3D3
	for <lists+linux-scsi@lfdr.de>; Mon,  7 Jun 2021 06:18:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230183AbhFGETw (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Mon, 7 Jun 2021 00:19:52 -0400
Received: from mailout4.samsung.com ([203.254.224.34]:33495 "EHLO
        mailout4.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229993AbhFGETw (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Mon, 7 Jun 2021 00:19:52 -0400
Received: from epcas2p1.samsung.com (unknown [182.195.41.53])
        by mailout4.samsung.com (KnoxPortal) with ESMTP id 20210607041759epoutp045a0521c897c5281467041b2e3ed3b351~GMc7Cvqz32231422314epoutp047
        for <linux-scsi@vger.kernel.org>; Mon,  7 Jun 2021 04:17:59 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout4.samsung.com 20210607041759epoutp045a0521c897c5281467041b2e3ed3b351~GMc7Cvqz32231422314epoutp047
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1623039479;
        bh=hB+TmtiXPUaTxMUgyTvickuQdnXHwSN1NcUpt2VMRx4=;
        h=Subject:Reply-To:From:To:CC:In-Reply-To:Date:References:From;
        b=nvILD2Q7tj5pd7aVDNU94wvyLeeHWkcpIkcS5nbY3PRtSsAK4bfllBVwphalt6DcL
         ub6nbFJbuIW2D0LRNYrKV9jvZpg80gmhlGPX9QtxpZJEK6Lctwl5eqkFo1ctrsXtZQ
         bA3WufCMlSOZlRj9+5sgQxFWvyTl4vZnxXehRBbw=
Received: from epsnrtp2.localdomain (unknown [182.195.42.163]) by
        epcas2p2.samsung.com (KnoxPortal) with ESMTP id
        20210607041758epcas2p2fc58949e4b887d7714f79112d78e8d8c~GMc6MfhML3038130381epcas2p2Q;
        Mon,  7 Jun 2021 04:17:58 +0000 (GMT)
Received: from epsmges2p2.samsung.com (unknown [182.195.40.191]) by
        epsnrtp2.localdomain (Postfix) with ESMTP id 4Fz0Tc39Pwz4x9Pw; Mon,  7 Jun
        2021 04:17:56 +0000 (GMT)
X-AuditID: b6c32a46-e01ff700000025de-a2-60bd9df4bb3c
Received: from epcas2p4.samsung.com ( [182.195.41.56]) by
        epsmges2p2.samsung.com (Symantec Messaging Gateway) with SMTP id
        57.2B.09694.4FD9DB06; Mon,  7 Jun 2021 13:17:56 +0900 (KST)
Mime-Version: 1.0
Subject: [PATCH v36 1/4] scsi: ufs: Introduce HPB feature
...
X-Msg-Type: PERSONAL
X-Reply-Demand: N
Message-ID: <20210607041755epcms2p271195b24f4a10e777d240ff5d844168f@epcms2p2>
Date:   Mon, 07 Jun 2021 13:17:55 +0900
X-CMS-MailID: 20210607041755epcms2p271195b24f4a10e777d240ff5d844168f
...
X-CPGSPASS: Y
CMS-TYPE: 102P
X-Brightmail-Tracker: 
        jlYupSNxjVb6L5s7IdF9BAAA
DLP-Filter: Pass
...
index 8380866d8ed0..84de0db35455 100644
...
index 52bd807f7940..639644817f36 100644
...
index af527e77fe66..f46566248a80 100644
...
@@ -4964,6 +4965,25 @@ static int ufshcd_change_queue_depth(struct scsi_device *sdev, int depth)
...
@@ -4973,6 +4993,8 @@ static int ufshcd_slave_configure(struct scsi_device *sdev)
...
@@ -4999,6 +5021,9 @@ static void ufshcd_slave_destroy(struct scsi_device *sdev)
 	struct ufs_hba *hba;
...
+
 	...
 	if (ufshcd_scsi_to_upiu_lun(sdev->lun) == UFS_UPIU_UFS_DEVICE_WLUN) {
 		unsigned long flags;
@@ -7083,6 +7108,8 @@ static int ufshcd_host_reset_and_restore(struct ufs_hba *hba)
...
@@ -7484,6 +7511,7 @@ static int ufs_get_device_desc(struct ufs_hba *hba)
 {
 	int err;
 	u8 model_index;
...
@@ -7511,9 +7539,16 @@ static int ufs_get_device_desc(struct ufs_hba *hba)
...
+
 	...
 	if (err < 0) {
@@ -7745,6 +7780,10 @@ static int ufshcd_device_geo_params_init(struct ufs_hba *hba)
...
+
 out:
 	kfree(desc_buf);
 	return err;
@@ -7887,6 +7926,7 @@ static int ufshcd_add_lus(struct ufs_hba *hba)
 	}
...
@@ -8035,6 +8075,7 @@ static int ufshcd_probe_hba(struct ufs_hba *hba, bool async)
...
+	ufshpb_reset(hba);
 out:
 	spin_lock_irqsave(hba->host->host_lock, flags);
 	if (ret)
@@ -8082,6 +8123,9 @@ static void ufshcd_async_scan(void *data, async_cookie_t cookie)
...
@@ -8783,6 +8827,8 @@ static int __ufshcd_wl_suspend(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
@@ -8906,6 +8952,7 @@ static int __ufshcd_wl_suspend(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
+		ufshpb_resume(hba);
 	...
 	return ret;
@@ -8983,6 +9030,8 @@ static int __ufshcd_wl_resume(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
index 5735a9516faa..f99059b31e0a 100644
--- a/drivers/scsi/ufs/ufshcd.h
+++ b/drivers/scsi/ufs/ufshcd.h
@@ -643,6 +643,25 @@ struct ufs_hba_variant_params {
