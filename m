...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 807B2367420
	for <lists+linux-scsi@lfdr.de>; Wed, 21 Apr 2021 22:25:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243916AbhDUU0X (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 21 Apr 2021 16:26:23 -0400
Received: from userp2120.oracle.com ([156.151.31.85]:52228 "EHLO
        userp2120.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S243691AbhDUU0V (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Wed, 21 Apr 2021 16:26:21 -0400
Received: from pps.filterd (userp2120.oracle.com [127.0.0.1])
        by userp2120.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 13LKNFen011232;
        Wed, 21 Apr 2021 20:25:39 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=from : to : cc :
 subject : date : message-id : references : in-reply-to : content-type :
 content-id : content-transfer-encoding : mime-version; s=corp-2020-01-29;
 bh=iDz85GlytoW4WE/Or4xQYjUHzwl6/Mqn5EMFiOVwsHo=;
 b= jw== 
Received: from userp3030.oracle.com (userp3030.oracle.com [156.151.31.80])
        by userp2120.oracle.com with ESMTP id 38022y2va5-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Wed, 21 Apr 2021 20:25:37 +0000
Received: from pps.filterd (userp3030.oracle.com [127.0.0.1])
        by userp3030.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 13LKEs1E087534;
        Wed, 21 Apr 2021 20:25:36 GMT
Received: from nam10-bn7-obe.outbound.protection.outlook.com (mail-bn7nam10lp2105.outbound.protection.outlook.com [104.47.70.105])
        by userp3030.oracle.com with ESMTP id 3809m15540-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Wed, 21 Apr 2021 20:25:35 +0000
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=iDz85GlytoW4WE/Or4xQYjUHzwl6/Mqn5EMFiOVwsHo=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=iDz85GlytoW4WE/Or4xQYjUHzwl6/Mqn5EMFiOVwsHo=;
 b=rdLODr6MnbvAHzNiWD+pVK8zPO7fqvQDklUmseEARsC4FewG4LuBF7gvKZq83Yz3RcOK0wPyyCOOCfYzoygwlKrSG3Xsq4kmvFLd/xd6nueAAcEceAslIsrXtTwrkkcu6iNP9CAk6Zi18SnLdC0lqmkk1wbQtOyGZeu+7185j/A=
...
Thread-Topic: [PATCH v3 06/24] mpi3mr: add support of event handling part-1
Thread-Index: AQHXNQuMpWpZTNFfuk2PgO582JL8Jqq/btmA
Date:   Wed, 21 Apr 2021 20:25:30 +0000
Message-ID: <767CF84D-0A7B-41D1-ACF5-269AA6C14240@oracle.com>
...
x-ms-office365-filtering-correlation-id: b2f34d77-5508-43fe-2881-08d905039bea
x-ms-traffictypediagnostic: SA2PR10MB4426:
x-ms-exchange-transport-forked: True
x-microsoft-antispam-prvs: <SA2PR10MB442638EE62C115DEC067F95EE6479@SA2PR10MB4426.namprd10.prod.outlook.com>
x-ms-oob-tlc-oobclassifiers: OLM:9508;
x-ms-exchange-senderadcheck: 1
x-microsoft-antispam: BCL:0;
x-microsoft-antispam-message-info: 
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:SN6PR10MB2943.namprd10.prod.outlook.com;PTR:;CAT:NONE;SFS:(366004)(136003)(346002)(396003)(376002)(39860400002)(44832011)(66946007)(8676002)(4326008)(186003)(19627235002)(66476007)(66446008)(2616005)(38100700002)(64756008)(30864003)(53546011)(316002)(122000001)(6506007)(54906003)(76116006)(6486002)(83380400001)(8936002)(5660300002)(36756003)(6512007)(71200400001)(33656002)(2906002)(86362001)(66556008)(6916009)(26005)(478600001)(32563001)(45980500001)(559001)(579004)(569008);DIR:OUT;SFP:1101;
x-ms-exchange-antispam-messagedata: =?us-ascii?Q?U43v+UlHNHOcYPghKRL9SMNqQc/TEnp9EQSAt7z7hy1OZWi54QjJ/1EEEqM5?=
 =?us-ascii?Q?UOuaEMFKOiaBn+c5DDquTSNE6dRnOHXHlJYh7AVlJzAblFjt6d/0U07KdZ8Q?=
 =?us-ascii?Q?kHKdJDSt4Ald4cOiWIWbTY8ExZGYSQgUDIL4bRqAmRp5CUlfs+I+RyptBsuK?=
 =?us-ascii?Q?gI+792ZLuTqnGdoRQJvrGWunEV5/YUUgLoaqf8Qo2/5hSqkK5qkLnekEQUui?=
 =?us-ascii?Q?jc8qOg/Y81Ku20x+I+/62HHVHbXCgBtgQtraAokXJmsLpI0SzlL1BE/NQiuE?=
 =?us-ascii?Q?Pb0DE+ldkskDfzrcIuDNsg3n1JrJJaz9bPkU4ufuelMaZdggGdFCNeAQJ/se?=
 =?us-ascii?Q?rzmLk8KsJ9xqcS29sKeXu4F+SAIdriYdM6qpxW2M/e09xOECDeuPCb9zcoyJ?=
 =?us-ascii?Q?yALXqNiz1rYHrAsqgIWHHW8qvKvqyU8HOq1mPdZLRh28XuNCCcert+URZ5P1?=
 =?us-ascii?Q?IXsFR4Lxs0hFbj+jxrXUfp3ltu4wbLl9UBLTFYXs3YVN1A/ou12HLDwFD6Jw?=
 =?us-ascii?Q?+7ymNVEHXupRqgSNBOCc6PSNcTuUGdPscJAyQQwIgFnYOahBFgq//RPGB8tX?=
 =?us-ascii?Q?H69vZ142dPm7X433t+grD3inQzD5nNdohfuqZbQ5MQuLTi0hGvus7188qHVC?=
 =?us-ascii?Q?Rf8DRZG4bxCq6YS1K7K8kzP2GP1xEOwv39HU88JeAdWGPiyx0aq1dZCwbxCx?=
 =?us-ascii?Q?vBLiQuDwqgkweMDrwNLdXpqFS+HSsus2zjFj9AUUX6bHT1pxSrE4thFfuAS+?=
 =?us-ascii?Q?L8AI/rXVOI4VXs24qxqGiQ+toMzoEATcg1UroMAnq3eibsvrL0ljiPvF7FMo?=
 =?us-ascii?Q?uhf04lAQEkmlOLH3Q5uyKyRk3ZeyYRtIV3uZAEIr6JizWu0ZI8e+YKRa++1O?=
 =?us-ascii?Q?3m+9/IWR+g0AEpEUiwkGs1c2atlcsoZ25gi8FgN0FznYaYiGIuPckJERvqR5?=
 =?us-ascii?Q?GMqp4dT/xDF1yuTCfDDNoIeoBvpuIaETNNDvj9lc0OcTEz8K3kMAcoh4pcko?=
 =?us-ascii?Q?aoYYDYOuuhP0gmIjcHogk32j5jbk0KZx0ToRyrLt91QC2pds+G3dimIaH/Y9?=
 =?us-ascii?Q?aLKzZV/GI3YjnfpvgVz/PBw2Gsi3t1Ext+OTNtpFY/fNmRiuCUYjx6JJNAnw?=
 =?us-ascii?Q?i9ikee1Pl778OqBZ3h3S65+CovusQRJFmUiIiYKylCietilSdIBAn+0witqb?=
 =?us-ascii?Q?o722rTAr698SugQYSxCPxgEf4TV/PLeUaonCxaNTRoE3VCaG0OizZzFpTXm7?=
 =?us-ascii?Q?e/lQ+cci0ux+NfiRCno2zegOE9t5TbI+9PrfH53QargWTSP21pGmubtzsNqY?=
 =?us-ascii?Q?Z7ficsva3yV5xLLGVOH2bUx4E6nISIyJK0VIc3jdVmU/rw=3D=3D?=
Content-Type: text/plain; charset="us-ascii"
Content-ID: <D0FD15B2193CBC4981CCC3E631BE7B64@namprd10.prod.outlook.com>
Content-Transfer-Encoding: quoted-printable
MIME-Version: 1.0
X-OriginatorOrg: oracle.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-AuthSource: SN6PR10MB2943.namprd10.prod.outlook.com
X-MS-Exchange-CrossTenant-Network-Message-Id: b2f34d77-5508-43fe-2881-08d905039bea
X-MS-Exchange-CrossTenant-originalarrivaltime: 21 Apr 2021 20:25:30.5606
 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: 4e2c6054-71cb-48f1-bd6c-3a9705aca71b
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-CrossTenant-userprincipalname: tI/Cz4Li7NAGBqPbrqCvAYu9YwP9v+w6e26xf1ofku0JTPD8lmtlMLtTAJ3yymSw6uJJHD7XeCfZmtA2mhSPwI5nI3d+0OnfBUYXAvN7TD8=
...
X-Proofpoint-ORIG-GUID: 2c-Mc7khaVLwr2oKGZmJgQfgc9fv3EG0
X-Proofpoint-GUID: 2c-Mc7khaVLwr2oKGZmJgQfgc9fv3EG0
X-Proofpoint-Virus-Version: vendor=nai engine=6200 definitions=9961 signatures=668683
...
>=20
> #endif  /* MPI30_API_H */
> diff --git a/drivers/scsi/mpi3mr/mpi/mpi30_cnfg.h b/drivers/scsi/mpi3mr/m=
pi/mpi30_cnfg.h
...
> + *
> + *           Name: mpi30_cnfg.h
> + *    Description: Contains definitions for Configuration messages and p=
ages
...
> +#define MPI3_MAN6_GPIO_FUNCTION_BKPLANE_MGMT_TYPE                       =
      (0x08)
> +#define MPI3_MAN6_GPIO_FUNCTION_ISTWI_MUX_RESET                         =
      (0x09)
...
> +#define MPI3_MAN6_GPIO_FUNCTION_GLOBAL_FAULT                            =
      (0x0C)
> +#define MPI3_MAN6_GPIO_FUNCTION_EPACK_ATTN                              =
      (0x0D)
...
> +#define MPI3_MAN6_GPIO_EXTINT_PARAM1_FLAGS_SOURCE_CABLE_MGMT            =
      (0x10)
> +#define MPI3_MAN6_GPIO_EXTINT_PARAM1_FLAGS_SOURCE_ACTIVE_CABLE_OVERCURRE=
NT    (0x20)
> +
...
> +#define MPI3_MAN6_GPIO_EXTINT_PARAM1_FLAGS_TRIGGER_LEVEL                =
      (0x01)
> +
> +/**** Defines for Param1 (PHY STATE) when FunctionCode is PORT_STATUS_GR=
EEN ****/
...
> +#define MPI3_MAN6_GPIO_PORT_GREEN_PARAM1_PHY_STATUS_ONE_OR_MORE_UP      =
      (0x01)
> +
> +/**** Defines for Param1 (INTERFACE_SIGNAL) when FunctionCode is CABLE_M=
ANAGEMENT ****/
...
> +#define MPI3_MAN6_GPIO_CABLE_MGMT_PARAM1_INTERFACE_CABLE_MGMT_ENABLE    =
      (0x02)
> +
> +/**** Defines for Param2 (ISTWI RESET) when FunctionCode is ISTWI_MUX_RE=
SET ****/
> +#define MPI3_MAN6_GPIO_ISTWI_MUX_RESET_PARAM2_SPEC_MUX                  =
      (0x00)
> +#define MPI3_MAN6_GPIO_ISTWI_MUX_RESET_PARAM2_ALL_MUXES                 =
      (0x01)
> +
...
> +    MPI3_CONFIG_PAGE_HEADER         Header;                             =
      /* 0x00 */
> +    U16                             Flags;                              =
      /* 0x08 */
> +    U16                             Reserved0A;                         =
...
> +    U8                              Reserved0D[3];                      =
      /* 0x0D */
> +    MPI3_MAN6_GPIO_ENTRY            GPIO[MPI3_MAN6_GPIO_MAX];           =
      /* 0x10 */
...
> +    U32                             EnclosureName[4];                   =
              /* 0x10 */
> +    MPI3_MAN7_RECEPTACLE_INFO       ReceptacleInfo[MPI3_MAN7_RECEPTACLE_=
INFO_MAX];    /* 0x20 */   /* variable length array */
...
> +    U8                              Reserved0D[3];                     /=
* 0x0D */
> +    MPI3_MAN8_PHY_INFO              PhyInfo[MPI3_MAN8_PHY_INFO_MAX];   /=
* 0x10 */  /* variable length array */
...
> +    MPI3_MAN9_RSRC_OUTSTANDING_REQS =3D 0,
> +    MPI3_MAN9_RSRC_TARGET_CMDS      =3D 1,
> +    MPI3_MAN9_RSRC_SAS_TARGETS      =3D 2,
> +    MPI3_MAN9_RSRC_PCIE_TARGETS     =3D 3,
> +    MPI3_MAN9_RSRC_INITIATORS       =3D 4,
> +    MPI3_MAN9_RSRC_VDS              =3D 5,
> +    MPI3_MAN9_RSRC_ENCLOSURES       =3D 6,
> +    MPI3_MAN9_RSRC_ENCLOSURE_PHYS   =3D 7,
> +    MPI3_MAN9_RSRC_EXPANDERS        =3D 8,
> +    MPI3_MAN9_RSRC_PCIE_SWITCHES    =3D 9,
> +    MPI3_MAN9_RSRC_PDS              =3D 10,
> +    MPI3_MAN9_RSRC_HOST_PDS         =3D 11,
> +    MPI3_MAN9_RSRC_ADV_HOST_PDS     =3D 12,
> +    MPI3_MAN9_RSRC_RAID_PDS         =3D 13,
...
> +    U32                             Reserved1C;                         =
    /* 0x1C */
> +    MPI3_MAN9_RSRC_ENTRY            Resource[MPI3_MAN9_RSRC_NUM_RESOURCE=
S]; /* 0x20 */
...
> +    U16     Flags;              /* 0x02 */
> +    U32     Reserved04;         /* 0x04 */
> +} MPI3_MAN10_ISTWI_CTRLR_ENTRY, MPI3_POINTER PTR_MPI3_MAN10_ISTWI_CTRLR_=
ENTRY,
...
> +    U8                              Reserved0D[3];                      =
            /* 0x0D */
> +    MPI3_MAN10_ISTWI_CTRLR_ENTRY    ISTWIController[MPI3_MAN10_ISTWI_CTR=
LR_MAX];    /* 0x10 */
...
> +    U32     Reserved04;         /* 0x04 */
> +} MPI3_MAN11_MUX_DEVICE_FORMAT, MPI3_POINTER PTR_MPI3_MAN11_MUX_DEVICE_F=
ORMAT,
...
> +} MPI3_MAN11_TEMP_SENSOR_DEVICE_FORMAT, MPI3_POINTER PTR_MPI3_MAN11_TEMP=
_SENSOR_DEVICE_FORMAT,
> +  Mpi3Man11TempSensorDeviceFormat_t, MPI3_POINTER pMpi3Man11TempSensorDe=
viceFormat_t;
> +
...
> +    U16     Reserved02;         /* 0x02 */
> +    U32     Reserved04;         /* 0x04 */
> +} MPI3_MAN11_SEEPROM_DEVICE_FORMAT, MPI3_POINTER PTR_MPI3_MAN11_SEEPROM_=
DEVICE_FORMAT,
> +  Mpi3Man11SeepromDeviceFormat_t, MPI3_POINTER pMpi3Man11SeepromDeviceFo=
rmat_t;
> +
...
> +    U8      Reserved01[3];      /* 0x01 */
> +    U32     Reserved04;         /* 0x04 */
> +} MPI3_MAN11_DDR_SPD_DEVICE_FORMAT, MPI3_POINTER PTR_MPI3_MAN11_DDR_SPD_=
DEVICE_FORMAT,
> +  Mpi3Man11DdrSpdDeviceFormat_t, MPI3_POINTER pMpi3Man11DdrSpdDeviceForm=
at_t;
> +
...
> +    U16     Reserved02;         /* 0x02 */
> +    U32     Reserved04;         /* 0x04 */
> +} MPI3_MAN11_CABLE_MGMT_DEVICE_FORMAT, MPI3_POINTER PTR_MPI3_MAN11_CABLE=
_MGMT_DEVICE_FORMAT,
> +  Mpi3Man11CableMgmtDeviceFormat_t, MPI3_POINTER pMpi3Man11CableMgmtDevi=
ceFormat_t;
> +
> +/**** Defines for the Type field ****/
...
> +    U16     Flags;              /* 0x00 */
> +    U16     Reserved02;         /* 0x02 */
> +} MPI3_MAN11_BKPLANE_SPEC_UBM_FORMAT, MPI3_POINTER PTR_MPI3_MAN11_BKPLAN=
E_SPEC_UBM_FORMAT,
> +  Mpi3Man11BkplaneSpecUBMFormat, MPI3_POINTER pMpi3Man11BkplaneSpecUBMFo=
rmat;
> +
> +#define MPI3_MAN11_BKPLANE_UBM_FLAGS_REFCLK_POLICY_ALWAYS_ENABLED  (0x02=
00)
> +#define MPI3_MAN11_BKPLANE_UBM_FLAGS_FORCE_POLLING                 (0x01=
00)
> +#define MPI3_MAN11_BKPLANE_UBM_FLAGS_MAX_FRU_MASK                  (0x00=
F0)
> +#define MPI3_MAN11_BKPLANE_UBM_FLAGS_MAX_FRU_SHIFT                 (4)
> +#define MPI3_MAN11_BKPLANE_UBM_FLAGS_POLL_INTERVAL_MASK            (0x00=
0F)
...
> +    U16     Flags;              /* 0x00 */
> +    U16     Reserved02;         /* 0x02 */
> +} MPI3_MAN11_BKPLANE_SPEC_VPP_FORMAT, MPI3_POINTER PTR_MPI3_MAN11_BKPLAN=
E_SPEC_VPP_FORMAT,
> +  Mpi3Man11BkplaneSpecVPPFormat, MPI3_POINTER pMpi3Man11BkplaneSpecVPPFo=
rmat;
> +
> +#define MPI3_MAN11_BKPLANE_VPP_FLAGS_REFCLK_POLICY_ALWAYS_ENABLED  (0x00=
40)
> +#define MPI3_MAN11_BKPLANE_VPP_FLAGS_PRESENCE_DETECT_MASK          (0x00=
30)
> +#define MPI3_MAN11_BKPLANE_VPP_FLAGS_PRESENCE_DETECT_GPIO          (0x00=
00)
> +#define MPI3_MAN11_BKPLANE_VPP_FLAGS_PRESENCE_DETECT_REG           (0x00=
10)
> +#define MPI3_MAN11_BKPLANE_VPP_FLAGS_POLL_INTERVAL_MASK            (0x00=
0F)
...
> +} MPI3_MAN11_BKPLANE_SPEC_FORMAT, MPI3_POINTER PTR_MPI3_MAN11_BKPLANE_SP=
EC_FORMAT,
...
> +    U16                                    Reserved02;             /* 0x=
02 */
> +    MPI3_MAN11_BKPLANE_SPEC_FORMAT         BackplaneMgmtSpecific;  /* 0x=
04 */
> +} MPI3_MAN11_BKPLANE_MGMT_DEVICE_FORMAT, MPI3_POINTER PTR_MPI3_MAN11_BKP=
LANE_MGMT_DEVICE_FORMAT,
> +  Mpi3Man11BkplaneMgmtDeviceFormat_t, MPI3_POINTER pMpi3Man11BkplaneMgmt=
DeviceFormat_t;
> +
> +/**** Defines for the Type field ****/
...
> +    U8      Reserved01[3];      /* 0x01 */
> +    U32     Reserved04;         /* 0x04 */
> +} MPI3_MAN11_GAS_GAUGE_DEVICE_FORMAT, MPI3_POINTER PTR_MPI3_MAN11_GAS_GA=
UGE_DEVICE_FORMAT,
> +  Mpi3Man11GasGaugeDeviceFormat_t, MPI3_POINTER pMpi3Man11GasGaugeDevice=
Format_t;
> +
> +/**** Defines for the Type field ****/
...
> +    U32                                     Words[2];
> +} MPI3_MAN11_DEVICE_SPECIFIC_FORMAT, MPI3_POINTER PTR_MPI3_MAN11_DEVICE_=
SPECIFIC_FORMAT,
> +  Mpi3Man11DeviceSpecificFormat_t, MPI3_POINTER pMpi3Man11DeviceSpecific=
Format_t;
> +
...
> +} MPI3_MAN11_ISTWI_DEVICE_FORMAT, MPI3_POINTER PTR_MPI3_MAN11_ISTWI_DEVI=
CE_FORMAT,
> +  Mpi3Man11IstwiDeviceFormat_t, MPI3_POINTER pMpi3Man11IstwiDeviceFormat=
_t;
> +
...
> +    U8                              Reserved0D[3];                      =
        /* 0x0D */
> +    MPI3_MAN11_ISTWI_DEVICE_FORMAT  ISTWIDevice[MPI3_MAN11_ISTWI_DEVICE_=
MAX];   /* 0x10 */
...
> +    U32                             Pattern[8];                         =
        /* 0x20 */
> +    MPI3_MAN12_SGPIO_INFO           SGPIOInfo[MPI3_MAN12_NUM_SGPIO_MAX];=
        /* 0x40 */   /* variable length */
> +} MPI3_MAN_PAGE12, MPI3_POINTER PTR_MPI3_MAN_PAGE12,
> +  Mpi3ManPage12_t, MPI3_POINTER pMpi3ManPage12_t;
> +
> +/**** Defines for the PageVersion field ****/
> +#define MPI3_MAN12_PAGEVERSION                                       (0x=
00)
> +
> +/**** Defines for the Flags field ****/
> +#define MPI3_MAN12_FLAGS_ERROR_PRESENCE_ENABLED                      (0x=
0400)
> +#define MPI3_MAN12_FLAGS_ACTIVITY_INVERT_ENABLED                     (0x=
0200)
> +#define MPI3_MAN12_FLAGS_GROUP_ID_DISABLED                           (0x=
0100)
> +#define MPI3_MAN12_FLAGS_SIO_CLK_FILTER_ENABLED                      (0x=
0004)
> +#define MPI3_MAN12_FLAGS_SCLOCK_SLOAD_TYPE_MASK                      (0x=
0002)
> +#define MPI3_MAN12_FLAGS_SCLOCK_SLOAD_TYPE_PUSH_PULL                 (0x=
0000)
> +#define MPI3_MAN12_FLAGS_SCLOCK_SLOAD_TYPE_OPEN_DRAIN                (0x=
0002)
> +#define MPI3_MAN12_FLAGS_SDATAOUT_TYPE_MASK                          (0x=
0001)
> +#define MPI3_MAN12_FLAGS_SDATAOUT_TYPE_PUSH_PULL                     (0x=
0000)
> +#define MPI3_MAN12_FLAGS_SDATAOUT_TYPE_OPEN_DRAIN                    (0x=
0001)
> +
> +/**** Defines for the SioClkFreq field ****/
> +#define MPI3_MAN12_SIO_CLK_FREQ_MIN                                  (32=
)        /* 32 Hz min SIO Clk Freq */
> +#define MPI3_MAN12_SIO_CLK_FREQ_MAX                                  (10=
0000)    /* 100 KHz max SIO Clk Freq */
> +
> +/**** Defines for the ActivityModulation field ****/
> +#define MPI3_MAN12_ACTIVITY_MODULATION_FORCE_OFF_MASK                (0x=
0000F000)
> +#define MPI3_MAN12_ACTIVITY_MODULATION_FORCE_OFF_SHIFT               (12=
)
> +#define MPI3_MAN12_ACTIVITY_MODULATION_MAX_ON_MASK                   (0x=
00000F00)
> +#define MPI3_MAN12_ACTIVITY_MODULATION_MAX_ON_SHIFT                  (8)
> +#define MPI3_MAN12_ACTIVITY_MODULATION_STRETCH_OFF_MASK              (0x=
000000F0)
> +#define MPI3_MAN12_ACTIVITY_MODULATION_STRETCH_OFF_SHIFT             (4)
> +#define MPI3_MAN12_ACTIVITY_MODULATION_STRETCH_ON_MASK               (0x=
0000000F)
> +#define MPI3_MAN12_ACTIVITY_MODULATION_STRETCH_ON_SHIFT              (0)
> +
> +/*** Defines for the Pattern field ****/
> +#define MPI3_MAN12_PATTERN_RATE_MASK                                 (0x=
E0000000)
> +#define MPI3_MAN12_PATTERN_RATE_2_HZ                                 (0x=
00000000)
> +#define MPI3_MAN12_PATTERN_RATE_4_HZ                                 (0x=
20000000)
> +#define MPI3_MAN12_PATTERN_RATE_8_HZ                                 (0x=
40000000)
> +#define MPI3_MAN12_PATTERN_RATE_16_HZ                                (0x=
60000000)
> +#define MPI3_MAN12_PATTERN_RATE_10_HZ                                (0x=
80000000)
> +#define MPI3_MAN12_PATTERN_RATE_20_HZ                                (0x=
A0000000)
> +#define MPI3_MAN12_PATTERN_RATE_40_HZ                                (0x=
C0000000)
> +#define MPI3_MAN12_PATTERN_LENGTH_MASK                               (0x=
1F000000)
> +#define MPI3_MAN12_PATTERN_LENGTH_SHIFT                              (24=
)
> +#define MPI3_MAN12_PATTERN_BIT_PATTERN_MASK                          (0x=
00FFFFFF)
...
> +    U8                              Reserved0B;                         =
               /* 0x0B */
> +} MPI3_MAN13_TRANSLATION_INFO, MPI3_POINTER PTR_MPI3_MAN13_TRANSLATION_I=
NFO,
> +  Mpi3Man13TranslationInfo, MPI3_POINTER pMpi3Man13TranslationInfo;
> +
> +/**** Defines for the SlotStatus field ****/
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_FAULT                     (0x2=
0000000)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_DEVICE_OFF                (0x1=
0000000)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_DEVICE_ACTIVITY           (0x0=
0800000)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_DO_NOT_REMOVE             (0x0=
0400000)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_DEVICE_MISSING            (0x0=
0100000)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_INSERT                    (0x0=
0080000)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_REMOVAL                   (0x0=
0040000)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_IDENTIFY                  (0x0=
0020000)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_OK                        (0x0=
0008000)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_RESERVED_DEVICE           (0x0=
0004000)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_HOT_SPARE                 (0x0=
0002000)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_CONSISTENCY_CHECK         (0x0=
0001000)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_IN_CRITICAL_ARRAY         (0x0=
0000800)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_IN_FAILED_ARRAY           (0x0=
0000400)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_REBUILD_REMAP             (0x0=
0000200)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_REBUILD_REMAP_ABORT       (0x0=
0000100)
> +#define MPI3_MAN13_TRANSLATION_SLOTSTATUS_PREDICTED_FAILURE         (0x0=
0000040)
> +
> +/**** Defines for the Mask field - use MPI3_MAN13_TRANSLATION_SLOTSTATUS=
_ defines ****/
> +
> +/**** Defines for the Activity, Locate, and Error fields ****/
> +#define MPI3_MAN13_BLINK_PATTERN_FORCE_OFF                          (0x0=
0)
> +#define MPI3_MAN13_BLINK_PATTERN_FORCE_ON                           (0x0=
1)
> +#define MPI3_MAN13_BLINK_PATTERN_PATTERN_0                          (0x0=
2)
> +#define MPI3_MAN13_BLINK_PATTERN_PATTERN_1                          (0x0=
3)
> +#define MPI3_MAN13_BLINK_PATTERN_PATTERN_2                          (0x0=
4)
> +#define MPI3_MAN13_BLINK_PATTERN_PATTERN_3                          (0x0=
5)
> +#define MPI3_MAN13_BLINK_PATTERN_PATTERN_4                          (0x0=
6)
> +#define MPI3_MAN13_BLINK_PATTERN_PATTERN_5                          (0x0=
7)
> +#define MPI3_MAN13_BLINK_PATTERN_PATTERN_6                          (0x0=
8)
> +#define MPI3_MAN13_BLINK_PATTERN_PATTERN_7                          (0x0=
9)
> +#define MPI3_MAN13_BLINK_PATTERN_ACTIVITY                           (0x0=
A)
> +#define MPI3_MAN13_BLINK_PATTERN_ACTIVITY_TRAIL                     (0x0=
B)
> +
...
> +    U32                             Reserved0C;                         =
               /* 0x0C */
> +    MPI3_MAN13_TRANSLATION_INFO     Translation[MPI3_MAN13_NUM_TRANSLATI=
ON_MAX];       /* 0x10 */  /* variable length */
> +} MPI3_MAN_PAGE13, MPI3_POINTER PTR_MPI3_MAN_PAGE13,
> +  Mpi3ManPage13_t, MPI3_POINTER pMpi3ManPage13_t;
> +
> +/**** Defines for the PageVersion field ****/
> +#define MPI3_MAN13_PAGEVERSION                                       (0x=
00)
> +
> +/***********************************************************************=
******
...
> +
> +/**** Defines for the PageVersion field ****/
> +#define MPI3_MAN14_PAGEVERSION                                       (0x=
00)
> +
> +/**** Defines for the Flags field ****/
> +#define MPI3_MAN14_FLAGS_AUTH_SESSION_REQ                            (0x=
01)
> +#define MPI3_MAN14_FLAGS_AUTH_API_MASK                               (0x=
0E)
> +#define MPI3_MAN14_FLAGS_AUTH_API_NONE                               (0x=
00)
> +#define MPI3_MAN14_FLAGS_AUTH_API_CEREBUS                            (0x=
02)
> +#define MPI3_MAN14_FLAGS_AUTH_API_DMTF_PMCI                          (0x=
04)
> +
> +/***********************************************************************=
******
...
> +    MPI3_CONFIG_PAGE_HEADER         Header;                             =
               /* 0x00 */
> +    U8                              NumVersionRecords;                  =
               /* 0x08 */
> +    U8                              Reserved09[3];                      =
               /* 0x09 */
> +    U32                             Reserved0C;                         =
               /* 0x0C */
> +    MPI3_MAN15_VERSION_RECORD       VersionRecord[MPI3_MAN15_VERSION_REC=
ORD_MAX];      /* 0x10 */
> +} MPI3_MAN_PAGE15, MPI3_POINTER PTR_MPI3_MAN_PAGE15,
> +  Mpi3ManPage15_t, MPI3_POINTER pMpi3ManPage15_t;
> +
> +/**** Defines for the PageVersion field ****/
> +#define MPI3_MAN15_PAGEVERSION                                       (0x=
00)
> +
> +/***********************************************************************=
******
...
> +    U32                                  Reserved0C[3];                 =
               /* 0x0C */
> +} MPI3_MAN16_CERTIFICATE_ALGORITHM, MPI3_POINTER PTR_MPI3_MAN16_CERTIFIC=
ATE_ALGORITHM,
> +  Mpi3Man16CertificateAlgorithm_t, MPI3_POINTER pMpi3Man16CertificateAlg=
orithm_t;
> +
...
> +    U8                                   Reserved0D[3];                 =
                 /* 0x0D */
> +    MPI3_MAN16_CERTIFICATE_ALGORITHM     CertificateAlgorithm[MPI3_MAN16=
_CERT_ALGO_MAX]; /* 0x10 */
> +} MPI3_MAN_PAGE16, MPI3_POINTER PTR_MPI3_MAN_PAGE16,
> +  Mpi3ManPage16_t, MPI3_POINTER pMpi3ManPage16_t;
> +
> +/**** Defines for the PageVersion field ****/
> +#define MPI3_MAN16_PAGEVERSION                                       (0x=
00)
> +
> +/***********************************************************************=
******
...
> +    U8                              Reserved0D[3];                      =
               /* 0x0D */
> +    MPI3_MAN17_HASH_ALGORITHM       HashAlgorithm[MPI3_MAN17_HASH_ALGORI=
THM_MAX];      /* 0x10 */
> +} MPI3_MAN_PAGE17, MPI3_POINTER PTR_MPI3_MAN_PAGE17,
> +  Mpi3ManPage17_t, MPI3_POINTER pMpi3ManPage17_t;
> +
> +/**** Defines for the PageVersion field ****/
> +#define MPI3_MAN17_PAGEVERSION                                       (0x=
00)
> +
> +/***********************************************************************=
******
...
> +    U32                             Reserved08;                         =
               /* 0x08 */
> +    U32                             NonpremiumFeatures;                 =
               /* 0x0C */
> +    U8                              AllowedPersonalities;               =
               /* 0x10 */
> +    U8                              Reserved11[3];                      =
               /* 0x11 */
...
> +
> +/**** Defines for the PageVersion field ****/
> +#define MPI3_MAN20_PAGEVERSION                                       (0x=
00)
> +
> +/**** Defines for the AllowedPersonalities field ****/
> +#define MPI3_MAN20_ALLOWEDPERSON_RAID_MASK                           (0x=
02)
> +#define MPI3_MAN20_ALLOWEDPERSON_RAID_ALLOWED                        (0x=
02)
> +#define MPI3_MAN20_ALLOWEDPERSON_RAID_NOT_ALLOWED                    (0x=
00)
> +#define MPI3_MAN20_ALLOWEDPERSON_EHBA_MASK                           (0x=
01)
> +#define MPI3_MAN20_ALLOWEDPERSON_EHBA_ALLOWED                        (0x=
01)
> +#define MPI3_MAN20_ALLOWEDPERSON_EHBA_NOT_ALLOWED                    (0x=
00)
> +
> +/**** Defines for the NonpremuimFeatures field ****/
> +#define MPI3_MAN20_NONPREMUIM_DISABLE_PD_DEGRADED_MASK               (0x=
01)
> +#define MPI3_MAN20_NONPREMUIM_DISABLE_PD_DEGRADED_ENABLED            (0x=
00)
> +#define MPI3_MAN20_NONPREMUIM_DISABLE_PD_DEGRADED_DISABLED           (0x=
01)
> +
> +/***********************************************************************=
******
...
> +
> +/**** Defines for the PageVersion field ****/
> +#define MPI3_MAN21_PAGEVERSION                                       (0x=
00)
> +
> +/**** Defines for the Flags field ****/
> +#define MPI3_MAN21_FLAGS_HOST_METADATA_CAPABILITY_MASK               (0x=
80)
> +#define MPI3_MAN21_FLAGS_HOST_METADATA_CAPABILITY_ENABLED            (0x=
80)
> +#define MPI3_MAN21_FLAGS_HOST_METADATA_CAPABILITY_DISABLED           (0x=
00)
> +#define MPI3_MAN21_FLAGS_UNCERTIFIED_DRIVES_MASK                     (0x=
60)
> +#define MPI3_MAN21_FLAGS_UNCERTIFIED_DRIVES_BLOCK                    (0x=
00)
> +#define MPI3_MAN21_FLAGS_UNCERTIFIED_DRIVES_ALLOW                    (0x=
20)
> +#define MPI3_MAN21_FLAGS_UNCERTIFIED_DRIVES_WARN                     (0x=
40)
> +#define MPI3_MAN21_FLAGS_BLOCK_SSD_WR_CACHE_CHANGE_MASK              (0x=
08)
> +#define MPI3_MAN21_FLAGS_BLOCK_SSD_WR_CACHE_CHANGE_ALLOW             (0x=
00)
> +#define MPI3_MAN21_FLAGS_BLOCK_SSD_WR_CACHE_CHANGE_PREVENT           (0x=
08)
> +#define MPI3_MAN21_FLAGS_SES_VPD_ASSOC_MASK                          (0x=
01)
> +#define MPI3_MAN21_FLAGS_SES_VPD_ASSOC_DEFAULT                       (0x=
00)
> +#define MPI3_MAN21_FLAGS_SES_VPD_ASSOC_OEM_SPECIFIC                  (0x=
01)
> +
> +/***********************************************************************=
******
...
> +    MPI3_CONFIG_PAGE_HEADER         Header;                             =
               /* 0x00 */
> +    U32                             ProductSpecificInfo[MPI3_MAN_PROD_SP=
ECIFIC_MAX];   /* 0x08 */  /* variable length array */
> +} MPI3_MAN_PAGE_PRODUCT_SPECIFIC, MPI3_POINTER PTR_MPI3_MAN_PAGE_PRODUCT=
_SPECIFIC,
> +  Mpi3ManPageProductSpecific_t, MPI3_POINTER pMpi3ManPageProductSpecific=
_t;
> +
> +/***********************************************************************=
******
...
> +
> +/**** Defines for the Flags field ****/
> +#define MPI3_IOUNIT1_FLAGS_NVME_WRITE_CACHE_MASK                   (0x00=
000030)
> +#define MPI3_IOUNIT1_FLAGS_NVME_WRITE_CACHE_ENABLE                 (0x00=
000000)
> +#define MPI3_IOUNIT1_FLAGS_NVME_WRITE_CACHE_DISABLE                (0x00=
000010)
> +#define MPI3_IOUNIT1_FLAGS_NVME_WRITE_CACHE_NO_MODIFY              (0x00=
000020)
> +#define MPI3_IOUNIT1_FLAGS_ATA_SECURITY_FREEZE_LOCK                (0x00=
000008)
> +#define MPI3_IOUNIT1_FLAGS_WRITE_SAME_BUFFER                       (0x00=
000004)
> +#define MPI3_IOUNIT1_FLAGS_SATA_WRITE_CACHE_MASK                   (0x00=
000003)
> +#define MPI3_IOUNIT1_FLAGS_SATA_WRITE_CACHE_ENABLE                 (0x00=
000000)
> +#define MPI3_IOUNIT1_FLAGS_SATA_WRITE_CACHE_DISABLE                (0x00=
000001)
> +#define MPI3_IOUNIT1_FLAGS_SATA_WRITE_CACHE_UNCHANGED              (0x00=
000002)
> +
...
> +    U8                              Reserved09[3];                      =
    /* 0x09 */
> +    U16                             GPIOVal[MPI3_IO_UNIT2_GPIO_VAL_MAX];=
    /* 0x0C */
...
> +    U16                             Reserved0E;                         =
/* 0x0E */
> +    MPI3_IO_UNIT3_SENSOR            Sensor[MPI3_IO_UNIT3_SENSOR_MAX];   =
/* 0x10 */
...
> +    U8                              Reserved0D[3];                      =
/* 0x0D */
> +    MPI3_IO_UNIT4_SENSOR            Sensor[MPI3_IO_UNIT4_SENSOR_MAX];   =
/* 0x10 */
...
> +    U8              SpinupFlags;        /* 0x02 */
> +    U8              Reserved03;         /* 0x03 */
> +} MPI3_IO_UNIT5_SPINUP_GROUP, MPI3_POINTER PTR_MPI3_IO_UNIT5_SPINUP_GROU=
P,
...
> +    U8                              SlotsAvailable;                     =
/* 0x0D */
> +    U8                              CurrentKeyEncryptionAlgo;           =
/* 0x0E */
> +    U8                              KeyDigestHashAlgo;                  =
/* 0x0F */
> +    U32                             Reserved10[2];                      =
/* 0x10 */
> +    U32                             CurrentKey[128];                    =
/* 0x18 */
> +    MPI3_IOUNIT8_DIGEST             Digest[MPI3_IOUNIT8_DIGEST_MAX];   /=
* 0x218 */  /* variable length */
...
> +    U16                             SASNotifyPrimitiveMasks;            =
    /* 0x0E */
> +    U32                             EventMasks[MPI3_IOC2_EVENTMASK_WORDS=
];  /* 0x10 */
...
> +    U32                             Reserved18[4];                      =
    /* 0x18 */
> +    MPI3_SECURITY_MAC               MAC;                                =
    /* 0x28 */
> +    MPI3_SECURITY_NONCE             Nonce;                              =
    /* 0x68 */
> +    MPI3_SECURITY0_CERT_CHAIN       CertificateChain;                   =
    /* 0xA8 */
...
> +    U16                             KeyDataSize;                        =
    /* 0x02 */
> +    U32                             AdditionalKeyData;                  =
    /* 0x04 */
> +    U32                             Reserved08[2];                      =
    /* 0x08 */
> +    MPI3_SECURITY1_KEY_DATA         KeyData;                            =
    /* 0x10 */
...
> +    U32                             Reserved94[3];                      =
        /* 0x94 */
> +    MPI3_SECURITY1_KEY_RECORD       KeyRecord[MPI3_SECURITY1_KEY_RECORD_=
MAX];   /* 0xA0 */
...
> +    U32             Reserved10;                         /* 0x10 */
> +} MPI3_SAS_IO_UNIT0_PHY_DATA, MPI3_POINTER PTR_MPI3_SAS_IO_UNIT0_PHY_DAT=
A,
...
> +    U8                              Reserved0D[3];                      =
    /* 0x0D */
> +    MPI3_SAS_IO_UNIT0_PHY_DATA      PhyData[MPI3_SAS_IO_UNIT0_PHY_MAX]; =
    /* 0x10 */
...
> +
> +/**** Use MPI3_SAS_NEG_LINK_RATE_ defines for the NegotiatedLinkRate fie=
ld ****/
> +
> +/**** Use MPI3_SAS_DEVICE_INFO_ defines (see mpi30_sas.h) for the Contro=
llerPhyDeviceInfo field ****/
> +
> +/**** Use MPI3_SAS_DISC_STATUS_ defines (see mpi30_ioc.h) for the Discov=
eryStatus field ****/
> +
> +/***********************************************************************=
******
...
> +    U32             Reserved08;                         /* 0x08 */
> +} MPI3_SAS_IO_UNIT1_PHY_DATA, MPI3_POINTER PTR_MPI3_SAS_IO_UNIT1_PHY_DAT=
A,
...
> +    U16                             Reserved12;                         =
    /* 0x12 */
> +    MPI3_SAS_IO_UNIT1_PHY_DATA      PhyData[MPI3_SAS_IO_UNIT1_PHY_MAX]; =
    /* 0x14 */
> +} MPI3_SAS_IO_UNIT_PAGE1, MPI3_POINTER PTR_MPI3_SAS_IO_UNIT_PAGE1,
> +  Mpi3SasIOUnitPage1_t, MPI3_POINTER pMpi3SasIOUnitPage1_t;
> +
> +/**** Defines for the PageVersion field ****/
> +#define MPI3_SASIOUNIT1_PAGEVERSION                                 (0x0=
0)
> +
> +/**** Defines for the ControlFlags field ****/
> +#define MPI3_SASIOUNIT1_CONTROL_CONTROLLER_DEVICE_SELF_TEST         (0x8=
000)
> +#define MPI3_SASIOUNIT1_CONTROL_SATA_SW_PRESERVE                    (0x1=
000)
> +#define MPI3_SASIOUNIT1_CONTROL_SATA_48BIT_LBA_REQUIRED             (0x0=
080)
> +#define MPI3_SASIOUNIT1_CONTROL_SATA_SMART_REQUIRED                 (0x0=
040)
> +#define MPI3_SASIOUNIT1_CONTROL_SATA_NCQ_REQUIRED                   (0x0=
020)
> +#define MPI3_SASIOUNIT1_CONTROL_SATA_FUA_REQUIRED                   (0x0=
010)
> +#define MPI3_SASIOUNIT1_CONTROL_TABLE_SUBTRACTIVE_ILLEGAL           (0x0=
008)
> +#define MPI3_SASIOUNIT1_CONTROL_SUBTRACTIVE_ILLEGAL                 (0x0=
004)
> +#define MPI3_SASIOUNIT1_CONTROL_FIRST_LVL_DISC_ONLY                 (0x0=
002)
> +#define MPI3_SASIOUNIT1_CONTROL_HARD_RESET_MASK                     (0x0=
001)
> +#define MPI3_SASIOUNIT1_CONTROL_HARD_RESET_DEVICE_NAME              (0x0=
000)
> +#define MPI3_SASIOUNIT1_CONTROL_HARD_RESET_SAS_ADDRESS              (0x0=
001)
> +
> +/**** Defines for the AdditionalControlFlags field ****/
> +#define MPI3_SASIOUNIT1_ACONTROL_DA_PERSIST_CONNECT                 (0x0=
100)
> +#define MPI3_SASIOUNIT1_ACONTROL_MULTI_PORT_DOMAIN_ILLEGAL          (0x0=
080)
> +#define MPI3_SASIOUNIT1_ACONTROL_SATA_ASYNCHROUNOUS_NOTIFICATION    (0x0=
040)
> +#define MPI3_SASIOUNIT1_ACONTROL_INVALID_TOPOLOGY_CORRECTION        (0x0=
020)
> +#define MPI3_SASIOUNIT1_ACONTROL_PORT_ENABLE_ONLY_SATA_LINK_RESET   (0x0=
010)
> +#define MPI3_SASIOUNIT1_ACONTROL_OTHER_AFFILIATION_SATA_LINK_RESET  (0x0=
008)
> +#define MPI3_SASIOUNIT1_ACONTROL_SELF_AFFILIATION_SATA_LINK_RESET   (0x0=
004)
> +#define MPI3_SASIOUNIT1_ACONTROL_NO_AFFILIATION_SATA_LINK_RESET     (0x0=
002)
> +#define MPI3_SASIOUNIT1_ACONTROL_ALLOW_TABLE_TO_TABLE               (0x0=
001)
> +
> +/**** Defines for the PortFlags field ****/
> +#define MPI3_SASIOUNIT1_PORT_FLAGS_AUTO_PORT_CONFIG                 (0x0=
1)
> +
> +/**** Defines for the PhyFlags field ****/
> +#define MPI3_SASIOUNIT1_PHYFLAGS_INIT_PERSIST_CONNECT               (0x4=
0)
> +#define MPI3_SASIOUNIT1_PHYFLAGS_TARG_PERSIST_CONNECT               (0x2=
0)
> +#define MPI3_SASIOUNIT1_PHYFLAGS_PHY_DISABLE                        (0x0=
8)
> +
> +/**** Defines for the MaxMinLinkRate field ****/
> +#define MPI3_SASIOUNIT1_MMLR_MAX_RATE_MASK                          (0xF=
0)
> +#define MPI3_SASIOUNIT1_MMLR_MAX_RATE_SHIFT                         (4)
> +#define MPI3_SASIOUNIT1_MMLR_MAX_RATE_6_0                           (0xA=
0)
> +#define MPI3_SASIOUNIT1_MMLR_MAX_RATE_12_0                          (0xB=
0)
> +#define MPI3_SASIOUNIT1_MMLR_MAX_RATE_22_5                          (0xC=
0)
> +#define MPI3_SASIOUNIT1_MMLR_MIN_RATE_MASK                          (0x0=
F)
> +#define MPI3_SASIOUNIT1_MMLR_MIN_RATE_6_0                           (0x0=
A)
> +#define MPI3_SASIOUNIT1_MMLR_MIN_RATE_12_0                          (0x0=
B)
> +#define MPI3_SASIOUNIT1_MMLR_MIN_RATE_22_5                          (0x0=
C)
> +
> +/**** Use MPI3_SAS_DEVICE_INFO_ defines (see mpi30_sas.h) for the Contro=
llerPhyDeviceInfo field ****/
...
> +    U8              Reserved0B;                         /* 0x0B */
> +} MPI3_SAS_IO_UNIT2_PHY_PM_SETTINGS, MPI3_POINTER PTR_MPI3_SAS_IO_UNIT2_=
PHY_PM_SETTINGS,
> +  Mpi3SasIOUnit2PhyPmSettings_t, MPI3_POINTER pMpi3SasIOUnit2PhyPmSettin=
gs_t;
> +
...
> +    U32                                 Reserved0C;                     =
                            /* 0x0C */
> +    MPI3_SAS_IO_UNIT2_PHY_PM_SETTINGS   SASPhyPowerManagementSettings[MP=
I3_SAS_IO_UNIT2_PHY_MAX];   /* 0x10 */
...
> +    MPI3_CONFIG_PAGE_HEADER         Header;                         /* 0=
x00 */
> +    U32                             Reserved08;                     /* 0=
x08 */
> +    U32                             PowerManagementCapabilities;    /* 0=
x0C */
...
> +    U8                              IOUnitPort;                     /* 0=
x08 */
> +    U8                              ReportGenLength;                /* 0=
x09 */
> +    U16                             EnclosureHandle;                /* 0=
x0A */
> +    U32                             Reserved0C;                     /* 0=
x0C */
> +    U64                             SASAddress;                     /* 0=
x10 */
> +    U32                             DiscoveryStatus;                /* 0=
x18 */
> +    U16                             DevHandle;                      /* 0=
x1C */
> +    U16                             ParentDevHandle;                /* 0=
x1E */
> +    U16                             ExpanderChangeCount;            /* 0=
x20 */
> +    U16                             ExpanderRouteIndexes;           /* 0=
x22 */
> +    U8                              NumPhys;                        /* 0=
x24 */
> +    U8                              SASLevel;                       /* 0=
...
> +    U16                             Flags;                          /* 0=
x26 */
> +    U16                             STPBusInactivityTimeLimit;      /* 0=
x28 */
> +    U16                             STPMaxConnectTimeLimit;         /* 0=
x2A */
> +    U16                             STP_SMP_NexusLossTime;          /* 0=
x2C */
> +    U16                             MaxNumRoutedSASAddresses;       /* 0=
x2E */
> +    U64                             ActiveZoneManagerSASAddress;    /* 0=
x30 */
> +    U16                             ZoneLockInactivityLimit;        /* 0=
x38 */
> +    U16                             Reserved3A;                     /* 0=
x3A */
> +    U8                              TimeToReducedFunc;              /* 0=
x3C */
> +    U8                              InitialTimeToReducedFunc;       /* 0=
x3D */
> +    U8                              MaxReducedFuncTime;             /* 0=
x3E */
> +    U8                              ExpStatus;                      /* 0=
x3F */
...
> +
> +/**** Defines for the ProgrammedLinkRate field - use MPI3_SAS_PRATE_ def=
ines ****/
> +
...
/
> +
> +/**** Defines for the AttachedDeviceInfo field - use MPI3_SAS_DEVICE_INF=
O_ defines ****/
> +
> +/**** Defines for the NegotiatedLinkRate field - use MPI3_SAS_NEG_LINK_R=
ATE_ defines ****/
> +
...
> +
> +/**** Defines for the AttachedPhyInfo field - use MPI3_SAS_APHYINFO_ def=
ines ****/
> +
...
> +
> +/**** Defines for the DeviceInfo field - use MPI3_SAS_DEVICE_INFO_ defin=
es ****/
> +
> +/***********************************************************************=
******
...
> +    U32                             Reserved08;                     /* 0=
x08 */
> +    U32                             InvalidDwordCount;              /* 0=
x0C */
> +    U32                             RunningDisparityErrorCount;     /* 0=
x10 */
> +    U32                             LossDwordSynchCount;            /* 0=
x14 */
> +    U32                             PhyResetProblemCount;           /* 0=
x18 */
...
> +
> +/**** Defines for the PhyEventCode field - use MPI3_SASPHY3_EVENT_CODE_ =
defines */
> +
...
> +    U8                              Reserved0D[3];                      =
        /* 0x0D */
> +    MPI3_SAS_PHY2_PHY_EVENT         PhyEvent[MPI3_SAS_PHY2_PHY_EVENT_MAX=
];      /* 0x10 */
...
> +    U16     Reserved0E;             /* 0x0E */
> +} MPI3_SAS_PHY3_PHY_EVENT_CONFIG, MPI3_POINTER PTR_MPI3_SAS_PHY3_PHY_EVE=
NT_CONFIG,
...
> +    U8                              Reserved0D[3];                      =
            /* 0x0D */
> +    MPI3_SAS_PHY3_PHY_EVENT_CONFIG  PhyEventConfig[MPI3_SAS_PHY3_PHY_EVE=
NT_MAX];    /* 0x10 */
...
> +    U8      IOUnitPort;                 /* 0x0C */
> +    U8      Reserved0D[3];              /* 0x0D */
> +} MPI3_PCIE_IO_UNIT0_PHY_DATA, MPI3_POINTER PTR_MPI3_PCIE_IO_UNIT0_PHY_D=
ATA,
...
> +
> +/**** Defines for the NegotiatedLinkRate field - use MPI3_PCIE_NEG_LINK_=
RATE_ defines ****/
> +
...
> +    U16                             Reserved0E;                         =
    /* 0x0E */
> +    MPI3_PCIE_IO_UNIT0_PHY_DATA     PhyData[MPI3_PCIE_IO_UNIT0_PHY_MAX];=
    /* 0x10 */
...
> +    U32     Reserved04;                 /* 0x04 */
> +    U32     Reserved08;                 /* 0x08 */
> +} MPI3_PCIE_IO_UNIT1_PHY_DATA, MPI3_POINTER PTR_MPI3_PCIE_IO_UNIT1_PHY_D=
ATA,
...
> +    U16                             Reserved12;                         =
    /* 0x12 */
> +    MPI3_PCIE_IO_UNIT1_PHY_DATA     PhyData[MPI3_PCIE_IO_UNIT1_PHY_MAX];=
    /* 0x14 */
...
> +
> +/**** Defines for the PhysicalPort field - use MPI3_DEVICE0_PHYPORT_ def=
ines ****/
> +
> +/***********************************************************************=
******
...
> +    U8      ZoneGroup;                  /* 0x0F */
> +} MPI3_DEVICE0_SAS_SATA_FORMAT, MPI3_POINTER PTR_MPI3_DEVICE0_SAS_SATA_F=
ORMAT,
...
> +} MPI3_DEVICE0_DEV_SPEC_FORMAT, MPI3_POINTER PTR_MPI3_DEVICE0_DEV_SPEC_F=
ORMAT,
...
> +#define MPI3_DEVICE0_WWID_INVALID                       (0xFFFFFFFFFFFFF=
FFF)
> +
...
> +#define MPI3_DEVICE0_ASTATUS_NO_ERRORS                              (0x0=
0)
> +#define MPI3_DEVICE0_ASTATUS_NEEDS_INITIALIZATION                   (0x0=
1)
> +#define MPI3_DEVICE0_ASTATUS_CAP_UNSUPPORTED                        (0x0=
2)
> +#define MPI3_DEVICE0_ASTATUS_DEVICE_BLOCKED                         (0x0=
3)
> +#define MPI3_DEVICE0_ASTATUS_UNAUTHORIZED                           (0x0=
4)
> +#define MPI3_DEVICE0_ASTATUS_DEVICE_MISSING_DELAY                   (0x0=
5)
> +/* SAS Access Status Codes  */
> +#define MPI3_DEVICE0_ASTATUS_SAS_UNKNOWN                            (0x1=
0)
> +#define MPI3_DEVICE0_ASTATUS_ROUTE_NOT_ADDRESSABLE                  (0x1=
1)
> +#define MPI3_DEVICE0_ASTATUS_SMP_ERROR_NOT_ADDRESSABLE              (0x1=
2)
> +/* SATA Access Status Codes  */
> +#define MPI3_DEVICE0_ASTATUS_SIF_UNKNOWN                            (0x2=
0)
> +#define MPI3_DEVICE0_ASTATUS_SIF_AFFILIATION_CONFLICT               (0x2=
1)
> +#define MPI3_DEVICE0_ASTATUS_SIF_DIAG                               (0x2=
2)
> +#define MPI3_DEVICE0_ASTATUS_SIF_IDENTIFICATION                     (0x2=
3)
> +#define MPI3_DEVICE0_ASTATUS_SIF_CHECK_POWER                        (0x2=
4)
> +#define MPI3_DEVICE0_ASTATUS_SIF_PIO_SN                             (0x2=
5)
> +#define MPI3_DEVICE0_ASTATUS_SIF_MDMA_SN                            (0x2=
6)
> +#define MPI3_DEVICE0_ASTATUS_SIF_UDMA_SN                            (0x2=
7)
> +#define MPI3_DEVICE0_ASTATUS_SIF_ZONING_VIOLATION                   (0x2=
8)
> +#define MPI3_DEVICE0_ASTATUS_SIF_NOT_ADDRESSABLE                    (0x2=
9)
> +#define MPI3_DEVICE0_ASTATUS_SIF_MAX                                (0x2=
F)
> +/* PCIe Access Status Codes  */
> +#define MPI3_DEVICE0_ASTATUS_PCIE_UNKNOWN                           (0x3=
0)
> +#define MPI3_DEVICE0_ASTATUS_PCIE_MEM_SPACE_ACCESS                  (0x3=
1)
> +#define MPI3_DEVICE0_ASTATUS_PCIE_UNSUPPORTED                       (0x3=
2)
> +#define MPI3_DEVICE0_ASTATUS_PCIE_MSIX_REQUIRED                     (0x3=
3)
> +/* NVMe Access Status Codes  */
> +#define MPI3_DEVICE0_ASTATUS_NVME_UNKNOWN                           (0x4=
0)
> +#define MPI3_DEVICE0_ASTATUS_NVME_READY_TIMEOUT                     (0x4=
1)
> +#define MPI3_DEVICE0_ASTATUS_NVME_DEVCFG_UNSUPPORTED                (0x4=
2)
> +#define MPI3_DEVICE0_ASTATUS_NVME_IDENTIFY_FAILED                   (0x4=
3)
> +#define MPI3_DEVICE0_ASTATUS_NVME_QCONFIG_FAILED                    (0x4=
4)
> +#define MPI3_DEVICE0_ASTATUS_NVME_QCREATION_FAILED                  (0x4=
5)
> +#define MPI3_DEVICE0_ASTATUS_NVME_EVENTCFG_FAILED                   (0x4=
6)
> +#define MPI3_DEVICE0_ASTATUS_NVME_GET_FEATURE_STAT_FAILED           (0x4=
7)
> +#define MPI3_DEVICE0_ASTATUS_NVME_IDLE_TIMEOUT                      (0x4=
8)
> +#define MPI3_DEVICE0_ASTATUS_NVME_CTRL_FAILURE_STATUS               (0x4=
9)
> +/* Virtual Device Access Status Codes  */
> +#define MPI3_DEVICE0_ASTATUS_VD_UNKNOWN                             (0x5=
0)
> +
> +/**** Defines for the Flags field ****/
...
*/
> +
> +/**** Defines for the DeviceForm field - use MPI3_DEVICE_DEVFORM_ define=
s ****/
> +
...
> +    U32                             Reserved00;             /* 0x00 */
> +} MPI3_DEVICE1_SAS_SATA_FORMAT, MPI3_POINTER PTR_MPI3_DEVICE1_SAS_SATA_F=
ORMAT,
...
> +
> +/*** MaxReadRequestSize, CurrentMaxPayloadSize, and MaxPayloadSizeSuppor=
ted  ***/
> +/***  all use the size definitions above - shifted to the proper positio=
n    ***/
...
> +} MPI3_DEVICE1_DEV_SPEC_FORMAT, MPI3_POINTER PTR_MPI3_DEVICE1_DEV_SPEC_F=
ORMAT,
...
> +
> +#endif  /* MPI30_CNFG_H */
> diff --git a/drivers/scsi/mpi3mr/mpi/mpi30_sas.h b/drivers/scsi/mpi3mr/mp=
i/mpi30_sas.h
> new file mode 100644
...
> + *
> + *           Name: mpi30_sas.h
> + *    Description: Contains MPI Serial Attached SCSI structures and defi=
nitions
...
> +} MPI3_SMP_PASSTHROUGH_REQUEST, MPI3_POINTER PTR_MPI3_SMP_PASSTHROUGH_RE=
QUEST,
...
> @@ -627,6 +818,8 @@ void *mpi3mr_get_reply_virt_addr(struct mpi3mr_ioc *m=
rioc,
...
> @@ -639,5 +832,14 @@ void mpi3mr_ioc_disable_intr(struct mpi3mr_ioc *mrio=
c);
...
> @@ -161,12 +161,14 @@ static void mpi3mr_handle_events(struct mpi3mr_ioc =
*mrioc,
...
> @@ -178,6 +180,11 @@ mpi3mr_get_drv_cmd(struct mpi3mr_ioc *mrioc, u16 hos=
t_tag,
> 	default:
> 		break;
> 	}
> +	if (host_tag >=3D MPI3MR_HOSTTAG_DEVRMCMD_MIN &&
> +	    host_tag <=3D MPI3MR_HOSTTAG_DEVRMCMD_MAX) {
> +		idx =3D host_tag - MPI3MR_HOSTTAG_DEVRMCMD_MIN;
> +		return &mrioc->dev_rmhs_cmds[idx];
> +	}
>=20
> 	return NULL;
> }
> @@ -1924,6 +1931,12 @@ static int mpi3mr_alloc_reply_sense_bufs(struct mp=
i3mr_ioc *mrioc)
...
> @@ -2134,6 +2147,163 @@ static int mpi3mr_issue_iocinit(struct mpi3mr_ioc=
 *mrioc)
> 	return retval;
> }
>=20
...
> +		return;
> +
> +	desired_event =3D (1 << (event % 32));
> +	word =3D event / 32;
> +
> +	mrioc->event_masks[word] &=3D ~desired_event;
> +}
> +
> +/**
...
> +	evtnotify_req.HostTag =3D cpu_to_le16(MPI3MR_HOSTTAG_INITCMDS);
> +	evtnotify_req.Function =3D MPI3_FUNCTION_EVENT_NOTIFICATION;
> +	for (i =3D 0; i < MPI3_EVENT_NOTIFY_EVENTMASK_WORDS; i++)
> +		evtnotify_req.EventMasks[i] =3D
> +		    cpu_to_le32(mrioc->event_masks[i]);
> +	init_completion(&mrioc->init_cmds.done);
> +	retval =3D mpi3mr_admin_request_post(mrioc, &evtnotify_req,
...
> +	mrioc->init_cmds.is_waiting =3D 1;
> +	mrioc->init_cmds.callback =3D NULL;
> +	evtack_req.HostTag =3D cpu_to_le16(MPI3MR_HOSTTAG_INITCMDS);
> +	evtack_req.Function =3D MPI3_FUNCTION_EVENT_ACK;
> +	evtack_req.Event =3D event;
> +	evtack_req.EventContext =3D cpu_to_le32(event_ctx);
> +
> +	init_completion(&mrioc->init_cmds.done);
> +	retval =3D mpi3mr_admin_request_post(mrioc, &evtack_req,
> +	    sizeof(evtack_req), 1);
> +	if (retval) {
...
>=20
> out_failed:
> @@ -2647,6 +2835,11 @@ static void mpi3mr_free_mem(struct mpi3mr_ioc *mri=
oc)
...
> 		for (i =3D 0; i < mrioc->chain_buf_count; i++) {
...
> @@ -125,6 +125,1280 @@ static void mpi3mr_clear_scmd_priv(struct mpi3mr_i=
oc *mrioc,
> 	}
> }
>=20
...
> +
> +	fwevt =3D kzalloc(sizeof(*fwevt) + len, GFP_ATOMIC);
> +	if (!fwevt)
> +		return NULL;
> +
...
> +	unsigned long flags;
> +
> +	if (mrioc->fwevt_worker_thread =3D=3D NULL)
> +		return;
> +
...
> +		fwevt =3D list_first_entry(&mrioc->fwevt_list,
...
> +
> +	tgtdev =3D kzalloc(sizeof(*tgtdev), GFP_ATOMIC);
> +	if (!tgtdev)
> +		return NULL;
...
> +		if (tgtdev->dev_handle =3D=3D handle)
> +			goto found_tgtdev;
> +	return NULL;
> +
> +found_tgtdev:
...
> +
> +	spin_lock_irqsave(&mrioc->tgtdev_lock, flags);
> +	tgtdev =3D __mpi3mr_get_tgtdev_by_handle(mrioc, handle);
> +	spin_unlock_irqrestore(&mrioc->tgtdev_lock, flags);
> +	return tgtdev;
> +}
> +
...
> +	assert_spin_locked(&mrioc->tgtdev_lock);
> +	list_for_each_entry(tgtdev, &mrioc->tgtdev_list, list)
> +		if (tgtdev->perst_id =3D=3D persist_id)
> +			goto found_tgtdev;
> +	return NULL;
> +
> +found_tgtdev:
...
> +
> +	spin_lock_irqsave(&mrioc->tgtdev_lock, flags);
> +	tgtdev =3D __mpi3mr_get_tgtdev_by_perst_id(mrioc, persist_id);
> +	spin_unlock_irqrestore(&mrioc->tgtdev_lock, flags);
> +	return tgtdev;
> +}
> +
...
> +	    list) {
> +		if ((tgtdev->dev_handle =3D=3D MPI3MR_INVALID_DEV_HANDLE) &&
> +		    tgtdev->host_exposed) {
...
> +	tgtdev =3D NULL;
> +	list_for_each_entry(tgtdev, &mrioc->tgtdev_list, list) {
> +		if ((tgtdev->dev_handle !=3D MPI3MR_INVALID_DEV_HANDLE) &&
...
> +
> +	tgtdev->perst_id =3D le16_to_cpu(dev_pg0->PersistentID);
> +	tgtdev->dev_handle =3D le16_to_cpu(dev_pg0->DevHandle);
> +	tgtdev->dev_type =3D dev_pg0->DeviceForm;
> +	tgtdev->encl_handle =3D le16_to_cpu(dev_pg0->EnclosureHandle);
> +	tgtdev->parent_handle =3D le16_to_cpu(dev_pg0->ParentDevHandle);
> +	tgtdev->slot =3D le16_to_cpu(dev_pg0->Slot);
> +	tgtdev->q_depth =3D le16_to_cpu(dev_pg0->QueueDepth);
...
> +		scsi_tgt_priv_data->perst_id =3D tgtdev->perst_id;
> +		scsi_tgt_priv_data->dev_handle =3D tgtdev->dev_handle;
...
> +	{
> +		Mpi3Device0SasSataFormat_t *sasinf =3D
> +		    &dev_pg0->DeviceSpecific.SasSataFormat;
> +		u16 dev_info =3D le16_to_cpu(sasinf->DeviceInfo);
> +
> +		tgtdev->dev_spec.sas_sata_inf.dev_info =3D dev_info;
> +		tgtdev->dev_spec.sas_sata_inf.sas_address =3D
> +		    le64_to_cpu(sasinf->SASAddress);
> +		if ((dev_info & MPI3_SAS_DEVICE_INFO_DEVICE_TYPE_MASK) !=3D
...
> +
> +		tgtdev->dev_spec.vol_inf.state =3D vdinf->VdState;
> +		if (vdinf->VdState =3D=3D MPI3_DEVICE0_VD_STATE_OFFLINE)
> +			tgtdev->is_hidden =3D 1;
> +		break;
> +	}
> +	default:
...
> +{
> +	u16 dev_handle =3D 0;
> +	u8 uhide =3D 0, delete =3D 0, cleanup =3D 0;
> +	struct mpi3mr_tgt_dev *tgtdev =3D NULL;
> +	Mpi3EventDataDeviceStatusChange_t *evtdata =3D
> +	    (Mpi3EventDataDeviceStatusChange_t *)fwevt->event_data;
> +
> +
> +	dev_handle =3D le16_to_cpu(evtdata->DevHandle);
> +	ioc_info(mrioc,
...
> +{
> +	struct mpi3mr_tgt_dev *tgtdev =3D NULL;
> +	u16 dev_handle =3D 0, perst_id =3D 0;
> +
> +	perst_id =3D le16_to_cpu(dev_pg0->PersistentID);
> +	dev_handle =3D le16_to_cpu(dev_pg0->DevHandle);
> +	ioc_info(mrioc,
...
> +	struct mpi3mr_fwevt *fwevt)
> +{
> +	Mpi3EventDataSasTopologyChangeList_t *event_data =3D
...
> +static void mpi3mr_fwevt_worker(struct work_struct *work)
> +{
> +	struct mpi3mr_fwevt *fwevt =3D container_of(work, struct mpi3mr_fwevt,
> +	    work);
...
> +		_rmhs_node =3D list_entry(mrioc->delayed_rmhs_list.next,
...
> +{
> +	u16 cmd_idx =3D drv_cmd->host_tag - MPI3MR_HOSTTAG_DEVRMCMD_MIN;
> +	struct delayed_dev_rmhs_node *delayed_dev_rmhs =3D NULL;
> +
> +	ioc_info(mrioc,
> +	    "%s :dev_rmhs_iouctrl_complete:handle(0x%04x), ioc_status(0x%04x), =
loginfo(0x%08x)\n",
...
> +			drv_cmd->retry_count++;
> +			ioc_info(mrioc,
> +			    "%s :dev_rmhs_iouctrl_complete: handle(0x%04x)retrying handshake =
retry=3D%d\n",
...
> +		delayed_dev_rmhs =3D list_entry(mrioc->delayed_rmhs_list.next,
> +		    struct delayed_dev_rmhs_node, list);
> +		drv_cmd->dev_handle =3D delayed_dev_rmhs->handle;
> +		drv_cmd->retry_count =3D 0;
> +		drv_cmd->iou_rc =3D delayed_dev_rmhs->iou_rc;
> +		ioc_info(mrioc,
> +		    "%s :dev_rmhs_iouctrl_complete: processing delayed TM: handle(0x%0=
4x)\n",
> +		    __func__, drv_cmd->dev_handle);
...
> +	drv_cmd->retry_count =3D 0;
> +	drv_cmd->dev_handle =3D MPI3MR_INVALID_DEV_HANDLE;
...
> +	if (tm_reply)
> +		pr_info(IOCNAME
> +		    "dev_rmhs_tr_complete:handle(0x%04x), ioc_status(0x%04x), loginfo(=
0x%08x), term_count(%d)\n",
...
> +	drv_cmd->callback =3D mpi3mr_dev_rmhs_complete_iou;
> +	iou_ctrl.Operation =3D drv_cmd->iou_rc;
> +	iou_ctrl.Param16[0] =3D cpu_to_le16(drv_cmd->dev_handle);
> +	iou_ctrl.HostTag =3D cpu_to_le16(drv_cmd->host_tag);
> +	iou_ctrl.Function =3D MPI3_FUNCTION_IO_UNIT_CONTROL;
> +
> +	retval =3D mpi3mr_admin_request_post(mrioc, &iou_ctrl, sizeof(iou_ctrl)=
,
> +	    1);
> +	if (retval) {
...
> +	int retval =3D 0;
> +	u16 cmd_idx =3D MPI3MR_NUM_DEVRMCMD;
> +	u8 retrycount =3D 5;
> +	struct mpi3mr_drv_cmd *drv_cmd =3D cmdparam;
> +	struct delayed_dev_rmhs_node *delayed_dev_rmhs =3D NULL;
> +
> +	if (drv_cmd)
> +		goto issue_cmd;
> +	do {
> +		cmd_idx =3D find_first_zero_bit(mrioc->devrem_bitmap,
> +		    MPI3MR_NUM_DEVRMCMD);
> +		if (cmd_idx < MPI3MR_NUM_DEVRMCMD) {
> +			if (!test_and_set_bit(cmd_idx, mrioc->devrem_bitmap))
> +				break;
> +			cmd_idx =3D MPI3MR_NUM_DEVRMCMD;
> +		}
> +	} while (retrycount--);
> +
> +	if (cmd_idx >=3D MPI3MR_NUM_DEVRMCMD) {
> +		delayed_dev_rmhs =3D kzalloc(sizeof(*delayed_dev_rmhs),
> +		    GFP_ATOMIC);
> +		if (!delayed_dev_rmhs)
> +			return;
> +		INIT_LIST_HEAD(&delayed_dev_rmhs->list);
> +		delayed_dev_rmhs->handle =3D handle;
> +		delayed_dev_rmhs->iou_rc =3D iou_rc;
...
> +		return;
> +	}
> +	drv_cmd =3D &mrioc->dev_rmhs_cmds[cmd_idx];
> +
> +issue_cmd:
> +	cmd_idx =3D drv_cmd->host_tag - MPI3MR_HOSTTAG_DEVRMCMD_MIN;
> +	ioc_info(mrioc,
...
> +	drv_cmd->state =3D MPI3MR_CMD_PENDING;
> +	drv_cmd->is_waiting =3D 0;
> +	drv_cmd->callback =3D mpi3mr_dev_rmhs_complete_tm;
> +	drv_cmd->dev_handle =3D handle;
> +	drv_cmd->iou_rc =3D iou_rc;
> +	tm_req.DevHandle =3D cpu_to_le16(handle);
> +	tm_req.TaskType =3D MPI3_SCSITASKMGMT_TASKTYPE_TARGET_RESET;
> +	tm_req.HostTag =3D cpu_to_le16(drv_cmd->host_tag);
> +	tm_req.TaskHostTag =3D cpu_to_le16(MPI3MR_HOSTTAG_INVALID);
...
> +	Mpi3EventNotificationReply_t *event_reply)
> +{
> +	Mpi3EventDataSasTopologyChangeList_t *topo_evt =3D
...
> +		handle =3D le16_to_cpu(topo_evt->PhyEntry[i].AttachedDevHandle);
> +		if (!handle)
> +			continue;
> +		reason_code =3D topo_evt->PhyEntry[i].Status &
> +		    MPI3_EVENT_SAS_TOPO_PHY_RC_MASK;
...
> +{
> +	u16 dev_handle =3D 0;
> +	u8 ublock =3D 0, block =3D 0, hide =3D 0, delete =3D 0, remove =3D 0;
> +	struct mpi3mr_tgt_dev *tgtdev =3D NULL;
> +	struct mpi3mr_stgt_priv_data *scsi_tgt_priv_data =3D NULL;
> +	Mpi3EventDataDeviceStatusChange_t *evtdata =3D
...
> +	u16 evt_type, sz;
> +	struct mpi3mr_fwevt *fwevt =3D NULL;
> +	bool ack_req =3D 0, process_evt_bh =3D 0;
> +
> +	if (mrioc->stop_drv_processing)
> +		return;
> +
> +	if ((event_reply->MsgFlags & MPI3_EVENT_NOTIFY_MSGFLAGS_ACK_MASK)
> +	    =3D=3D MPI3_EVENT_NOTIFY_MSGFLAGS_ACK_REQUIRED)
> +		ack_req =3D 1;
> +
> +	evt_type =3D event_reply->Event;
> +
> +	switch (evt_type) {
> +	case MPI3_EVENT_DEVICE_ADDED:
> +	{
...
> +		sz =3D event_reply->EventDataLength * 4;
> +		fwevt =3D mpi3mr_alloc_fwevt(sz);
> +		if (!fwevt) {
...
> +		fwevt->event_id =3D evt_type;
> +		fwevt->send_ack =3D ack_req;
> +		fwevt->process_evt =3D process_evt_bh;
> +		fwevt->evt_ctx =3D le32_to_cpu(event_reply->EventContext);
...
>  * @mrioc: Adapter instance reference
> @@ -587,6 +1861,33 @@ static int mpi3mr_scan_finished(struct Scsi_Host *s=
host,
>  */
...
>=20
> /**
> @@ -599,6 +1900,35 @@ static void mpi3mr_slave_destroy(struct scsi_device=
 *sdev)
>  */
...
> +
> +	spin_lock_irqsave(&mrioc->tgtdev_lock, flags);
> +	tgt_dev =3D __mpi3mr_get_tgtdev_from_tgtpriv(mrioc, scsi_tgt_priv_data)=
;
> +	if (tgt_dev && (tgt_dev->starget =3D=3D starget) &&
> +	    (tgt_dev->perst_id =3D=3D starget->id))
> +		tgt_dev->starget =3D NULL;
> +	if (tgt_dev) {
> +		scsi_tgt_priv_data->tgt_dev =3D NULL;
> +		scsi_tgt_priv_data->perst_id =3D 0;
> +		mpi3mr_tgtdev_put(tgt_dev);
> +		mpi3mr_tgtdev_put(tgt_dev);
> +	}
> +	spin_unlock_irqrestore(&mrioc->tgtdev_lock, flags);
...
> +	starget->hostdata =3D NULL;
> +
> }
>=20
> /**
> @@ -612,7 +1942,25 @@ static void mpi3mr_target_destroy(struct scsi_targe=
t *starget)
>  */
...
> }
>=20
> @@ -626,7 +1974,37 @@ static int mpi3mr_slave_configure(struct scsi_devic=
e *sdev)
>  */
...
> +	scsi_tgt_priv_data =3D starget->hostdata;
> +
> +	scsi_dev_priv_data =3D kzalloc(sizeof(*scsi_dev_priv_data), GFP_KERNEL)=
;
...
> }
>=20
> @@ -640,7 +2018,33 @@ static int mpi3mr_slave_alloc(struct scsi_device *s=
dev)
>  */
...
> }
>=20
> @@ -836,7 +2240,7 @@ mpi3mr_probe(struct pci_dev *pdev, const struct pci_=
device_id *id)
> {
...
> @@ -857,11 +2261,21 @@ mpi3mr_probe(struct pci_dev *pdev, const struct pc=
i_device_id *id)
...
>=20
> @@ -877,6 +2291,17 @@ mpi3mr_probe(struct pci_dev *pdev, const struct pci=
_device_id *id)
...
> 		ioc_err(mrioc, "failure at %s:%d/%s()!\n",
> @@ -903,6 +2328,8 @@ mpi3mr_probe(struct pci_dev *pdev, const struct pci_=
device_id *id)
> addhost_failed:
...
Patch itself looks good other than comment by Tom earlier for double alloca=
tion of mpi3mr_alloc_reply_sense_bufs.=20
Once fixed please add my=20
