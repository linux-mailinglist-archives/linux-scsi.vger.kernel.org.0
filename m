Return-Path: <linux-scsi+bounces-842-lists+linux-scsi=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-scsi@lfdr.de
Delivered-To: lists+linux-scsi@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id A8AD980D44E
	for <lists+linux-scsi@lfdr.de>; Mon, 11 Dec 2023 18:42:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 295BB1F219FE
	for <lists+linux-scsi@lfdr.de>; Mon, 11 Dec 2023 17:42:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A408E4E62A;
	Mon, 11 Dec 2023 17:42:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=cisco.com header.i=@cisco.com header.b="iBuZAndH"
X-Original-To: linux-scsi@vger.kernel.org
Received: from alln-iport-3.cisco.com (alln-iport-3.cisco.com [173.37.142.90])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EDBB3D5;
	Mon, 11 Dec 2023 09:42:43 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=cisco.com; i=@cisco.com; l=32138; q=dns/txt;
  s=iport; t=1702316564; x=1703526164;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=qDw2r2rDc3t3J5rbWI5NFcp74D3afYODZh06sjgot80=;
  b=iBuZAndH0oc6QcHixEAsNGu8CEb0uw7oHvCmAQu+Wk2f5jO5d1l/miHJ
   eB59tSXZA2aMouj5u2mAHDwsQQKzpPKk1hRosK7hugTJGOHDzJptgxpWS
   iPNEaYQZEqsORt+PirMWOiGO9YQtnqCuseq7x4lzmSC7hFJuXDwPGms/S
   Y=;
X-CSE-ConnectionGUID: kUi08uTmSse0cYTjJ+13dw==
X-CSE-MsgGUID: kslSweEARbuSthoZ2Kvpkw==
X-IronPort-AV: E=Sophos;i="6.04,268,1695686400"; 
   d="scan'208";a="186635536"
Received: from rcdn-core-1.cisco.com ([173.37.93.152])
  by alln-iport-3.cisco.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Dec 2023 17:42:43 +0000
Received: from localhost.cisco.com ([10.193.101.253])
	(authenticated bits=0)
	by rcdn-core-1.cisco.com (8.15.2/8.15.2) with ESMTPSA id 3BBHaKr6009547
	(version=TLSv1.2 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=NO);
	Mon, 11 Dec 2023 17:42:42 GMT
...
Subject: [PATCH v6 12/13] scsi: fnic: Improve logs and add support for multiqueue (MQ)
Date: Mon, 11 Dec 2023 09:36:16 -0800
Message-Id: <20231211173617.932990-13-kartilak@cisco.com>
...
+		FNIC_SCSI_DBG(KERN_DEBUG, fnic->lport->host, fnic->fnic_num,
 		...
 		goto fnic_device_reset_clean;
@@ -2507,7 +2519,7 @@ int fnic_device_reset(struct scsi_cmnd *sc)
...
@@ -2652,7 +2663,7 @@ void fnic_scsi_abort_io(struct fc_lport *lp)
