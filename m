...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1897F2F57A1
	for <lists+linux-scsi@lfdr.de>; Thu, 14 Jan 2021 04:00:39 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728429AbhANCDN (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 13 Jan 2021 21:03:13 -0500
Received: from smtp.infotech.no ([82.134.31.41]:49907 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729420AbhAMXUz (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Wed, 13 Jan 2021 18:20:55 -0500
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id C9AE62042C4;
        Wed, 13 Jan 2021 23:46:21 +0100 (CET)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id UDm60ny89qM7; Wed, 13 Jan 2021 23:46:19 +0100 (CET)
Received: from xtwo70.bingwo.ca (host-104-157-204-209.dyn.295.ca [104.157.204.209])
        by smtp.infotech.no (Postfix) with ESMTPA id 74AE42042AE;
        Wed, 13 Jan 2021 23:46:18 +0100 (CET)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        kashyap.desai@broadcom.com
Subject: [PATCH v13 40/45] sg: remove rcv_done request state
Date:   Wed, 13 Jan 2021 17:45:21 -0500
Message-Id: <20210113224526.861000-41-dgilbert@interlog.com>
...
index d0f25f8f572b..bbf63787490b 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -3261,9 +3261,10 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
...
@@ -3275,8 +3276,7 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
 				continue;
...
@@ -3286,14 +3286,35 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
 			}
 			break;
 		}
...
@@ -3411,8 +3432,9 @@ sg_setup_req(struct sg_comm_wr_t *cwrp, int dxfr_len)
 	bool found = false;
...
@@ -3425,45 +3447,48 @@ sg_setup_req(struct sg_comm_wr_t *cwrp, int dxfr_len)
 		act_empty = true;
 		mk_new_srp = true;
...
+		WRITE_ONCE(fp->prev_used_idx, r_srp->rq_idx);
 		...
 		mk_new_srp = true;
@@ -3536,7 +3561,7 @@ sg_deact_request(struct sg_fd *sfp, struct sg_request *srp)
 	sbp = srp->sense_bp;
 	srp->sense_bp = NULL;
...
@@ -3627,7 +3652,7 @@ sg_add_sfp(struct sg_device *sdp)
 		}
 		srp->rq_idx = idx;
 		srp->parentfp = sfp;
...
@@ -3778,8 +3803,6 @@ sg_rq_st_str(enum sg_rq_state rq_st, bool long_str)
...
-		return long_str ? "receive_done" : "fin";
 	...
 	default:
@@ -4056,7 +4079,8 @@ sg_proc_debug_fd(struct sg_fd *fp, char *obp, int len, unsigned long idx)
