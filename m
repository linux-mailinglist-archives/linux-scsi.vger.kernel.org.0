...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7D48A38E286
	for <lists+linux-scsi@lfdr.de>; Mon, 24 May 2021 10:46:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232477AbhEXIrw (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Mon, 24 May 2021 04:47:52 -0400
Received: from mailout1.samsung.com ([203.254.224.24]:39549 "EHLO
        mailout1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232470AbhEXIrw (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Mon, 24 May 2021 04:47:52 -0400
Received: from epcas2p2.samsung.com (unknown [182.195.41.54])
        by mailout1.samsung.com (KnoxPortal) with ESMTP id 20210524084623epoutp01ba86fd90e7b8fa984aff7e07f8da7468~B9FQ1io251233812338epoutp01b
        for <linux-scsi@vger.kernel.org>; Mon, 24 May 2021 08:46:23 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout1.samsung.com 20210524084623epoutp01ba86fd90e7b8fa984aff7e07f8da7468~B9FQ1io251233812338epoutp01b
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1621845983;
        bh=0CeUeLCwWfMPb3URZR+rEClOpmGu9dK1cY9WImJ8aUY=;
        h=Subject:Reply-To:From:To:CC:In-Reply-To:Date:References:From;
        b=GOY3ZRDdLwCDe9BoY8NfLWTl5yNpvzmXuIj/xizE1rXH8MriKFOWqLMzTHO0ihJXL
         8xXWgLZ1dmrpIhzdfjH8qgAT1CHGdiXsMzXcghWCSLKQ1vUYszQDQVO5XQ5cTWXE/V
         4wgaEEE/S/tOqEetHsTVP8IYnymLtsJa6V4EIkaI=
Received: from epsnrtp2.localdomain (unknown [182.195.42.163]) by
        epcas2p1.samsung.com (KnoxPortal) with ESMTP id
        20210524084621epcas2p120eef23b883236a4cdba7c978f121073~B9FPN3W4f2693626936epcas2p1P;
        Mon, 24 May 2021 08:46:21 +0000 (GMT)
Received: from epsmges2p3.samsung.com (unknown [182.195.40.186]) by
        epsnrtp2.localdomain (Postfix) with ESMTP id 4FpW5l0SjKz4x9QK; Mon, 24 May
        2021 08:46:19 +0000 (GMT)
X-AuditID: b6c32a47-521b2a80000024d9-62-60ab67dae825
Received: from epcas2p4.samsung.com ( [182.195.41.56]) by
        epsmges2p3.samsung.com (Symantec Messaging Gateway) with SMTP id
        32.96.09433.AD76BA06; Mon, 24 May 2021 17:46:18 +0900 (KST)
Mime-Version: 1.0
Subject: [PATCH v35 4/4] scsi: ufs: Add HPB 2.0 support
...
X-Msg-Type: PERSONAL
X-Reply-Demand: N
Message-ID: <20210524084618epcms2p69bf8cc3ad2ed9b4823aa212f09924390@epcms2p6>
Date:   Mon, 24 May 2021 17:46:18 +0900
X-CMS-MailID: 20210524084618epcms2p69bf8cc3ad2ed9b4823aa212f09924390
...
X-CPGSPASS: Y
CMS-TYPE: 102P
X-Brightmail-Tracker: H4sIAAAAAAAAA+NgFnrFJsWRmVeSWpSXmKPExsWy7bCmhe6t9NUJBidOmlo8mLeNzWJv2wl2
        ...
        
DLP-Filter: Pass
...
References: <20210524084345epcms2p63dde85f3fdc127c29d25ada7d7f539cb@epcms2p6>
        <CGME20210524084345epcms2p63dde85f3fdc127c29d25ada7d7f539cb@epcms2p6>
Precedence: bulk
...
index 1bd4cf6785af..aa170ccaa2de 100644
...
index 1de1340339ad..632353aa2891 100644
--- a/drivers/scsi/ufs/ufshcd.c
+++ b/drivers/scsi/ufs/ufshcd.c
@@ -2661,7 +2661,12 @@ static int ufshcd_queuecommand(struct Scsi_Host *host, struct scsi_cmnd *cmd)
...
@@ -3115,7 +3120,7 @@ int ufshcd_query_attr(struct ufs_hba *hba, enum query_opcode opcode,
  *
...
+int ufshcd_query_attr_retry(struct ufs_hba *hba,
 	...
 	u32 *attr_val)
 {
@@ -4910,7 +4915,8 @@ static int ufshcd_change_queue_depth(struct scsi_device *sdev, int depth)
...
@@ -7487,8 +7493,18 @@ static int ufs_get_device_desc(struct ufs_hba *hba)
...
@@ -8067,6 +8083,7 @@ static const struct attribute_group *ufshcd_driver_groups[] = {
...
index 044276689c59..f6802c627bac 100644
--- a/drivers/scsi/ufs/ufshcd.h
+++ b/drivers/scsi/ufs/ufshcd.h
@@ -656,6 +656,8 @@ struct ufs_hba_variant_params {
...
+ * @is_legacy: flag to check HPB 1.0
 ...
 struct ufshpb_dev_info {
 	int num_lu;
@@ -663,6 +665,8 @@ struct ufshpb_dev_info {
 	int srgn_size;
...
@@ -1102,6 +1106,9 @@ int ufshcd_read_desc_param(struct ufs_hba *hba,
 			   u8 param_offset,
 			   u8 *param_read_buf,
 			   u8 param_size);
...
index a9339a90bce3..85801e35a53b 100644
...
+		return 0;
 	...
 	ufshpb_get_pos_from_lpn(hpb, lpn, &rgn_idx, &srgn_idx, &srgn_offset);
@@ -327,18 +587,18 @@ void ufshpb_prep(struct ufs_hba *hba, struct ufshcd_lrb *lrbp)
...
@@ -351,28 +611,45 @@ void ufshpb_prep(struct ufs_hba *hba, struct ufshcd_lrb *lrbp)
 		 * active state.
 		 */
...
@@ -380,35 +657,54 @@ static struct ufshpb_req *ufshpb_get_map_req(struct ufshpb_lu *hpb,
 	}
...
@@ -491,6 +787,13 @@ static void ufshpb_activate_subregion(struct ufshpb_lu *hpb,
...
@@ -498,8 +801,8 @@ static void ufshpb_map_req_compl_fn(struct request *req, blk_status_t error)
 	struct ufshpb_subregion *srgn;
 	unsigned long flags;
...
+		map_req->rb.srgn_idx;
 	...
 	spin_lock_irqsave(&hpb->rgn_state_lock, flags);
@@ -509,6 +812,16 @@ static void ufshpb_map_req_compl_fn(struct request *req, blk_status_t error)
...
+
 ...
 {
@@ -522,6 +835,25 @@ static void ufshpb_set_read_buf_cmd(unsigned char *cdb, int rgn_idx,
 	cdb[9] = 0x00;
 }
...
+
 ...
 {
@@ -534,12 +866,12 @@ static int ufshpb_execute_map_req(struct ufshpb_lu *hpb,
...
@@ -555,8 +887,8 @@ static int ufshpb_execute_map_req(struct ufshpb_lu *hpb,
 	if (unlikely(last))
...
@@ -688,6 +1020,31 @@ static void ufshpb_purge_active_subregion(struct ufshpb_lu *hpb,
 	}
 }
...
+
 static void __ufshpb_evict_region(struct ufshpb_lu *hpb,
 				  struct ufshpb_region *rgn)
 {
@@ -1210,6 +1567,16 @@ static void ufshpb_lu_parameter_init(struct ufs_hba *hba,
 	u32 entries_per_rgn;
...
@@ -1355,7 +1722,7 @@ ufshpb_sysfs_attr_show_func(rb_active_cnt);
...
@@ -1366,10 +1733,118 @@ static struct attribute *hpb_dev_attrs[] = {
 };
...
+
 ...
 {
 	hpb->stats.hit_cnt = 0;
@@ -1380,6 +1855,11 @@ static void ufshpb_stat_init(struct ufshpb_lu *hpb)
...
+
 ...
 {
 	int ret;
@@ -1412,14 +1892,24 @@ static int ufshpb_lu_hpb_init(struct ufs_hba *hba, struct ufshpb_lu *hpb)
...
+	ufshpb_pre_req_mempool_destroy(hpb);
 ...
 release_req_cache:
@@ -1428,7 +1918,7 @@ static int ufshpb_lu_hpb_init(struct ufs_hba *hba, struct ufshpb_lu *hpb)
 }
...
+ufshpb_alloc_hpb_lu(struct ufs_hba *hba, struct scsi_device *sdev,
 ...
 {
@@ -1439,7 +1929,8 @@ ufshpb_alloc_hpb_lu(struct ufs_hba *hba, int lun,
 	if (!hpb)
 		return NULL;
...
@@ -1449,6 +1940,7 @@ ufshpb_alloc_hpb_lu(struct ufs_hba *hba, int lun,
 		goto release_hpb;
 	}
...
+	sdev->hostdata = hpb;
 ...
 release_hpb:
@@ -1651,6 +2143,7 @@ void ufshpb_destroy_lu(struct ufs_hba *hba, struct scsi_device *sdev)
...
@@ -1690,6 +2183,7 @@ static void ufshpb_hpb_lu_prepared(struct ufs_hba *hba)
...
+			ufshpb_issue_umap_all_req(hpb);
 			...
 			ufshpb_destroy_lu(hba, sdev);
@@ -1714,7 +2208,7 @@ void ufshpb_init_hpb_lu(struct ufs_hba *hba, struct scsi_device *sdev)
 	if (ret)
 		goto out;
...
+	hpb = ufshpb_alloc_hpb_lu(hba, sdev, &hba->ufshpb_dev,
 	...
 	if (!hpb)
 		goto out;
@@ -1722,9 +2216,6 @@ void ufshpb_init_hpb_lu(struct ufs_hba *hba, struct scsi_device *sdev)
...
@@ -1811,8 +2302,9 @@ void ufshpb_get_geo_info(struct ufs_hba *hba, u8 *geo_buf)
...
@@ -1823,13 +2315,27 @@ void ufshpb_get_dev_info(struct ufs_hba *hba, u8 *desc_buf)
 	}
