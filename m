...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6DA941BA72E
	for <lists+linux-scsi@lfdr.de>; Mon, 27 Apr 2020 17:02:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727881AbgD0PCc (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Mon, 27 Apr 2020 11:02:32 -0400
Received: from userp2130.oracle.com ([156.151.31.86]:50326 "EHLO
        userp2130.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728090AbgD0PCb (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Mon, 27 Apr 2020 11:02:31 -0400
Received: from pps.filterd (userp2130.oracle.com [127.0.0.1])
        by userp2130.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 03RExmBg180026;
        Mon, 27 Apr 2020 15:02:07 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=subject : to : cc :
 references : from : message-id : date : mime-version : in-reply-to :
 content-type : content-transfer-encoding; s=corp-2020-01-29;
 bh=+HbGB8TFyGt6i+Ih7nSx26D1H9bzBCyA1ExMGdqHHZI=;
 b= Bw== 
Received: from aserp3030.oracle.com (aserp3030.oracle.com [141.146.126.71])
        by userp2130.oracle.com with ESMTP id 30p01ngnm2-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Mon, 27 Apr 2020 15:02:06 +0000
Received: from pps.filterd (aserp3030.oracle.com [127.0.0.1])
        by aserp3030.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 03REvvRX158025;
        Mon, 27 Apr 2020 15:00:05 GMT
Received: from userv0122.oracle.com (userv0122.oracle.com [156.151.31.75])
        by aserp3030.oracle.com with ESMTP id 30mxrqfcqr-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Mon, 27 Apr 2020 15:00:04 +0000
Received: from abhmp0018.oracle.com (abhmp0018.oracle.com [141.146.116.24])
        by userv0122.oracle.com (8.14.4/8.14.4) with ESMTP id 03RExxIO002747;
        Mon, 27 Apr 2020 15:00:00 GMT
Received: from [10.154.123.249] (/10.154.123.249)
        by default (Oracle Beehive Gateway v4.0)
        with ESMTP ; Mon, 27 Apr 2020 07:59:58 -0700
Subject: Re: [PATCH v4 11/11] qla2xxx: Fix endianness annotations in source
 files
...
References: <20200427030310.19687-1-bvanassche@acm.org>
 <20200427030310.19687-12-bvanassche@acm.org>
From:   himanshu.madhani@oracle.com
Organization: Oracle Corporation
Message-ID: <5ec86411-deaa-73e1-c0b8-8a35c37acc1e@oracle.com>
Date:   Mon, 27 Apr 2020 09:59:56 -0500
User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:68.0)
 Gecko/20100101 Thunderbird/68.7.0
MIME-Version: 1.0
In-Reply-To: <20200427030310.19687-12-bvanassche@acm.org>
Content-Type: text/plain; charset=utf-8; format=flowed
Content-Language: en-US
Content-Transfer-Encoding: 7bit
X-Proofpoint-Virus-Version: vendor=nai engine=6000 definitions=9603 signatures=668686
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 mlxscore=0 phishscore=0 suspectscore=29
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 bulkscore=0 spamscore=0 clxscore=1015
 ...
 suspectscore=29 malwarescore=0 lowpriorityscore=0 impostorscore=0
 classifier=spam adjust=0 reason=mlx scancount=1 engine=8.12.0-2003020000
 definitions=main-2004270126
...
> index ff8835b4626a..625e695896c1 100644
...
>   	rval = QLA_SUCCESS;
>   	mb0 = 0;
> @@ -441,7 +441,7 @@ qla2xxx_dump_ram(struct qla_hw_data *ha, uint32_t addr, uint16_t *ram,
...
>   		}
> @@ -453,9 +453,9 @@ qla2xxx_dump_ram(struct qla_hw_data *ha, uint32_t addr, uint16_t *ram,
>   
>   static inline void
...
> @@ -472,10 +472,10 @@ qla24xx_copy_eft(struct qla_hw_data *ha, void *ptr)
>   }
>   
>   static inline void *
...
>   
>   	if (!ha->fce)
> @@ -499,7 +499,7 @@ qla25xx_copy_fce(struct qla_hw_data *ha, void *ptr, uint32_t **last_chain)
>   }
>   
>   static inline void *
...
>   
> @@ -517,11 +517,11 @@ qla25xx_copy_exlogin(struct qla_hw_data *ha, void *ptr, uint32_t **last_chain)
...
>   	struct qla2xxx_offld_chain *c = ptr;
>   
> @@ -539,12 +539,12 @@ qla81xx_copy_exchoffld(struct qla_hw_data *ha, void *ptr, uint32_t **last_chain)
>   	ptr += sizeof(struct qla2xxx_offld_chain);
...
> @@ -591,7 +591,7 @@ qla2xxx_copy_atioqueues(struct qla_hw_data *ha, void *ptr,
>   }
>   
>   static inline void *
...
>   	struct qla2xxx_mqueue_chain *q;
>   	struct qla2xxx_mqueue_header *qh;
> @@ -662,7 +662,7 @@ qla25xx_copy_mqueues(struct qla_hw_data *ha, void *ptr, uint32_t **last_chain)
>   }
>   
>   static inline void *
...
>   	uint8_t que_cnt;
> @@ -728,7 +728,7 @@ qla2300_fw_dump(scsi_qla_host_t *vha, int hardware_locked)
>   	uint32_t	cnt;
...
>   	void		*nxt;
> @@ -900,7 +900,7 @@ qla2100_fw_dump(scsi_qla_host_t *vha, int hardware_locked)
>   	uint16_t	mb0, mb2;
>   	struct qla_hw_data *ha = vha->hw;
>   	struct device_reg_2xxx __iomem *reg = &ha->iobase->isp;
> -	uint16_t __iomem *dmp_reg;
...
> @@ -1097,14 +1097,14 @@ qla24xx_fw_dump(scsi_qla_host_t *vha, int hardware_locked)
>   	uint32_t	cnt;
>   	struct qla_hw_data *ha = vha->hw;
>   	struct device_reg_24xx __iomem *reg = &ha->iobase->isp24;
> -	uint32_t __iomem *dmp_reg;
...
>   
>   	if (IS_P3P_TYPE(ha))
> @@ -1356,13 +1356,13 @@ qla25xx_fw_dump(scsi_qla_host_t *vha, int hardware_locked)
>   	uint32_t	cnt;
>   	struct qla_hw_data *ha = vha->hw;
>   	struct device_reg_24xx __iomem *reg = &ha->iobase->isp24;
> -	uint32_t __iomem *dmp_reg;
...
>   
>   	flags = 0;
> @@ -1682,13 +1682,13 @@ qla81xx_fw_dump(scsi_qla_host_t *vha, int hardware_locked)
>   	uint32_t	cnt;
>   	struct qla_hw_data *ha = vha->hw;
>   	struct device_reg_24xx __iomem *reg = &ha->iobase->isp24;
> -	uint32_t __iomem *dmp_reg;
...
>   
>   	flags = 0;
> @@ -2010,13 +2010,13 @@ qla83xx_fw_dump(scsi_qla_host_t *vha, int hardware_locked)
>   	uint32_t	cnt;
>   	struct qla_hw_data *ha = vha->hw;
>   	struct device_reg_24xx __iomem *reg = &ha->iobase->isp24;
> -	uint32_t __iomem *dmp_reg;
...
>   
>   	flags = 0;
> @@ -2734,7 +2734,7 @@ ql_dump_regs(uint level, scsi_qla_host_t *vha, uint id)
>   	struct device_reg_2xxx __iomem *reg = &ha->iobase->isp;
...
> index 9a84297f6fdb..c7d4592591ff 100644
...
>   	}
> @@ -4091,7 +4091,7 @@ qla24xx_config_rings(struct scsi_qla_host *vha)
...
>   	}
> @@ -7152,7 +7154,7 @@ qla24xx_nvram_config(scsi_qla_host_t *vha)
>   	int   rval;
...
>   	uint32_t chksum;
>   	uint16_t cnt;
> @@ -7180,7 +7182,7 @@ qla24xx_nvram_config(scsi_qla_host_t *vha)
...
> @@ -7208,7 +7210,7 @@ qla24xx_nvram_config(scsi_qla_host_t *vha)
...
> @@ -7376,7 +7378,7 @@ qla24xx_nvram_config(scsi_qla_host_t *vha)
...
> @@ -7444,7 +7446,7 @@ qla27xx_check_image_status_signature(struct qla27xx_image_status *image_status)
>   static ulong
...
>   	uint32_t sum = 0;
>   
> @@ -7507,7 +7509,7 @@ qla28xx_get_aux_images(
...
> @@ -7540,7 +7542,7 @@ qla28xx_get_aux_images(
...
> @@ -7605,7 +7607,7 @@ qla27xx_get_active_image(struct scsi_qla_host *vha,
>   		goto check_sec_image;
>   	}
>   
...
>   	    QLA_SUCCESS) {
>   		WARN_ON_ONCE(true);
> @@ -7712,7 +7714,7 @@ qla24xx_load_risc_flash(scsi_qla_host_t *vha, uint32_t *srisc_addr,
...
> @@ -7725,18 +7727,18 @@ qla24xx_load_risc_flash(scsi_qla_host_t *vha, uint32_t *srisc_addr,
...
> @@ -7776,9 +7778,9 @@ qla24xx_load_risc_flash(scsi_qla_host_t *vha, uint32_t *srisc_addr,
>   		fwdt->template = NULL;
>   		fwdt->length = 0;
>   
> -		dcode = (void *)req->ring;
...
>   		    j, faddr, risc_size);
> @@ -7847,7 +7849,8 @@ qla2x00_load_risc(scsi_qla_host_t *vha, uint32_t *srisc_addr)
>   {
>   	int	rval;
>   	int	i, fragment;
...
>   	struct fw_blob *blob;
>   	struct qla_hw_data *ha = vha->hw;
> @@ -7867,7 +7870,7 @@ qla2x00_load_risc(scsi_qla_host_t *vha, uint32_t *srisc_addr)
>   
...
> @@ -7915,7 +7918,7 @@ qla2x00_load_risc(scsi_qla_host_t *vha, uint32_t *srisc_addr)
>   			    "words 0x%x.\n", risc_addr, wlen);
>   
>   			for (i = 0; i < wlen; i++)
...
>   			    wlen);
> @@ -7952,7 +7955,7 @@ qla24xx_load_risc_blob(scsi_qla_host_t *vha, uint32_t *srisc_addr)
>   	ulong i;
>   	uint j;
>   	struct fw_blob *blob;
> -	uint32_t *fwcode;
...
> @@ -7968,8 +7971,8 @@ qla24xx_load_risc_blob(scsi_qla_host_t *vha, uint32_t *srisc_addr)
>   		return QLA_FUNCTION_FAILED;
>   	}
>   
...
> @@ -7980,7 +7983,7 @@ qla24xx_load_risc_blob(scsi_qla_host_t *vha, uint32_t *srisc_addr)
>   		return QLA_FUNCTION_FAILED;
>   	}
>   
> -	dcode = (void *)req->ring;
...
>   	segments = FA_RISC_CODE_SEGMENTS;
>   	for (j = 0; j < segments; j++) {
> @@ -8006,7 +8009,7 @@ qla24xx_load_risc_blob(scsi_qla_host_t *vha, uint32_t *srisc_addr)
>   			    dlen);
>   
>   			for (i = 0; i < dlen; i++)
...
>   			if (rval) {
> @@ -8060,7 +8063,7 @@ qla24xx_load_risc_blob(scsi_qla_host_t *vha, uint32_t *srisc_addr)
>   
>   		dcode = fwdt->template;
...
> @@ -8331,7 +8334,7 @@ qla81xx_nvram_config(scsi_qla_host_t *vha)
>   	int   rval;
...
>   	uint32_t chksum;
>   	uint16_t cnt;
> @@ -8378,7 +8381,7 @@ qla81xx_nvram_config(scsi_qla_host_t *vha)
>   	    "primary" : "secondary");
...
>   		chksum += le32_to_cpu(*dptr);
>   
> @@ -8405,7 +8408,7 @@ qla81xx_nvram_config(scsi_qla_host_t *vha)
>   		memset(nv, 0, ha->nvram_size);
>   		nv->nvram_version = cpu_to_le16(ICB_VERSION);
>   		nv->version = cpu_to_le16(ICB_VERSION);
> -		nv->frame_payload_size = 2048;
...
>   		nv->exchange_count = cpu_to_le16(0);
>   		nv->port_name[0] = 0x21;
> @@ -8449,7 +8452,7 @@ qla81xx_nvram_config(scsi_qla_host_t *vha)
>   	}
>   
...
>   
> @@ -8612,10 +8615,10 @@ qla81xx_nvram_config(scsi_qla_host_t *vha)
>   	}
>   
>   	 /* enable RIDA Format2 */
...
> index 3e31a175304c..93c06a754d5c 100644
...
> index 9d38328974c6..a4354d2a8043 100644
...
> index dd17d8dc39b6..2b3f1b46e3cf 100644
> --- a/drivers/scsi/qla2xxx/qla_os.c
> +++ b/drivers/scsi/qla2xxx/qla_os.c
> @@ -5951,7 +5951,7 @@ void qla24xx_process_purex_rdp(struct scsi_qla_host *vha, void *pkt)
...
> @@ -5962,7 +5962,7 @@ void qla24xx_process_purex_rdp(struct scsi_qla_host *vha, void *pkt)
...
>   
> @@ -5974,8 +5974,8 @@ void qla24xx_process_purex_rdp(struct scsi_qla_host *vha, void *pkt)
>   
...
> @@ -6025,7 +6025,7 @@ void qla24xx_process_purex_rdp(struct scsi_qla_host *vha, void *pkt)
...
> @@ -6052,17 +6052,17 @@ void qla24xx_process_purex_rdp(struct scsi_qla_host *vha, void *pkt)
...
>   		}
>   	}
> @@ -6134,7 +6134,7 @@ void qla24xx_process_purex_rdp(struct scsi_qla_host *vha, void *pkt)
>   		memset(sfp, 0, SFP_RTDI_LEN);
...
> index cdda70ae7b4e..c6f80358c94b 100644
...
same comment as previous patch. this looks sane and will reduce 
endianess warnings. but driver maintainer need to verify if this works 
with all flavor of hardware.
