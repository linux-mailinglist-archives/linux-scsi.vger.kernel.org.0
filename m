...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 403AE4202DF
	for <lists+linux-scsi@lfdr.de>; Sun,  3 Oct 2021 18:38:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231296AbhJCQkM (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 3 Oct 2021 12:40:12 -0400
Received: from smtp.infotech.no ([82.134.31.41]:55374 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231289AbhJCQj7 (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 3 Oct 2021 12:39:59 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 3952A2041CE;
        Sun,  3 Oct 2021 18:38:10 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 9csdSWsGzPHa; Sun,  3 Oct 2021 18:38:07 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-23-91-187-47.dyn.295.ca [23.91.187.47])
        by smtp.infotech.no (Postfix) with ESMTPA id 0426D2041C0;
        Sun,  3 Oct 2021 18:37:41 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        Damien.LeMoal@wdc.com
Subject: [PATCH v21 40/46] sg: remove rcv_done request state
Date:   Sun,  3 Oct 2021 12:31:45 -0400
Message-Id: <20211003163151.585349-41-dgilbert@interlog.com>
...
index 2a192962abbb..cc8f90829e67 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
-		err = err ? err : err2;
 	...
 	sg_deact_request(sfp, srp);
 	return err < 0 ? err : 0;
@@ -1449,7 +1448,6 @@ sg_read_v1v2(void __user *buf, int count, struct sg_fd *sfp,
...
-	atomic_set(&srp->rq_st, SG_RS_RCV_DONE);
 	...
 	sg_deact_request(sfp, srp);
 	return res;
@@ -1623,7 +1621,6 @@ sg_get_dur(struct sg_request *srp, const enum sg_rq_state *sr_stp,
...
@@ -1694,9 +1691,13 @@ sg_wait_event_srp(struct file *filp, struct sg_fd *sfp, void __user *p,
...
@@ -2463,8 +2464,7 @@ sg_rq_end_io(struct request *rq, blk_status_t status)
 	}
...
@@ -2933,6 +2933,8 @@ sg_start_req(struct sg_request *srp, struct sg_comm_wr_t *cwrp, int dxfer_dir)
 	}
 fini:
...
+			blk_rq_unmap_user(rq->bio);
 		...
 		srp->rq = NULL;
 		if (us_xfer && rq->bio)
@@ -3146,9 +3148,10 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
...
@@ -3160,8 +3163,7 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
 				continue;
...
@@ -3171,14 +3173,37 @@ sg_find_srp_by_id(struct sg_fd *sfp, int pack_id)
 			}
 			break;
 		}
...
@@ -3296,8 +3321,9 @@ sg_setup_req(struct sg_comm_wr_t *cwrp, int dxfr_len)
 	bool found = false;
...
@@ -3310,45 +3336,48 @@ sg_setup_req(struct sg_comm_wr_t *cwrp, int dxfr_len)
 		act_empty = true;
 		mk_new_srp = true;
...
+		WRITE_ONCE(fp->prev_used_idx, r_srp->rq_idx);
 		...
 		mk_new_srp = true;
@@ -3421,7 +3450,7 @@ sg_deact_request(struct sg_fd *sfp, struct sg_request *srp)
 	sbp = srp->sense_bp;
 	srp->sense_bp = NULL;
...
@@ -3512,7 +3541,7 @@ sg_add_sfp(struct sg_device *sdp)
 		}
 		srp->rq_idx = idx;
 		srp->parentfp = sfp;
...
@@ -3661,8 +3690,6 @@ sg_rq_st_str(enum sg_rq_state rq_st, bool long_str)
...
-		return long_str ? "receive_done" : "fin";
 	...
 	default:
@@ -3939,7 +3966,8 @@ sg_proc_debug_fd(struct sg_fd *fp, char *obp, int len, unsigned long idx)
