...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6BDEE333870
	for <lists+linux-scsi@lfdr.de>; Wed, 10 Mar 2021 10:15:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232428AbhCJJOl (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 10 Mar 2021 04:14:41 -0500
Received: from m42-2.mailgun.net ([69.72.42.2]:61762 "EHLO m42-2.mailgun.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231811AbhCJJOj (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Wed, 10 Mar 2021 04:14:39 -0500
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1615367679; h=Message-ID: References: In-Reply-To: Subject:
 Cc: To: From: Date: Content-Transfer-Encoding: Content-Type:
 MIME-Version: Sender; bh=CJOq9xJMStBo8iLApHEJ61jh1iWq/F4Dl7nucvxR2dc=;
 b=YEQa10WQcY/cejz1bbTkrDfRMExHPWPtkgsGbf0RTafUGtID3og/sM7TCdMe/jzpnCynPOl+
 4NuYWmDMAuHq+QqxMWFaJBqAv5KuV/Rk3D7NcY/OpaVpmWja6urLnOQasmYxrbFMcNIRYSA/
 rDUfrNnWOSPui9xRmFwyZPOK7vw=
X-Mailgun-Sending-Ip: 69.72.42.2
X-Mailgun-Sid: WyJlNmU5NiIsICJsaW51eC1zY3NpQHZnZXIua2VybmVsLm9yZyIsICJiZTllNGEiXQ==
Received: from smtp.codeaurora.org
 (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171]) by
 smtp-out-n05.prod.us-west-2.postgun.com with SMTP id
 60488dea6e1c22bc8d05f19c (version=TLS1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256); Wed, 10 Mar 2021 09:14:18
 GMT
Sender: cang=codeaurora.org@mg.codeaurora.org
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id 1D03DC43461; Wed, 10 Mar 2021 09:14:18 +0000 (UTC)
...
Received: from mail.codeaurora.org (localhost.localdomain [127.0.0.1])
        ...
        by smtp.codeaurora.org (Postfix) with ESMTPSA id A0A94C433CA;
        Wed, 10 Mar 2021 09:14:12 +0000 (UTC)
MIME-Version: 1.0
Content-Type: text/plain; charset=US-ASCII;
 format=flowed
Content-Transfer-Encoding: 7bit
Date:   Wed, 10 Mar 2021 17:14:12 +0800
...
In-Reply-To: <989e8d9c7dcb0ca0841c9ba95881891e@codeaurora.org>
References: <20210303062633epcms2p252227acd30ad15c1ca821d7e3f547b9e@epcms2p2>
 ...
 <989e8d9c7dcb0ca0841c9ba95881891e@codeaurora.org>
Message-ID: <4d83aef7b8cf9efbe10f3379e09beacd@codeaurora.org>
...
> it is pointless to push next version.
> 
> Regards,
> Can Guo.

Somehow my setup cannot replicate the issue anymore today, weird...
I won't spend much time testing device control mode since now,
please go ahead if you have the next version ready.

Can Guo.

> 
> On 2021-03-03 14:29, Daejun Park wrote:
...
>> +}
>> +
>>  static struct ufshpb_lu *ufshpb_get_hpb_data(struct scsi_device 
>> *sdev)
>>  {
...
>>  {
>> @@ -1440,7 +1932,8 @@ ufshpb_alloc_hpb_lu(struct ufs_hba *hba, int 
>> lun,
>>  	if (!hpb)
>>  		return NULL;
>> 
...
>> 
>> @@ -1450,6 +1943,7 @@ ufshpb_alloc_hpb_lu(struct ufs_hba *hba, int 
>> lun,
>>  		goto release_hpb;
>>  	}
>> 
