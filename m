...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AA85B28EAC7
	for <lists+linux-scsi@lfdr.de>; Thu, 15 Oct 2020 04:07:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729635AbgJOCHM (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 14 Oct 2020 22:07:12 -0400
Received: from smtp.infotech.no ([82.134.31.41]:40122 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728528AbgJOCHH (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Wed, 14 Oct 2020 22:07:07 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 53383204269;
        Thu, 15 Oct 2020 04:07:04 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id fYocAKyeI1DB; Thu, 15 Oct 2020 04:07:00 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-104-157-204-209.dyn.295.ca [104.157.204.209])
        by smtp.infotech.no (Postfix) with ESMTPA id E8ACD20424C;
        Thu, 15 Oct 2020 04:06:55 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v11 10/44] sg: improve naming
Date:   Wed, 14 Oct 2020 22:06:09 -0400
Message-Id: <20201015020643.432908-11-dgilbert@interlog.com>
...
index 131fec52df29..7aae7ce6cebf 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -2008,7 +2023,7 @@ sg_build_indirect(struct sg_scatter_hold *schp, struct sg_fd *sfp,
 		  int buff_size)
 {
...
+	int max_sgat_sz = sfp->parentdp->max_sgat_sz;
 	...
 	struct sg_device *sdp = sfp->parentdp;
@@ -2017,13 +2032,13 @@ sg_build_indirect(struct sg_scatter_hold *schp, struct sg_fd *sfp,
 		return -EFAULT;
 	if (0 == blk_size)
...
@@ -2064,9 +2079,9 @@ sg_build_indirect(struct sg_scatter_hold *schp, struct sg_fd *sfp,
 	}		/* end of for loop */
...
+	schp->buflen = blk_size;
 	if (rem_sz > 0)	/* must have failed */
 		return -ENOMEM;
 	return 0;
@@ -2083,12 +2098,12 @@ sg_build_indirect(struct sg_scatter_hold *schp, struct sg_fd *sfp,
 static void
...
@@ -2115,7 +2130,7 @@ sg_rd_append(struct sg_request *srp, void __user *outp, int num_xfer)
 		return 0;
...
+	for (k = 0; k < schp->num_sgat && schp->pages[k]; k++) {
 		if (num > num_xfer) {
 			if (copy_to_user(outp, page_address(schp->pages[k]),
 					   num_xfer))
@@ -2163,22 +2178,21 @@ sg_link_reserve(struct sg_fd *sfp, struct sg_request *srp, int size)
 	rem = size;
...
-	}
 ...
 static void
@@ -2186,10 +2200,10 @@ sg_unlink_reserve(struct sg_fd *sfp, struct sg_request *srp)
 {
...
@@ -2200,7 +2214,7 @@ sg_unlink_reserve(struct sg_fd *sfp, struct sg_request *srp)
...
@@ -2279,7 +2293,7 @@ sg_add_sfp(struct sg_device *sdp)
 		kfree(sfp);
...
@@ -2288,8 +2302,8 @@ sg_add_sfp(struct sg_device *sdp)
...
@@ -2299,7 +2313,7 @@ sg_add_sfp(struct sg_device *sdp)
 static void
...
+	struct sg_fd *sfp = container_of(work, struct sg_fd, ew_fd.work);
 	...
 	struct sg_request *srp;
 	unsigned long iflags;
@@ -2314,9 +2328,9 @@ sg_remove_sfp_usercontext(struct work_struct *work)
 	}
...
@@ -2336,11 +2350,11 @@ sg_remove_sfp(struct kref *kref)
 	unsigned long iflags;
...
+	schedule_work(&sfp->ew_fd.work);
 ...
 static int
@@ -2627,19 +2641,19 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
...
@@ -2663,8 +2677,8 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
 					cp = "     ";
 			}
 			seq_puts(s, cp);
...
+			usg = srp->data.num_sgat;
 			seq_puts(s, srp->done ?
 				 ((1 == srp->done) ?  "rcv:" : "fin:")
 				  : "act:");
@@ -2717,8 +2731,8 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 				   scsidp->lun,
