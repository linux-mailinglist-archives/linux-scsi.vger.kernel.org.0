...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 62BF657817E
	for <lists+linux-scsi@lfdr.de>; Mon, 18 Jul 2022 14:03:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234618AbiGRMDU (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Mon, 18 Jul 2022 08:03:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49824 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234614AbiGRMDS (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Mon, 18 Jul 2022 08:03:18 -0400
Received: from mta-01.yadro.com (mta-02.yadro.com [89.207.88.252])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1160023BF4;
        Mon, 18 Jul 2022 05:03:16 -0700 (PDT)
Received: from localhost (unknown [127.0.0.1])
        by mta-01.yadro.com (Postfix) with ESMTP id 6975441253;
        Mon, 18 Jul 2022 12:03:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=yadro.com; h=
        content-type:content-type:content-transfer-encoding:mime-version
        :references:in-reply-to:x-mailer:message-id:date:date:subject
        :subject:from:from:received:received:received:received; s=
        mta-01; t=1658145792; x=1659960193; bh=Tkl+zatztNDm6Kqin4txodgfT
        BtK9BpbLcFMWgmlwQw=; b=t1o+0pgiNevcb3MuN/b7HpUZJcBgyXU9heYQaA5Ym
        Vgyfoeq2t1XgWWjgnaZSxBdQzujzeG9ACDvMsqT05k0uQKetE5AQGt+nph5I9HTv
        br8N1e2Sfmd671539AgZujR9ErQlUabYdDkq0WK3EuWSLrHQaX71Du3dj004lwUW
        N0=
X-Virus-Scanned: amavisd-new at yadro.com
Received: from mta-01.yadro.com ([127.0.0.1])
        by localhost (mta-01.yadro.com [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id pcuJUPGGtsx8; Mon, 18 Jul 2022 15:03:12 +0300 (MSK)
Received: from T-EXCH-02.corp.yadro.com (t-exch-02.corp.yadro.com [172.17.10.102])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-SHA384 (256/256 bits))
        (No client certificate requested)
        by mta-01.yadro.com (Postfix) with ESMTPS id 157BC41243;
...
Subject: [PATCH 2/6] scsi: target: core: add list of opcodes for RSOC
Date:   Mon, 18 Jul 2022 15:01:13 +0300
Message-ID: <20220718120117.4435-3-d.bogdanov@yadro.com>
...
@@ -1308,8 +1308,603 @@ spc_emulate_testunitready(struct se_cmd *cmd)
 	return 0;
 }
...
+	&tcm_opcode_xdwriteread10,
+	&tcm_opcode_xdwriteread32,
