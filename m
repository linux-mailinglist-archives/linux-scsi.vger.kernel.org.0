...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3DE2A369D53
	for <lists+linux-scsi@lfdr.de>; Sat, 24 Apr 2021 01:35:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232809AbhDWXfu (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Fri, 23 Apr 2021 19:35:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49346 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232614AbhDWXfk (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Fri, 23 Apr 2021 19:35:40 -0400
Received: from mail-pl1-x62c.google.com (mail-pl1-x62c.google.com [IPv6:2607:f8b0:4864:20::62c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B919CC061756
        for <linux-scsi@vger.kernel.org>; Fri, 23 Apr 2021 16:35:03 -0700 (PDT)
Received: by mail-pl1-x62c.google.com with SMTP id o16so12362330plg.5
        for <linux-scsi@vger.kernel.org>; Fri, 23 Apr 2021 16:35:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=SCxrfsfQ4Ra99305B+6gn8tKcsf2jDn36V0tVCWL1BE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=SCxrfsfQ4Ra99305B+6gn8tKcsf2jDn36V0tVCWL1BE=;
        b=
X-Gm-Message-State: AOAM533JRLk9Gymxfn7UpanmPhgTPO57Xp5WjS/9M4GonKhnYJ9NeT1V
        swEr7Yjopi8EjO8+2SHgFVswjcWluw0=
X-Google-Smtp-Source: ABdhPJzhuYWuYzloM6nfTk6A+6ZuQqq4Bpg6uFnbDpSJF/gALoYqX7x2V+xzhNdReR+YG01BvQRbtQ==
X-Received: by 2002:a17:90a:34c5:: with SMTP id m5mr6971988pjf.147.1619220902633;
        Fri, 23 Apr 2021 16:35:02 -0700 (PDT)
...
Subject: [PATCH v8 03/31] elx: libefc_sli: Data structures and defines for mbox commands
Date:   Fri, 23 Apr 2021 16:34:27 -0700
Message-Id: <20210423233455.27243-4-jsmart2021@gmail.com>
...
supported speeds
---
 drivers/scsi/elx/libefc_sli/sli4.h | 1640 +++++++++++++++++++++++++++-
 1 file changed, 1639 insertions(+), 1 deletion(-)

diff --git a/drivers/scsi/elx/libefc_sli/sli4.h b/drivers/scsi/elx/libefc_sli/sli4.h
index d194b566b588..238fed679d4f 100644
--- a/drivers/scsi/elx/libefc_sli/sli4.h
+++ b/drivers/scsi/elx/libefc_sli/sli4.h
@@ -1990,6 +1990,1532 @@ enum sli4_els_cmd_type {
...
+};
 ...
 struct sli4_queue {
@@ -2020,7 +3546,7 @@ struct sli4_queue {
 	} u;
 };
...
+/* Parameters used to populate WQE*/
 struct sli_bls_params {
 	u32		s_id;
 	u32		d_id;
@@ -2081,4 +3607,116 @@ struct sli_fcp_tgt_params {
 	u16		tag;
 };
