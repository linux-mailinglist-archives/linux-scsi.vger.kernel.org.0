...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id E48BD1388F0
	for <lists+linux-scsi@lfdr.de>; Mon, 13 Jan 2020 00:58:36 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387563AbgALX6g (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 12 Jan 2020 18:58:36 -0500
Received: from smtp.infotech.no ([82.134.31.41]:52080 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2387562AbgALX6f (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 12 Jan 2020 18:58:35 -0500
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 01283204248;
        Mon, 13 Jan 2020 00:58:34 +0100 (CET)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id KsgwbUyr0Hr6; Mon, 13 Jan 2020 00:58:32 +0100 (CET)
Received: from xtwo70.bingwo.ca (unknown [213.52.86.138])
        by smtp.infotech.no (Postfix) with ESMTPA id 016332042A7;
        Mon, 13 Jan 2020 00:58:00 +0100 (CET)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v6 28/37] sg: rework debug info
Date:   Mon, 13 Jan 2020 00:57:46 +0100
Message-Id: <20200112235755.14197-29-dgilbert@interlog.com>
...
index 3087a66bb1dd..5e5e66bdc912 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
@@ -2430,7 +2430,7 @@ sg_rq_end_io(struct request *rq, blk_status_t status)
...
+		if (scsi_rp->sense && !srp->sense_bp) {
 			srp->sense_bp = mempool_alloc(sg_sense_pool,
 						      GFP_ATOMIC);
 			if (srp->sense_bp) {
@@ -2443,6 +2443,9 @@ sg_rq_end_io(struct request *rq, blk_status_t status)
...
@@ -3968,116 +3971,211 @@ sg_proc_seq_show_devstrs(struct seq_file *s, void *v)
 	return 0;
 }
