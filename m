...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B80BC301FEC
	for <lists+linux-scsi@lfdr.de>; Mon, 25 Jan 2021 02:30:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726333AbhAYB35 (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 24 Jan 2021 20:29:57 -0500
Received: from smtp.infotech.no ([82.134.31.41]:45512 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726449AbhAYB2I (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 24 Jan 2021 20:28:08 -0500
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 3D624204273;
        Mon, 25 Jan 2021 02:27:04 +0100 (CET)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id jHYmBFQ9pZoZ; Mon, 25 Jan 2021 02:26:59 +0100 (CET)
Received: from xtwo70.bingwo.ca (host-104-157-204-209.dyn.295.ca [104.157.204.209])
        by smtp.infotech.no (Postfix) with ESMTPA id 3231820425B;
        Mon, 25 Jan 2021 02:26:56 +0100 (CET)
...
Subject: [PATCH v14 02/45] sg: remove typedefs, type+formatting cleanup
Date:   Sun, 24 Jan 2021 20:26:07 -0500
Message-Id: <20210125012650.269411-3-dgilbert@interlog.com>
...
index acb5bb8788ee..d343fdd16741 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
@@ -3,7 +3,7 @@
  *  History:
...
@@ -1893,12 +1922,12 @@ sg_start_req(Sg_request *srp, unsigned char *cmd)
 }
...
@@ -1920,7 +1949,8 @@ sg_finish_rem_req(Sg_request *srp)
 }
...
@@ -1933,7 +1963,8 @@ sg_build_sgat(Sg_scatter_hold * schp, const Sg_fd * sfp, int tablesize)
 }
...
@@ -2015,7 +2046,7 @@ sg_build_indirect(Sg_scatter_hold * schp, Sg_fd * sfp, int buff_size)
 }
...
@@ -2038,9 +2069,9 @@ sg_remove_scat(Sg_fd * sfp, Sg_scatter_hold * schp)
 }
...
@@ -2071,9 +2102,9 @@ sg_read_oxfer(Sg_request * srp, char __user *outp, int num_read_xfer)
 }
...
@@ -2089,10 +2120,10 @@ sg_build_reserve(Sg_fd * sfp, int req_size)
 }
...
+	struct sg_scatter_hold *rsv_schp = &sfp->reserve;
 	...
 	srp->res_used = 1;
@@ -2121,9 +2152,9 @@ sg_link_reserve(Sg_fd * sfp, Sg_request * srp, int size)
 }
...
@@ -2139,12 +2170,12 @@ sg_unlink_reserve(Sg_fd * sfp, Sg_request * srp)
 }
...
@@ -2158,7 +2189,7 @@ sg_add_request(Sg_fd * sfp)
 		if (k >= SG_MAX_QUEUE)
 			goto out_unlock;
 	}
...
@@ -2171,7 +2202,7 @@ sg_add_request(Sg_fd * sfp)
...
+sg_remove_request(struct sg_fd *sfp, struct sg_request *srp)
 {
 	unsigned long iflags;
 	int res = 0;
@@ -2188,10 +2219,10 @@ sg_remove_request(Sg_fd * sfp, Sg_request * srp)
 	return res;
 }
...
@@ -2241,13 +2272,13 @@ sg_remove_sfp_usercontext(struct work_struct *work)
 {
...
+		srp = list_first_entry(&sfp->rq_list, struct sg_request, entry);
 		...
 		list_del(&srp->entry);
 		srp->parentfp = NULL;
@@ -2312,12 +2343,13 @@ sg_last_dev(void)
 #endif
...
+static struct sg_device *
 ...
 {
 	struct sg_device *sdp;
@@ -2413,13 +2445,15 @@ sg_proc_init(void)
 }
...
@@ -2440,7 +2474,8 @@ sg_proc_write_adio(struct file *filp, const char __user *buffer,
 	return count;
 }
...
@@ -2465,14 +2500,16 @@ sg_proc_write_dressz(struct file *filp, const char __user *buffer,
 	return -ERANGE;
 }
...
@@ -2498,7 +2536,8 @@ static void * dev_seq_start(struct seq_file *s, loff_t *pos)
 	return it;
 }
...
@@ -2506,15 +2545,17 @@ static void * dev_seq_next(struct seq_file *s, void *v, loff_t *pos)
...
@@ -2537,10 +2578,11 @@ static int sg_proc_seq_show_dev(struct seq_file *s, void *v)
 	return 0;
 }
...
@@ -2557,11 +2599,12 @@ static int sg_proc_seq_show_devstrs(struct seq_file *s, void *v)
 }
...
+	struct sg_fd *fp;
 	...
 	const char * cp;
 	unsigned int ms;
@@ -2620,10 +2663,11 @@ static void sg_proc_debug_helper(struct seq_file *s, Sg_device * sdp)
 	}
 }
