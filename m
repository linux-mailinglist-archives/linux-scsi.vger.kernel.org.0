...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1958F4202B4
	for <lists+linux-scsi@lfdr.de>; Sun,  3 Oct 2021 18:32:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231215AbhJCQeY (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 3 Oct 2021 12:34:24 -0400
Received: from smtp.infotech.no ([82.134.31.41]:55063 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231132AbhJCQeX (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 3 Oct 2021 12:34:23 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 1EE862041BD;
        Sun,  3 Oct 2021 18:31:59 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id kdcjKTi5pLnR; Sun,  3 Oct 2021 18:31:55 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-23-91-187-47.dyn.295.ca [23.91.187.47])
        by smtp.infotech.no (Postfix) with ESMTPA id 6E7132041AC;
        Sun,  3 Oct 2021 18:31:53 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        Damien.LeMoal@wdc.com, Hannes Reinecke <hare@suse.com>
Subject: [PATCH v21 01/46] sg: move functions around
Date:   Sun,  3 Oct 2021 12:31:06 -0400
Message-Id: <20211003163151.585349-2-dgilbert@interlog.com>
...
index 8f05248920e8..cc3ddf6a8126 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
@@ -8,11 +8,12 @@
...
@@ -836,6 +639,76 @@ sg_common_write(Sg_fd * sfp, Sg_request * srp,
 	return 0;
 }
...
+
 ...
 {
 	unsigned long flags;
@@ -847,6 +720,173 @@ static int srp_done(Sg_fd *sfp, Sg_request *srp)
 	return ret;
 }
...
+
 ...
 exit_sg(void)
 {
@@ -1724,7 +1770,7 @@ sg_start_req(Sg_request *srp, unsigned char *cmd)
...
+			     REQ_OP_DRV_OUT : REQ_OP_DRV_IN, 0);
 	if (IS_ERR(rq)) {
 		kfree(long_cmdp);
 		return PTR_ERR(rq);
@@ -2031,9 +2077,10 @@ sg_link_reserve(Sg_fd * sfp, Sg_request * srp, int size)
 			rem -= num;
 	}
...
+	}
 ...
 static void
@@ -2054,26 +2101,6 @@ sg_unlink_reserve(Sg_fd * sfp, Sg_request * srp)
 	sfp->res_in_use = 0;
 }
