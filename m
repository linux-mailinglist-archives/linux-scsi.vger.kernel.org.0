...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id ED662637D93
	for <lists+linux-scsi@lfdr.de>; Thu, 24 Nov 2022 17:22:30 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229568AbiKXQWa (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Thu, 24 Nov 2022 11:22:30 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56964 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229495AbiKXQW2 (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Thu, 24 Nov 2022 11:22:28 -0500
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 386D116F0E1
        for <linux-scsi@vger.kernel.org>; Thu, 24 Nov 2022 08:22:24 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1669306944; x=1700842944;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=urSSD1B79n4Uy2HSgecjGXL5FKaoj0ZGgZGq37LIwyc=;
  b=g62hWRsKnMsEgltZQxr0aKnOjF7ttidLHdhf0bFzbGx6P/HzOGlQkpVN
   rU3l+h90yI09V3xwXHxQceuNbAj8d4zzMSQgNvivqJwVDViYv9yZUKYH9
   HBySXA+cX02R4FnHn8YDRTc+8BERjDp5xrTdhiNBociuuzwpB0M+H2LNP
   tZ8ILJ8WZW2YEejiIEf39UNDfNLzyZOKwbfnRF3/sOsXicj8uF0YkEtKI
   KW40bnttJZWs/DiCIUyd46Pn4TeQBmdm8ANfltPAUpMUnzF5gZJl5a7Pu
   F7/+VO4LGcMP6whhLH9JFeKAqGVnXJz8fbyRMjORIlCOt1xyYcBZyZkRT
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10541"; a="294035177"
X-IronPort-AV: E=Sophos;i="5.96,190,1665471600"; 
   d="scan'208";a="294035177"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Nov 2022 08:22:23 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10541"; a="673288399"
X-IronPort-AV: E=Sophos;i="5.96,190,1665471600"; 
   d="scan'208";a="673288399"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
  by orsmga008.jf.intel.com with ESMTP; 24 Nov 2022 08:22:20 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oyEzU-00042z-0H;
        Thu, 24 Nov 2022 16:22:20 +0000
Date:   Fri, 25 Nov 2022 00:21:40 +0800
...
Message-ID: <202211250027.gCxsvCJl-lkp@intel.com>
References: <20221123131801.4409-1-hare@suse.de>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="R+NH7towl9wkK/lP"
...
[also build test ERROR on jejb-scsi/for-next linus/master v6.1-rc6]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Hannes-Reinecke/scsi-do-not-put-scsi_common-in-a-separate-module/20221123-213847
base:   https://git.kernel.org/pub/scm/linux/kernel/git/mkp/scsi.git for-next
patch link:    https://lore.kernel.org/r/20221123131801.4409-1-hare%40suse.de
patch subject: [PATCH] scsi: do not put scsi_common in a separate module
config: microblaze-randconfig-c043-20221124
compiler: microblaze-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/7f10f5c8423c80a4a9069fd81733035b88409baf
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Hannes-Reinecke/scsi-do-not-put-scsi_common-in-a-separate-module/20221123-213847
        git checkout 7f10f5c8423c80a4a9069fd81733035b88409baf
...
All errors (new ones prefixed by >>):
   ...
   microblaze-linux-ld: drivers/target/target_core_transport.o: in function `scsi_command_size':
>> target_core_transport.o:(.text+0xb4): undefined reference to `scsi_command_size_tbl'
   microblaze-linux-ld: drivers/target/target_core_transport.o: in function `scsi_command_control':
   target_core_transport.o:(.text+0xf4): undefined reference to `scsi_command_size_tbl'
   microblaze-linux-ld: drivers/target/target_core_transport.o: in function `translate_sense_reason':
>> target_core_transport.o:(.text+0xf78): undefined reference to `scsi_build_sense_buffer'
>> microblaze-linux-ld: target_core_transport.o:(.text+0xfac): undefined reference to `scsi_set_sense_information'
   microblaze-linux-ld: drivers/target/target_core_spc.o: in function `spc_emulate_report_luns':
>> (.text+0xff8): undefined reference to `int_to_scsilun'
>> microblaze-linux-ld: (.text+0x1140): undefined reference to `int_to_scsilun'
   microblaze-linux-ld: drivers/target/target_core_spc.o: in function `spc_emulate_request_sense':
>> target_core_spc.o:(.text+0x1798): undefined reference to `scsi_build_sense_buffer'
   microblaze-linux-ld: drivers/target/sbp/sbp_target.o: in function `sbp_fetch_command':
>> .tmp_gl_sbp_target.o:(.text+0x344c): undefined reference to `scsi_command_size_tbl'
   microblaze-linux-ld: drivers/vhost/scsi.o: in function `vhost_scsi_handle_vq':
>> .tmp_gl_scsi.o:(.text+0x73a4): undefined reference to `scsi_command_size_tbl'
