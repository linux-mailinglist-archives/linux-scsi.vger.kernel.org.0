...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 115013C59C3
	for <lists+linux-scsi@lfdr.de>; Mon, 12 Jul 2021 13:03:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1353597AbhGLJIE (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Mon, 12 Jul 2021 05:08:04 -0400
Received: from mailout4.samsung.com ([203.254.224.34]:58225 "EHLO
        mailout4.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1382426AbhGLJBZ (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Mon, 12 Jul 2021 05:01:25 -0400
Received: from epcas2p2.samsung.com (unknown [182.195.41.54])
        by mailout4.samsung.com (KnoxPortal) with ESMTP id 20210712085834epoutp047e835bc8eb48e8cafb2e7607c3769355~Q-25ZT5Xd2852028520epoutp04J
        for <linux-scsi@vger.kernel.org>; Mon, 12 Jul 2021 08:58:34 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout4.samsung.com 20210712085834epoutp047e835bc8eb48e8cafb2e7607c3769355~Q-25ZT5Xd2852028520epoutp04J
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1626080314;
        bh=51n60dHP1818A6ioOSDwYUWSG4BjpNJ3vtj1BQfIryM=;
        h=Subject:Reply-To:From:To:CC:In-Reply-To:Date:References:From;
        b=jAw2WicntNxlI9Ca7xW6D7uhykooSejI65gvQaDsgGNLbn+/Jka8fWJtjtV1yrpX1
         GXn/P/IHcTXD9+DaHj3nNGbtkuf/Qff5fCPBgVwyavUT+mIlbqr+EI04ZC6UQAwLqw
         TwfM4Dy5Xj3jPdOvzPh6sc78xKpkAcdgMdh2ISYk=
Received: from epsnrtp1.localdomain (unknown [182.195.42.162]) by
        epcas2p4.samsung.com (KnoxPortal) with ESMTP id
        20210712085834epcas2p4ee0b53e4f3f56324c760c594177e18ea~Q-24nMFTi2392123921epcas2p4F;
        Mon, 12 Jul 2021 08:58:34 +0000 (GMT)
Received: from epsmges2p2.samsung.com (unknown [182.195.40.185]) by
        epsnrtp1.localdomain (Postfix) with ESMTP id 4GNd3C47jrz4x9Q8; Mon, 12 Jul
        2021 08:58:31 +0000 (GMT)
X-AuditID: b6c32a46-0abff70000002545-9d-60ec04372b92
Received: from epcas2p2.samsung.com ( [182.195.41.54]) by
        epsmges2p2.samsung.com (Symantec Messaging Gateway) with SMTP id
        78.A3.09541.7340CE06; Mon, 12 Jul 2021 17:58:31 +0900 (KST)
Mime-Version: 1.0
Subject: [PATCH v40 1/4] scsi: ufs: Introduce HPB feature
...
X-Msg-Type: PERSONAL
X-Reply-Demand: N
Message-ID: <20210712085830epcms2p8c1288b7f7a81b044158a18232617b572@epcms2p8>
Date:   Mon, 12 Jul 2021 17:58:30 +0900
X-CMS-MailID: 20210712085830epcms2p8c1288b7f7a81b044158a18232617b572
...
X-CPGSPASS: Y
CMS-TYPE: 102P
X-Brightmail-Tracker: H4sIAAAAAAAAA+NgFnrNJsWRmVeSWpSXmKPExsWy7bCmma45y5sEgwvfpS0ezNvGZrG37QS7
        ...
        
DLP-Filter: Pass
...
References: <20210712085751epcms2p29fd10cbd7e2b4ea384aa2d9493e7c695@epcms2p2>
        <CGME20210712085751epcms2p29fd10cbd7e2b4ea384aa2d9493e7c695@epcms2p8>
Precedence: bulk
...
index 8380866d8ed0..6e688f33b52e 100644
...
index 2d137953e7b4..ee650526c560 100644
...
index 5b31de83a63a..8bea8a82022a 100644
...
+
 	...
 	if (ufshcd_scsi_to_upiu_lun(sdev->lun) == UFS_UPIU_UFS_DEVICE_WLUN) {
 		unsigned long flags;
@@ -7098,6 +7123,7 @@ static int ufshcd_host_reset_and_restore(struct ufs_hba *hba)
...
+		ufshpb_resume(hba);
 	...
 	return ret;
@@ -8996,6 +9042,8 @@ static int __ufshcd_wl_resume(struct ufs_hba *hba, enum ufs_pm_op pm_op)
