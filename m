...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2F9C01B9550
	for <lists+linux-scsi@lfdr.de>; Mon, 27 Apr 2020 05:03:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726403AbgD0DDi (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 26 Apr 2020 23:03:38 -0400
Received: from mail-pj1-f68.google.com ([209.85.216.68]:53593 "EHLO
        mail-pj1-f68.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726374AbgD0DDh (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Sun, 26 Apr 2020 23:03:37 -0400
Received: by mail-pj1-f68.google.com with SMTP id hi11so6894566pjb.3
        for <linux-scsi@vger.kernel.org>; Sun, 26 Apr 2020 20:03:33 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=ef2/9n8ZdFxdasIMb7Mt6ZSpAxtppzro7MauLAfpnGA=;
        b=
X-Gm-Message-State: AGi0PuZwE0OAmtF0zaaxeJmO5/YwhmkM0ND75ewqD0LqTaZ0+vsZqjrT
        K4ejCOL20L6YqIxdliqUID8=
X-Google-Smtp-Source: APiQypL/Vy2FsQ4+7ahtyZdcm/vhzAY2uopPjmJ/SenUdu2Kag/rN3t5QWmqV4dFg4/CW8voZPPG3w==
X-Received: by 2002:a17:902:ab95:: with SMTP id f21mr19258243plr.188.1587956612320;
        Sun, 26 Apr 2020 20:03:32 -0700 (PDT)
Received: from asus.hsd1.ca.comcast.net ([2601:647:4000:d7:612a:373a:aa97:7fa7])
        by smtp.gmail.com with ESMTPSA id v94sm9982617pjb.39.2020.04.26.20.03.30
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 26 Apr 2020 20:03:31 -0700 (PDT)
...
Subject: [PATCH v4 10/11] qla2xxx: Fix endianness annotations in header files
Date:   Sun, 26 Apr 2020 20:03:09 -0700
Message-Id: <20200427030310.19687-11-bvanassche@acm.org>
...
index 82fab3df891b..1adb3ce07080 100644
...
@@ -3614,98 +3614,98 @@ struct rdp_req_payload {
...
@@ -3743,17 +3743,17 @@ struct qlt_hw_data {
...
@@ -4247,7 +4247,7 @@ struct qla_hw_data {
...
@@ -4427,7 +4427,7 @@ struct qla_hw_data {
...
+	uint32_t file_prd_off;	/* File firmware product offset */
 	...
 	void		*md_tmplt_hdr;
@@ -4733,13 +4733,13 @@ typedef struct scsi_qla_host {
...
index f18d2d00d28c..470d9291384e 100644
