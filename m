Return-Path: <linux-scsi+bounces-22497-lists+linux-scsi=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-scsi@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id EOlEEqkIxGk+vgQAu9opvQ
	(envelope-from <linux-scsi+bounces-22497-lists+linux-scsi=lfdr.de@vger.kernel.org>)
	for <lists+linux-scsi@lfdr.de>; Wed, 25 Mar 2026 17:09:13 +0100
X-Original-To: lists+linux-scsi@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 85818328B82
	for <lists+linux-scsi@lfdr.de>; Wed, 25 Mar 2026 17:09:12 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id DCA663157FBD
	for <lists+linux-scsi@lfdr.de>; Wed, 25 Mar 2026 15:24:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3C6EF3C456B;
	Wed, 25 Mar 2026 15:23:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=qualcomm.com header.i=@qualcomm.com header.b="MQ/rFB17"
X-Original-To: linux-scsi@vger.kernel.org
Received: from mx0a-0031df01.pphosted.com (mx0a-0031df01.pphosted.com [205.220.168.131])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B1DFE3E123D;
	Wed, 25 Mar 2026 15:23:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=205.220.168.131
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1774452224; cv=none; b=beOhej6LQA5QkzwljziOiOXNOHfzT/TuSa23wqBuAxdrmNc4C9olzTXTdWSkPK0qmZC97Q/0kvCKAMF5wJo2BGgQKyy7+mOR3rPTBccauQnSMEkFbLvIp8q5egWVx5vXBsffymFLjHsn9ivxhI6B6Gn6wnyzzUWGr6sqrYOFeX4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1774452224; c=relaxed/simple;
	bh=kcjBQgncxU5DMeHFLMweclMW0gyTTrJmKVAGp+09PEE=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=FDfip7tmKnLYzhykvmotXfK7aub/bJbLJ6cQGMDLmVTeRXVgg7FJrVUAXvK+cnHD+OFPEObxQQ2VEzRggjzwaEsAWHkVVkqmjb1gwQ456LXN7YRwyJhGjYp+7FA0pi+ns4ny3mB0qmEX/vcZo4em0tCAZM6ZXSPXxujfXqSl6pw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=oss.qualcomm.com; spf=pass smtp.mailfrom=qualcomm.com; dkim=pass (2048-bit key) header.d=qualcomm.com header.i=@qualcomm.com header.b=MQ/rFB17; arc=none smtp.client-ip=205.220.168.131
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=oss.qualcomm.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=qualcomm.com
Received: from pps.filterd (m0279862.ppops.net [127.0.0.1])
	by mx0a-0031df01.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id 62PFH8Uu2432194;
	Wed, 25 Mar 2026 15:23:21 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=qualcomm.com; h=
	cc:content-transfer-encoding:date:from:in-reply-to:message-id
	:mime-version:references:subject:to; s=qcppdkim1; bh=aTeWnjP8Ld6
	QCv9GCa8b7Gy4ZhMQzzfS1438RUTjNIU=; b=MQ/rFB17BW2GQJ1CsPbM9WD0sQg
	
Received: from nalasppmta01.qualcomm.com (Global_NAT1.qualcomm.com [129.46.96.20])
	by mx0a-0031df01.pphosted.com (PPS) with ESMTPS id 4d489mje06-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Wed, 25 Mar 2026 15:23:21 +0000 (GMT)
Received: from pps.filterd (NALASPPMTA01.qualcomm.com [127.0.0.1])
	by NALASPPMTA01.qualcomm.com (8.18.1.2/8.18.1.2) with ESMTP id 62PFMUKM018979;
	Wed, 25 Mar 2026 15:23:20 GMT
Received: from pps.reinject (localhost [127.0.0.1])
	by NALASPPMTA01.qualcomm.com (PPS) with ESMTPS id 4d475qfhbx-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Wed, 25 Mar 2026 15:23:20 +0000
Received: from NALASPPMTA01.qualcomm.com (NALASPPMTA01.qualcomm.com [127.0.0.1])
	by pps.reinject (8.17.1.5/8.17.1.5) with ESMTP id 62PFNKFc019632;
	Wed, 25 Mar 2026 15:23:20 GMT
Received: from hu-devc-lv-u22-c.qualcomm.com (hu-cang-lv.qualcomm.com [10.81.25.255])
	by NALASPPMTA01.qualcomm.com (PPS) with ESMTPS id 62PFNKs8019631
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Wed, 25 Mar 2026 15:23:20 +0000
Received: by hu-devc-lv-u22-c.qualcomm.com (Postfix, from userid 359480)
	id 2FBE15AE; Wed, 25 Mar 2026 08:23:20 -0700 (PDT)
...
Subject: [PATCH v5 04/12] scsi: ufs: core: Add support for TX Equalization
Date: Wed, 25 Mar 2026 08:21:46 -0700
Message-Id: <20260325152154.1604082-5-can.guo@oss.qualcomm.com>
...
X-Proofpoint-Virus-Version: vendor=nai engine=6200 definitions=5800 signatures=585085
X-Proofpoint-Spam-Details-Enc: AW1haW4tMjYwMzI1MDExMCBTYWx0ZWRfXw1GHdkf/kCtf
 
X-Proofpoint-GUID: xL1Xu8PFMwuQQHxJm1iYifKhttM_HOQK
X-Proofpoint-ORIG-GUID: xL1Xu8PFMwuQQHxJm1iYifKhttM_HOQK
X-Authority-Analysis: v=2.4 cv=AKSYvs3t c=1 sm=1 tr=0 ts=69c3fde9 cx=c_pps
 a=ouPCqIW2jiPt+lZRy3xVPw==:117 a=ouPCqIW2jiPt+lZRy3xVPw==:17
 a=Yq5XynenixoA:10 a=VkNPw1HP01LnGYTKEx00:22 a=u7WPNUs3qKkmUXheDGA7:22
 a=_K5XuSEh1TEqbUxoQ0s3:22 a=PY6Zn8H8AAAA:8 a=N54-gffFAAAA:8 a=EUspDBNiAAAA:8
 a=ufAJUjbdAAAA:8 a=peLwTRnrCxS4aL57SlYA:9 a=ySS05r0LPNlNiX1MMvNp:22
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-22497-lists,linux-scsi=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[micron.com:email,tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns,oss.qualcomm.com:mid,acm.org:email,qualcomm.com:dkim,qualcomm.com:email];
	TAGGED_RCPT(0.00)[linux-scsi];
	RCVD_COUNT_SEVEN(0.00)[10]
X-Rspamd-Queue-Id: 85818328B82
...
---
 ...
 drivers/ufs/core/ufs-txeq.c    | 1186 ++++++++++++++++++++++++++++++++
 drivers/ufs/core/ufshcd-priv.h |   38 +
 drivers/ufs/core/ufshcd.c      |   50 +-
 include/ufs/ufshcd.h           |  135 ++++
 include/ufs/unipro.h           |  114 ++-
 6 files changed, 1516 insertions(+), 9 deletions(-)
...
index 000000000000..04f9f1ffa43e
--- /dev/null
...
index 64220e3aa86e..d9da4f3c1f14 100644
...
+
  ...
  * @hba: per adapter instance
@@ -4823,6 +4850,12 @@ int ufshcd_config_pwr_mode(struct ufs_hba *hba,
...
@@ -6822,6 +6855,7 @@ static void ufshcd_err_handler(struct work_struct *work)
...
@@ -7085,6 +7119,7 @@ static irqreturn_t ufshcd_check_errors(struct ufs_hba *hba, u32 intr_status)
...
+			ufshcd_print_tx_eq_params(hba);
 		...
 		retval |= IRQ_HANDLED;
@@ -7866,6 +7901,7 @@ static int ufshcd_abort(struct scsi_cmnd *cmd)
 		ufshcd_print_evt_hist(hba);
 		ufshcd_print_host_state(hba);
 		ufshcd_print_pwr_info(hba);
+		ufshcd_print_tx_eq_params(hba);
...
@@ -8843,6 +8879,8 @@ static void ufshcd_tune_unipro_params(struct ufs_hba *hba)
