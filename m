...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D498A338713
	for <lists+linux-scsi@lfdr.de>; Fri, 12 Mar 2021 09:08:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232187AbhCLIIN (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Fri, 12 Mar 2021 03:08:13 -0500
Received: from mailout3.samsung.com ([203.254.224.33]:55897 "EHLO
        mailout3.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232182AbhCLIH5 (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Fri, 12 Mar 2021 03:07:57 -0500
Received: from epcas2p2.samsung.com (unknown [182.195.41.54])
        by mailout3.samsung.com (KnoxPortal) with ESMTP id 20210312080755epoutp033bb56244f3a3412904a1475a40dac122~rid1hJ0g92507525075epoutp03X
        for <linux-scsi@vger.kernel.org>; Fri, 12 Mar 2021 08:07:55 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout3.samsung.com 20210312080755epoutp033bb56244f3a3412904a1475a40dac122~rid1hJ0g92507525075epoutp03X
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1615536475;
        bh=3hk6rODYDiAQmOrCyuquaUn7ontLwv3eZsWYvLIDBsI=;
        h=Subject:Reply-To:From:To:CC:In-Reply-To:Date:References:From;
        b=TdsTeD7NRDU5vBoD/Om3J1mMEJ8jt3J4M+vNaVolhTYsPbr9jdZcPEt5lXQnM7u/k
         BgEVP0byQyBAeKy493azNEIu2ueZN18AwvvfcyN9XDyWwX6ecvJFJJJNiTEhcApedj
         oJCPwc+QmHtiO/MXzNvRNWexO5HlnU52J0OUt778=
Received: from epsnrtp3.localdomain (unknown [182.195.42.164]) by
        epcas2p4.samsung.com (KnoxPortal) with ESMTP id
        20210312080754epcas2p4b31f42cbca2fe82f2d1fd0f004afd5d8~rid0hOguB0941209412epcas2p4d;
        Fri, 12 Mar 2021 08:07:54 +0000 (GMT)
Received: from epsmges2p4.samsung.com (unknown [182.195.40.184]) by
        epsnrtp3.localdomain (Postfix) with ESMTP id 4Dxdj373SJz4x9Q0; Fri, 12 Mar
        2021 08:07:51 +0000 (GMT)
X-AuditID: b6c32a48-4f9ff7000000cd1f-83-604b215745d3
Received: from epcas2p4.samsung.com ( [182.195.41.56]) by
        epsmges2p4.samsung.com (Symantec Messaging Gateway) with SMTP id
        1A.B4.52511.7512B406; Fri, 12 Mar 2021 17:07:51 +0900 (KST)
Mime-Version: 1.0
Subject: [PATCH v27 4/4] scsi: ufs: Add HPB 2.0 support
...
X-Msg-Type: PERSONAL
X-Reply-Demand: N
Message-ID: <20210312080751epcms2p42c0324b5788b85218c68edbf36344d15@epcms2p4>
Date:   Fri, 12 Mar 2021 17:07:51 +0900
X-CMS-MailID: 20210312080751epcms2p42c0324b5788b85218c68edbf36344d15
...
X-CPGSPASS: Y
CMS-TYPE: 102P
X-Brightmail-Tracker: H4sIAAAAAAAAA+NgFnrAJsWRmVeSWpSXmKPExsWy7bCmhW64oneCwZzNxhYP5m1js9jbdoLd
        ...
        
        bN1zBAAA
DLP-Filter: Pass
...
References: <20210312080600epcms2p3f04061fbf25f2afb1588fa005541fbce@epcms2p3>
        <CGME20210312080600epcms2p3f04061fbf25f2afb1588fa005541fbce@epcms2p4>
Precedence: bulk
...
index 201dc24d55b3..73880e704d9a 100644
...
+int ufshpb_prep(struct ufs_hba *hba, struct ufshcd_lrb *lrbp)
 {
 	...
 	struct ufshpb_region *rgn;
@@ -291,11 +562,12 @@ void ufshpb_prep(struct ufs_hba *hba, struct ufshcd_lrb *lrbp)
 	u64 ppn;
 	unsigned long flags;
...
+		return -ENODEV;
 	...
 	if (ufshpb_get_state(hpb) == HPB_INIT)
 		return;
@@ -303,17 +575,17 @@ void ufshpb_prep(struct ufs_hba *hba, struct ufshcd_lrb *lrbp)
