Return-Path: <linux-scsi+bounces-8626-lists+linux-scsi=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-scsi@lfdr.de
Delivered-To: lists+linux-scsi@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id A66C198E43C
	for <lists+linux-scsi@lfdr.de>; Wed,  2 Oct 2024 22:36:24 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 678B81F2369D
	for <lists+linux-scsi@lfdr.de>; Wed,  2 Oct 2024 20:36:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4187B216A36;
	Wed,  2 Oct 2024 20:36:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=acm.org header.i=@acm.org header.b="LiNQfbr+"
X-Original-To: linux-scsi@vger.kernel.org
Received: from 009.lax.mailroute.net (009.lax.mailroute.net [199.89.1.12])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 76CE081720
	for <linux-scsi@vger.kernel.org>; Wed,  2 Oct 2024 20:36:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=199.89.1.12
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1727901379; cv=none; b=dYIzpgDHPi6YT4Bk6+9I5Yvkj6RzBF5GhVB0JxGuWdg6rOO6xQvYqXLfNO3NKOdEtyyMAZTcOLPte4QrnIudiqitMfnidI5pM/Dw7N6H/74KfvMrMkpMBy46di7FNkDltqeAgfd/3xoCoTSUcW1jYEfOoNmmjsuho2vMM63w1Kw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1727901379; c=relaxed/simple;
	bh=BsYA2Le1juae9iS6Gt0rricx3oJfJiscZpVzkvDo3I4=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=q7IKO4G/eiLNj/Ywch06EZk2QaJaBCpf4/a0znYv3JRW/Nzy5KWu2VaLiUFY6F1+FVPOvZ5IOJ/kB31u6DOG0MkPb2LHHleo3rF/NPpQJCJYlp1ILbUqMJ44DTXF+123ef2J3Pk9EUYljFTPTpVeMsicsM7i5WaaMIfDK+WDqKU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=acm.org; spf=pass smtp.mailfrom=acm.org; dkim=pass (2048-bit key) header.d=acm.org header.i=@acm.org header.b=LiNQfbr+; arc=none smtp.client-ip=199.89.1.12
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=acm.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=acm.org
Received: from localhost (localhost [127.0.0.1])
	by 009.lax.mailroute.net (Postfix) with ESMTP id 4XJmmY6MJ5zlgMWC;
	Wed,  2 Oct 2024 20:36:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=acm.org; h=
	content-transfer-encoding:mime-version:references:in-reply-to
	:x-mailer:message-id:date:date:subject:subject:from:from
	:received:received; s=mr01; t=1727901354; x=1730493355; bh=PUkyh
	r1U45aF/5b98AJyreFjuiApLWmLaAbnCK4NYJw=; b=LiNQfbr+aAKstjnTGIMnv
	
X-Virus-Scanned: by MailRoute
Received: from 009.lax.mailroute.net ([127.0.0.1])
 by localhost (009.lax [127.0.0.1]) (mroute_mailscanner, port 10029) with LMTP
 id iEcix-9VKLYm; Wed,  2 Oct 2024 20:35:54 +0000 (UTC)
Received: from bvanassche.mtv.corp.google.com (unknown [104.135.204.82])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	(Authenticated sender: bvanassche@acm.org)
	by 009.lax.mailroute.net (Postfix) with ESMTPSA id 4XJmmB3tp2zlgMW9;
	Wed,  2 Oct 2024 20:35:54 +0000 (UTC)
From: Bart Van Assche <bvanassche@acm.org>
To: "Martin K . Petersen" <martin.petersen@oracle.com>
Cc: linux-scsi@vger.kernel.org,
	Bart Van Assche <bvanassche@acm.org>,
	Jonathan Corbet <corbet@lwn.net>
Subject: [PATCH v2 03/11] scsi: lpfc: Remove the changelog
Date: Wed,  2 Oct 2024 13:33:55 -0700
Message-ID: <20241002203528.4104996-4-bvanassche@acm.org>
...
---
 ...
 1 file changed, 1865 deletions(-)
 delete mode 100644 Documentation/scsi/ChangeLog.lpfc

diff --git a/Documentation/scsi/ChangeLog.lpfc b/Documentation/scsi/Chang=
eLog.lpfc
deleted file mode 100644
index ccc48b8359bf..000000000000
...
-	  the sli layer which checks the mbox_cmpl =3D=3D 0 to free mail box
-	  resources.
...
-	* Makefile cleanup.  Use ?=3D operator for setting default
...
-	  converted.
-	* If the mbox_cmpl =3D=3D lpfc_sli_wake_mbox_wait in
...
-	  clean;make ADVANCED=3D1 on SMP x86, 2.6.10-rc2 on RHEL 4 Beta
...
-	  Fixed comment, and macro values so def=3D256, min=3D1, max=3D32768.
...
-	* Modify Makefile to (1) make BUILD_NO_DEBUG=3D1 will hide some
-	  (binary) attributes (2) make BUILD_FC_TRANS=3D0 will build driver
...
-	* Added recognition for BUILD_FC_TRANS=3D2 to Makefile to define
-	  FC_TRANS_VER2.
...
-	* Moved #if LINUX_VERSION_CODE >=3D KERNEL_VERSION(2,6,6) to include
...
-	  C=3D1). Mostly these are "using integer as pointer warnings"
...
-	* Changed 2 occurrences of if( 1 !=3D f(x)) to if(f(x) !=3D 1)
...
-	  "[PATCH] use scsi host private data in ->proc_info. =20
-	* Applied patch from Christoph Hellwig (hch@infradead.org) as follows
-	  "Re: [Emulex] Ready for next round.  This patch cleans up the memory=20
...
-	* Added fixes to targetless hosts that caused modprobe and insmod to ha=
ng.
...
-	  create_flag).
-	* Make lpfc_sli_reset_on_init =3D 1
-	* Minor cleanup to quieten sparse.
-	* Removed missing function =3D 0 in tmo routine in lpfc_els.c.
...
-	* Remove redundant port_cmp !=3D 2 check in if
-	  (!port_cmp) { .... if (port_cmp !=3D 2).... }
...
-	  targetp =3D=3D NULL in the scsi fast path.  Increased number of
...
-	  lpfc_log_verbose=3D"lpfc:0,lpfc0:0x10,lpfc1:4,lpfc100:0xffff" The
-	  "," delimter does not matter. It can be anything or not exist at
-	  all. ie param =3D "lpfc:0lpfc0:0x10.lpfc1:4txtlpfc100:0xffff" will
...
-	* Replace mlist->dma.list =3D dmp->dma.list; to mlist =3D dmp.
...
-	  lpfc.h
-	* Remove lpfc_hba.h
-	* Remove duplicate rc definitions from=20
...
-	  ELX_READ_LXHBA ELX_SET ELX_DBG LPFC_TRACE=20
...
-	* Fix a 2.6 kernel check to be >=3D 2.6.0 instead of > (was missing
-	  2.6.0).
