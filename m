Return-Path: <linux-scsi+bounces-841-lists+linux-scsi=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-scsi@lfdr.de
Delivered-To: lists+linux-scsi@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 48BF380D44C
	for <lists+linux-scsi@lfdr.de>; Mon, 11 Dec 2023 18:42:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 9E8441F21A23
	for <lists+linux-scsi@lfdr.de>; Mon, 11 Dec 2023 17:42:38 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AF9C54E62A;
	Mon, 11 Dec 2023 17:42:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=cisco.com header.i=@cisco.com header.b="Htm1oEhN"
X-Original-To: linux-scsi@vger.kernel.org
Received: from alln-iport-3.cisco.com (alln-iport-3.cisco.com [173.37.142.90])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3C2ADC7;
	Mon, 11 Dec 2023 09:42:23 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=cisco.com; i=@cisco.com; l=55611; q=dns/txt;
  s=iport; t=1702316543; x=1703526143;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=kxb51+y+HT3qWlvGgdQ/6WJ6/0cmeaTtEdi1+eSTo8A=;
  b=Htm1oEhNSquzJUqMjobmYRh3pi/o1boKWoH2yok4cztwHFH6xLt9S9L7
   G/eCsw1hYerar2KCd1v6evlQ/gMP03AmiwjltQW25nDyAlGixC54TNgYE
   kwVNrHm5FMq19RRjAzhpL6VxZn3nAM9vLj1Sls+UiECczp9t1wRRDUUia
   I=;
X-CSE-ConnectionGUID: dPupch4dR0qZF45Ld+SrGg==
X-CSE-MsgGUID: +qkU8JzxQDGHVlSiEtc91g==
X-IronPort-AV: E=Sophos;i="6.04,268,1695686400"; 
   d="scan'208";a="186635331"
Received: from rcdn-core-1.cisco.com ([173.37.93.152])
  by alln-iport-3.cisco.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Dec 2023 17:42:22 +0000
Received: from localhost.cisco.com ([10.193.101.253])
	(authenticated bits=0)
	by rcdn-core-1.cisco.com (8.15.2/8.15.2) with ESMTPSA id 3BBHaKr5009547
	(version=TLSv1.2 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=NO);
	Mon, 11 Dec 2023 17:42:21 GMT
...
Subject: [PATCH v6 11/13] scsi: fnic: Add support for multiqueue (MQ) in fnic driver
Date: Mon, 11 Dec 2023 09:36:15 -0800
Message-Id: <20231211173617.932990-12-kartilak@cisco.com>
...
---
 ...
 drivers/scsi/fnic/fnic_scsi.c | 575 +++++++++++++++++++---------------
 3 files changed, 328 insertions(+), 254 deletions(-)

diff --git a/drivers/scsi/fnic/fnic.h b/drivers/scsi/fnic/fnic.h
index 879e0f5b9b0a..34de8f0aacb2 100644
...
index e9acb2e7dd2e..42807e89859c 100644
...
@@ -1051,7 +1073,7 @@ static void fnic_fcpio_icmnd_cmpl_handler(struct fnic *fnic,
...
+static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic, unsigned int cq_index,
 ...
 {
 	u8 type;
@@ -1065,51 +1087,76 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
...
@@ -1130,7 +1177,7 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
...
+		spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 		...
 		switch (hdr_status) {
@@ -1165,7 +1212,7 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
 		}
...
@@ -1191,14 +1238,14 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
 		 */
 		if (io_req->abts_done) {
 			complete(io_req->abts_done);
-			spin_unlock_irqrestore(io_lock, flags);
...
+			spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 			...
 			fnic_release_ioreq_buf(fnic, io_req, sc);
 			mempool_free(io_req, fnic->io_req_pool);
@@ -1224,7 +1271,7 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
...
@@ -1239,7 +1286,7 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
 		}
...
@@ -1259,13 +1306,13 @@ static void fnic_fcpio_itmf_cmpl_handler(struct fnic *fnic,
 			      fnic_fcpio_status_to_str(hdr_status));
 		if (io_req->dr_done)
...
@@ -1292,17 +1339,19 @@ static int fnic_fcpio_cmpl_handler(struct vnic_dev *vdev,
 		break;
 	}
...
@@ -1355,18 +1404,33 @@ int fnic_wq_copy_cmpl_handler(struct fnic *fnic, int copy_work_to_do, unsigned i
...
+
 	if ((fnic_priv(sc)->flags & FNIC_DEVICE_RESET) &&
 	    !(fnic_priv(sc)->flags & FNIC_DEV_RST_DONE)) {
 		/*
@@ -1378,20 +1442,16 @@ static bool fnic_cleanup_io_iter(struct scsi_cmnd *sc, void *data)
 			complete(io_req->dr_done);
...
@@ -1401,7 +1461,6 @@ static bool fnic_cleanup_io_iter(struct scsi_cmnd *sc, void *data)
 	fnic_release_ioreq_buf(fnic, io_req, sc);
 	mempool_free(io_req, fnic->io_req_pool);
...
@@ -1412,12 +1471,6 @@ static bool fnic_cleanup_io_iter(struct scsi_cmnd *sc, void *data)
 	else
...
-
 	FNIC_TRACE(fnic_cleanup_io,
 		   ...
 		   jiffies_to_msecs(jiffies - start_time),
@@ -1446,8 +1499,8 @@ void fnic_wq_copy_cleanup_handler(struct vnic_wq_copy *wq,
 	struct fnic_io_req *io_req;
 	struct scsi_cmnd *sc;
 	unsigned long flags;
-	spinlock_t *io_lock;
...
@@ -1460,8 +1513,8 @@ void fnic_wq_copy_cleanup_handler(struct vnic_wq_copy *wq,
 	if (!sc)
 		return;
...
+	spin_lock_irqsave(&fnic->wq_copy_lock[hwq], flags);
 	...
 	io_req = fnic_priv(sc)->io_req;
@@ -1469,13 +1522,15 @@ void fnic_wq_copy_cleanup_handler(struct vnic_wq_copy *wq,
...
+	spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	fnic_release_ioreq_buf(fnic, io_req, sc);
@@ -1499,9 +1554,10 @@ void fnic_wq_copy_cleanup_handler(struct vnic_wq_copy *wq,
...
@@ -1514,13 +1570,13 @@ static inline int fnic_queue_abort_io_req(struct fnic *fnic, int tag,
...
@@ -1537,7 +1593,7 @@ static inline int fnic_queue_abort_io_req(struct fnic *fnic, int tag,
 		atomic64_set(&fnic->fnic_stats.fw_stats.max_fw_reqs,
 		  atomic64_read(&fnic->fnic_stats.fw_stats.active_fw_reqs));
...
+	spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	return 0;
@@ -1551,24 +1607,27 @@ struct fnic_rport_abort_io_iter_data {
...
@@ -1577,7 +1636,7 @@ static bool fnic_rport_abort_io_iter(struct scsi_cmnd *sc, void *data)
 		FNIC_SCSI_DBG(KERN_DEBUG, fnic->lport->host,
...
@@ -1586,7 +1645,7 @@ static bool fnic_rport_abort_io_iter(struct scsi_cmnd *sc, void *data)
...
+		spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	if (io_req->abts_done) {
@@ -1617,31 +1676,31 @@ static bool fnic_rport_abort_io_iter(struct scsi_cmnd *sc, void *data)
 	FNIC_SCSI_DBG(KERN_DEBUG, fnic->lport->host,
...
@@ -1719,7 +1778,6 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
 	struct fnic *fnic;
 	struct fnic_io_req *io_req = NULL;
 	struct fc_rport *rport;
-	spinlock_t *io_lock;
 	...
 	unsigned long start_time = 0;
 	int ret = SUCCESS;
@@ -1729,8 +1787,10 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
...
@@ -1740,23 +1800,25 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
...
@@ -1769,18 +1831,17 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
 	 *
...
@@ -1812,7 +1873,7 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
...
@@ -1829,15 +1890,15 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
 	/* Now queue the abort command to firmware */
 	int_to_scsilun(sc->device->lun, &fc_lun);
...
@@ -1861,12 +1922,12 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
 				     fnic->config.ed_tov));
...
+		spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 		...
 		ret = FAILED;
 		goto fnic_abort_cmd_end;
@@ -1875,7 +1936,7 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
...
@@ -1889,7 +1950,7 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
 	/* IO out of order */
...
@@ -1905,15 +1966,18 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
...
+	spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	fnic_release_ioreq_buf(fnic, io_req, sc);
 	mempool_free(io_req, fnic->io_req_pool);
@@ -1928,7 +1992,7 @@ int fnic_abort_cmd(struct scsi_cmnd *sc)
 		atomic64_inc(&fnic_stats->io_stats.io_completions);
...
@@ -1946,29 +2010,31 @@ static inline int fnic_queue_dr_io_req(struct fnic *fnic,
 				       struct scsi_cmnd *sc,
 				       struct fnic_io_req *io_req)
 {
-	struct vnic_wq_copy *wq = &fnic->hw_copy_wq[0];
...
+		free_wq_copy_descs(fnic, wq, hwq);
 	...
 	if (!vnic_wq_copy_desc_avail(wq)) {
 		FNIC_SCSI_DBG(KERN_DEBUG, fnic->lport->host,
@@ -1994,7 +2060,7 @@ static inline int fnic_queue_dr_io_req(struct fnic *fnic,
 		  atomic64_read(&fnic->fnic_stats.fw_stats.active_fw_reqs));
...
+	spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	return ret;
@@ -2009,12 +2075,13 @@ struct fnic_pending_aborts_iter_data {
...
-	spinlock_t *io_lock;
 	...
 	struct scsi_lun fc_lun;
 	DECLARE_COMPLETION_ONSTACK(tm_done);
@@ -2023,11 +2090,13 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
...
@@ -2040,7 +2109,7 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
...
+		spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	if ((fnic_priv(sc)->flags & FNIC_DEVICE_RESET) &&
@@ -2048,7 +2117,7 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
 		FNIC_SCSI_DBG(KERN_INFO, fnic->lport->host,
...
@@ -2069,35 +2138,34 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
...
@@ -2105,10 +2173,10 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
 				    (fnic->config.ed_tov));
...
@@ -2117,7 +2185,7 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
...
+		spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 		...
 		iter_data->ret = FAILED;
 		return false;
@@ -2125,9 +2193,11 @@ static bool fnic_pending_aborts_iter(struct scsi_cmnd *sc, void *data)
...
+	spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	/* original sc used for lr is handled by dev reset code */
 	if (sc != iter_data->lr_sc) {
@@ -2198,15 +2268,15 @@ int fnic_device_reset(struct scsi_cmnd *sc)
 	struct fc_rport *rport;
 	int status;
 	int ret = FAILED;
-	spinlock_t *io_lock;
...
+	uint16_t hwq = 0;
 	...
 	/* Wait for rport to unblock */
 	fc_block_scsi_eh(sc);
@@ -2236,7 +2306,7 @@ int fnic_device_reset(struct scsi_cmnd *sc)
...
@@ -2245,17 +2315,14 @@ int fnic_device_reset(struct scsi_cmnd *sc)
...
+	spin_lock_irqsave(&fnic->wq_copy_lock[hwq], flags);
 	...
 	/*
@@ -2265,36 +2332,43 @@ int fnic_device_reset(struct scsi_cmnd *sc)
 	if (!io_req) {
...
@@ -2303,12 +2377,12 @@ int fnic_device_reset(struct scsi_cmnd *sc)
...
+				"io_req is null mqtag 0x%x sc 0x%p\n", mqtag, sc);
 	...
 	io_req->dr_done = NULL;
@@ -2324,41 +2398,41 @@ int fnic_device_reset(struct scsi_cmnd *sc)
 		FNIC_SCSI_DBG(KERN_DEBUG, fnic->lport->host,
...
+				spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 				...
 				msecs_to_jiffies(FNIC_LUN_RESET_TIMEOUT));
 				break;
@@ -2369,12 +2443,12 @@ int fnic_device_reset(struct scsi_cmnd *sc)
 			}
 		}
 	} else {
-		spin_unlock_irqrestore(io_lock, flags);
...
@@ -2390,7 +2464,7 @@ int fnic_device_reset(struct scsi_cmnd *sc)
 	 * succeeds
 	 */
...
+		spin_lock_irqsave(&fnic->wq_copy_lock[hwq], flags);
 		...
 		FNIC_SCSI_DBG(KERN_DEBUG, fnic->lport->host,
 			      "Device reset failed"
@@ -2399,17 +2473,20 @@ int fnic_device_reset(struct scsi_cmnd *sc)
 	}
...
+	spin_unlock_irqrestore(&fnic->wq_copy_lock[hwq], flags);
 	...
 	if (io_req) {
 		start_time = io_req->start_time;
@@ -2649,12 +2726,17 @@ void fnic_exch_mgr_reset(struct fc_lport *lp, u32 sid, u32 did)
...
@@ -2665,12 +2747,11 @@ static bool fnic_abts_pending_iter(struct scsi_cmnd *sc, void *data)
...
@@ -2682,7 +2763,7 @@ static bool fnic_abts_pending_iter(struct scsi_cmnd *sc, void *data)
