...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A0B3720F29A
	for <lists+linux-scsi@lfdr.de>; Tue, 30 Jun 2020 12:23:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732505AbgF3KXw (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 30 Jun 2020 06:23:52 -0400
Received: from mx0b-0016f401.pphosted.com ([67.231.156.173]:48164 "EHLO
        mx0b-0016f401.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1729336AbgF3KXu (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>);
        Tue, 30 Jun 2020 06:23:50 -0400
Received: from pps.filterd (m0045851.ppops.net [127.0.0.1])
        by mx0b-0016f401.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 05UAK8ih010477
        for <linux-scsi@vger.kernel.org>; Tue, 30 Jun 2020 03:23:45 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=marvell.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-type; s=pfpt0818; bh=5BOmYMyoreGau1bYotE0t/RpVRxUzeX2ii1HVfcn4ug=;
 b= 5Q== 
Received: from sc-exch03.marvell.com ([199.233.58.183])
        by mx0b-0016f401.pphosted.com with ESMTP id 31x5mnk680-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-SHA384 bits=256 verify=NOT)
        for <linux-scsi@vger.kernel.org>; Tue, 30 Jun 2020 03:23:44 -0700
Received: from DC5-EXCH02.marvell.com (10.69.176.39) by SC-EXCH03.marvell.com
 (10.93.176.83) with Microsoft SMTP Server (TLS) id 15.0.1497.2; Tue, 30 Jun
 2020 03:23:43 -0700
Received: from DC5-EXCH02.marvell.com (10.69.176.39) by DC5-EXCH02.marvell.com
 (10.69.176.39) with Microsoft SMTP Server (TLS) id 15.0.1497.2; Tue, 30 Jun
 2020 03:23:42 -0700
Received: from maili.marvell.com (10.69.176.80) by DC5-EXCH02.marvell.com
 (10.69.176.39) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Tue, 30 Jun 2020 03:23:42 -0700
Received: from dut1171.mv.qlogic.com (unknown [10.112.88.18])
        by maili.marvell.com (Postfix) with ESMTP id 9DA113F703F;
        Tue, 30 Jun 2020 03:23:42 -0700 (PDT)
Received: from dut1171.mv.qlogic.com (localhost [127.0.0.1])
        by dut1171.mv.qlogic.com (8.14.7/8.14.7) with ESMTP id 05UANgXH029711;
        Tue, 30 Jun 2020 03:23:42 -0700
Received: (from root@localhost)
        by dut1171.mv.qlogic.com (8.14.7/8.14.7/Submit) id 05UANg8k029710;
        Tue, 30 Jun 2020 03:23:42 -0700
From:   Nilesh Javali <njavali@marvell.com>
To:     <martin.petersen@oracle.com>
CC:     <linux-scsi@vger.kernel.org>,
        <GR-QLogic-Storage-Upstream@marvell.com>
Subject: [PATCH v4 2/2] qla2xxx: SAN congestion management(SCM) implementation.
Date:   Tue, 30 Jun 2020 03:22:29 -0700
Message-ID: <20200630102229.29660-3-njavali@marvell.com>
...
index 3c1fef7e052e..f6b8502a35ab 100644
...
@@ -3817,6 +3839,12 @@ struct qla_hw_data {
...
+		uint32_t	scm_enabled:1;
 	...
 	uint16_t max_exchg;
@@ -4134,6 +4162,13 @@ struct qla_hw_data {
 	int		init_cb_size;
...
@@ -4196,6 +4231,12 @@ struct qla_hw_data {
...
@@ -4506,6 +4547,13 @@ struct purex_item {
 	} iocb;
 };
...
+
  ...
  */
@@ -4714,6 +4762,7 @@ typedef struct scsi_qla_host {
 	__le16 dport_data[4];
...
index 6957047a5b02..039099ddc472 100644
...
+}
 ...
 const char *const port_state_str[] = {
 	"Unknown",
@@ -820,7 +845,7 @@ qla24xx_queue_purex_item(scsi_qla_host_t *vha, struct purex_item *pkt,
...
+
  ...
  * @vha: SCSI driver HA context
@@ -1348,6 +1478,19 @@ qla2x00_async_event(scsi_qla_host_t *vha, struct rsp_que *rsp, uint16_t *mb)
...
@@ -3277,6 +3420,7 @@ void qla24xx_process_response_queue(struct scsi_qla_host *vha,
 {
...
@@ -3332,7 +3476,6 @@ void qla24xx_process_response_queue(struct scsi_qla_host *vha,
...
-
 				...
 				break;
@@ -3382,29 +3525,40 @@ void qla24xx_process_response_queue(struct scsi_qla_host *vha,
...
index 7d00db8ac5d9..f8d5ea00d343 100644
