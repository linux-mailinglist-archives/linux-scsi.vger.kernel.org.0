...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9BE9638E27D
	for <lists+linux-scsi@lfdr.de>; Mon, 24 May 2021 10:45:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232418AbhEXIqs (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Mon, 24 May 2021 04:46:48 -0400
Received: from mailout4.samsung.com ([203.254.224.34]:50308 "EHLO
        mailout4.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232347AbhEXIqr (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Mon, 24 May 2021 04:46:47 -0400
Received: from epcas2p2.samsung.com (unknown [182.195.41.54])
        by mailout4.samsung.com (KnoxPortal) with ESMTP id 20210524084518epoutp0448cfe72e425f82e6c6f4b30af2724174~B9EUbvIai3048030480epoutp044
        for <linux-scsi@vger.kernel.org>; Mon, 24 May 2021 08:45:18 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout4.samsung.com 20210524084518epoutp0448cfe72e425f82e6c6f4b30af2724174~B9EUbvIai3048030480epoutp044
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1621845918;
        bh=86KAgzE4WtoeBj9DvDCPb2CxNmdzSmdFNS3PiFUy4/A=;
        h=Subject:Reply-To:From:To:CC:In-Reply-To:Date:References:From;
        b=Oa/k6qwx/ITvKNN++D++IDDnwnXfdHFWZ40T7C9nHBAs/qMw8xKfvC4G3dVWlZ+cf
         iq8nomrC7pFYH8ARIVYWoQ7zJtpsySwngbHpuR1F4sDemONKnp4dtkomuNXusMrqUb
         GS1FZYrgxpncv9a59s2j7bjiA378klqLBLnvDTVU=
Received: from epsnrtp4.localdomain (unknown [182.195.42.165]) by
        epcas2p1.samsung.com (KnoxPortal) with ESMTP id
        20210524084517epcas2p176d11c35f95995d0c32ca05e9f860d8f~B9ETpO2uR0107601076epcas2p1k;
        Mon, 24 May 2021 08:45:17 +0000 (GMT)
Received: from epsmges2p1.samsung.com (unknown [182.195.40.190]) by
        epsnrtp4.localdomain (Postfix) with ESMTP id 4FpW4V6Jdkz4x9QL; Mon, 24 May
        2021 08:45:14 +0000 (GMT)
X-AuditID: b6c32a45-db3ff70000002584-45-60ab679a2185
Received: from epcas2p2.samsung.com ( [182.195.41.54]) by
        epsmges2p1.samsung.com (Symantec Messaging Gateway) with SMTP id
        C1.99.09604.A976BA06; Mon, 24 May 2021 17:45:14 +0900 (KST)
Mime-Version: 1.0
Subject: [PATCH v35 2/4] scsi: ufs: L2P map management for HPB read
...
X-Msg-Type: PERSONAL
X-Reply-Demand: N
Message-ID: <20210524084514epcms2p74d8419501f48e063b2aa8f80347a61ae@epcms2p7>
Date:   Mon, 24 May 2021 17:45:14 +0900
X-CMS-MailID: 20210524084514epcms2p74d8419501f48e063b2aa8f80347a61ae
...
X-CPGSPASS: Y
CMS-TYPE: 102P
X-Brightmail-Tracker: 
        dYziX+pDNfR9BAAA
DLP-Filter: Pass
...
index e289b4905543..20cdaf0441a6 100644
--- a/drivers/scsi/ufs/ufshcd.c
+++ b/drivers/scsi/ufs/ufshcd.c
@@ -5066,6 +5066,9 @@ ufshcd_transfer_rsp_status(struct ufs_hba *hba, struct ufshcd_lrb *lrbp)
...
@@ -9316,6 +9319,7 @@ void ufshcd_remove(struct ufs_hba *hba)
...
index 6f7887126d22..5f01b0e56477 100644
...
@@ -237,11 +1133,47 @@ static int ufshpb_lu_hpb_init(struct ufs_hba *hba, struct ufshpb_lu *hpb)
 {
 	int ret;
...
@@ -273,6 +1205,33 @@ ufshpb_alloc_hpb_lu(struct ufs_hba *hba, int lun,
 	return NULL;
 }
...
+
 ...
 {
 	int err = 0;
@@ -316,7 +1275,7 @@ void ufshpb_reset(struct ufs_hba *hba)
 	struct scsi_device *sdev;
...
@@ -333,13 +1292,15 @@ void ufshpb_reset_host(struct ufs_hba *hba)
 	struct scsi_device *sdev;
...
@@ -349,13 +1310,14 @@ void ufshpb_suspend(struct ufs_hba *hba)
 	struct scsi_device *sdev;
...
@@ -365,7 +1327,7 @@ void ufshpb_resume(struct ufs_hba *hba)
 	struct scsi_device *sdev;
...
@@ -373,6 +1335,7 @@ void ufshpb_resume(struct ufs_hba *hba)
 		    (ufshpb_get_state(hpb) != HPB_SUSPEND))
 			continue;
...
@@ -425,7 +1388,7 @@ static int ufshpb_get_lu_info(struct ufs_hba *hba, int lun,
...
+	struct ufshpb_lu *hpb = ufshpb_get_hpb_data(sdev);
 	...
 	if (!hpb)
 		return;
@@ -435,8 +1398,13 @@ void ufshpb_destroy_lu(struct ufs_hba *hba, struct scsi_device *sdev)
...
+
 	...
 	kfree(hpb);
@@ -444,24 +1412,41 @@ void ufshpb_destroy_lu(struct ufs_hba *hba, struct scsi_device *sdev)
...
@@ -483,6 +1468,9 @@ void ufshpb_init_hpb_lu(struct ufs_hba *hba, struct scsi_device *sdev)
 	if (!hpb)
 		goto out;
...
@@ -492,6 +1480,57 @@ void ufshpb_init_hpb_lu(struct ufs_hba *hba, struct scsi_device *sdev)
...
@@ -556,7 +1595,13 @@ void ufshpb_init(struct ufs_hba *hba)
...
@@ -565,3 +1610,16 @@ void ufshpb_init(struct ufs_hba *hba)
 			break;
 	}
 }
+
