...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id ADCE54202CA
	for <lists+linux-scsi@lfdr.de>; Sun,  3 Oct 2021 18:37:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231296AbhJCQj2 (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 3 Oct 2021 12:39:28 -0400
Received: from smtp.infotech.no ([82.134.31.41]:55227 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231289AbhJCQj0 (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 3 Oct 2021 12:39:26 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 419B42041BB;
        Sun,  3 Oct 2021 18:37:36 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id DcjN8mVYQFsM; Sun,  3 Oct 2021 18:37:32 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-23-91-187-47.dyn.295.ca [23.91.187.47])
        by smtp.infotech.no (Postfix) with ESMTPA id B88B62041D7;
        Sun,  3 Oct 2021 18:35:23 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        Damien.LeMoal@wdc.com
Subject: [PATCH v21 19/46] sg: introduce request state machine
Date:   Sun,  3 Oct 2021 12:31:24 -0400
Message-Id: <20211003163151.585349-20-dgilbert@interlog.com>
...
index bb2632e46904..00b3950e76a9 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
-	u8 cmnd[SG_MAX_CDB_SIZE];
 	...
 	if (res)
@@ -747,10 +779,25 @@ sg_common_write(struct sg_fd *sfp, struct sg_comm_wr_t *cwrp)
 	return 0;
 }
...
@@ -785,6 +832,32 @@ srp_done(struct sg_fd *sfp, struct sg_request *srp)
 	return ret;
 }
...
+
 ...
 sg_receive_v3(struct sg_fd *sfp, char __user *buf, size_t count,
 	      struct sg_request *srp)
@@ -1314,7 +1387,7 @@ sg_ioctl_common(struct file *filp, struct sg_device *sdp, struct sg_fd *sfp,
 	case SG_GET_LOW_DMA:
...
+	case SG_NEXT_CMD_LEN:	/* active only in v2 interface */
 		...
 		if (result)
@@ -2205,48 +2278,37 @@ sg_remove_sgat(struct sg_fd *sfp, struct sg_scatter_hold *schp)
 static int
...
+	return res;
 ...
 static void
@@ -2295,6 +2357,22 @@ sg_unlink_reserve(struct sg_fd *sfp, struct sg_request *srp)
 	sfp->res_in_use = 0;
 }
...
@@ -2326,23 +2404,21 @@ sg_setup_req(struct sg_fd *sfp)
 	return NULL;
 }
...
-	return res;
 ...
 static struct sg_fd *
@@ -2400,6 +2476,15 @@ sg_add_sfp(struct sg_device *sdp)
 	return sfp;
 }
...
+ */
 ...
 {
@@ -2493,6 +2578,33 @@ sg_get_dev(int dev)
 	return sdp;
 }
...
@@ -2788,8 +2900,9 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
