...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AA0BE36C0E1
	for <lists+linux-scsi@lfdr.de>; Tue, 27 Apr 2021 10:31:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235210AbhD0IcE (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 27 Apr 2021 04:32:04 -0400
Received: from mx2.suse.de ([195.135.220.15]:49440 "EHLO mx2.suse.de"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S235133AbhD0Ibv (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Tue, 27 Apr 2021 04:31:51 -0400
X-Virus-Scanned: by amavisd-new at test-mx.suse.de
Received: from relay2.suse.de (unknown [195.135.221.27])
        by mx2.suse.de (Postfix) with ESMTP id 48AF8B020;
...
Subject: [PATCH 09/40] scsi: Kill DRIVER_SENSE
Date:   Tue, 27 Apr 2021 10:30:15 +0200
Message-Id: <20210427083046.31620-10-hare@suse.de>
...
to sg.h, and update sg, bsg, and scsi_ioctl to set the DRIVER_SENSE
...
---
 ...
 include/scsi/sg.h                           | 11 +++++++
 35 files changed, 76 insertions(+), 115 deletions(-)

diff --git a/block/bsg.c b/block/bsg.c
index bd10922d5cbb..9e6ff0d71d25 100644
--- a/block/bsg.c
+++ b/block/bsg.c
...
index 99d58786e0d5..b6b3541c6406 100644
...
index c3f965cf4d0a..612decaccfb5 100644
...
@@ -2194,8 +2192,7 @@ scsi_mode_sense(struct scsi_device *sdev, int dbd, int modepage,
...
+		if (scsi_sense_valid(sshdr)) {
 			if ((sshdr->sense_key == ILLEGAL_REQUEST) &&
 				...
 				/*
@@ -3278,7 +3275,6 @@ EXPORT_SYMBOL(scsi_vpd_tpg_id);
...
index 737cea9d908e..6b7d5f03fb2b 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
index 7327e12f3373..6e52b71b52a0 100644
--- a/include/scsi/sg.h
+++ b/include/scsi/sg.h
