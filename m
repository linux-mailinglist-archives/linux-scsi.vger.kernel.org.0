...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A9046CF449
	for <lists+linux-scsi@lfdr.de>; Tue,  8 Oct 2019 09:50:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730459AbfJHHug (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 8 Oct 2019 03:50:36 -0400
Received: from smtp.infotech.no ([82.134.31.41]:34831 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730439AbfJHHud (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Tue, 8 Oct 2019 03:50:33 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id A3F0B204238;
        Tue,  8 Oct 2019 09:50:24 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id IAMM6aFOh8Au; Tue,  8 Oct 2019 09:50:24 +0200 (CEST)
Received: from xtwo70.bingwo.ca (unknown [82.134.31.172])
        by smtp.infotech.no (Postfix) with ESMTPA id 1BBF1204237;
        Tue,  8 Oct 2019 09:50:24 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v5 22/23] sg: sg_fill_request_element
Date:   Tue,  8 Oct 2019 09:50:21 +0200
Message-Id: <20191008075022.30055-23-dgilbert@interlog.com>
...
index 7f3a4b937a5a..aaae37ab77ba 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -643,6 +644,18 @@ sg_write(struct file *filp, const char __user *p, size_t count, loff_t *ppos)
...
+
 ...
 sg_fetch_cmnd(struct file *filp, struct sg_fd *sfp, const u8 __user *u_cdbp,
 	      int len, u8 *cdbp)
@@ -664,18 +677,6 @@ sg_fetch_cmnd(struct file *filp, struct sg_fd *sfp, const u8 __user *u_cdbp,
 	return 0;
 }
...
@@ -897,6 +898,11 @@ sg_rec_v3_state(struct sg_fd *sfp, struct sg_request *srp)
 	return err;
 }
...
@@ -1339,7 +1343,7 @@ sg_ioctl(struct file *filp, unsigned int cmd_in, unsigned long arg)
 			return result;
...
+	case SG_GET_PACK_ID:    /* or tag of oldest "read"-able, -1 if none */
 		...
 		spin_lock_irqsave(&sfp->rq_list_lock, iflags);
 		list_for_each_entry(srp, &sfp->rq_list, entry) {
@@ -1703,6 +1707,39 @@ sg_rq_end_io_usercontext(struct work_struct *work)
...
+	int done = 1;
 	...
 	if (WARN_ON(srp->done != 0))
 		return;
@@ -1730,44 +1767,22 @@ sg_rq_end_io(struct request *rq, blk_status_t status)
...
+
 ...
 {
@@ -2177,15 +2209,8 @@ sg_start_req(struct sg_request *srp, u8 *cmd)
 		}
