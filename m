...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 292C036C0E2
	for <lists+linux-scsi@lfdr.de>; Tue, 27 Apr 2021 10:31:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235211AbhD0IcE (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 27 Apr 2021 04:32:04 -0400
Received: from mx2.suse.de ([195.135.220.15]:49444 "EHLO mx2.suse.de"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S235145AbhD0Ibv (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Tue, 27 Apr 2021 04:31:51 -0400
X-Virus-Scanned: by amavisd-new at test-mx.suse.de
Received: from relay2.suse.de (unknown [195.135.221.27])
        by mx2.suse.de (Postfix) with ESMTP id 4DE1AB023;
...
Subject: [PATCH 14/40] scsi: Drop the now obsolete driver_byte definitions
Date:   Tue, 27 Apr 2021 10:30:20 +0200
Message-Id: <20210427083046.31620-15-hare@suse.de>
...
index b6b3541c6406..4dd61e36ee29 100644
...
index 2c2d59251ef1..59c5e729f40c 100644
--- a/include/scsi/scsi.h
+++ b/include/scsi/scsi.h
@@ -181,20 +181,6 @@ static inline int scsi_is_wlun(u64 lun)
...
-
  ...
  */
@@ -226,12 +212,10 @@ enum scsi_disposition {
...
index 6e52b71b52a0..f6b18591ed9d 100644
--- a/include/scsi/sg.h
+++ b/include/scsi/sg.h
