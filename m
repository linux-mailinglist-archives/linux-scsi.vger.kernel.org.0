Return-Path: <linux-scsi+bounces-7439-lists+linux-scsi=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-scsi@lfdr.de
Delivered-To: lists+linux-scsi@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id BCC839552DF
	for <lists+linux-scsi@lfdr.de>; Fri, 16 Aug 2024 23:58:15 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 3DE641F228E5
	for <lists+linux-scsi@lfdr.de>; Fri, 16 Aug 2024 21:58:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 25D601BC9E7;
	Fri, 16 Aug 2024 21:58:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=acm.org header.i=@acm.org header.b="F4nOxNlC"
X-Original-To: linux-scsi@vger.kernel.org
Received: from 008.lax.mailroute.net (008.lax.mailroute.net [199.89.1.11])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EB6021C5791
	for <linux-scsi@vger.kernel.org>; Fri, 16 Aug 2024 21:58:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=199.89.1.11
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1723845490; cv=none; b=NDF43Z7Z4d44NehqbhIr40PVUrV73Ngh4EpdFSxOgHRYjkYl++t47QfIgcyNhk6+WJrmxfygrYOR8+xL3QgzifU1XE35z8t6BpGBJgjgLnOgoZaPIamRFrJiDv4X02v/iFatcklo2ZtbUjvU36CaQXnaOZEV4mG59yxxcBLkUZE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1723845490; c=relaxed/simple;
	bh=a9mxduMrPlgormZjtF+Y6/mi/rT7wgoIZ4sTRPV52Gg=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=S/mCfRd+iZeKog/PmzgZ+Ajuy01dfMor955o6h+fPqWBE8OtWkhWDmzr9dmV1aG0xkCN4T3F/yMvK/r0PVfk8eT9gc/Uqx6xYdtpcLu8DILP6JF21hYk/nqDGeaYWtV0HJEckuCHo5rMRc+yD8M89Oj/KSjiI/PWjz8BUtWmQ8E=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=acm.org; spf=pass smtp.mailfrom=acm.org; dkim=pass (2048-bit key) header.d=acm.org header.i=@acm.org header.b=F4nOxNlC; arc=none smtp.client-ip=199.89.1.11
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=acm.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=acm.org
Received: from localhost (localhost [127.0.0.1])
	by 008.lax.mailroute.net (Postfix) with ESMTP id 4Wlwpm470Fz6ClY99;
	Fri, 16 Aug 2024 21:58:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=acm.org; h=
	content-transfer-encoding:mime-version:references:in-reply-to
	:x-mailer:message-id:date:date:subject:subject:from:from
	:received:received; s=mr01; t=1723845398; x=1726437399; bh=1nOn7
	azklsmk/nO9bEs6vLPVL+lCfhCpQ0D+TTHcJLI=; b=F4nOxNlCpAVIf9+YHNzrK
	
X-Virus-Scanned: by MailRoute
Received: from 008.lax.mailroute.net ([127.0.0.1])
 by localhost (008.lax [127.0.0.1]) (mroute_mailscanner, port 10029) with LMTP
 id 1vSwpghandym; Fri, 16 Aug 2024 21:56:38 +0000 (UTC)
Received: from bvanassche.mtv.corp.google.com (unknown [104.135.204.82])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	(Authenticated sender: bvanassche@acm.org)
	by 008.lax.mailroute.net (Postfix) with ESMTPSA id 4Wlwmr6ts0z6ClY95;
	Fri, 16 Aug 2024 21:56:28 +0000 (UTC)
...
Subject: [PATCH v2 01/18] scsi: Expand all create*_workqueue() invocations
Date: Fri, 16 Aug 2024 14:55:24 -0700
Message-ID: <20240816215605.36240-2-bvanassche@acm.org>
...
index 0b3d0c8e0dda..22d5e27485c5 100644
--- a/drivers/ufs/core/ufshcd.c
+++ b/drivers/ufs/core/ufshcd.c
@@ -1800,7 +1800,8 @@ static void ufshcd_init_clk_scaling(struct ufs_hba =
*hba)
=20
...
@@ -10460,7 +10461,7 @@ int ufshcd_init(struct ufs_hba *hba, void __iomem=
