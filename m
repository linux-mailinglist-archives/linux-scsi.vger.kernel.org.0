Return-Path: <linux-scsi+bounces-653-lists+linux-scsi=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-scsi@lfdr.de
Delivered-To: lists+linux-scsi@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 71CCB807807
	for <lists+linux-scsi@lfdr.de>; Wed,  6 Dec 2023 19:49:04 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id A740F2820FE
	for <lists+linux-scsi@lfdr.de>; Wed,  6 Dec 2023 18:49:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 585456EB5A
	for <lists+linux-scsi@lfdr.de>; Wed,  6 Dec 2023 18:49:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=cisco.com header.i=@cisco.com header.b="ePoSdf+D"
X-Original-To: linux-scsi@vger.kernel.org
Received: from rcdn-iport-8.cisco.com (rcdn-iport-8.cisco.com [173.37.86.79])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8AB8ED50;
	Wed,  6 Dec 2023 10:46:39 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=cisco.com; i=@cisco.com; l=6820; q=dns/txt; s=iport;
  t=1701888400; x=1703098000;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=/bNrQe+R5gfKa+rzSY7t7bgs+bqaIH20xQN+CrRI7pQ=;
  b=ePoSdf+DzGJdMZwTMCCXxmKKRb9E7lOztDVa2Rwe1UomnlOmXrr9oCTv
   EIN3mbpKPuvh7sM3P+xuYlgIzqLVa9l7GxAMZLDIbjCTnQCz600qZVbqP
   ODMcGKHr/THnQbLv8b845tP4TpOuVZzcnSdBJ63qmbMj2joO1lseAp8rv
   0=;
X-CSE-ConnectionGUID: Qi/vvIOwRS2NwkjptCRsng==
X-CSE-MsgGUID: scfLOy/CTuC2aw2iimxXdA==
X-IronPort-AV: E=Sophos;i="6.04,256,1695686400"; 
   d="scan'208";a="148079788"
Received: from alln-core-4.cisco.com ([173.36.13.137])
  by rcdn-iport-8.cisco.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 06 Dec 2023 18:46:39 +0000
Received: from localhost.cisco.com ([10.193.101.253])
	(authenticated bits=0)
	by alln-core-4.cisco.com (8.15.2/8.15.2) with ESMTPSA id 3B6IkHD0010013
	(version=TLSv1.2 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=NO);
	Wed, 6 Dec 2023 18:46:38 GMT
...
Subject: [PATCH v5 04/13] scsi: fnic: Rename wq_copy to hw_copy_wq
Date: Wed,  6 Dec 2023 10:46:06 -0800
Message-Id: <20231206184615.878755-5-kartilak@cisco.com>
