...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EFE855E82F0
	for <lists+linux-scsi@lfdr.de>; Fri, 23 Sep 2022 22:12:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231864AbiIWUMH (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Fri, 23 Sep 2022 16:12:07 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37700 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231300AbiIWUMD (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Fri, 23 Sep 2022 16:12:03 -0400
Received: from mail-pf1-f174.google.com (mail-pf1-f174.google.com [209.85.210.174])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1CE441231D6
        for <linux-scsi@vger.kernel.org>; Fri, 23 Sep 2022 13:11:58 -0700 (PDT)
Received: by mail-pf1-f174.google.com with SMTP id 9so1118593pfz.12
        for <linux-scsi@vger.kernel.org>; Fri, 23 Sep 2022 13:11:58 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:references:in-reply-to
         ...
         :subject:date;
        bh=LKgwFeJeRCwxV/zn+hCmpFx9Cia4rClGZ9wRWegi3O0=;
        b=
X-Gm-Message-State: ACrzQf3Boo9nmoX0+h61xXPJRSHR5rek67LMscaI5xTO51D1TYSFwmMr
        43QjW/puGKOzeOWujcm+6JA=
X-Google-Smtp-Source: AMsMyM6AbyW8UwpowYnW2jY3h9hOeRPMHW3JiRkOSVqEpTef/4Hfg6r+a59M6gm9BzMUIb+3o8SaEw==
X-Received: by 2002:a63:4b02:0:b0:43c:1909:d350 with SMTP id y2-20020a634b02000000b0043c1909d350mr7636776pga.188.1663963917472;
        Fri, 23 Sep 2022 13:11:57 -0700 (PDT)
Received: from bvanassche-linux.mtv.corp.google.com ([2620:15c:211:201:aa13:bc38:2a63:318e])
        by smtp.gmail.com with ESMTPSA id b7-20020a170902650700b001754fa42065sm6388435plk.143.2022.09.23.13.11.54
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 23 Sep 2022 13:11:56 -0700 (PDT)
...
Subject: [PATCH 2/8] scsi: core: Change the return type of .eh_timed_out()
Date:   Fri, 23 Sep 2022 13:11:32 -0700
Message-Id: <20220923201138.2113123-3-bvanassche@acm.org>
...
index 6bfb0256b4ce..4d0eba6d4a9d 100644
...
@@ -337,22 +336,26 @@ enum blk_eh_timer_return scsi_timeout(struct request *req)
...
index df4aa4a5f83c..24dcd4ec796e 100644
--- a/drivers/scsi/scsi_transport_fc.c
+++ b/drivers/scsi/scsi_transport_fc.c
@@ -2528,15 +2528,15 @@ static int fc_vport_match(struct attribute_container *cont,
  * Notes:
...
@@ -4060,7 +4060,7 @@ fc_bsg_job_timeout(struct request *req)
