...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CCFDE4202BB
	for <lists+linux-scsi@lfdr.de>; Sun,  3 Oct 2021 18:33:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231255AbhJCQfo (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 3 Oct 2021 12:35:44 -0400
Received: from smtp.infotech.no ([82.134.31.41]:55118 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231239AbhJCQfn (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 3 Oct 2021 12:35:43 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 0E3C82041AF;
        Sun,  3 Oct 2021 18:33:39 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 3i5iy0ahTIok; Sun,  3 Oct 2021 18:33:28 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-23-91-187-47.dyn.295.ca [23.91.187.47])
        by smtp.infotech.no (Postfix) with ESMTPA id 84DFF2041CE;
        Sun,  3 Oct 2021 18:33:14 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        Damien.LeMoal@wdc.com, Hannes Reinecke <hare@suse.com>
Subject: [PATCH v21 07/46] sg: move header to uapi section
Date:   Sun,  3 Oct 2021 12:31:12 -0400
Message-Id: <20211003163151.585349-8-dgilbert@interlog.com>
...
---
 ...
 include/uapi/scsi/sg.h | 364 +++++++++++++++++++++++++++++++++++++++++
 2 files changed, 374 insertions(+), 296 deletions(-)
 create mode 100644 include/uapi/scsi/sg.h

diff --git a/include/scsi/sg.h b/include/scsi/sg.h
index 843cefb8efce..f9fa142bf23a 100644
--- a/include/scsi/sg.h
+++ b/include/scsi/sg.h
@@ -4,71 +4,17 @@
...
@@ -96,242 +42,10 @@ struct compat_sg_io_hdr {
...
index 000000000000..5213d79ecc84
--- /dev/null
