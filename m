...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 567C7369D57
	for <lists+linux-scsi@lfdr.de>; Sat, 24 Apr 2021 01:35:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S244133AbhDWXgH (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Fri, 23 Apr 2021 19:36:07 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49344 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235740AbhDWXfr (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Fri, 23 Apr 2021 19:35:47 -0400
Received: from mail-pf1-x42b.google.com (mail-pf1-x42b.google.com [IPv6:2607:f8b0:4864:20::42b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 213C7C06138D
        for <linux-scsi@vger.kernel.org>; Fri, 23 Apr 2021 16:35:07 -0700 (PDT)
Received: by mail-pf1-x42b.google.com with SMTP id h11so4010259pfn.0
        for <linux-scsi@vger.kernel.org>; Fri, 23 Apr 2021 16:35:07 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=YwcXg1IdKUISCuamUc1bWYWaYUMiOBpDYFcZ7ZIBreU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=YwcXg1IdKUISCuamUc1bWYWaYUMiOBpDYFcZ7ZIBreU=;
        b=
X-Gm-Message-State: AOAM530ibpjpC7v1+La1UvHtxEMXNAWkZG5CqkVWAcAYo8qfN5NF8Rk0
        PokH1eFuxrTs/4qxhbWKtKm91UJbD74=
X-Google-Smtp-Source: ABdhPJxn85uEOgklE0a8SRpNnzyELCAKOKrpAZc94YyzMCGwrMdf0GOZjBs0OkPXWxv+b3CSGDl3vw==
X-Received: by 2002:a63:d748:: with SMTP id w8mr5938969pgi.266.1619220905704;
        Fri, 23 Apr 2021 16:35:05 -0700 (PDT)
...
Subject: [PATCH v8 07/31] elx: libefc_sli: APIs to setup SLI library
Date:   Fri, 23 Apr 2021 16:34:31 -0700
Message-Id: <20210423233455.27243-8-jsmart2021@gmail.com>
...
---
 ...
 drivers/scsi/elx/libefc_sli/sli4.h |  402 ++++++++++
 2 files changed, 1537 insertions(+)

diff --git a/drivers/scsi/elx/libefc_sli/sli4.c b/drivers/scsi/elx/libefc_sli/sli4.c
index 2c57f5e5613d..c2215111eead 100644
--- a/drivers/scsi/elx/libefc_sli/sli4.c
+++ b/drivers/scsi/elx/libefc_sli/sli4.c
@@ -4033,3 +4033,1138 @@ sli_cqe_async(struct sli4 *sli4, void *buf)
...
index 540569cdb84d..0d9157c0755a 100644
--- a/drivers/scsi/elx/libefc_sli/sli4.h
+++ b/drivers/scsi/elx/libefc_sli/sli4.h
@@ -3728,4 +3728,406 @@ sli_cmd_fill_hdr(struct sli4_rqst_hdr *hdr, u8 opc, u8 sub, u32 ver, __le32 len)
