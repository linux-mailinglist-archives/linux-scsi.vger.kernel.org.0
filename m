...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DB9A338DE97
	for <lists+linux-scsi@lfdr.de>; Mon, 24 May 2021 03:02:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232176AbhEXBDc (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 23 May 2021 21:03:32 -0400
Received: from smtp.infotech.no ([82.134.31.41]:33102 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232130AbhEXBDa (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 23 May 2021 21:03:30 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id A6809204269;
        Mon, 24 May 2021 03:02:00 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id IeqQ04GgsMm3; Mon, 24 May 2021 03:01:58 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-45-58-219-4.dyn.295.ca [45.58.219.4])
        by smtp.infotech.no (Postfix) with ESMTPA id C159820426F;
        Mon, 24 May 2021 03:01:53 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        Hannes Reinecke <hare@suse.com>
Subject: [PATCH v19 03/45] sg: sg_log and is_enabled
Date:   Sun, 23 May 2021 21:01:05 -0400
Message-Id: <20210524010147.94845-4-dgilbert@interlog.com>
...
index e26284512544..33fd280dc5da 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
+	       (rw ? "OUT" : "IN"));
 	...
 	/*
 	 * NOTE
@@ -1927,9 +1948,8 @@ sg_finish_rem_req(struct sg_request *srp)
...
@@ -1975,9 +1995,8 @@ sg_build_indirect(struct sg_scatter_hold *schp, struct sg_fd *sfp,
...
@@ -2013,18 +2032,13 @@ sg_build_indirect(struct sg_scatter_hold *schp, struct sg_fd *sfp,
...
+	SG_LOG(5, sfp, "%s: k_use_sg=%d, order=%d\n", __func__, k, order);
 	...
 	if (rem_sz > 0)	/* must have failed */
 		return -ENOMEM;
@@ -2042,35 +2056,34 @@ sg_build_indirect(struct sg_scatter_hold *schp, struct sg_fd *sfp,
 static void
...
@@ -2100,8 +2113,7 @@ sg_build_reserve(struct sg_fd *sfp, int req_size)
 {
...
+	SG_LOG(3, sfp, "%s: buflen=%d\n", __func__, req_size);
 	do {
 		if (req_size < PAGE_SIZE)
 			req_size = PAGE_SIZE;
@@ -2121,8 +2133,7 @@ sg_link_reserve(struct sg_fd *sfp, struct sg_request *srp, int size)
 	int k, num, rem;
...
@@ -2140,8 +2151,7 @@ sg_link_reserve(struct sg_fd *sfp, struct sg_request *srp, int size)
 	}
...
@@ -2150,9 +2160,8 @@ sg_unlink_reserve(struct sg_fd *sfp, struct sg_request *srp)
 {
 	struct sg_scatter_hold *req_schp = &srp->data;
...
+	       (int)req_schp->k_use_sg);
 	...
 	req_schp->bufflen = 0;
 	req_schp->pages = NULL;
@@ -2243,18 +2252,15 @@ sg_add_sfp(struct sg_device *sdp)
 	}
...
@@ -2280,15 +2286,12 @@ sg_remove_sfp_usercontext(struct work_struct *work)
...
@@ -2311,7 +2314,6 @@ sg_remove_sfp(struct kref *kref)
...
-#ifdef CONFIG_SCSI_PROC_FS
 ...
 {
@@ -2323,19 +2325,6 @@ sg_idr_max_id(int id, void *p, void *data)
 	return 0;
 }
...
@@ -2365,7 +2354,7 @@ sg_get_dev(int dev)
 	return sdp;
 }
...
@@ -2438,6 +2427,17 @@ sg_proc_init(void)
 	return 0;
 }
...
@@ -2695,7 +2695,7 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 	return 0;
 }
