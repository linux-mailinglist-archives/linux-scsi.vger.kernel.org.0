...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 17DD628EAC4
	for <lists+linux-scsi@lfdr.de>; Thu, 15 Oct 2020 04:07:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729062AbgJOCHF (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Wed, 14 Oct 2020 22:07:05 -0400
Received: from smtp.infotech.no ([82.134.31.41]:40089 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728050AbgJOCHC (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Wed, 14 Oct 2020 22:07:02 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 4114920414F;
        Thu, 15 Oct 2020 04:07:01 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id Wf1485cMQqiZ; Thu, 15 Oct 2020 04:06:59 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-104-157-204-209.dyn.295.ca [104.157.204.209])
        by smtp.infotech.no (Postfix) with ESMTPA id C7F1B204247;
        Thu, 15 Oct 2020 04:06:54 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de
Subject: [PATCH v11 09/44] sg: sg_allow_if_err_recovery and renames
Date:   Wed, 14 Oct 2020 22:06:08 -0400
Message-Id: <20201015020643.432908-10-dgilbert@interlog.com>
...
index 0ace3e2e464a..131fec52df29 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
@@ -1940,7 +1960,7 @@ sg_start_req(struct sg_request *srp, u8 *cmd)
 }
...
@@ -2085,7 +2105,7 @@ sg_remove_scat(struct sg_fd *sfp, struct sg_scatter_hold *schp)
...
+sg_rd_append(struct sg_request *srp, void __user *outp, int num_xfer)
 {
 	...
 	int k, num;
@@ -2288,7 +2308,7 @@ sg_remove_sfp_usercontext(struct work_struct *work)
...
@@ -2366,7 +2386,7 @@ sg_get_dev(int dev)
...
@@ -2377,7 +2397,7 @@ static const struct proc_ops adio_proc_ops = {
...
@@ -2426,13 +2446,13 @@ sg_proc_init(void)
 	if (!p)
 		return 1;
...
@@ -2456,9 +2476,9 @@ sg_proc_seq_show_int(struct seq_file *s, void *v)
 }
...
+	return single_open(filp, sg_proc_seq_show_int, &sg_allow_dio);
 ...
 static ssize_t 
@@ -2478,9 +2498,9 @@ sg_proc_write_adio(struct file *filp, const char __user *buffer,
 }
...
+	return single_open(filp, sg_proc_seq_show_int, &sg_big_buff);
 ...
 static ssize_t 
@@ -2542,7 +2562,7 @@ dev_seq_start(struct seq_file *s, loff_t *pos)
 static void *
...
@@ -2557,7 +2577,7 @@ dev_seq_stop(struct seq_file *s, void *v)
 static int
...
@@ -2583,7 +2603,7 @@ sg_proc_seq_show_dev(struct seq_file *s, void *v)
 static int
...
+	struct sg_proc_deviter *it = (struct sg_proc_deviter *)v;
 	...
 	struct scsi_device *scsidp;
 	unsigned long iflags;
@@ -2671,7 +2691,7 @@ sg_proc_debug_helper(struct seq_file *s, struct sg_device *sdp)
 static int
