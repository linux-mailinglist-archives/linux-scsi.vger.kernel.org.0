...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id F12F84202BA
	for <lists+linux-scsi@lfdr.de>; Sun,  3 Oct 2021 18:33:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231252AbhJCQfn (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Sun, 3 Oct 2021 12:35:43 -0400
Received: from smtp.infotech.no ([82.134.31.41]:55127 "EHLO smtp.infotech.no"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231248AbhJCQfm (ORCPT <rfc822;linux-scsi@vger.kernel.org>);
        Sun, 3 Oct 2021 12:35:42 -0400
Received: from localhost (localhost [127.0.0.1])
        by smtp.infotech.no (Postfix) with ESMTP id 0BE562041AC;
        Sun,  3 Oct 2021 18:33:39 +0200 (CEST)
X-Virus-Scanned: by amavisd-new-2.6.6 (20110518) (Debian) at infotech.no
Received: from smtp.infotech.no ([127.0.0.1])
        by localhost (smtp.infotech.no [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id KFe1DBVQS4TA; Sun,  3 Oct 2021 18:33:28 +0200 (CEST)
Received: from xtwo70.bingwo.ca (host-23-91-187-47.dyn.295.ca [23.91.187.47])
        by smtp.infotech.no (Postfix) with ESMTPA id D4D2A2041C0;
        Sun,  3 Oct 2021 18:32:45 +0200 (CEST)
From:   Douglas Gilbert <dgilbert@interlog.com>
To:     linux-scsi@vger.kernel.org
Cc:     martin.petersen@oracle.com, jejb@linux.vnet.ibm.com, hare@suse.de,
        Damien.LeMoal@wdc.com, Hannes Reinecke <hare@suse.com>
Subject: [PATCH v21 06/46] sg: make open count an atomic
Date:   Sun,  3 Oct 2021 12:31:11 -0400
Message-Id: <20211003163151.585349-7-dgilbert@interlog.com>
...
index 0f743ed8a720..af64f7c65f8c 100644
--- a/drivers/scsi/sg.c
+++ b/drivers/scsi/sg.c
...
+	else if (atomic_read(&sdp->open_cnt) == 0)
 	...
 	mutex_unlock(&sdp->open_rel_lock);
 	return 0;
@@ -1114,7 +1116,7 @@ sg_ioctl_common(struct file *filp, struct sg_device *sdp, struct sg_fd *sfp,
...
+		return put_user(sdp->max_sgat_elems, ip);
 	case SG_SET_RESERVED_SIZE:
 		...
 		if (result)
@@ -1565,7 +1567,7 @@ sg_alloc(struct scsi_device *scsidp)
...
+	sdp->max_sgat_elems = queue_max_segments(q);
 	...
 	kref_init(&sdp->d_ref);
 	error = 0;
@@ -1950,7 +1952,7 @@ sg_build_indirect(struct sg_scatter_hold *schp, struct sg_fd *sfp,
 		  int buff_size)
 {
...
@@ -1964,7 +1966,7 @@ sg_build_indirect(struct sg_scatter_hold *schp, struct sg_fd *sfp,
 	       blk_size);
...
@@ -2648,9 +2650,9 @@ sg_proc_seq_show_debug(struct seq_file *s, void *v)
 				   scsidp->lun,
