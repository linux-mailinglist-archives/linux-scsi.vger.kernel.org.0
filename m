...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DC38039737B
	for <lists+linux-scsi@lfdr.de>; Tue,  1 Jun 2021 14:47:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233856AbhFAMsn (ORCPT <rfc822;lists+linux-scsi@lfdr.de>);
        Tue, 1 Jun 2021 08:48:43 -0400
Received: from smtp-out1.suse.de ([195.135.220.28]:40228 "EHLO
        smtp-out1.suse.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233758AbhFAMsm (ORCPT
        <rfc822;linux-scsi@vger.kernel.org>); Tue, 1 Jun 2021 08:48:42 -0400
Received: from imap.suse.de (imap-alt.suse-dmz.suse.de [192.168.254.47])
        (using TLSv1.2 with cipher ECDHE-ECDSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by smtp-out1.suse.de (Postfix) with ESMTPS id CF06A21919;
        Tue,  1 Jun 2021 12:47:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        t=1622551620; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=N0QvOaCcMPLagxp2LJHWDiEWoRm4GW+APCPJoRTajtw=;
        b=SJh6z7Yn484LS40jQdtdjWAMe2nktBoxbRm9/Vm+LQ+Ixqj21xUVx7dfYNX/mniv/WfcJz
        78xE94o/tvaSQMfPycdnRAqbk8WQkKojgWJdloVKupKgMePhrK+YUx+DipZffl58Mi7SYC
        bhGCBxN5k/10LeK/cW1uUiHi6CpbxtI=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        s=susede2_ed25519; t=1622551620;
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=N0QvOaCcMPLagxp2LJHWDiEWoRm4GW+APCPJoRTajtw=;
        b=k7xuYw+sqW7FWZyJ5Ck5CNu4NMFk55/ta41AGajzhRjHjvwaaC7OX2YIC0Nw8+pU4ZU2GB
        0y282WNtDuJjn5Bw==
Received: from imap3-int (imap-alt.suse-dmz.suse.de [192.168.254.47])
        by imap.suse.de (Postfix) with ESMTP id B03E2118DD;
        Tue,  1 Jun 2021 12:47:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        t=1622551620; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
...
Received: from director2.suse.de ([192.168.254.72])
        ...
        id YJGeKkQstmBvZQAALh3uQQ
        (envelope-from <hare@suse.de>); Tue, 01 Jun 2021 12:47:00 +0000
...
Subject: Re: [PATCH v2 03/10] qla2xxx: Add send, receive and accept for
 auth_els
Message-ID: <b0904ae4-22a0-b7b8-2860-7725885135cf@suse.de>
Date:   Tue, 1 Jun 2021 14:47:00 +0200
...
The whole point of 'list_for_each_safe()' is that you don't need to
protect against deletion of the entries.
Having to drop the lock here will (slightly) defeat it's purpose.
Also there's nothing in qla_enode_free() which would require the lock to
be dropped.
So please consider either not dropping the lock here or (maybe) move to
implicit list unrolling like
...
If the node is on a list it's 'list_head' structure should be pointing
to a list, ie it should be possible to do a 'list_empty()' to get this
information, no?
